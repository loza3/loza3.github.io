define(['dart_sdk', 'packages/path/src/path_set.dart', 'packages/collection/src/functions.dart', 'packages/term_glyph/src/generated/top_level.dart'], (function load__packages__source_span__src__location_mixin_dart(dart_sdk, packages__path__src__path_set$46dart, packages__collection__src__functions$46dart, packages__term_glyph__src__generated__top_level$46dart) {
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/.pub-cache/hosted/pub.dartlang.org/source_span-1.9.0/lib/src/highlighter.dart",
  ...
  location_mixin.SourceLocationMixin = class SourceLocationMixin extends core.Object {
    ...
    get hashCode() {
      let t0, t0$;
      return dart.notNull((t0$ = (t0 = this.sourceUrl, t0 == null ? null : dart.hashCode(t0)), t0$ == null ? 0 : t0$)) + this.offset;
    }
    toString() {
  ...
  dart.setLibraryUri(span_with_context.SourceSpanWithContext, I[3]);
  ...
  highlighter.Highlighter = class Highlighter extends core.Object {
    ...
    static _collateLines(highlights) {
      let highlightsByUrl = functions.groupBy(highlighter._Highlight, core.Object, highlights, dart.fn(highlight => {
        let t3;
        t3 = highlight.span.sourceUrl;
        return t3 == null ? new core.Object.new() : t3;
    ...
    [_writeMultilineHighlights](line, highlightsByColumn, opts) {
      ...
      for (let highlight of highlightsByColumn) {
        let startLine = (t3 = highlight, t3 == null ? null : t3.span.start.line);
        let endLine = (t3$ = highlight, t3$ == null ? null : t3$.span.end.line);
    ...
    [_writeUnderline](line, span, character) {
      let t3;
      if (!!utils.isMultiline(span)) dart.assertFailed(null, I[4], 414, 12, "!isMultiline(span)");
      if (!line.text[$contains](span.text)) dart.assertFailed("\"" + line.text + "\" should contain \"" + span.text + "\"", I[4], 415, 12, "line.text.contains(span.text)");
      ...
      t3 = this[_buffer];
      (() => {
        t3.write(" "[$times](startColumn));
        t3.write(character[$times](math.max(core.int, endColumn - startColumn, 1)));
        return t3;
      })();
    }
    [_writeArrow](line, column, opts) {
      ...
      t3 = this[_buffer];
      (() => {
        t3.write(top_level.horizontalLine[$times](1 + column + tabs * (4 - 1)));
        t3.write("^");
        return t3;
      })();
    }
    ...
    [_writeSidebar](opts) {
      ...
      if (!(line == null || text == null)) dart.assertFailed(null, I[4], 468, 12, "line == null || text == null");
      if (line != null) text = (dart.notNull(line) + 1)[$toString]();
      this[_colorize](dart.fn(() => {
        let t4, t4$, t3;
        t3 = this[_buffer];
        (() => {
          t3.write((t4 = text, t4 == null ? "" : t4)[$padRight](this[_paddingBeforeSidebar]));
          t3.write((t4$ = end, t4$ == null ? top_level.verticalLine : t4$));
          return t3;
        })();
  ...
  (highlighter.Highlighter.multiple = function(primarySpan, primaryLabel, secondarySpans, opts) {
    ...
    highlighter.Highlighter.__.call(this, highlighter.Highlighter._collateLines((() => {
      let t2 = T.JSArrayOf_Highlight().of([new highlighter._Highlight.new(primarySpan, {label: primaryLabel, primary: true})]);
      for (let entry of secondarySpans[$entries])
        t2.push(new highlighter._Highlight.new(entry.key, {label: entry.value}));
      return t2;
    })()), color ? (t3 = primaryColor, t3 == null ? "[31m" : t3) : null, color ? (t3$ = secondaryColor, t3$ == null ? "[34m" : t3$) : null);
  }).prototype = highlighter.Highlighter.prototype;
  ...
  span['SourceSpanExtension|messageMultiple'] = function SourceSpanExtension$124messageMultiple($this, message, label, secondarySpans, opts) {
    ...
    let buffer = (t4 = new core.StringBuffer.new(), (() => {
      t4.write("line " + dart.str($this.start.line + 1) + ", column " + dart.str($this.start.column + 1));
      return t4;
    })());
    if ($this.sourceUrl != null) buffer.write(" of " + path.prettyUri($this.sourceUrl));
    t4$ = buffer;
    (() => {
      t4$.writeln(": " + message);
      t4$.write(span['SourceSpanExtension|highlightMultiple']($this, label, secondarySpans, {color: color, primaryColor: primaryColor, secondaryColor: secondaryColor}));
      return t4$;
    })();
    return buffer.toString();
  };
  ...
  (location.SourceLocation.new = function(offset, opts) {
    ...
    this[line$] = (t9 = line, t9 == null ? 0 : t9);
    this[column$] = (t9$ = column, t9$ == null ? offset : t9$);
    if (this.offset < 0) {
  ...
  dart.setLibraryUri(location.SourceLocation, I[6]);
  ...
  dart.setLibraryUri(location.SourceLocationBase, I[6]);
