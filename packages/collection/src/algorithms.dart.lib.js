define(['dart_sdk', 'packages/collection/src/utils.dart'], (function load__packages__collection__src__algorithms_dart(dart_sdk, packages__collection__src__utils$46dart) {
  ...
  var I = ["file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/.pub-cache/hosted/pub.dartlang.org/collection-1.16.0/lib/src/algorithms.dart"];
  ...
  algorithms._merge = function _merge(E, K, keyOf, compare, firstList, firstStart, firstEnd, secondList, secondStart, secondEnd, target, targetOffset) {
    ...
    if (!(firstStart < firstEnd)) dart.assertFailed(null, I[0], 361, 10, "firstStart < firstEnd");
    if (!(secondStart < secondEnd)) dart.assertFailed(null, I[0], 362, 10, "secondStart < secondEnd");
