define(['dart_sdk'], (function load__packages__flare_flutter__base__block_types_dart(dart_sdk) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  var block_types = Object.create(dart.library);
  ...
  dart.addTypeCaches(block_types.BlockTypes);
  dart.setLibraryUri(block_types.BlockTypes, I[0]);
  dart.setStaticFieldSignature(block_types.BlockTypes, () => ['unknown', 'components', 'actorNode', 'actorBone', 'actorRootBone', 'actorImage', 'view', 'animation', 'animations', 'atlases', 'atlas', 'actorIKTarget', 'actorEvent', 'customIntProperty', 'customFloatProperty', 'customStringProperty', 'customBooleanProperty', 'actorColliderRectangle', 'actorColliderTriangle', 'actorColliderCircle', 'actorColliderPolygon', 'actorColliderLine', 'actorImageSequence', 'actorNodeSolo', 'jellyComponent', 'actorJellyBone', 'actorIKConstraint', 'actorDistanceConstraint', 'actorTranslationConstraint', 'actorRotationConstraint', 'actorScaleConstraint', 'actorTransformConstraint', 'actorShape', 'actorPath', 'colorFill', 'colorStroke', 'gradientFill', 'gradientStroke', 'radialGradientFill', 'radialGradientStroke', 'actorEllipse', 'actorRectangle', 'actorTriangle', 'actorStar', 'actorPolygon', 'actorSkin', 'actorArtboard', 'artboards', 'actorLayerEffectRenderer', 'actorMask', 'actorBlur', 'actorDropShadow', 'actorInnerShadow']);
  dart.defineLazy(block_types.BlockTypes, {
    ...
    /*block_types.BlockTypes.actorLayerEffectRenderer*/get actorLayerEffectRenderer() {
      return 116;
    },
    /*block_types.BlockTypes.actorMask*/get actorMask() {
      return 117;
    },
    /*block_types.BlockTypes.actorBlur*/get actorBlur() {
      return 118;
    },
    /*block_types.BlockTypes.actorDropShadow*/get actorDropShadow() {
      return 119;
    },
    /*block_types.BlockTypes.actorInnerShadow*/get actorInnerShadow() {
      return 120;
    }
  }, false);
  ...
  dart.trackLibraries("packages/flare_flutter/base/block_types.dart", {
    "package:flare_flutter/base/block_types.dart": block_types
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["block_types.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;EA4GA;;;;;;MArDmB,8BAAO;;;MACP,iCAAU;;;MACV,gCAAS;;;MACT,gCAAS;;;MACT,oCAAa;;;MACb,iCAAU;;;MACV,2BAAI;;;MACJ,gCAAS;;;MACT,iCAAU;;;MACV,8BAAO;;;MACP,4BAAK;;;MACL,oCAAa;;;MACb,iCAAU;;;MACV,wCAAiB;;;MACjB,0CAAmB;;;MACnB,2CAAoB;;;MACpB,4CAAqB;;;MACrB,6CAAsB;;;MACtB,4CAAqB;;;MACrB,0CAAmB;;;MACnB,2CAAoB;;;MACpB,wCAAiB;;;MACjB,yCAAkB;;;MAClB,oCAAa;;;MACb,qCAAc;;;MACd,qCAAc;;;MACd,wCAAiB;;;MACjB,8CAAuB;;;MACvB,iDAA0B;;;MAC1B,8CAAuB;;;MACvB,2CAAoB;;;MACpB,+CAAwB;;;MACxB,iCAAU;;;MACV,gCAAS;;;MACT,gCAAS;;;MACT,kCAAW;;;MACX,mCAAY;;;MACZ,qCAAc;;;MACd,yCAAkB;;;MAClB,2CAAoB;;;MACpB,mCAAY;;;MACZ,qCAAc;;;MACd,oCAAa;;;MACb,gCAAS;;;MACT,mCAAY;;;MACZ,gCAAS;;;MACT,oCAAa;;;MACb,gCAAS;;;MACT,+CAAwB;;;MACxB,gCAAS;;;MACT,gCAAS;;;MACT,sCAAe;;;MACf,uCAAgB;;;;;MA3GZ,yBAAa","file":"../../../../../../../../../../../packages/flare_flutter/base/block_types.dart.lib.js"}');
  // Exports:
  return {
    base__block_types: block_types
  };
}));

//# sourceMappingURL=block_types.dart.lib.js.map
