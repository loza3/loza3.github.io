define(['dart_sdk', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/services/text_editing_delta.dart'], (function load__packages__flutter__src__services__system_chrome_dart(dart_sdk, packages__flutter__src__foundation__object$46dart, packages__flutter__src__services__text_editing_delta$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C[0] = dart.constList([C[1] || CT.C1, C[2] || CT.C2, C[3] || CT.C3, C[4] || CT.C4], system_chrome.DeviceOrientation);
    },
    get C6() {
    ...
    get C5() {
      return C[5] = dart.constList([C[6] || CT.C6, C[7] || CT.C7], system_chrome.SystemUiOverlay);
    },
    get C9() {
    ...
    get C8() {
      return C[8] = dart.constList([C[9] || CT.C9, C[10] || CT.C10, C[11] || CT.C11, C[12] || CT.C12, C[13] || CT.C13], system_chrome.SystemUiMode);
    },
    get C15() {
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/services/system_chrome.dart"
  ];
  ...
  system_chrome.SystemUiOverlayStyle = class SystemUiOverlayStyle extends core.Object {
    ...
    [_toMap]() {
      ...
      return new (T.IdentityMapOfString$dynamic()).from(["systemNavigationBarColor", (t6 = this.systemNavigationBarColor, t6 == null ? null : t6.value), "systemNavigationBarDividerColor", (t6$ = this.systemNavigationBarDividerColor, t6$ == null ? null : t6$.value), "systemStatusBarContrastEnforced", this.systemStatusBarContrastEnforced, "statusBarColor", (t6$0 = this.statusBarColor, t6$0 == null ? null : t6$0.value), "statusBarBrightness", (t6$1 = this.statusBarBrightness, t6$1 == null ? null : dart.toString(t6$1)), "statusBarIconBrightness", (t6$2 = this.statusBarIconBrightness, t6$2 == null ? null : dart.toString(t6$2)), "systemNavigationBarIconBrightness", (t6$3 = this.systemNavigationBarIconBrightness, t6$3 == null ? null : dart.toString(t6$3)), "systemNavigationBarContrastEnforced", this.systemNavigationBarContrastEnforced]);
    }
    toString() {
    ...
    copyWith(opts) {
      ...
      let systemStatusBarContrastEnforced = opts && 'systemStatusBarContrastEnforced' in opts ? opts.systemStatusBarContrastEnforced : null;
      let systemNavigationBarIconBrightness = opts && 'systemNavigationBarIconBrightness' in opts ? opts.systemNavigationBarIconBrightness : null;
      return new system_chrome.SystemUiOverlayStyle.new({systemNavigationBarColor: (t6 = systemNavigationBarColor, t6 == null ? this.systemNavigationBarColor : t6), systemNavigationBarDividerColor: (t6$ = systemNavigationBarDividerColor, t6$ == null ? this.systemNavigationBarDividerColor : t6$), systemNavigationBarContrastEnforced: (t6$0 = systemNavigationBarContrastEnforced, t6$0 == null ? this.systemNavigationBarContrastEnforced : t6$0), statusBarColor: (t6$1 = statusBarColor, t6$1 == null ? this.statusBarColor : t6$1), statusBarIconBrightness: (t6$2 = statusBarIconBrightness, t6$2 == null ? this.statusBarIconBrightness : t6$2), statusBarBrightness: (t6$3 = statusBarBrightness, t6$3 == null ? this.statusBarBrightness : t6$3), systemStatusBarContrastEnforced: (t6$4 = systemStatusBarContrastEnforced, t6$4 == null ? this.systemStatusBarContrastEnforced : t6$4), systemNavigationBarIconBrightness: (t6$5 = systemNavigationBarIconBrightness, t6$5 == null ? this.systemNavigationBarIconBrightness : t6$5)});
    }
    get hashCode() {
  ...
  system_chrome.SystemChrome = class SystemChrome extends core.Object {
    ...
    static setSystemUIChangeCallback(callback) {
      return async.async(dart.void, function* setSystemUIChangeCallback() {
        ...
        if (callback != null) {
          yield system_channels.SystemChannels.platform.invokeMethod(dart.void, "SystemChrome.setSystemUIChangeListener");
        }
      });
    }
    static restoreSystemUIOverlays() {
      return async.async(dart.void, function* restoreSystemUIOverlays() {
        yield system_channels.SystemChannels.platform.invokeMethod(dart.void, "SystemChrome.restoreSystemUIOverlays");
      });
    }
    static setSystemUIOverlayStyle(style) {
      if (!(style !== null)) dart.assertFailed(null, I[1], 574, 12, "style != null");
      ...
      async.scheduleMicrotask(dart.fn(() => {
        if (!(system_chrome.SystemChrome._pendingStyle != null)) dart.assertFailed(null, I[1], 587, 14, "_pendingStyle != null");
  ...
  system_chrome._stringify = function _stringify(list) {
    return (() => {
      let t6 = T.JSArrayOfString().of([]);
      for (let item of list)
        t6.push(dart.toString(item));
      return t6;
    })();
  };
  ...
  }, '{"version":3,"sourceRoot":"","sources":["system_chrome.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAkDA;;;;;;;;;;;;MAlBK,sCAAM;;;MAKT,0CAAU;;;MAMV,6CAAa;;;MAGb,4CAAY;;;MAGZ,8CAAc;;;;;;;IAcA;;;;;;IAMH;;;;;;;;;;;;;QATiC;QAAY;IAAZ;IAAY;;EAAe;;;;;;;;;;;;IAuBzE;;;;;;;;;;;;MARK,oCAAM;;;MAGT,iCAAG;;;MAIH,oCAAM;;;;;;;IAkGR;;;;;;;;;;;;MA1FK,iCAAM;;;MAiBT,mCAAQ;;;MAmBR,oCAAS;;;MAkBT,0CAAe;;;MAkBf,qCAAU;;;MAiBV,iCAAM;;;;;;;;;;;;;;;IAuBO;;;;;;IAKA;;;;;;IAOK;;;;;;IAiBN;;;;;;IAKC;;;;;;IAKK;;;;;;IAKA;;;;;;IAiBN;;;;;;;;;;;;;;;;;;;AAsBV,YAAwB,6CACtB,8EAA4B,OAA0B,WACtD,8FAAmC,OAAiC,YACpE,mCAAmC,sCACnC,8DAAkB,OAAgB,aAClC,wEAAuB,OAAqB,sBAC5C,gFAA2B,OAAyB,sBACpD,oGAAqC,OAAmC,sBACxE,uCAAuC;IAE3C;;AAGqB,YAAG,AAA8D,0BAA5C,MAAM,0BAAwB,eAAG,kBAAS;IAAE;;;UAI7E;UACA;UACD;UACC;UACK;UACA;UACN;UACM;AAEZ,YAAO,wEAC8C,KAAzB,wBAAwB,EAAxB,aAAiC,uEACM,MAAhC,+BAA+B,EAA/B,cAAwC,mFACA,OAApC,mCAAmC,EAAnC,eAA4C,mEAClD,OAAf,cAAc,EAAd,eAAuB,uDACU,OAAxB,uBAAuB,EAAvB,eAAgC,4DAChB,OAApB,mBAAmB,EAAnB,eAA4B,oEACgB,OAAhC,+BAA+B,EAA/B,eAAwC,kFACJ,OAAlC,iCAAiC,EAAjC,eAA0C;IAEjF;;AAGoB,YAAO,kBACzB,+BACA,sCACA,0CACA,qBACA,0BACA,8BACA,sCACA;IACD;YAGuB;;AACtB,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAQT,uCARG,KAAK,KAC0B,YAA/B,AAAM,KAAD,2BAA6B,kCACI,YAAtC,AAAM,KAAD,kCAAoC,yCACzC,AAAM,AAAoC,KAArC,wCAAwC,4CACxB,YAArB,AAAM,KAAD,iBAAmB,wBACxB,AAAM,AAAwB,KAAzB,4BAA4B,gCACjC,AAAM,AAAoB,KAArB,wBAAwB,4BAC7B,AAAM,AAAgC,KAAjC,oCAAoC,wCACzC,AAAM,AAAkC,KAAnC,sCAAsC;IACpD;;;QAhKO;QACA;QACA;QACA;QACA;QACA;QACA;QACA;IAPA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;;EACL;;;;;;;;;;;;;;;;;;;;;;;;MAsEgC,wCAAK;;;MASL,uCAAI;;;;;;;;oCAwG+B;AAAzB;AAIzC,QAHD,MAAqB,AAAS,gEAC5B,yCACA,yBAAW,YAAY;MAE3B;;6CAOqF;AAAhC;AAOlD,QAND,MAAqB,AAAS,gEAC5B,kDACiB,4CACf,SAAS,AAAY,WAAD,QACpB,gBAAgB,AAAY,WAAD;MAGjC;;sCA4BqE;AAAvB;AACyB,QAArE,MAAM,kDAAoC,8CAAkB,QAAQ;MACtE;;kCAkCwD;UAA+B;AAA7C;AACxC,YAAI,IAAI,KAAiB;AAItB,UAHD,MAAqB,AAAS,gEAC5B,uCACA,AAAK,IAAD;;AAGN,gBAAO,AAAK,AAAuB,IAAxB,KAAiB,qCAAU,QAAQ;AAI7C,UAHD,MAAqB,AAAS,gEAC5B,2CACA,yBAAmB,eAAR,QAAQ;;MAGzB;;qCAsBsE;AAAzB;AACiB,QAA5C,AAAS,2DAA0B,QAAQ;AAE3D,YAAI,QAAQ;AAGT,UAFD,MAAqB,AAAS,gEAC5B;;MAGN;;;AAW2C;AAGxC,QAFD,MAAqB,AAAS,gEAC5B;MAEJ;;mCAkDyD;AACvD,YAAO,AAAM,KAAD;AACZ,UAAI;AAEmB,QAArB,2CAAgB,KAAK;AACrB;;AAEF,UAAI,AAAM,KAAD,SAAI;AAGX;;AAEmB,MAArB,2CAAgB,KAAK;AAWnB,MAVF,wBAAkB;AAChB,cAAO,AAAc;AACrB,yBAAI,0CAAiB;AAIlB,UAHc,AAAS,gEACtB,wCACa,AAAE,eAAf;AAE0B,UAA5B,0CAAe;;AAEG,QAApB,2CAAgB;;IAEpB;;AAMgD;IAAY;;;;EAjP5C;;;;;;;;MA6Oa,wCAAa;;;;MAKb,uCAAY;;;;;iDA3PL;AAAS,UAAQ;;AACrD,eAAmB,OAAQ,KAAI;AAAO,8BAAL,IAAI;;;EACtC","file":"../../../../../../../../../../packages/flutter/src/services/system_chrome.dart.lib.js"}');
  // Exports:
  return {
