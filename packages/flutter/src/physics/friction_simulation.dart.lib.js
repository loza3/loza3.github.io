define(['dart_sdk', 'packages/flutter/src/physics/tolerance.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/physics/simulation.dart', 'packages/flutter/src/foundation/math.dart'], (function load__packages__flutter__src__physics__friction_simulation_dart(dart_sdk, packages__flutter__src__physics__tolerance$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__physics__simulation$46dart, packages__flutter__src__foundation__math$46dart) {
  ...
  var C = [void 0];
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/physics/friction_simulation.dart",
  ...
  friction_simulation.BoundedFrictionSimulation = class BoundedFrictionSimulation extends friction_simulation.FrictionSimulation {
    ...
    x(time) {
      return math$.clampDouble(super.x(time), this[_minX$], this[_maxX$]);
    }
    isDone(time) {
  ...
  (friction_simulation.BoundedFrictionSimulation.new = function(drag, position, velocity, _minX, _maxX) {
    this[_minX$] = _minX;
    this[_maxX$] = _maxX;
    if (!(math$.clampDouble(position, _minX, _maxX) === position)) dart.assertFailed(null, I[0], 121, 14, "clampDouble(position, _minX, _maxX) == position");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["friction_simulation.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;mBA4C4C,eAAsB,aAAoB,eAAsB;AACxG,YAAO,AAAc,AAA6B,aAA9B,KAAI,OAAO,AAAY,WAAD,KAAI,OAAO,AAAc,AAAK,aAAN,YAAS,AAAY,WAAD;AACtF,YAAO,AAAc,AAAM,aAAP,YAAU,AAAY,WAAD;AACzC,YAAqC,AAAK,CAAlC,AAAY,WAAD,GAAG,aAAa,aAAU,AAAc,aAAD;AAC1D,YAAO,gDACL,gDAAS,aAAa,EAAE,WAAW,EAAE,aAAa,EAAE,WAAW,GAC/D,aAAa,EACb,aAAa,cACF,uCAAoB,AAAY,WAAD;IAE9C;;;;oBAc8B,eAAsB,aAAoB,eAAsB;AAC5F,YAAY,6BAA0C,CAA7B,AAAc,aAAD,GAAG,WAAW,KAAK,AAAc,aAAD,GAAG,WAAW;IACtF;MAGgB;AAAS,YAAA,AAAG,AAAwC,YAAtC,AAAG,AAAwB,WAAjB,SAAI,aAAO,IAAI,IAAI,iBAAW,AAAG,WAAE;IAAQ;OAGlE;AAAS,YAAA,AAAG,YAAO,SAAI,aAAO,IAAI;IAAC;;AAG/B,YAAA,AAAG,YAAE,AAAG,WAAE;IAAQ;YAKjB;AACpB,UAAI,AAAE,CAAD,KAAI;AACP,cAAO;;AAET,UAAI,AAAG,aAAG,QAAQ,AAAG,WAAE,IAAK,AAAE,AAAK,CAAN,GAAG,YAAM,AAAE,CAAD,GAAG,cAAW,AAAE,AAAK,CAAN,GAAG,YAAM,AAAE,CAAD,GAAG;AACjE;;AAEF,YAAY,AAAoC,UAAhC,AAAS,AAAW,AAAK,kBAAb,AAAE,CAAD,GAAG,YAAM,WAAK,OAAO;IACpD;WAGmB;AAAS,YAAA,AAAS,AAAM,SAAZ,IAAI,YAAU,AAAU;IAAQ;;AAG1C,YAAG,AAA6I,0BAA3H,MAAM,wBAAsB,UAAO,AAAM,8BAAgB,KAAG,WAAQ,AAAG,2BAAgB,KAAG,YAAS,AAAG,2BAAgB,KAAG;IAAE;;yDA1E5J,MACA,UACA;QACD;IACG,cAAE,IAAI;IACH,iBAAO,SAAI,IAAI;IACrB,WAAE,QAAQ;IACV,WAAE,QAAQ;AARlB,gFAIQ,SAAS;;EAIC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA+FF;AACd,YAAO,mBAAkB,QAAE,IAAI,GAAG,cAAO;IAC3C;WAGmB;AACjB,YAAa,AACkC,cAD3B,IAAI,KACJ,AAAM,CAAvB,AAAQ,OAAN,IAAI,IAAI,wBAAe,AAAU,2BAClB,AAAM,CAAvB,AAAQ,OAAN,IAAI,IAAI,wBAAe,AAAU;IACxC;;AAGqB,YAAG,AAAiN,0BAA/L,MAAM,+BAA6B,UAAO,AAAM,8BAAgB,KAAG,WAAQ,AAAG,2BAAgB,KAAG,YAAS,AAAG,2BAAgB,KAAG,UAAO,AAAM,+BAAgB,KAAG,OAAI,AAAM,+BAAgB,KAAG;IAAE;;gEAvBjO,MACA,UACA,UACD,OACA;IADA;IACA;UACI,AAAoC,kBAAxB,QAAQ,EAAE,KAAK,EAAE,KAAK,MAAK,QAAQ;AAN1D,2EACQ,IAAI,EACJ,QAAQ,EACR,QAAQ;;EAG2C","file":"../../../../../../../../../../packages/flutter/src/physics/friction_simulation.dart.lib.js"}');
  // Exports:
  return {
