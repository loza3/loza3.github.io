define(['dart_sdk', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/painting/edge_insets.dart', 'packages/flutter/src/foundation/collections.dart'], (function load__packages__flutter__src__painting__borders_dart(dart_sdk, packages__flutter__src__foundation__object$46dart, packages__flutter__src__painting__edge_insets$46dart, packages__flutter__src__foundation__collections$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C3() {
      return C[3] = dart.constList([C[4] || CT.C4, C[5] || CT.C5, C[6] || CT.C6], borders$.StrokeAlign);
    },
    get C7() {
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/borders.dart"
  ];
  ...
  borders$.StrokeAlign = class StrokeAlign extends core._Enum {
    toString() {
      return "StrokeAlign." + this[_name];
    }
  };
  (borders$.StrokeAlign.new = function(index, name) {
    borders$.StrokeAlign.__proto__.new.call(this, index, name);
    ;
  }).prototype = borders$.StrokeAlign.prototype;
  dart.addTypeTests(borders$.StrokeAlign);
  dart.addTypeCaches(borders$.StrokeAlign);
  dart.setLibraryUri(borders$.StrokeAlign, I[0]);
  dart.setStaticFieldSignature(borders$.StrokeAlign, () => ['values', 'inside', 'center', 'outside']);
  dart.defineExtensionMethods(borders$.StrokeAlign, ['toString']);
  dart.defineLazy(borders$.StrokeAlign, {
    /*borders$.StrokeAlign.values*/get values() {
      return C[3] || CT.C3;
    },
    /*borders$.StrokeAlign.inside*/get inside() {
      return C[4] || CT.C4;
    },
    /*borders$.StrokeAlign.center*/get center() {
      return C[5] || CT.C5;
    },
    /*borders$.StrokeAlign.outside*/get outside() {
      return C[6] || CT.C6;
    }
  }, false);
  ...
  borders$.BorderSide = class BorderSide extends core.Object {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      let strokeAlign = opts && 'strokeAlign' in opts ? opts.strokeAlign : C[4] || CT.C4;
      return new borders$.BorderSide.new({color: color, width: width, style: style, strokeAlign: strokeAlign});
    }
    static merge(a, b) {
      if (!(a !== null)) dart.assertFailed(null, I[1], 108, 12, "a != null");
      if (!(b !== null)) dart.assertFailed(null, I[1], 109, 12, "b != null");
      if (!borders$.BorderSide.canMerge(a, b)) dart.assertFailed(null, I[1], 110, 12, "canMerge(a, b)");
      ...
      if (!a.color._equals(b.color)) dart.assertFailed(null, I[1], 122, 12, "a.color == b.color");
      if (!(a.style === b.style)) dart.assertFailed(null, I[1], 123, 12, "a.style == b.style");
    ...
    copyWith(opts) {
      ...
      if (!(width == null || dart.notNull(width) >= 0.0)) dart.assertFailed(null, I[1], 163, 12, "width == null || width >= 0.0");
      return new borders$.BorderSide.new({color: (t4 = color, t4 == null ? this.color : t4), width: (t4$ = width, t4$ == null ? this.width : t4$), style: (t4$0 = style, t4$0 == null ? this.style : t4$0)});
    }
    scale(t) {
      if (!(t !== null)) dart.assertFailed(null, I[1], 188, 12, "t != null");
    ...
    static canMerge(a, b) {
      if (!(a !== null)) dart.assertFailed(null, I[1], 225, 12, "a != null");
      if (!(b !== null)) dart.assertFailed(null, I[1], 226, 12, "b != null");
      if (a.style === borders$.BorderStyle.none && a.width === 0.0 || b.style === borders$.BorderStyle.none && b.width === 0.0) {
        return true;
      }
      return a.style === b.style && a.color._equals(b.color) && a.strokeAlign === b.strokeAlign;
    }
    static lerp(a, b, t) {
      if (!(a !== null)) dart.assertFailed(null, I[1], 242, 12, "a != null");
      if (!(b !== null)) dart.assertFailed(null, I[1], 243, 12, "b != null");
      if (!(t !== null)) dart.assertFailed(null, I[1], 244, 12, "t != null");
      if (t === 0.0) {
        return a;
      }
      if (t === 1.0) {
      ...
      if (a.strokeAlign !== b.strokeAlign) {
        let strokeAlign = t > 0.5 ? b.strokeAlign : a.strokeAlign;
        return new borders$.BorderSide.new({color: dart.nullCheck(ui.Color.lerp(colorA, colorB, t)), width: t > 0.5 ? dart.nullCheck(ui.lerpDouble(0, b.width, t * 2 - 1)) : dart.nullCheck(ui.lerpDouble(a.width, 0, t * 2)), strokeAlign: strokeAlign});
      }
    ...
    toString() {
      if (this.strokeAlign === borders$.StrokeAlign.inside) {
        return object.objectRuntimeType(this, "BorderSide") + "(" + dart.str(this.color) + ", " + this.width[$toStringAsFixed](1) + ", " + dart.str(this.style) + ")";
      }
      return object.objectRuntimeType(this, "BorderSide") + "(" + dart.str(this.color) + ", " + this.width[$toStringAsFixed](1) + ", " + dart.str(this.style) + ", " + dart.str(this.strokeAlign) + ")";
    }
  };
  (borders$.BorderSide.new = function(opts) {
    ...
    if (!(color !== null)) dart.assertFailed(null, I[1], 91, 15, "color != null");
    if (!(width !== null)) dart.assertFailed(null, I[1], 92, 15, "width != null");
    if (!(width >= 0.0)) dart.assertFailed(null, I[1], 93, 15, "width >= 0.0");
    if (!(style !== null)) dart.assertFailed(null, I[1], 94, 15, "style != null");
    ;
  ...
  dart.setFieldSignature(borders$.BorderSide, () => ({
    ...
    strokeAlign: dart.finalFieldType(borders$.StrokeAlign)
  }));
  dart.setStaticFieldSignature(borders$.BorderSide, () => ['none']);
  ...
  borders$.ShapeBorder = class ShapeBorder extends core.Object {
    ...
    ['+'](other) {
      let t4, t4$;
      t4$ = (t4 = this.add(other), t4 == null ? other.add(this, {reversed: true}) : t4);
      return t4$ == null ? new borders$._CompoundBorder.new(T.JSArrayOfShapeBorder().of([other, this])) : t4$;
    }
    lerpFrom(a, t) {
      if (a == null) {
        return this.scale(t);
    ...
    static lerp(a, b, t) {
      let t4;
      if (!(t !== null)) dart.assertFailed(null, I[1], 483, 12, "t != null");
      let result = null;
      if (b != null) {
  ...
  borders$.OutlinedBorder = class OutlinedBorder extends borders$.ShapeBorder {
    ...
    static lerp(a, b, t) {
      let t4;
      if (!(t !== null)) dart.assertFailed(null, I[1], 598, 12, "t != null");
      let result = null;
      if (b != null) {
        result = b.lerpFrom(a, t);
      }
      ...
      t4 = T.OutlinedBorderN().as(result);
      return t4 == null ? t < 0.5 ? a : b : t4;
    }
  };
  (borders$.OutlinedBorder.new = function(opts) {
    let side = opts && 'side' in opts ? opts.side : C[9] || CT.C9;
    this[side$] = side;
    if (!(side !== null)) dart.assertFailed(null, I[1], 558, 66, "side != null");
  ...
  borders$._CompoundBorder = class _CompoundBorder extends borders$.ShapeBorder {
    ...
    add(other, opts) {
      ...
      if (!borders$._CompoundBorder.is(other)) {
        ...
        let merged = (t4 = ours.add(other, {reversed: reversed}), t4 == null ? other.add(ours, {reversed: !reversed}) : t4);
        if (merged != null) {
          let result = (() => {
            let t4 = T.ListOfShapeBorder().of(this.borders);
            return t4;
          })();
      ...
      let mergedBorders = (() => {
        let t5 = T.JSArrayOfShapeBorder().of([]);
        if (reversed) t5[$addAll](this.borders);
        if (borders$._CompoundBorder.is(other))
          t5[$addAll](other.borders);
        else
          t5.push(other);
        if (!reversed) t5[$addAll](this.borders);
        return t5;
    ...
    static lerp(a, b, t) {
      let t6;
      if (!(t !== null)) dart.assertFailed(null, I[1], 679, 12, "t != null");
      if (!(borders$._CompoundBorder.is(a) || borders$._CompoundBorder.is(b))) dart.assertFailed(null, I[1], 680, 12, "a is _CompoundBorder || b is _CompoundBorder");
  ...
  (borders$._CompoundBorder.new = function(borders) {
    ...
    if (!(borders !== null)) dart.assertFailed(null, I[1], 615, 14, "borders != null");
    if (!(borders[$length] >= 2)) dart.assertFailed(null, I[1], 616, 14, "borders.length >= 2");
    if (!!borders[$any](dart.fn(border => borders$._CompoundBorder.is(border), T.ShapeBorderTobool()))) dart.assertFailed(null, I[1], 617, 14, "!borders.any((ShapeBorder border) => border is _CompoundBorder)");
  ...
  borders$.paintBorder = function paintBorder(canvas, rect, opts) {
    let t6;
    let top = opts && 'top' in opts ? opts.top : C[9] || CT.C9;
    let right = opts && 'right' in opts ? opts.right : C[9] || CT.C9;
    let bottom = opts && 'bottom' in opts ? opts.bottom : C[9] || CT.C9;
    let left = opts && 'left' in opts ? opts.left : C[9] || CT.C9;
    if (!(canvas !== null)) dart.assertFailed(null, I[1], 780, 10, "canvas != null");
    if (!(rect !== null)) dart.assertFailed(null, I[1], 781, 10, "rect != null");
    if (!(top !== null)) dart.assertFailed(null, I[1], 782, 10, "top != null");
    if (!(right !== null)) dart.assertFailed(null, I[1], 783, 10, "right != null");
    if (!(bottom !== null)) dart.assertFailed(null, I[1], 784, 10, "bottom != null");
    if (!(left !== null)) dart.assertFailed(null, I[1], 785, 10, "left != null");
