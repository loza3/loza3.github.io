define(['dart_sdk', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/foundation/collections.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/painting/colors.dart', 'packages/flutter/src/services/mouse_cursor.dart', 'packages/flutter/src/gestures/events.dart', 'packages/flutter/src/gestures/tap.dart', 'packages/flutter/src/gestures/long_press.dart', 'packages/flutter/src/gestures/recognizer.dart', 'packages/flutter/src/gestures/hit_test.dart', 'packages/flutter/src/services/mouse_tracking.dart', 'packages/flutter/src/foundation/math.dart', 'packages/flutter/src/services/text_editing.dart'], (function load__packages__flutter__src__painting__placeholder_span_dart(dart_sdk, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__foundation__collections$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__painting__colors$46dart, packages__flutter__src__services__mouse_cursor$46dart, packages__flutter__src__gestures__events$46dart, packages__flutter__src__gestures__tap$46dart, packages__flutter__src__gestures__long_press$46dart, packages__flutter__src__gestures__recognizer$46dart, packages__flutter__src__gestures__hit_test$46dart, packages__flutter__src__services__mouse_tracking$46dart, packages__flutter__src__foundation__math$46dart, packages__flutter__src__services__text_editing$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C12() {
      return C[12] = dart.constList([C[13] || CT.C13, C[14] || CT.C14], text_painter.TextWidthBasis);
    },
    get C15() {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/inline_span.dart",
    "package:flutter/src/painting/inline_span.dart",
    "package:flutter/src/painting/placeholder_span.dart",
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/strut_style.dart",
    "package:flutter/src/painting/strut_style.dart",
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/text_style.dart",
    "package:flutter/src/painting/text_style.dart",
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/text_span.dart",
    "package:flutter/src/painting/text_span.dart",
    "package:flutter/src/painting/text_painter.dart",
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/text_painter.dart"
  ];
  ...
  inline_span.InlineSpan = class InlineSpan extends diagnostics.DiagnosticableTree {
    ...
    getSpanForPosition(position) {
      if (!this.debugAssertIsValid()) dart.assertFailed(null, I[0], 231, 12, "debugAssertIsValid()");
  ...
  text_style.TextStyle = class TextStyle extends Object_Diagnosticable$36$ {
    ...
    get [_fontFamily]() {
      if (this[_package$1] != null && this.fontFamily != null) {
        ...
        if (!dart.nullCheck(this.fontFamily)[$startsWith](fontFamilyPrefix)) dart.assertFailed(null, I[5], 799, 14, "fontFamily!.startsWith(fontFamilyPrefix)");
    ...
    copyWith(opts) {
      ...
      let $package = opts && 'package' in opts ? opts.package : null;
      let overflow = opts && 'overflow' in opts ? opts.overflow : null;
      if (!(color == null || foreground == null)) dart.assertFailed(text_style._kColorForegroundWarning, I[5], 842, 12, "color == null || foreground == null");
      if (!(backgroundColor == null || background == null)) dart.assertFailed(text_style._kColorBackgroundWarning, I[5], 843, 12, "backgroundColor == null || background == null");
      let newDebugLabel = null;
      if (!dart.fn(() => {
        let t0;
        if (this.debugLabel != null) {
          newDebugLabel = (t0 = debugLabel, t0 == null ? "(" + dart.str(this.debugLabel) + ").copyWith" : t0);
        }
        return true;
      }, T.VoidTobool())()) dart.assertFailed(null, I[5], 845, 12, "() {\n      if (this.debugLabel != null) {\n        newDebugLabel = debugLabel ?? '(${this.debugLabel}).copyWith';\n      }\n      return true;\n    }()");
      return new text_style.TextStyle.new({inherit: (t0 = inherit, t0 == null ? this.inherit : t0), color: this.foreground == null && foreground == null ? (t0$ = color, t0$ == null ? this.color : t0$) : null, backgroundColor: this.background == null && background == null ? (t0$0 = backgroundColor, t0$0 == null ? this.backgroundColor : t0$0) : null, fontSize: (t0$1 = fontSize, t0$1 == null ? this.fontSize : t0$1), fontWeight: (t0$2 = fontWeight, t0$2 == null ? this.fontWeight : t0$2), fontStyle: (t0$3 = fontStyle, t0$3 == null ? this.fontStyle : t0$3), letterSpacing: (t0$4 = letterSpacing, t0$4 == null ? this.letterSpacing : t0$4), wordSpacing: (t0$5 = wordSpacing, t0$5 == null ? this.wordSpacing : t0$5), textBaseline: (t0$6 = textBaseline, t0$6 == null ? this.textBaseline : t0$6), height: (t0$7 = height, t0$7 == null ? this.height : t0$7), leadingDistribution: (t0$8 = leadingDistribution, t0$8 == null ? this.leadingDistribution : t0$8), locale: (t0$9 = locale, t0$9 == null ? this.locale : t0$9), foreground: (t0$10 = foreground, t0$10 == null ? this.foreground : t0$10), background: (t0$11 = background, t0$11 == null ? this.background : t0$11), shadows: (t0$12 = shadows, t0$12 == null ? this.shadows : t0$12), fontFeatures: (t0$13 = fontFeatures, t0$13 == null ? this.fontFeatures : t0$13), fontVariations: (t0$14 = fontVariations, t0$14 == null ? this.fontVariations : t0$14), decoration: (t0$15 = decoration, t0$15 == null ? this.decoration : t0$15), decorationColor: (t0$16 = decorationColor, t0$16 == null ? this.decorationColor : t0$16), decorationStyle: (t0$17 = decorationStyle, t0$17 == null ? this.decorationStyle : t0$17), decorationThickness: (t0$18 = decorationThickness, t0$18 == null ? this.decorationThickness : t0$18), debugLabel: newDebugLabel, fontFamily: (t0$19 = fontFamily, t0$19 == null ? this[_fontFamily] : t0$19), fontFamilyFallback: (t0$20 = fontFamilyFallback, t0$20 == null ? this.fontFamilyFallback : t0$20), package: (t0$21 = $package, t0$21 == null ? this[_package$1] : t0$21), overflow: (t0$22 = overflow, t0$22 == null ? this.overflow : t0$22)});
    }
    apply(opts) {
      ...
      let $package = opts && 'package' in opts ? opts.package : null;
      let overflow = opts && 'overflow' in opts ? opts.overflow : null;
      if (!(fontSizeFactor !== null)) dart.assertFailed(null, I[5], 940, 12, "fontSizeFactor != null");
      if (!(fontSizeDelta !== null)) dart.assertFailed(null, I[5], 941, 12, "fontSizeDelta != null");
      if (!(this.fontSize != null || fontSizeFactor === 1.0 && fontSizeDelta === 0.0)) dart.assertFailed(null, I[5], 942, 12, "fontSize != null || (fontSizeFactor == 1.0 && fontSizeDelta == 0.0)");
      if (!(fontWeightDelta !== null)) dart.assertFailed(null, I[5], 943, 12, "fontWeightDelta != null");
      if (!(this.fontWeight != null || fontWeightDelta === 0.0)) dart.assertFailed(null, I[5], 944, 12, "fontWeight != null || fontWeightDelta == 0.0");
      if (!(letterSpacingFactor !== null)) dart.assertFailed(null, I[5], 945, 12, "letterSpacingFactor != null");
      if (!(letterSpacingDelta !== null)) dart.assertFailed(null, I[5], 946, 12, "letterSpacingDelta != null");
      if (!(this.letterSpacing != null || letterSpacingFactor === 1.0 && letterSpacingDelta === 0.0)) dart.assertFailed(null, I[5], 947, 12, "letterSpacing != null || (letterSpacingFactor == 1.0 && letterSpacingDelta == 0.0)");
      if (!(wordSpacingFactor !== null)) dart.assertFailed(null, I[5], 948, 12, "wordSpacingFactor != null");
      if (!(wordSpacingDelta !== null)) dart.assertFailed(null, I[5], 949, 12, "wordSpacingDelta != null");
      if (!(this.wordSpacing != null || wordSpacingFactor === 1.0 && wordSpacingDelta === 0.0)) dart.assertFailed(null, I[5], 950, 12, "wordSpacing != null || (wordSpacingFactor == 1.0 && wordSpacingDelta == 0.0)");
      if (!(heightFactor !== null)) dart.assertFailed(null, I[5], 951, 12, "heightFactor != null");
      if (!(heightDelta !== null)) dart.assertFailed(null, I[5], 952, 12, "heightDelta != null");
      if (!(decorationThicknessFactor !== null)) dart.assertFailed(null, I[5], 953, 12, "decorationThicknessFactor != null");
      if (!(decorationThicknessDelta !== null)) dart.assertFailed(null, I[5], 954, 12, "decorationThicknessDelta != null");
      if (!(this.decorationThickness != null || decorationThicknessFactor === 1.0 && decorationThicknessDelta === 0.0)) dart.assertFailed(null, I[5], 955, 12, "decorationThickness != null || (decorationThicknessFactor == 1.0 && decorationThicknessDelta == 0.0)");
    ...
    merge(other) {
      ...
      if (!dart.fn(() => {
        ...
        if (other.debugLabel != null || this.debugLabel != null) {
          mergedDebugLabel = "(" + dart.str((t0 = this.debugLabel, t0 == null ? "unknown" : t0)) + ").merge(" + dart.str((t0$ = other.debugLabel, t0$ == null ? "unknown" : t0$)) + ")";
        }
        return true;
      }, T.VoidTobool())()) dart.assertFailed(null, I[5], 1025, 12, "() {\n      if (other.debugLabel != null || debugLabel != null) {\n        mergedDebugLabel = '(${debugLabel ?? _kDefaultDebugLabel}).merge(${other.debugLabel ?? _kDefaultDebugLabel})';\n      }\n      return true;\n    }()");
    ...
    static lerp(a, b, t) {
      ...
      if (!(t !== null)) dart.assertFailed(null, I[5], 1075, 12, "t != null");
      if (!(a == null || b == null || a.inherit === b.inherit)) dart.assertFailed(null, I[5], 1076, 12, "a == null || b == null || a.inherit == b.inherit");
      if (a == null && b == null) {
        return null;
      }
      ...
      if (b == null) {
        return new text_style.TextStyle.new({inherit: a.inherit, color: ui.Color.lerp(a.color, null, t), backgroundColor: ui.Color.lerp(null, a.backgroundColor, t), fontSize: t < 0.5 ? a.fontSize : null, fontWeight: ui.FontWeight.lerp(a.fontWeight, null, t), fontStyle: t < 0.5 ? a.fontStyle : null, letterSpacing: t < 0.5 ? a.letterSpacing : null, wordSpacing: t < 0.5 ? a.wordSpacing : null, textBaseline: t < 0.5 ? a.textBaseline : null, height: t < 0.5 ? a.height : null, leadingDistribution: t < 0.5 ? a.leadingDistribution : null, locale: t < 0.5 ? a.locale : null, foreground: t < 0.5 ? a.foreground : null, background: t < 0.5 ? a.background : null, shadows: t < 0.5 ? a.shadows : null, fontFeatures: t < 0.5 ? a.fontFeatures : null, fontVariations: t < 0.5 ? a.fontVariations : null, decoration: t < 0.5 ? a.decoration : null, decorationColor: ui.Color.lerp(a.decorationColor, null, t), decorationStyle: t < 0.5 ? a.decorationStyle : null, decorationThickness: t < 0.5 ? a.decorationThickness : null, debugLabel: lerpDebugLabel, fontFamily: t < 0.5 ? a[_fontFamily] : null, fontFamilyFallback: t < 0.5 ? a.fontFamilyFallback : null, package: t < 0.5 ? a[_package$1] : null, overflow: t < 0.5 ? a.overflow : null});
      }
    ...
    getTextStyle(opts) {
      ...
      return ui.TextStyle.new({color: this.color, decoration: this.decoration, decorationColor: this.decorationColor, decorationStyle: this.decorationStyle, decorationThickness: this.decorationThickness, fontWeight: this.fontWeight, fontStyle: this.fontStyle, textBaseline: this.textBaseline, leadingDistribution: this.leadingDistribution, fontFamily: this.fontFamily, fontFamilyFallback: this.fontFamilyFallback, fontSize: this.fontSize == null ? null : dart.nullCheck(this.fontSize) * textScaleFactor, letterSpacing: this.letterSpacing, wordSpacing: this.wordSpacing, height: this.height, locale: this.locale, foreground: this.foreground, background: (t0 = this.background, t0 == null ? this.backgroundColor != null ? (t1 = ui.Paint.new(), (() => {
          ...
          return t1;
        })()) : null : t0), shadows: this.shadows, fontFeatures: this.fontFeatures, fontVariations: this.fontVariations});
    }
    getParagraphStyle(opts) {
      ...
      if (!(textScaleFactor !== null)) dart.assertFailed(null, I[5], 1240, 12, "textScaleFactor != null");
      if (!(maxLines == null || dart.notNull(maxLines) > 0)) dart.assertFailed(null, I[5], 1241, 12, "maxLines == null || maxLines > 0");
    ...
    get hashCode() {
      return core.Object.hash(this.inherit, this.color, this.backgroundColor, this.fontSize, this.fontWeight, this.fontStyle, this.letterSpacing, this.wordSpacing, this.textBaseline, this.height, this.leadingDistribution, this.locale, this.foreground, this.background, this.shadows == null ? null : core.Object.hashAll(dart.nullCheck(this.shadows)), this.fontFeatures == null ? null : core.Object.hashAll(dart.nullCheck(this.fontFeatures)), this.fontVariations == null ? null : core.Object.hashAll(dart.nullCheck(this.fontVariations)), this.decoration, this.decorationColor, core.Object.hash(this.decorationStyle, this.decorationThickness, this.fontFamily, this.fontFamilyFallback == null ? null : core.Object.hashAll(dart.nullCheck(this.fontFamilyFallback)), this[_package$1], this.overflow));
    }
    toStringShort() {
    ...
    debugFillProperties(properties, opts) {
      ...
      if (this.decoration != null || this.decorationColor != null || this.decorationStyle != null || this.decorationThickness != null) {
        ...
        if (!decorationDescription[$isNotEmpty]) dart.assertFailed(null, I[5], 1440, 14, "decorationDescription.isNotEmpty");
  ...
  text_span.TextSpan = class TextSpan extends inline_span.InlineSpan {
    ...
    build(builder, opts) {
      ...
      if (!this.debugAssertIsValid()) dart.assertFailed(null, I[7], 270, 12, "debugAssertIsValid()");
    ...
    computeToPlainText(buffer, opts) {
      let includeSemanticsLabels = opts && 'includeSemanticsLabels' in opts ? opts.includeSemanticsLabels : true;
      let includePlaceholders = opts && 'includePlaceholders' in opts ? opts.includePlaceholders : true;
      if (!this.debugAssertIsValid()) dart.assertFailed(null, I[7], 350, 12, "debugAssertIsValid()");
    ...
    computeSemanticsInformation(collector, opts) {
      ...
      if (!this.debugAssertIsValid()) dart.assertFailed(null, I[7], 372, 12, "debugAssertIsValid()");
    ...
    compareTo(other) {
      ...
      if (textSpan.text != this.text || (t2 = this.children, t2 == null ? null : t2[$length]) != (t2$ = textSpan.children, t2$ == null ? null : t2$[$length]) || this.style == null !== (textSpan.style == null)) {
        return basic_types.RenderComparison.layout;
      }
  ...
  (text_span.TextSpan.new = function(opts) {
    ...
    if (!!(text == null && semanticsLabel != null)) dart.assertFailed(null, I[7], 80, 15, "!(text == null && semanticsLabel != null)");
  ...
  inline_span.Accumulator = class Accumulator extends core.Object {
    ...
    increment(addend) {
      if (!(addend >= 0)) dart.assertFailed(null, I[0], 28, 12, "addend >= 0");
  ...
  (inline_span.InlineSpanSemanticsInformation.new = function(text, opts) {
    ...
    if (!(isPlaceholder === false || text === "￼" && semanticsLabel == null && recognizer == null)) dart.assertFailed(null, I[0], 62, 15, "isPlaceholder == false || (text == '\\uFFFC' && semanticsLabel == null && recognizer == null)");
  ...
  text_painter.TextPainter = class TextPainter extends core.Object {
    static ['_#new#tearOff'](opts) {
      ...
      let locale = opts && 'locale' in opts ? opts.locale : null;
      let strutStyle = opts && 'strutStyle' in opts ? opts.strutStyle : null;
      let textWidthBasis = opts && 'textWidthBasis' in opts ? opts.textWidthBasis : C[13] || CT.C13;
      let textHeightBehavior = opts && 'textHeightBehavior' in opts ? opts.textHeightBehavior : null;
    ...
    set text(value) {
      ...
      if (!dart.equals((t6 = this[_text], t6 == null ? null : t6.style), (t6$ = value, t6$ == null ? null : t6$.style))) {
        this[_layoutTemplate] = null;
      }
      let comparison = value == null ? basic_types.RenderComparison.layout : (t6$1 = (t6$0 = this[_text], t6$0 == null ? null : t6$0.compareTo(value)), t6$1 == null ? basic_types.RenderComparison.layout : t6$1);
      this[_text] = value;
    ...
    set textAlign(value) {
      if (!(value !== null)) dart.assertFailed(null, I[10], 259, 12, "value != null");
    ...
    set textScaleFactor(value) {
      if (!(value !== null)) dart.assertFailed(null, I[10], 302, 12, "value != null");
    ...
    set ellipsis(value) {
      if (!(value == null || value[$isNotEmpty])) dart.assertFailed(null, I[10], 330, 12, "value == null || value.isNotEmpty");
    ...
    set maxLines(value) {
      if (!(value == null || dart.notNull(value) > 0)) dart.assertFailed(null, I[10], 360, 12, "value == null || value > 0");
    ...
    set textWidthBasis(value) {
      if (!(value !== null)) dart.assertFailed(null, I[10], 396, 12, "value != null");
    ...
    setPlaceholderDimensions(value) {
      ...
      }, T.VoidToint())() === value[$length])) dart.assertFailed(null, I[10], 446, 12, "() {\n      int placeholderCount = 0;\n      text!.visitChildren((InlineSpan span) {\n        if (span is PlaceholderSpan) {\n          placeholderCount += 1;\n        }\n        return true;\n      });\n      return placeholderCount;\n    }() == value.length");
      this[_placeholderDimensions] = value;
      this.markNeedsLayout();
    }
    [_createParagraphStyle](defaultTextDirection = null) {
      let t7, t6, t7$, t6$;
      if (!(this.textAlign !== null)) dart.assertFailed(null, I[10], 464, 12, "textAlign != null");
      if (!(this.textDirection != null || defaultTextDirection != null)) dart.assertFailed("TextPainter.textDirection must be set to a non-null value before using the TextPainter.", I[10], 465, 12, "textDirection != null || defaultTextDirection != null");
      t6$ = (t6 = dart.nullCheck(this[_text]).style, t6 == null ? null : t6.getParagraphStyle({textAlign: this.textAlign, textDirection: (t7 = this.textDirection, t7 == null ? defaultTextDirection : t7), textScaleFactor: this.textScaleFactor, maxLines: this[_maxLines], textHeightBehavior: this[_textHeightBehavior], ellipsis: this[_ellipsis], locale: this[_locale], strutStyle: this[_strutStyle]}));
      return t6$ == null ? ui.ParagraphStyle.new({textAlign: this.textAlign, textDirection: (t7$ = this.textDirection, t7$ == null ? defaultTextDirection : t7$), fontSize: 14 * this.textScaleFactor, maxLines: this.maxLines, textHeightBehavior: this[_textHeightBehavior], ellipsis: this.ellipsis, locale: this.locale}) : t6$;
    }
    [_createLayoutTemplate]() {
      let t7, t6, t6$;
      let builder = ui.ParagraphBuilder.new(this[_createParagraphStyle](ui.TextDirection.rtl));
      let textStyle = (t6 = this.text, t6 == null ? null : (t7 = t6.style, t7 == null ? null : t7.getTextStyle({textScaleFactor: this.textScaleFactor})));
      if (textStyle != null) {
      ...
      t6$ = builder.build();
      return (() => {
        t6$.layout(C[16] || CT.C16);
        return t6$;
      })();
    }
    get preferredLineHeight() {
      let t6;
      return (t6 = this[_layoutTemplate], t6 == null ? this[_layoutTemplate] = this[_createLayoutTemplate]() : t6).height;
    }
    [_applyFloatingPointHack](layoutValue) {
      return layoutValue[$ceilToDouble]();
    }
    get minIntrinsicWidth() {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 533, 12, "!_debugNeedsLayout");
      return this[_applyFloatingPointHack](dart.nullCheck(this[_paragraph]).minIntrinsicWidth);
    }
    get maxIntrinsicWidth() {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 541, 12, "!_debugNeedsLayout");
      return this[_applyFloatingPointHack](dart.nullCheck(this[_paragraph]).maxIntrinsicWidth);
    }
    get width() {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 549, 12, "!_debugNeedsLayout");
    ...
    get height() {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 559, 12, "!_debugNeedsLayout");
      return this[_applyFloatingPointHack](dart.nullCheck(this[_paragraph]).height);
    }
    get size() {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 567, 12, "!_debugNeedsLayout");
      return new ui.Size.new(this.width, this.height);
    }
    computeDistanceToActualBaseline(baseline) {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 576, 12, "!_debugNeedsLayout");
      if (!(baseline !== null)) dart.assertFailed(null, I[10], 577, 12, "baseline != null");
      switch (baseline) {
        case C[17] || CT.C17:
          {
    ...
    get didExceedMaxLines() {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 598, 12, "!_debugNeedsLayout");
      return dart.nullCheck(this[_paragraph]).didExceedMaxLines;
    }
    [_createParagraph]() {
      if (!(this[_paragraph] == null || this[_rebuildParagraphForPaint])) dart.assertFailed(null, I[10], 608, 12, "_paragraph == null || _rebuildParagraphForPaint");
      let text = this.text;
      if (text == null) {
    ...
    [_layoutParagraph](minWidth, maxWidth) {
      ...
      if (minWidth !== maxWidth) {
        ...
        newWidth = math$.clampDouble(newWidth, minWidth, maxWidth);
    ...
    layout(opts) {
      ...
      if (!(this.text != null)) dart.assertFailed("TextPainter.text must be set to a non-null value before using the TextPainter.", I[10], 653, 12, "text != null");
      if (!(this.textDirection != null)) dart.assertFailed("TextPainter.textDirection must be set to a non-null value before using the TextPainter.", I[10], 654, 12, "textDirection != null");
      if (this[_paragraph] != null && minWidth === this[_lastMinWidth] && maxWidth === this[_lastMaxWidth]) {
        return;
      }
    ...
    paint(canvas, offset) {
      ...
      if (this[_rebuildParagraphForPaint]) {
        ...
        if (!dart.fn(() => {
          debugSize = this.size;
          return true;
        }, T.VoidTobool())()) dart.assertFailed(null, I[10], 698, 14, "() {\n        debugSize = size;\n        return true;\n      }()");
        this[_createParagraph]();
        this[_layoutParagraph](minWidth, maxWidth);
        if (!dart.equals(debugSize, this.size)) dart.assertFailed(null, I[10], 709, 14, "debugSize == size");
      }
    ...
    [_getRectFromUpstream](offset, caretPrototype) {
      let flattenedText = dart.nullCheck(this[_text]).toPlainText({includeSemanticsLabels: false});
      ...
      while (boxes[$isEmpty]) {
        ...
        return new ui.Rect.fromLTRB(math$.clampDouble(dx, 0.0, dart.nullCheck(this[_paragraph]).width), box.top, math$.clampDouble(dx, 0.0, dart.nullCheck(this[_paragraph]).width), box.bottom);
      }
      return null;
    }
    ...
    get [_emptyOffset]() {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 852, 12, "!_debugNeedsLayout");
      if (!(this.textAlign !== null)) dart.assertFailed(null, I[10], 853, 12, "textAlign != null");
      switch (this.textAlign) {
        ...
        case C[15] || CT.C15:
          {
            if (!(this.textDirection != null)) dart.assertFailed(null, I[10], 863, 16, "textDirection != null");
        ...
        case C[25] || CT.C25:
          {
            if (!(this.textDirection != null)) dart.assertFailed(null, I[10], 871, 16, "textDirection != null");
            switch (dart.nullCheck(this.textDirection)) {
              case C[22] || CT.C22:
                {
                  return ui.Offset.zero;
    ...
    set [_caretMetrics](library$32package$58flutter$47src$47painting$47text_painter$46dart$58$58_caretMetrics$35param) {
      this[__TextPainter__caretMetrics] = library$32package$58flutter$47src$47painting$47text_painter$46dart$58$58_caretMetrics$35param;
    }
    get [_caretMetrics]() {
      let t6;
      t6 = this[__TextPainter__caretMetrics];
      return t6 == null ? dart.throw(new _internal.LateError.fieldNI("_caretMetrics")) : t6;
    }
    [_computeCaretMetrics](position, caretPrototype) {
      let t6, t6$;
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 913, 12, "!_debugNeedsLayout");
      if (position._equals(this[_previousCaretPosition]) && caretPrototype._equals(this[_previousCaretPrototype])) {
        return;
      }
      let offset = position.offset;
      if (!(position.affinity !== null)) dart.assertFailed(null, I[10], 918, 12, "position.affinity != null");
      let rect = null;
    ...
    getBoxesForSelection(selection, opts) {
      ...
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 962, 12, "!_debugNeedsLayout");
      if (!(boxHeightStyle !== null)) dart.assertFailed(null, I[10], 963, 12, "boxHeightStyle != null");
      if (!(boxWidthStyle !== null)) dart.assertFailed(null, I[10], 964, 12, "boxWidthStyle != null");
    ...
    getWordBoundary(position) {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 989, 12, "!_debugNeedsLayout");
      return dart.nullCheck(this[_paragraph]).getWordBoundary(position);
    }
    getLineBoundary(position) {
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 997, 12, "!_debugNeedsLayout");
      return dart.nullCheck(this[_paragraph]).getLineBoundary(position);
    }
    computeLineMetrics() {
      let t6;
      if (!!this[_debugNeedsLayout]) dart.assertFailed(null, I[10], 1014, 12, "!_debugNeedsLayout");
      t6 = this[_lineMetricsCache];
      return t6 == null ? this[_lineMetricsCache] = dart.nullCheck(this[_paragraph]).computeLineMetrics() : t6;
    }
  };
