define(['dart_sdk', 'packages/flutter/src/services/text_editing_delta.dart', 'packages/flutter/src/painting/_network_image_web.dart', 'packages/flutter/src/foundation/synchronous_future.dart', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__painting__image_resolution_dart(dart_sdk, packages__flutter__src__services__text_editing_delta$46dart, packages__flutter__src__painting___network_image_web$46dart, packages__flutter__src__foundation__synchronous_future$46dart, packages__flutter__src__foundation__object$46dart) {
  'use strict';
  ...
  var C = [void 0];
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/image_resolution.dart",
  ...
  image_resolution.AssetImage = class AssetImage extends image_provider.AssetBundleImageProvider {
    ...
    obtainKey(configuration) {
      ...
      chosenBundle.loadStructuredData(T.MapNOfString$ListOfString(), "AssetManifest.json", C[0] || CT.C0).then(dart.void, dart.fn(manifest => {
        ...
        if (!(completer != null)) dart.assertFailed(null, I[0], 323, 14, "completer != null");
        if (!(result == null)) dart.assertFailed(null, I[0], 324, 14, "result == null");
    ...
    [_findBestVariant](candidates, value) {
      if (candidates.containsKey(value)) {
        return dart.nullCheck(candidates._get(value));
      }
    ...
    [_parseScale](key) {
      ...
      if (match != null && match.groupCount > 0) {
        return core.double.parse(dart.nullCheck(match.group(1)));
      }
      return 1;
    }
    _equals(other) {
  ...
  (image_resolution.AssetImage.new = function(assetName, opts) {
    ...
    if (!(assetName !== null)) dart.assertFailed(null, I[0], 254, 15, "assetName != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["image_resolution.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAiQe;;;;;;IAeM;;;;;;IAIL;;;;;;;;;;;;AAdQ,YAAA,AAAQ,wBAAU,iBAAY,AAA8B,uBAAnB,gBAAO,MAAE;IAAU;cAoBzB;;AAOrC,0BAA8C,OAAxB,kBAAP,aAAU,AAAc,aAAD,eAAhB,cAA2B;AACnC;AACH;AAkC3B,MAhCF,AAAa,AAAyF,AA0BpG,YA1BU,wGACV,QAA4B;AACb,yBAIZ,eAJyB,qBACxB,cACA,aAAa,EACb,AAAS,QAAD,WAAW,OAAO,AAAQ,QAAA,QAAC;AAExB,0BAAc,kBAAY,UAAU;AACvB,kBAAM,oDACtB,YAAY,QACd,UAAU,SACT,WAAW;AAEpB,YAAI,SAAS;AAIY,UAAvB,AAAU,SAAD,UAAU,GAAG;;AAM8B,UAApD,SAAS,qDAAuC,GAAG;;0DAG5C,SAAQ,OAAkB;AAGrC,cAAO,AAAU,SAAD;AAChB,cAAO,AAAO,MAAD;AACyB,QAA7B,AAAE,eAAX,SAAS,gBAAgB,KAAK,EAAE,KAAK;;AAEvC,UAAI,MAAM;AAGR,cAAa,gBAAN,MAAM;;AAI6B,MAA5C,YAAY;AACZ,YAAO,AAAU,UAAD;IAClB;2BAEkE;AAChE,UAAI,AAAS,QAAD;AACV,cAAO,4DAA8C;;AAG5B,uBAAmC,2BAAtB,AAAK,oBAAO,QAAQ;AACrC,iBAAO,AAAW,UAAD;AACR,2BAAwC;;AACtE,iBAAkB,MAAO,KAAI;AAAK,oBAAH,GAAG,EAAE,sBAAkC,aAAhB,AAAU,UAAA,QAAC,GAAG;;;AAGtE,YAAO,4DAA8C,cAAc;IACrE;qBAE8B,MAAyB,QAAsB;AAC3E,UAAI,AAAO,AAAiB,MAAlB,6BAA6B,AAAW,UAAD,YAAY,AAAW,UAAD;AACrE,cAAO,KAAI;;AAGsB,oBAAU;AAC7C,eAAkB,YAAa,WAAU;AACI,QAA3C,AAAO,OAAA,MAAC,kBAAY,SAAS,GAAK,SAAS;;AAK7C,YAAO,wBAAiB,OAAO,EAAyB,eAAvB,AAAO,MAAD;IACzC;uBAcsD,YAAmB;AACvE,UAAI,AAAW,UAAD,aAAa,KAAK;AAC9B,cAAwB,gBAAjB,AAAU,UAAA,MAAC,KAAK;;AAEX,kBAAQ,AAAW,UAAD,eAAe,KAAK;AACtC,kBAAQ,AAAW,UAAD,eAAe,KAAK;AACpD,UAAI,AAAM,KAAD;AACP,cAAO,AAAU,WAAA,MAAC,KAAK;;AAEzB,UAAI,AAAM,KAAD;AACP,cAAO,AAAU,WAAA,MAAC,KAAK;;AAOzB,UAAI,AAAM,KAAD,QAAoB,AAAM,KAAD,GAAmB,CAAT,aAAN,KAAK,iBAAG,KAAK,KAAI;AACrD,cAAO,AAAU,WAAA,MAAC,KAAK;;AAEvB,cAAO,AAAU,WAAA,MAAC,KAAK;;IAE3B;kBAI0B;AACxB,UAAI,AAAI,GAAD,KAAI;AACT;;AAGQ,qBAAe,eAAM,GAAG;AAC3B,0BAAgB;AACvB,UAAI,AAAS,AAAa,AAAO,QAArB,yBAAuB;AACsC,QAAvE,gBAAgB,AAAS,AAAY,QAAb,qBAAc,AAAS,AAAa,AAAO,QAArB,yBAAuB;;AAG1D,kBAAQ,AAAoB,2DAAW,aAAa;AACjE,UAAI,KAAK,YAAY,AAAM,AAAW,KAAZ,cAAc;AACtC,cAAc,mBAAoB,eAAd,AAAM,KAAD,OAAO;;AAElC;IACF;YAGwB;;AACtB,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAET,gCAFG,KAAK,KACL,AAAM,AAAQ,KAAT,aAAY,gBACJ,YAAb,AAAM,KAAD,SAAW;IACzB;;AAGoB,YAAO,kBAAK,cAAS;IAAO;;AAG3B,YAAG,AAA0E,0BAAxD,MAAM,gBAAc,uBAAU,eAAM,eAAU,eAAO;IAAG;;8CA1L3F;QACA;QACA;IAFA;IACA;IACA;UACK,AAAU,SAAD;AAJf;;EAIwB;;;;;;;;;;;;;;;;;;;;;;;;;;MA0BV,8CAAkB;;;MA2HlB,+CAAmB;YAAG,iBAAO;;;;MArYtC,wCAAuB;;;MAKvB,8BAAa","file":"../../../../../../../../../../packages/flutter/src/painting/image_resolution.dart.lib.js"}');
  // Exports:
  return {
