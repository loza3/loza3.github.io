define(['dart_sdk', 'packages/flutter/src/painting/debug.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__painting__box_shadow_dart(dart_sdk, packages__flutter__src__painting__debug$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/box_shadow.dart",
  ...
  box_shadow.BoxShadow = class BoxShadow extends ui.Shadow {
    ...
    static lerpList(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 114, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["box_shadow.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAyCe;;;;;;IAKG;;;;;;;;;;;;;;;;AAUF,yCAAS;AACjB,mBAAQ;AACR,wBAAwB,uBAAK,gBAAW;;;AAC5C,WAAO,AAKN;AAJC,YAAI;AACsB,UAAxB,AAAO,MAAD,cAAc;;AAEtB,cAAO;;AAET,YAAO,OAAM;IACf;UAIuB;AACrB,YAAO,sCACE,oBACC,AAAO,iBAAE,MAAM,eACX,AAAW,kBAAE,MAAM,gBACjB,AAAa,oBAAE,MAAM,aACxB;IAEf;gBASkC,GAAc,GAAU;AACxD,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAQ,AAAE,gBAAH,CAAC,QAAQ,CAAC;;AAEnB,UAAI,AAAE,CAAD;AACH,cAAO,AAAE,EAAD,OAAO,AAAI,MAAE,CAAC;;AAExB,YAAO,sCACiC,eAAzB,cAAK,AAAE,CAAD,QAAQ,AAAE,CAAD,QAAQ,CAAC,YACK,eAA3B,eAAK,AAAE,CAAD,SAAS,AAAE,CAAD,SAAS,CAAC,gBACe,eAAzC,cAAW,AAAE,CAAD,aAAa,AAAE,CAAD,aAAa,CAAC,kBACO,eAA7C,cAAW,AAAE,CAAD,eAAe,AAAE,CAAD,eAAe,CAAC,eAClD,AAAE,AAAU,CAAX,eAAwB,sBAAS,AAAE,CAAD,aAAa,AAAE,CAAD;IAEhE;oBAOkD,GAAoB,GAAU;AAC9E,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAEU,MAAnB,AAAE,CAAD,WAAD,IAAiB,gCAAf;AACiB,MAAnB,AAAE,CAAD,WAAD,IAAiB,gCAAf;AACQ,yBAAoB,mBAAI,AAAE,CAAD,WAAS,AAAE,CAAD;AAC7C,YAAkB;;AAChB,iBAAS,IAAI,GAAG,AAAE,CAAD,GAAG,YAAY,EAAE,IAAA,AAAE,CAAD,GAAI;AAAgC,iCAAnB,0BAAK,AAAC,CAAA,QAAC,CAAC,GAAG,AAAC,CAAA,QAAC,CAAC,GAAG,CAAC;AACtE,iBAAS,IAAI,YAAY,EAAE,AAAE,CAAD,GAAG,AAAE,CAAD,WAAS,IAAA,AAAE,CAAD,GAAI;AAAQ,kBAAL,AAAC,CAAA,QAAC,CAAC,QAAQ,AAAI,MAAE,CAAC;AACnE,iBAAS,IAAI,YAAY,EAAE,AAAE,CAAD,GAAG,AAAE,CAAD,WAAS,IAAA,AAAE,CAAD,GAAI;AAAQ,kBAAL,AAAC,CAAA,QAAC,CAAC,QAAQ,CAAC;;;IAEjE;YAGwB;;AACtB,UAAI,AAAU,SAAM,KAAK;AACvB,cAAO;;AAET,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAKT,yBALG,KAAK,KACL,AAAM,AAAM,KAAP,eAAU,eACf,AAAM,AAAO,KAAR,gBAAW,gBAChB,AAAM,AAAW,KAAZ,gBAAe,mBACpB,AAAM,AAAa,KAAd,kBAAiB,qBACtB,AAAM,AAAU,KAAX,eAAc;IAC5B;;AAGoB,YAAO,kBAAK,YAAO,aAAQ,iBAAY,mBAAc;IAAU;;AAG9D,YAAA,AAA8G,yBAAlG,cAAK,gBAAG,eAAM,OAAI,yBAAkB,mBAAY,OAAI,yBAAkB,qBAAc,gBAAG,kBAAS;IAAE;;;QAlH3H;QACA;QACA;QACD;QACA;IADA;IACA;AALD,0DACE,KAAK,UACL,MAAM,cACN,UAAU;;EAGhB","file":"../../../../../../../../../../packages/flutter/src/painting/box_shadow.dart.lib.js"}');
  // Exports:
  return {
