define(['dart_sdk', 'packages/flutter/src/painting/borders.dart'], (function load__packages__flutter__src__painting__notched_shapes_dart(dart_sdk, packages__flutter__src__painting__borders$46dart) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["notched_shapes.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;EAsBsB;;;;;;;;iBAmCG,MAAY;;AACjC,UAAI,AAAM,KAAD,aAAa,AAAK,IAAD,UAAU,KAAK;AACvC,aAAO;;AAAQ,qBAAQ,IAAI;;;;AAKhB,wBAAc,AAAM,AAAM,KAAP,SAAS;AAa5B,cAAI,WAAW;AACf,cAAI,AAAK,AAAI,CAAR,MAAM,CAAC;AACZ,cAAI,AAAK,AAAI,IAAL,OAAO,AAAM,AAAO,KAAR;AAEpB,eAAU,UAAK,AAAE,AAAI,AAAI,AAAI,CAAb,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,IAAI,AAAE,AAAI,AAAQ,CAAb,GAAG,CAAC,GAAG,AAAE,CAAD,GAAG,CAAC,GAAG,AAAE,CAAD,GAAG,CAAC;AACrD,iBAA0B,CAAjB,AAAE,AAAI,AAAK,CAAV,GAAG,CAAC,GAAG,CAAC,GAAI,EAAE,KAAK,AAAE,AAAI,CAAL,GAAG,CAAC,GAAG,AAAE,CAAD,GAAG,CAAC;AAC1C,iBAA0B,CAAjB,AAAE,AAAI,AAAK,CAAV,GAAG,CAAC,GAAG,CAAC,GAAI,EAAE,KAAK,AAAE,AAAI,CAAL,GAAG,CAAC,GAAG,AAAE,CAAD,GAAG,CAAC;AAC1C,iBAAY,UAAK,AAAE,AAAI,CAAL,GAAG,CAAC,GAAG,AAAK,IAAD,GAAG,IAAI;AACpC,iBAAY,UAAK,AAAE,AAAI,CAAL,GAAG,CAAC,GAAG,AAAK,IAAD,GAAG,IAAI;AAE7B,cAAI,yBAAqB,GAAG;AAGxB,MAAxB,AAAC,CAAA,QAAC,GAAK,kBAAO,AAAE,CAAD,OAAO,CAAC;AACJ,MAAnB,AAAC,CAAA,QAAC,GAAK,kBAAO,CAAC,EAAE,CAAC;AACL,gBAAM,AAAE,CAAD,GAAG,IAAI,CAAC,MAAM;AACsC,MAAxE,AAAC,CAAA,QAAC,GAAK,AAAI,AAAO,GAAR,GAAG,IAAI,GAAG,AAAI,GAAD,GAAG,IAAI,GAAG,kBAAO,IAAI,EAAE,IAAI,IAAI,kBAAO,IAAI,EAAE,IAAI;AAI/B,MAAxC,AAAC,CAAA,QAAC,GAAK,kBAAO,AAAK,CAAJ,MAAU,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC;AACO,MAAxC,AAAC,CAAA,QAAC,GAAK,kBAAO,AAAK,CAAJ,MAAU,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC;AACO,MAAxC,AAAC,CAAA,QAAC,GAAK,kBAAO,AAAK,CAAJ,MAAU,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC;AAGjC,eAAS,IAAI,GAAG,AAAE,CAAD,GAAG,AAAE,CAAD,WAAS,IAAA,AAAE,CAAD,GAAI;AACN,QAA3B,AAAC,CAAA,QAAC,CAAC,EAAQ,AAAE,eAAN,AAAC,CAAA,QAAC,CAAC,QAAK,AAAM,KAAD;;AAGtB,YAAO;;AACH,mBAAO,AAAK,IAAD,OAAO,AAAK,IAAD;AACtB,mBAAW,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC;AACnB,8BAAsB,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC;AAClD,uBACI,eAAJ,AAAC,CAAA,QAAC,cACa,uBAAS,WAAW,cACxB;AAEX,8BAAsB,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC,QAAY,AAAE,eAAN,AAAC,CAAA,QAAC;AAClD,mBAAO,AAAK,IAAD,QAAQ,AAAK,IAAD;AACvB,mBAAO,AAAK,IAAD,QAAQ,AAAK,IAAD;AACvB,mBAAO,AAAK,IAAD,OAAO,AAAK,IAAD;AACtB;;;IACN;;;AA9EM;;EAA0B;;;;;;;;;;;IAqGd;;;;;;IAQC;;;;;;;;;iBAGI,UAAgB;AAI1B,qBAAW,AAAK,uBAAa,QAAQ;AAChD,UAAI,sBAAiB,SAAS;AACjB,wBAAiB,AAAE,eAAP,yBAAoB,SAAS;AACpD,cAAY,iBAAsB,6BAAY,QAAQ,EAAE,SAAS;;AAEnE,YAAO,SAAQ;IACjB;;uDA5BiC,MAAa;IAAb;IAAa;AAAxC;;EAAgD","file":"../../../../../../../../../../packages/flutter/src/painting/notched_shapes.dart.lib.js"}');
  // Exports:
  return {
