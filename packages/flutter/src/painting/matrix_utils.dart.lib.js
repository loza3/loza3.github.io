define(['dart_sdk', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__painting__matrix_utils_dart(dart_sdk, packages__vector_math__vector_math_64$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/matrix_utils.dart",
  ...
  matrix_utils.MatrixUtils = class MatrixUtils extends core.Object {
    static ['_#_#tearOff']() {
      return new matrix_utils.MatrixUtils.__();
    }
    static getAsTranslation(transform) {
      if (!(transform !== null)) dart.assertFailed(null, I[0], 21, 12, "transform != null");
    ...
    static getAsScale(transform) {
      if (!(transform !== null)) dart.assertFailed(null, I[0], 48, 12, "transform != null");
      let values = transform.storage;
    ...
    static matrixEquals(a, b) {
      ...
      if (!(a != null || b != null)) dart.assertFailed(null, I[0], 77, 12, "a != null || b != null");
      if (a == null) {
        return matrix_utils.MatrixUtils.isIdentity(dart.nullCheck(b));
      }
      if (b == null) {
        return matrix_utils.MatrixUtils.isIdentity(a);
      }
    ...
    static inverseTransformRect(transform, rect) {
      ...
      if (matrix_utils.MatrixUtils.isIdentity(transform)) {
        return rect;
      }
    ...
    static createCylindricalProjectionTransform(opts) {
      ...
      if (!(radius !== null)) dart.assertFailed(null, I[0], 490, 12, "radius != null");
      if (!(angle !== null)) dart.assertFailed(null, I[0], 491, 12, "angle != null");
      if (!(perspective >= 0 && perspective <= 1.0)) dart.assertFailed(null, I[0], 492, 12, "perspective >= 0 && perspective <= 1.0");
      if (!(orientation !== null)) dart.assertFailed(null, I[0], 493, 12, "orientation != null");
  ...
  dart.setStaticMethodSignature(matrix_utils.MatrixUtils, () => ['getAsTranslation', 'getAsScale', 'matrixEquals', 'isIdentity', 'transformPoint', '_safeTransformRect', '_accumulate', 'transformRect', '_min4', '_max4', 'inverseTransformRect', 'createCylindricalProjectionTransform', 'forceToPoint']);
  dart.setLibraryUri(matrix_utils.MatrixUtils, I[1]);
  dart.setStaticFieldSignature(matrix_utils.MatrixUtils, () => ['_minMax']);
  dart.defineLazy(matrix_utils.MatrixUtils, {
    /*matrix_utils.MatrixUtils._minMax*/get _minMax() {
      return _native_typed_data.NativeFloat64List.new(4);
    }
  }, false);
  matrix_utils.TransformProperty = class TransformProperty extends diagnostics.DiagnosticsProperty$(vector_math_64.Matrix4) {
    static ['_#new#tearOff'](name, value, opts) {
      ...
      return new matrix_utils.TransformProperty.new(name, value, {showName: showName, defaultValue: defaultValue, level: level});
    }
    valueToString(opts) {
  ...
  (matrix_utils.TransformProperty.new = function(name, value, opts) {
    ...
    if (!(showName !== null)) dart.assertFailed(null, I[0], 564, 15, "showName != null");
    if (!(level !== null)) dart.assertFailed(null, I[0], 565, 15, "level != null");
