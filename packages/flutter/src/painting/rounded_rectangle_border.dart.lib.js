define(['dart_sdk', 'packages/flutter/src/painting/borders.dart', 'packages/flutter/src/painting/border_radius.dart', 'packages/flutter/src/painting/edge_insets.dart', 'packages/flutter/src/painting/circle_border.dart', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__painting__rounded_rectangle_border_dart(dart_sdk, packages__flutter__src__painting__borders$46dart, packages__flutter__src__painting__border_radius$46dart, packages__flutter__src__painting__edge_insets$46dart, packages__flutter__src__painting__circle_border$46dart, packages__flutter__src__foundation__object$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/rounded_rectangle_border.dart",
  ...
  rounded_rectangle_border.RoundedRectangleBorder = class RoundedRectangleBorder extends borders.OutlinedBorder {
    ...
    lerpFrom(a, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 62, 12, "t != null");
    ...
    lerpTo(b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 81, 12, "t != null");
        ...
        case C[8] || CT.C8:
          {
            ...
            if (width === 0.0) {
              ...
              if (this.side.strokeAlign === borders.StrokeAlign.inside) {
                ...
                let borderRadiusResolved = this.borderRadius.resolve(textDirection);
  ...
  (rounded_rectangle_border.RoundedRectangleBorder.new = function(opts) {
    ...
    if (!(side !== null)) dart.assertFailed(null, I[0], 34, 15, "side != null");
    if (!(borderRadius !== null)) dart.assertFailed(null, I[0], 35, 15, "borderRadius != null");
  ...
  rounded_rectangle_border._RoundedRectangleToCircleBorder = class _RoundedRectangleToCircleBorder extends borders.OutlinedBorder {
    ...
    lerpFrom(a, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 214, 12, "t != null");
      if (rounded_rectangle_border.RoundedRectangleBorder.is(a)) {
    ...
    get hashCode() {
      return core.Object.hash(this.side, this.borderRadius, this.circleness);
    }
    toString() {
  ...
  (rounded_rectangle_border._RoundedRectangleToCircleBorder.new = function(opts) {
    ...
    if (!(side !== null)) dart.assertFailed(null, I[0], 190, 15, "side != null");
    if (!(borderRadius !== null)) dart.assertFailed(null, I[0], 191, 15, "borderRadius != null");
    if (!(circleness !== null)) dart.assertFailed(null, I[0], 192, 15, "circleness != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["rounded_rectangle_border.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAqC6B;;;;;;;;;;;;AAIzB,cAAQ,AAAK;;;AAET,kBAAkB,gCAAI,AAAK;;;;AAE3B,kBAAkB,gCAAI,AAAK,AAAM,kBAAE;;;;AAEnC,kBAAkB;;;IAExB;UAGyB;AACvB,YAAO,gEACC,AAAK,gBAAM,CAAC,iBACJ,AAAa,uBAAE,CAAC;IAElC;aAGmC,GAAU;AAC3C,YAAO,AAAE,CAAD;AACR,UAAM,mDAAF,CAAC;AACH,cAAO,gEACY,wBAAK,AAAE,CAAD,OAAO,WAAM,CAAC,iBACmC,eAArC,wCAAK,AAAE,CAAD,eAAe,mBAAc,CAAC;;AAG3E,UAAM,8BAAF,CAAC;AACH,cAAO,yEACY,wBAAK,AAAE,CAAD,OAAO,WAAM,CAAC,iBACvB,+BACF,AAAI,MAAE,CAAC;;AAGvB,YAAa,gBAAS,CAAC,EAAE,CAAC;IAC5B;WAGiC,GAAU;AACzC,YAAO,AAAE,CAAD;AACR,UAAM,mDAAF,CAAC;AACH,cAAO,gEACY,wBAAK,WAAM,AAAE,CAAD,OAAO,CAAC,iBACmC,eAArC,wCAAK,mBAAc,AAAE,CAAD,eAAe,CAAC;;AAG3E,UAAM,8BAAF,CAAC;AACH,cAAO,yEACY,wBAAK,WAAM,AAAE,CAAD,OAAO,CAAC,iBACvB,+BACF,CAAC;;AAGjB,YAAa,cAAO,CAAC,EAAE,CAAC;IAC1B;;;UAK8C;UAA4B;AACxE,YAAO,iEACM,KAAL,IAAI,EAAJ,aAAa,gCACQ,MAAb,YAAY,EAAZ,cAAqB;IAEvC;iBAGuB;;UAAuB;AAChC,uBAAa,AAAa,AAAuB,0BAAf,aAAa,UAAU,IAAI;AAC7D;AACZ,cAAQ,AAAK;;;AAEoC,YAA7C,eAAe,AAAW,UAAD,SAAS,AAAK;AACvC;;;;AAEiD,YAAjD,eAAe,AAAW,UAAD,SAAS,AAAK,AAAM,kBAAE;AAC/C;;;;AAEyB,YAAzB,eAAe,UAAU;AACzB;;;AAEJ,WAAO;;AACH,oBAAS,YAAY;;;IAC3B;iBAGuB;;UAAuB;AAC5C,WAAO;;AACH,oBAAS,AAAa,AAAuB,0BAAf,aAAa,UAAU,IAAI;;;IAC/D;UAGkB,QAAa;;UAAuB;AACpD,cAAQ,AAAK;;;AAET;;;;AAEa,wBAAQ,AAAK;AAC1B,gBAAI,AAAM,KAAD,KAAI;AACwE,cAAnF,AAAO,MAAD,WAAW,AAAa,AAAuB,0BAAf,aAAa,UAAU,IAAI,GAAG,AAAK;;AAE7D,gDAAQ;AAChB,2BAAQ,AAAK;;;AACjB,kBAAI,AAAK,AAAY,0BAAe;AACtB,4BAAQ,AAAa,AAAuB,0BAAf,aAAa,UAAU,IAAI;AACxD,4BAAQ,AAAM,KAAD,SAAS,KAAK;AACD,gBAAtC,AAAO,MAAD,YAAY,KAAK,EAAE,KAAK,EAAE,KAAK;;AAE1B;AACA;AACX,oBAAI,AAAK,AAAY,0BAAe;AACH,kBAA/B,QAAQ,AAAK,IAAD,SAAS,AAAM,KAAD,GAAG;AACE,kBAA/B,QAAQ,AAAK,IAAD,SAAS,AAAM,KAAD,GAAG;;AAEjB,kBAAZ,QAAQ,IAAI;AACe,kBAA3B,QAAQ,AAAK,IAAD,SAAS,KAAK;;AAET,2CAAuB,AAAa,0BAAQ,aAAa;AACsB,gBAAlG,AAAO,MAAD,YAAY,AAAqB,oBAAD,SAAS,KAAK,GAAG,AAAqB,oBAAD,SAAS,KAAK,GAAG,KAAK;;;;;IAI3G;YAGwB;;AACtB,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAET,oDAFG,KAAK,KACL,AAAM,AAAK,KAAN,cAAS,cACd,AAAM,AAAa,KAAd,sBAAiB;IAC/B;;AAGoB,YAAO,kBAAK,WAAM;IAAa;;AAIjD,YAAU,AAAyE,0BAAvD,MAAM,4BAA0B,eAAE,aAAI,gBAAG,qBAAY;IACnF;;;QAtJQ;QACD;;UACK,AAAK,IAAD;UACJ,AAAa,YAAD;AAJlB,oFACE,IAAI;;EAGqB;;;;;;;;;;;;;;;;;;;;;;;;;;;IA+JN;;;;;;IAEd;;;;;;;;;;;;;AAIX,YAAkB,gCAAI,AAAK;IAC7B;UAGyB;AACvB,YAAO,yEACC,AAAK,gBAAM,CAAC,iBACJ,AAAa,uBAAE,CAAC,eAClB,CAAC;IAEjB;aAGmC,GAAU;AAC3C,YAAO,AAAE,CAAD;AACR,UAAM,mDAAF,CAAC;AACH,cAAO,yEACY,wBAAK,AAAE,CAAD,OAAO,WAAM,CAAC,iBACmC,eAArC,wCAAK,AAAE,CAAD,eAAe,mBAAc,CAAC,gBAC3D,AAAW,kBAAE,CAAC;;AAG9B,UAAM,8BAAF,CAAC;AACH,cAAO,yEACY,wBAAK,AAAE,CAAD,OAAO,WAAM,CAAC,iBACvB,+BACF,AAAW,kBAAqB,CAAlB,AAAI,MAAE,oBAAe,AAAI,MAAE,CAAC;;AAG1D,UAAM,4DAAF,CAAC;AACH,cAAO,yEACY,wBAAK,AAAE,CAAD,OAAO,WAAM,CAAC,iBACmC,eAArC,wCAAK,AAAE,CAAD,eAAe,mBAAc,CAAC,gBACjB,eAAvC,cAAW,AAAE,CAAD,aAAa,iBAAY,CAAC;;AAGzD,YAAa,gBAAS,CAAC,EAAE,CAAC;IAC5B;WAGiC,GAAU;AACzC,UAAM,mDAAF,CAAC;AACH,cAAO,yEACY,wBAAK,WAAM,AAAE,CAAD,OAAO,CAAC,iBACmC,eAArC,wCAAK,mBAAc,AAAE,CAAD,eAAe,CAAC,gBAC3D,AAAW,mBAAG,AAAI,MAAE,CAAC;;AAGrC,UAAM,8BAAF,CAAC;AACH,cAAO,yEACY,wBAAK,WAAM,AAAE,CAAD,OAAO,CAAC,iBACvB,+BACF,AAAW,kBAAqB,CAAlB,AAAI,MAAE,mBAAc,CAAC;;AAGnD,UAAM,4DAAF,CAAC;AACH,cAAO,yEACY,wBAAK,WAAM,AAAE,CAAD,OAAO,CAAC,iBACmC,eAArC,wCAAK,mBAAc,AAAE,CAAD,eAAe,CAAC,gBACjB,eAAvC,cAAW,iBAAY,AAAE,CAAD,aAAa,CAAC;;AAGzD,YAAa,cAAO,CAAC,EAAE,CAAC;IAC1B;kBAEsB;AACpB,UAAI,AAAW,oBAAG,OAAO,AAAK,AAAM,IAAP,WAAU,AAAK,IAAD;AACzC,cAAO,KAAI;;AAEb,UAAI,AAAK,AAAM,IAAP,SAAS,AAAK,IAAD;AACN,oBAAQ,AAAW,AAA6B,mBAA1B,AAAK,AAAO,IAAR,UAAU,AAAK,IAAD,UAAU;AAC/D,cAAY,sBACV,AAAK,IAAD,OACJ,AAAK,AAAI,IAAL,OAAO,KAAK,EAChB,AAAK,IAAD,QACJ,AAAK,AAAO,IAAR,UAAU,KAAK;;AAGR,oBAAQ,AAAW,AAA6B,mBAA1B,AAAK,AAAM,IAAP,SAAS,AAAK,IAAD,WAAW;AAC/D,cAAY,sBACV,AAAK,AAAK,IAAN,QAAQ,KAAK,EACjB,AAAK,IAAD,MACJ,AAAK,AAAM,IAAP,SAAS,KAAK,EAClB,AAAK,IAAD;;IAGV;0BAEuC,MAAqB;AACvC,2BAAiB,AAAa,0BAAQ,aAAa;AACtE,UAAI,AAAW,oBAAG;AAChB,cAAO,eAAc;;AAEvB,YAAoB,iCAAK,cAAc,EAAe,wCAAS,AAAK,AAAa,IAAd,gBAAgB,MAAM;IAC3F;iBAGuB;;UAAuB;AAChC,uBAAqD,AAAE,eAA1C,0BAAoB,IAAI,EAAE,aAAa,WAAW,kBAAY,IAAI;AAC/E;AACZ,cAAQ,AAAK;;;AAEoC,YAA7C,eAAe,AAAW,UAAD,SAAS,AAAK;AACvC;;;;AAEiD,YAAjD,eAAe,AAAW,UAAD,SAAS,AAAK,AAAM,kBAAE;AAC/C;;;;AAEyB,YAAzB,eAAe,UAAU;AACzB;;;AAEJ,WAAO;;AACH,oBAAS,YAAY;;;IAC3B;iBAGuB;;UAAuB;AAC5C,WAAO;;AACH,oBAAiD,AAAE,eAA1C,0BAAoB,IAAI,EAAE,aAAa,WAAW,kBAAY,IAAI;;;IACjF;;;UAGuD;UAA4B;UAAsB;AACvG,YAAO,0EACM,KAAL,IAAI,EAAJ,aAAa,gCACQ,MAAb,YAAY,EAAZ,cAAqB,uCACZ,OAAX,UAAU,EAAV,eAAmB;IAEnC;UAGkB,QAAa;UAAuB;AACpD,cAAQ,AAAK;;;AAET;;;;AAEa,wBAAQ,AAAK;AAC1B,gBAAI,AAAM,KAAD,KAAI;AAC2F,cAAtG,AAAO,MAAD,WAAmD,AAAE,eAA1C,0BAAoB,IAAI,EAAE,aAAa,WAAW,kBAAY,IAAI,IAAI,AAAK;;AAEhF,+BAAqD,AAAE,eAA1C,0BAAoB,IAAI,EAAE,aAAa,WAAW,kBAAY,IAAI;AAC/E;AACZ,sBAAQ,AAAK;;;AAEmC,oBAA5C,eAAe,AAAW,UAAD,SAAS,AAAM,KAAD,GAAG;AAC1C;;;;AAEyB,oBAAzB,eAAe,UAAU;AACzB;;;;AAE4C,oBAA5C,eAAe,AAAW,UAAD,SAAS,AAAM,KAAD,GAAG;AAC1C;;;AAE0C,cAA9C,AAAO,MAAD,WAAW,YAAY,EAAE,AAAK;;;;IAG5C;YAGwB;;AACtB,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAGT,6DAHG,KAAK,KACL,AAAM,AAAK,KAAN,cAAS,cACd,AAAM,AAAa,KAAd,sBAAiB,sBACtB,AAAM,AAAW,KAAZ,gBAAe;IAC7B;;AAGoB,YAAO,kBAAK,WAAM,mBAAc;IAAW;;AAI7D,YAAO,AAA4H,sCAAnG,aAAI,gBAAG,qBAAY,OAAuB,CAAlB,AAAW,kBAAE,uBAAqB,KAAG;IAC/F;;;QA5LQ;QACD;QACS;IADT;IACS;UACJ,AAAK,IAAD;UACJ,AAAa,YAAD;UACZ,AAAW,UAAD;AANhB,6FACE,IAAI;;EAKmB","file":"../../../../../../../../../../packages/flutter/src/painting/rounded_rectangle_border.dart.lib.js"}');
  // Exports:
  return {
