define(['dart_sdk', 'packages/flutter/src/painting/image_stream.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/scheduler/binding.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__painting__image_cache_dart(dart_sdk, packages__flutter__src__painting__image_stream$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__scheduler__binding$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  var T = {
    ...
    VoidTo_PendingImage: () => (T.VoidTo_PendingImage = dart.constFn(dart.fnType(image_cache._PendingImage, [])))(),
    _PendingImageTodynamic: () => (T._PendingImageTodynamic = dart.constFn(dart.fnType(dart.dynamic, [image_cache._PendingImage])))(),
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/image_cache.dart",
  ...
  image_cache.ImageCache = class ImageCache extends core.Object {
    ...
    set maximumSize(value) {
      let t0;
      if (!(value !== null)) dart.assertFailed(null, I[0], 102, 12, "value != null");
      if (!(value >= 0)) dart.assertFailed(null, I[0], 103, 12, "value >= 0");
    ...
    evict(key, opts) {
      ...
      if (!(includeLive !== null)) dart.assertFailed(null, I[0], 243, 12, "includeLive != null");
      if (includeLive) {
    ...
    [_touch](key, image, timelineTask) {
      if (!(timelineTask != null)) dart.assertFailed(null, I[0], 289, 12, "timelineTask != null");
    ...
    putIfAbsent(key, loader, opts) {
      ...
      if (!(key !== null)) dart.assertFailed(null, I[0], 327, 12, "key != null");
      if (!(loader !== null)) dart.assertFailed(null, I[0], 328, 12, "loader != null");
      let timelineTask = null;
      ...
      function pendingImage$35get() {
        let t2;
        t2 = pendingImage;
        return t2 == null ? dart.throw(new _internal.LateError.localNI("pendingImage")) : t2;
      }
      dart.fn(pendingImage$35get, T.VoidTo_PendingImage());
      function pendingImage$35set(pendingImage$35param) {
        return pendingImage = pendingImage$35param;
      }
      dart.fn(pendingImage$35set, T._PendingImageTodynamic());
      const listener = (info, syncCall) => {
        ...
        if (!listenedOnce) {
          pendingImage$35get().removeListener();
        }
      ...
      pendingImage$35set(new image_cache._PendingImage.new(result, streamListener));
      if (trackPendingImage) {
        this[_pendingImages][$_set](key, pendingImage$35get());
      }
    ...
    [_checkCacheSize](timelineTask) {
      ...
      {
        checkCacheTask = (t4 = new developer.TimelineTask.new({parent: timelineTask}), (() => {
          t4.start("checkCacheSize");
          return t4;
        })());
      ...
      if (!(this[_currentSizeBytes] >= 0)) dart.assertFailed(null, I[0], 531, 12, "_currentSizeBytes >= 0");
      if (!(this[_cache][$length] <= this.maximumSize)) dart.assertFailed(null, I[0], 532, 12, "_cache.length <= maximumSize");
      if (!(this[_currentSizeBytes] <= this.maximumSizeBytes)) dart.assertFailed(null, I[0], 533, 12, "_currentSizeBytes <= maximumSizeBytes");
    }
  ...
  (image_cache.ImageCacheStatus.__ = function(opts) {
    ...
    this[live$] = live;
    if (!(!pending || !keepAlive)) dart.assertFailed(null, I[0], 560, 15, "!pending || !keepAlive");
    ;
  ...
  image_cache._CachedImageBase = class _CachedImageBase extends core.Object {
    dispose() {
      if (!(this.handle != null)) dart.assertFailed(null, I[0], 625, 12, "handle != null");
      binding.SchedulerBinding.instance.addPostFrameCallback(dart.fn(timeStamp => {
        let t4;
        if (!(this.handle != null)) dart.assertFailed(null, I[0], 629, 14, "handle != null");
        t4 = this.handle;
  ...
  (image_cache._CachedImageBase.new = function(completer, opts) {
    ...
    if (!(completer !== null)) dart.assertFailed(null, I[0], 616, 15, "completer != null");
  ...
  image_cache._LiveImage = class _LiveImage extends image_cache._CachedImageBase {
    ...
    get [_handleRemove]() {
      let t4;
      t4 = this[___LiveImage__handleRemove];
      return t4 == null ? dart.throw(new _internal.LateError.fieldNI("_handleRemove")) : t4;
    }
    set [_handleRemove](library$32package$58flutter$47src$47painting$47image_cache$46dart$58$58_handleRemove$35param) {
      this[___LiveImage__handleRemove] = library$32package$58flutter$47src$47painting$47image_cache$46dart$58$58_handleRemove$35param;
    }
    dispose() {
