define(['dart_sdk', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/alignment.dart', 'packages/flutter/src/foundation/collections.dart'], (function load__packages__flutter__src__painting__gradient_dart(dart_sdk, packages__vector_math__vector_math_64$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__alignment$46dart, packages__flutter__src__foundation__collections$46dart) {
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/gradient.dart"
  ];
  ...
  gradient.GradientRotation = class GradientRotation extends gradient.GradientTransform {
    ...
    _equals(other) {
      ...
      return gradient.GradientRotation.is(other) && other.radians === this.radians;
    }
    get hashCode() {
  ...
  gradient.Gradient = class Gradient extends core.Object {
    ...
    [_impliedStops]() {
      ...
      if (!(this.colors[$length] >= 2)) dart.assertFailed("colors list must have at least two colors", I[1], 211, 12, "colors.length >= 2");
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[1], 314, 12, "t != null");
      let result = null;
      if (b != null) {
      ...
      if (!(a != null && b != null)) dart.assertFailed(null, I[1], 328, 12, "a != null && b != null");
  ...
  (gradient.Gradient.new = function(opts) {
    ...
    if (!(colors !== null)) dart.assertFailed(null, I[1], 173, 15, "colors != null");
    ;
  ...
  gradient.LinearGradient = class LinearGradient extends gradient.Gradient {
    ...
    lerpFrom(a, t) {
      if (a == null || gradient.LinearGradient.is(a)) {
        return gradient.LinearGradient.lerp(T.LinearGradientN().as(a), this, t);
      }
      return super.lerpFrom(a, t);
    }
    lerpTo(b, t) {
      if (b == null || gradient.LinearGradient.is(b)) {
        return gradient.LinearGradient.lerp(this, T.LinearGradientN().as(b), t);
      }
      return super.lerpTo(b, t);
    }
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[1], 494, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
    ...
    _equals(other) {
      ...
      return gradient.LinearGradient.is(other) && other.begin._equals(this.begin) && other.end._equals(this.end) && other.tileMode === this.tileMode && dart.equals(other.transform, this.transform) && collections.listEquals(ui.Color, other.colors, this.colors) && collections.listEquals(core.double, other.stops, this.stops);
    }
    get hashCode() {
    ...
    toString() {
      let description = (() => {
        let t0 = T.JSArrayOfString().of(["begin: " + dart.str(this.begin), "end: " + dart.str(this.end), "colors: " + dart.str(this.colors)]);
        if (this.stops != null) t0.push("stops: " + dart.str(this.stops));
        t0.push("tileMode: " + dart.str(this.tileMode));
        if (this.transform != null) t0.push("transform: " + dart.str(this.transform));
        return t0;
      })();
  ...
  (gradient.LinearGradient.new = function(opts) {
    ...
    if (!(begin !== null)) dart.assertFailed(null, I[1], 389, 15, "begin != null");
    if (!(end !== null)) dart.assertFailed(null, I[1], 390, 15, "end != null");
    if (!(tileMode !== null)) dart.assertFailed(null, I[1], 391, 15, "tileMode != null");
  ...
  gradient.RadialGradient = class RadialGradient extends gradient.Gradient {
    ...
    lerpFrom(a, t) {
      if (a == null || gradient.RadialGradient.is(a)) {
        return gradient.RadialGradient.lerp(T.RadialGradientN().as(a), this, t);
      }
      return super.lerpFrom(a, t);
    }
    lerpTo(b, t) {
      if (b == null || gradient.RadialGradient.is(b)) {
        return gradient.RadialGradient.lerp(this, T.RadialGradientN().as(b), t);
      }
      return super.lerpTo(b, t);
    }
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[1], 777, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
    ...
    _equals(other) {
      ...
      return gradient.RadialGradient.is(other) && other.center._equals(this.center) && other.radius === this.radius && other.tileMode === this.tileMode && dart.equals(other.transform, this.transform) && collections.listEquals(ui.Color, other.colors, this.colors) && collections.listEquals(core.double, other.stops, this.stops) && dart.equals(other.focal, this.focal) && other.focalRadius === this.focalRadius;
    }
    get hashCode() {
    ...
    toString() {
      let description = (() => {
        let t1 = T.JSArrayOfString().of(["center: " + dart.str(this.center), "radius: " + debug.debugFormatDouble(this.radius), "colors: " + dart.str(this.colors)]);
        if (this.stops != null) t1.push("stops: " + dart.str(this.stops));
        t1.push("tileMode: " + dart.str(this.tileMode));
        if (this.focal != null) t1.push("focal: " + dart.str(this.focal));
        t1.push("focalRadius: " + debug.debugFormatDouble(this.focalRadius));
        if (this.transform != null) t1.push("transform: " + dart.str(this.transform));
        return t1;
      })();
  ...
  (gradient.RadialGradient.new = function(opts) {
    ...
    if (!(center !== null)) dart.assertFailed(null, I[1], 645, 15, "center != null");
    if (!(radius !== null)) dart.assertFailed(null, I[1], 646, 15, "radius != null");
    if (!(tileMode !== null)) dart.assertFailed(null, I[1], 647, 15, "tileMode != null");
    if (!(focalRadius !== null)) dart.assertFailed(null, I[1], 648, 15, "focalRadius != null");
  ...
  gradient.SweepGradient = class SweepGradient extends gradient.Gradient {
    ...
    lerpFrom(a, t) {
      if (a == null || gradient.SweepGradient.is(a)) {
        return gradient.SweepGradient.lerp(T.SweepGradientN().as(a), this, t);
      }
      return super.lerpFrom(a, t);
    }
    lerpTo(b, t) {
      if (b == null || gradient.SweepGradient.is(b)) {
        return gradient.SweepGradient.lerp(this, T.SweepGradientN().as(b), t);
      }
      return super.lerpTo(b, t);
    }
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[1], 1048, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
    ...
    _equals(other) {
      ...
      return gradient.SweepGradient.is(other) && other.center._equals(this.center) && other.startAngle === this.startAngle && other.endAngle === this.endAngle && other.tileMode === this.tileMode && dart.equals(other.transform, this.transform) && collections.listEquals(ui.Color, other.colors, this.colors) && collections.listEquals(core.double, other.stops, this.stops);
    }
    get hashCode() {
    ...
    toString() {
      let description = (() => {
        let t2 = T.JSArrayOfString().of(["center: " + dart.str(this.center), "startAngle: " + debug.debugFormatDouble(this.startAngle), "endAngle: " + debug.debugFormatDouble(this.endAngle), "colors: " + dart.str(this.colors)]);
        if (this.stops != null) t2.push("stops: " + dart.str(this.stops));
        t2.push("tileMode: " + dart.str(this.tileMode));
        if (this.transform != null) t2.push("transform: " + dart.str(this.transform));
        return t2;
      })();
  ...
  (gradient.SweepGradient.new = function(opts) {
    ...
    if (!(center !== null)) dart.assertFailed(null, I[1], 944, 15, "center != null");
    if (!(startAngle !== null)) dart.assertFailed(null, I[1], 945, 15, "startAngle != null");
    if (!(endAngle !== null)) dart.assertFailed(null, I[1], 946, 15, "endAngle != null");
    if (!(tileMode !== null)) dart.assertFailed(null, I[1], 947, 15, "tileMode != null");
  ...
  gradient._sample = function _sample(colors, stops, t) {
    if (!(colors !== null)) dart.assertFailed(null, I[1], 23, 10, "colors != null");
    if (!colors[$isNotEmpty]) dart.assertFailed(null, I[1], 24, 10, "colors.isNotEmpty");
    if (!(stops !== null)) dart.assertFailed(null, I[1], 25, 10, "stops != null");
    if (!stops[$isNotEmpty]) dart.assertFailed(null, I[1], 26, 10, "stops.isNotEmpty");
    if (!(t !== null)) dart.assertFailed(null, I[1], 27, 10, "t != null");
    if (t <= stops[$first]) {
      return colors[$first];
    }
    if (t >= stops[$last]) {
  ...
  gradient._interpolateColorsAndStops = function _interpolateColorsAndStops(aColors, aStops, bColors, bStops, t) {
    ...
    let stops = (t3 = new (T.SplayTreeSetOfdouble()).new(), (() => {
      t3.addAll(aStops);
      t3.addAll(bStops);
      return t3;
    })());
  ...
  }, '{"version":3,"sourceRoot":"","sources":["gradient.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;2CAeuB,QAAa;IAAb;IAAa;;EAAM;;;;;;;;;;;;EAyDf;;;;;;IAiCZ;;;;;;;;;cAGU;;UAAwB;AAC7C,YAAO,AAAO,MAAD;AACA,uBAAkB,SAAI;AACtB,+BAAqB,AAAE,IAAO,SAAI;AAClC,mBAAS,AAAO,MAAD;AACf,oBAAU,AAAW,AAAY,UAAb,GAAG,AAAO,MAAD,MAAM,AAAmB,kBAAD,GAAG,AAAO,MAAD;AAC9D,oBAAU,AAAY,AAAY,CAAvB,UAAU,GAAG,AAAO,MAAD,MAAM,AAAmB,kBAAD,GAAG,AAAO,MAAD;AAE5E,WAAe;;AACX,qBAAU,OAAO,EAAE,OAAO;AAC1B,mBAAQ;;;IACd;YAGwB;;AACtB,UAAI,AAAU,SAAM,KAAK;AACvB,cAAO;;AAET,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AACT,8BADG,KAAK,KACL,AAAM,AAAQ,KAAT,aAAY;IAC1B;;AAGoB,YAAA,AAAQ;IAAQ;;AAIlC,YAAU,AAAqF,0BAAnE,MAAM,sBAAoB,eAAY,wBAAkB,gBAAS;IAC/F;;;IArC4B;AAAtB;;EAA8B;;;;;;;;;;;;;;;;;;;;IA8ElB;;;;;;IAkBE;;;;;;IAMK;;;;;;;AAGvB,UAAI;AACF,cAAY,gBAAL;;AAET,YAAO,AAAO,AAAO,wBAAG,sBAAG;AACd,uBAAa,AAAI,OAAG,AAAO,AAAO,uBAAE;AACjD,YAAO,2BACL,AAAO,sBACP,QAAK,SAAU,AAAM,KAAD,GAAG,UAAU,+BACvB;IAEd;aAgD6B,GAAU;AACrC,UAAI,AAAE,CAAD;AACH,cAAO,YAAM,CAAC;;AAEhB,YAAO;IACT;WA2B2B,GAAU;AACnC,UAAI,AAAE,CAAD;AACH,cAAO,YAAM,AAAI,MAAE,CAAC;;AAEtB,YAAO;IACT;gBAUgC,GAAa,GAAU;AACrD,YAAO,AAAE,CAAD;AACE;AACV,UAAI,CAAC;AACsB,QAAzB,SAAS,AAAE,CAAD,UAAU,CAAC,EAAE,CAAC;;AAE1B,UAAI,AAAO,MAAD,YAAY,CAAC;AACE,QAAvB,SAAS,AAAE,CAAD,QAAQ,CAAC,EAAE,CAAC;;AAExB,UAAI,MAAM;AACR,cAAO,OAAM;;AAEf,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,YAAO,AAAU,CAAT,YAAY,CAAC;AACrB,YAAO,AAAE,EAAD,GAAG,MAAO,AAAE,eAAH,CAAC,QAAQ,AAAI,MAAG,AAAE,CAAD,GAAG,OAAS,AAAE,eAAH,CAAC,QAAkB,CAAT,AAAE,CAAD,GAAG,OAAO;IACpE;wBAEoC,QAAuB;;AACzD,WAAO;uCAAW,aAAU,MAAM,kBAAiB,aAAa,iBAAzD,OAA4D;IACrE;;;QApKgB;QACT;QACA;IAFS;IACT;IACA;UACK,AAAO,MAAD;;EAAS;;;;;;;;;;;;;;;;;;;;;;;;;;IAyOH;;;;;;IAeA;;;;;;IAWT;;;;;;;;;;;;;;;iBAGU;UAAuB;AAC9C,YAAmB,oBACjB,AAAM,AAAuB,mBAAf,aAAa,aAAa,IAAI,GAC5C,AAAI,AAAuB,iBAAf,aAAa,aAAa,IAAI,GAC1C,aAAQ,uBAAiB,eAAU,wBAAkB,IAAI,EAAE,aAAa;IAE5E;UAO4B;AAC1B,YAAO,yCACE,iBACF,kBACG,AAAO,AAA8D,4BAAnD,QAAO,SAAyC,eAAzB,cAAK,MAAM,KAAK,EAAE,MAAM,0CAClE,sBACG;IAEd;aAG6B,GAAU;AACrC,UAAI,AAAE,CAAD,YAAe,2BAAF,CAAC;AACjB,cAAsB,8BAAO,uBAAF,CAAC,GAAqB,MAAM,CAAC;;AAE1D,YAAa,gBAAS,CAAC,EAAE,CAAC;IAC5B;WAG2B,GAAU;AACnC,UAAI,AAAE,CAAD,YAAe,2BAAF,CAAC;AACjB,cAAsB,8BAAK,MAAQ,uBAAF,CAAC,GAAqB,CAAC;;AAE1D,YAAa,cAAO,CAAC,EAAE,CAAC;IAC1B;gBAqB4C,GAAmB,GAAU;AACvE,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAQ,AAAE,gBAAH,CAAC,QAAQ,CAAC;;AAEnB,UAAI,AAAE,CAAD;AACH,cAAO,AAAE,EAAD,OAAO,AAAI,MAAE,CAAC;;AAEF,yBAAe,oCACjC,AAAE,CAAD,SACD,AAAE,CAAD,mBACD,AAAE,CAAD,SACD,AAAE,CAAD,mBACD,CAAC;AAEL,YAAO,yCAC6C,eAAzB,iCAAK,AAAE,CAAD,QAAQ,AAAE,CAAD,QAAQ,CAAC,SACL,eAArB,iCAAK,AAAE,CAAD,MAAM,AAAE,CAAD,MAAM,CAAC,YACnC,AAAa,YAAD,gBACb,AAAa,YAAD,kBACT,AAAE,CAAD,GAAG,MAAM,AAAE,CAAD,YAAY,AAAE,CAAD;IAEtC;YAGwB;;AACtB,UAAI,AAAU,SAAM,KAAK;AACvB,cAAO;;AAET,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAMT,4BANG,KAAK,KACL,AAAM,AAAM,KAAP,eAAU,eACf,AAAM,AAAI,KAAL,aAAQ,aACb,AAAM,AAAS,KAAV,cAAa,iBACF,YAAhB,AAAM,KAAD,YAAc,mBACnB,iCAAkB,AAAM,KAAD,SAAS,gBAChC,oCAAmB,AAAM,KAAD,QAAQ;IACzC;;AAGoB,YAAO,kBACzB,YACA,UACA,eACA,gBACO,oBAAQ,cACf,AAAM,qBAAU,OAAc,oBAAa,eAAL;IACvC;;AAIoB,wBAAsB;yCACvC,AAAe,qBAAN,aACT,AAAW,mBAAJ,WACP,AAAiB,sBAAP;AACV,YAAI,oBAA8B,QAAf,qBAAS;AACP,gBAArB,wBAAY;AACZ,YAAI,wBAA0C,QAAvB,yBAAa;;;AAGtC,YAAU,AAAsE,0BAApD,MAAM,oBAAkB,MAAG,AAAY,WAAD,QAAM,QAAM;IAChF;;;QAhLO;QACA;QACU;QACT;QACD;QACC;IALD;IACA;IAGA;UAEK,AAAM,KAAD;UACL,AAAI,GAAD;UACH,AAAS,QAAD;AATd,8DAGW,MAAM,SACf,KAAK,aAEL,SAAS;;EAGY;;;;;;;;;;;;;;;;;;;;;;;;IAiRL;;;;;;IAQX;;;;;;IAgBE;;;;;;IAUU;;;;;;IAYZ;;;;;;;;;;;;;;;;;iBAGY;UAAuB;AAC9C,YAAmB,oBACjB,AAAO,AAAuB,oBAAf,aAAa,aAAa,IAAI,GAC7C,AAAO,cAAE,AAAK,IAAD,eACb,aAAQ,uBAAiB,eACzB,wBAAkB,IAAI,EAAE,aAAa,GACrC,AAAM,qBAAW,OAAY,AAAE,AAAuB,eAA9B,oBAAe,aAAa,aAAa,IAAI,GACrE,AAAY,mBAAE,AAAK,IAAD;IAEtB;UAO4B;AAC1B,YAAO,0CACG,qBACA,qBACA,AAAO,AAA8D,4BAAnD,QAAO,SAAyC,eAAzB,cAAK,MAAM,KAAK,EAAE,MAAM,0CAClE,sBACG,sBACH,yBACM;IAEjB;aAG6B,GAAU;AACrC,UAAI,AAAE,CAAD,YAAe,2BAAF,CAAC;AACjB,cAAsB,8BAAO,uBAAF,CAAC,GAAqB,MAAM,CAAC;;AAE1D,YAAa,gBAAS,CAAC,EAAE,CAAC;IAC5B;WAG2B,GAAU;AACnC,UAAI,AAAE,CAAD,YAAe,2BAAF,CAAC;AACjB,cAAsB,8BAAK,MAAQ,uBAAF,CAAC,GAAqB,CAAC;;AAE1D,YAAa,cAAO,CAAC,EAAE,CAAC;IAC1B;gBAqB4C,GAAmB,GAAU;AACvE,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAQ,AAAE,gBAAH,CAAC,QAAQ,CAAC;;AAEnB,UAAI,AAAE,CAAD;AACH,cAAO,AAAE,EAAD,OAAO,AAAI,MAAE,CAAC;;AAEF,yBAAe,oCACjC,AAAE,CAAD,SACD,AAAE,CAAD,mBACD,AAAE,CAAD,SACD,AAAE,CAAD,mBACD,CAAC;AAEL,YAAO,0CACgD,eAA3B,iCAAK,AAAE,CAAD,SAAS,AAAE,CAAD,SAAS,CAAC,YACvC,sBAAI,KAAyC,eAAjC,cAAW,AAAE,CAAD,SAAS,AAAE,CAAD,SAAS,CAAC,aACjD,AAAa,YAAD,gBACb,AAAa,YAAD,kBACT,AAAE,CAAD,GAAG,MAAM,AAAE,CAAD,YAAY,AAAE,CAAD,kBACT,iCAAK,AAAE,CAAD,QAAQ,AAAE,CAAD,QAAQ,CAAC,gBAC/B,sBAAI,KAAmD,eAA3C,cAAW,AAAE,CAAD,cAAc,AAAE,CAAD,cAAc,CAAC;IAE5E;YAGwB;;AACtB,UAAI,AAAU,SAAM,KAAK;AACvB,cAAO;;AAET,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAQT,4BARG,KAAK,KACL,AAAM,AAAO,KAAR,gBAAW,gBAChB,AAAM,AAAO,KAAR,YAAW,eAChB,AAAM,AAAS,KAAV,cAAa,iBACF,YAAhB,AAAM,KAAD,YAAc,mBACnB,iCAAkB,AAAM,KAAD,SAAS,gBAChC,oCAAmB,AAAM,KAAD,QAAQ,eACpB,YAAZ,AAAM,KAAD,QAAU,eACf,AAAM,AAAY,KAAb,iBAAgB;IAC9B;;AAGoB,YAAO,kBACzB,aACA,aACA,eACA,gBACO,oBAAQ,cACf,AAAM,qBAAU,OAAc,oBAAa,eAAL,cACtC,YACA;IACD;;AAIoB,wBAAsB;yCACvC,AAAiB,sBAAP,cACV,AAAsC,aAA3B,wBAAkB,cAC7B,AAAiB,sBAAP;AACV,YAAI,oBAA8B,QAAf,qBAAS;AACP,gBAArB,wBAAY;AACZ,YAAI,oBAA8B,QAAf,qBAAS;AACoB,gBAAhD,kBAAgB,wBAAkB;AAClC,YAAI,wBAA0C,QAAvB,yBAAa;;;AAGtC,YAAU,AAAsE,0BAApD,MAAM,oBAAkB,MAAG,AAAY,WAAD,QAAM,QAAM;IAChF;;;QArNO;QACA;QACU;QACT;QACD;QACA;QACA;QACC;IAPD;IACA;IAGA;IACA;IACA;UAEK,AAAO,MAAD;UACN,AAAO,MAAD;UACN,AAAS,QAAD;UACR,AAAY,WAAD;AAZjB,8DAGW,MAAM,SACf,KAAK,aAIL,SAAS;;EAIe;;;;;;;;;;;;;;;;;;;;;;;;;IA2TR;;;;;;IAKX;;;;;;IAKA;;;;;;IAWE;;;;;;;;;;;;;;;;iBAGU;UAAuB;AAC9C,YAAmB,mBACjB,AAAO,AAAuB,oBAAf,aAAa,aAAa,IAAI,GAC7C,aAAQ,uBAAiB,eACzB,iBACA,eACA,wBAAkB,IAAI,EAAE,aAAa;IAEzC;UAO2B;AACzB,YAAO,yCACG,yBACI,2BACF,uBACF,AAAO,AAA8D,4BAAnD,QAAO,SAAyC,eAAzB,cAAK,MAAM,KAAK,EAAE,MAAM,0CAClE,sBACG;IAEd;aAG6B,GAAU;AACrC,UAAI,AAAE,CAAD,YAAe,0BAAF,CAAC;AACjB,cAAqB,6BAAO,sBAAF,CAAC,GAAoB,MAAM,CAAC;;AAExD,YAAa,gBAAS,CAAC,EAAE,CAAC;IAC5B;WAG2B,GAAU;AACnC,UAAI,AAAE,CAAD,YAAe,0BAAF,CAAC;AACjB,cAAqB,6BAAK,MAAQ,sBAAF,CAAC,GAAoB,CAAC;;AAExD,YAAa,cAAO,CAAC,EAAE,CAAC;IAC1B;gBAoB0C,GAAkB,GAAU;AACpE,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAQ,AAAE,gBAAH,CAAC,QAAQ,CAAC;;AAEnB,UAAI,AAAE,CAAD;AACH,cAAO,AAAE,EAAD,OAAO,AAAI,MAAE,CAAC;;AAEF,yBAAe,oCACjC,AAAE,CAAD,SACD,AAAE,CAAD,mBACD,AAAE,CAAD,SACD,AAAE,CAAD,mBACD,CAAC;AAEL,YAAO,yCACgD,eAA3B,iCAAK,AAAE,CAAD,SAAS,AAAE,CAAD,SAAS,CAAC,gBACnC,sBAAI,KAAiD,eAAzC,cAAW,AAAE,CAAD,aAAa,AAAE,CAAD,aAAa,CAAC,eACtD,sBAAI,KAA6C,eAArC,cAAW,AAAE,CAAD,WAAW,AAAE,CAAD,WAAW,CAAC,aACvD,AAAa,YAAD,gBACb,AAAa,YAAD,kBACT,AAAE,CAAD,GAAG,MAAM,AAAE,CAAD,YAAY,AAAE,CAAD;IAEtC;YAGwB;;AACtB,UAAI,AAAU,SAAM,KAAK;AACvB,cAAO;;AAET,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAOT,2BAPG,KAAK,KACL,AAAM,AAAO,KAAR,gBAAW,gBAChB,AAAM,AAAW,KAAZ,gBAAe,mBACpB,AAAM,AAAS,KAAV,cAAa,iBAClB,AAAM,AAAS,KAAV,cAAa,iBACF,YAAhB,AAAM,KAAD,YAAc,mBACnB,iCAAkB,AAAM,KAAD,SAAS,gBAChC,oCAAmB,AAAM,KAAD,QAAQ;IACzC;;AAGoB,YAAO,kBACzB,aACA,iBACA,eACA,eACA,gBACO,oBAAQ,cACf,AAAM,qBAAU,OAAc,oBAAa,eAAL;IACvC;;AAIoB,wBAAsB;yCACvC,AAAiB,sBAAP,cACV,AAA8C,iBAA/B,wBAAkB,kBACjC,AAA0C,eAA7B,wBAAkB,gBAC/B,AAAiB,sBAAP;AACV,YAAI,oBAA8B,QAAf,qBAAS;AACP,gBAArB,wBAAY;AACZ,YAAI,wBAA0C,QAAvB,yBAAa;;;AAGtC,YAAU,AAAqE,0BAAnD,MAAM,mBAAiB,MAAG,AAAY,WAAD,QAAM,QAAM;IAC/E;;;QApLO;QACA;QACA;QACU;QACT;QACD;QACC;IAND;IACA;IACA;IAGA;UAEK,AAAO,MAAD;UACN,AAAW,UAAD;UACV,AAAS,QAAD;UACR,AAAS,QAAD;AAXd,6DAIW,MAAM,SACf,KAAK,aAEL,SAAS;;EAIY;;;;;;;;;;;;;;;;;;;sCA75BL,QAAqB,OAAc;AAC3D,UAAO,AAAO,MAAD;AACb,SAAO,AAAO,MAAD;AACb,UAAO,AAAM,KAAD;AACZ,SAAO,AAAM,KAAD;AACZ,UAAO,AAAE,CAAD;AACR,QAAI,AAAE,CAAD,IAAI,AAAM,KAAD;AACZ,YAAO,AAAO,OAAD;;AAEf,QAAI,AAAE,CAAD,IAAI,AAAM,KAAD;AACZ,YAAO,AAAO,OAAD;;AAEL,gBAAQ,AAAM,KAAD,kBAAgB,QAAQ,KAAM,AAAE,CAAD,IAAI,CAAC;AAC3D,UAAO,AAAM,KAAD,KAAI,CAAC;AACjB,UAGC,gBAHY,cACT,AAAM,MAAA,QAAC,KAAK,GAAG,AAAM,MAAA,QAAC,AAAM,KAAD,GAAG,IACX,CAAlB,AAAE,CAAD,GAAG,AAAK,KAAA,QAAC,KAAK,MAAM,AAAK,AAAY,KAAZ,QAAC,AAAM,KAAD,GAAG,KAAK,AAAK,KAAA,QAAC,KAAK;EAE1D;4EAGc,SACC,QACD,SACC,QACN;;AAEP,UAAO,AAAQ,AAAO,OAAR,aAAW;AACzB,UAAO,AAAQ,AAAO,OAAR,aAAW;AACzB,UAAO,AAAO,AAAO,MAAR,cAAW,AAAQ,OAAD;AAC/B,UAAO,AAAO,AAAO,MAAR,cAAW,AAAQ,OAAD;AACJ,4DAAQ;AAC/B,gBAAO,MAAM;AACb,gBAAO,MAAM;;;AACE,4BAAoB,AAAM,KAAD,mBAAkB;AAC5C,6BAAqB,AAAkB,AAEvD,iBAFsD,iBAChD,QAAQ,QAAsF,eAAvE,cAAK,iBAAQ,OAAO,EAAE,MAAM,EAAE,IAAI,GAAG,iBAAQ,OAAO,EAAE,MAAM,EAAE,IAAI,GAAG,CAAC,4CAClF;AACnB,UAAO,kCAAgB,kBAAkB,EAAE,iBAAiB;EAC9D","file":"../../../../../../../../../../packages/flutter/src/painting/gradient.dart.lib.js"}');
  // Exports:
  return {
