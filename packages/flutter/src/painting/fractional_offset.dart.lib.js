define(['dart_sdk', 'packages/flutter/src/painting/alignment.dart'], (function load__packages__flutter__src__painting__fractional_offset_dart(dart_sdk, packages__flutter__src__painting__alignment$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/fractional_offset.dart",
  ...
  fractional_offset.FractionalOffset = class FractionalOffset extends alignment.Alignment {
    ...
    static fromOffsetAndSize(offset, size) {
      if (!(size !== null)) dart.assertFailed(null, I[0], 68, 12, "size != null");
      if (!(offset !== null)) dart.assertFailed(null, I[0], 69, 12, "offset != null");
    ...
    ['-'](other) {
      if (!fractional_offset.FractionalOffset.is(other)) {
        return super['-'](other);
      }
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 183, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
  ...
  (fractional_offset.FractionalOffset.new = function(dx, dy) {
    if (!(dx !== null)) dart.assertFailed(null, I[0], 59, 14, "dx != null");
    if (!(dy !== null)) dart.assertFailed(null, I[0], 60, 14, "dy != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["fractional_offset.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;6BAkEoD,QAAa;AAC7D,YAAO,AAAK,IAAD;AACX,YAAO,AAAO,MAAD;AACb,YAAO,4CACL,AAAO,AAAG,MAAJ,MAAM,AAAK,IAAD,QAChB,AAAO,AAAG,MAAJ,MAAM,AAAK,IAAD;IAEpB;;;;6BAWkD,QAAa;AAC7D,YAAwB,sDACtB,AAAO,MAAD,MAAG,AAAK,IAAD,WACb,AAAK,IAAD;IAER;;;;;AASiB,YAAU,EAAT,AAAE,SAAE,OAAO;IAAG;;AAQf,YAAU,EAAT,AAAE,SAAE,OAAO;IAAG;UA8BD;AAC7B,WAAU,sCAAN,KAAK;AACP,cAAa,YAAE,KAAK;;AAEtB,YAAO,4CAAiB,AAAG,UAAE,AAAM,KAAD,KAAK,AAAG,UAAE,AAAM,KAAD;IACnD;UAG+B;AAC7B,WAAU,sCAAN,KAAK;AACP,cAAa,YAAE,KAAK;;AAEtB,YAAO,4CAAiB,AAAG,UAAE,AAAM,KAAD,KAAK,AAAG,UAAE,AAAM,KAAD;IACnD;;AAIE,YAAO,4CAAiB,CAAC,SAAI,CAAC;IAChC;UAGmC;AACjC,YAAO,4CAAiB,AAAG,UAAE,KAAK,EAAE,AAAG,UAAE,KAAK;IAChD;UAGmC;AACjC,YAAO,4CAAiB,AAAG,UAAE,KAAK,EAAE,AAAG,UAAE,KAAK;IAChD;WAGoC;AAClC,YAAO,4CAAqB,AAAU,CAAb,UAAM,KAAK,6BAAkB,AAAU,CAAb,UAAM,KAAK;IAChE;UAGmC;AACjC,YAAO,4CAAiB,AAAG,iBAAE,KAAK,GAAE,AAAG,iBAAE,KAAK;IAChD;gBAOgD,GAAqB,GAAU;AAC7E,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAO,4CAA6C,eAAzB,cAAW,KAAM,AAAE,eAAH,CAAC,MAAM,CAAC,IAA+B,eAAxB,cAAW,KAAK,AAAE,CAAD,KAAK,CAAC;;AAEnF,UAAI,AAAE,CAAD;AACH,cAAO,4CAA4C,eAAxB,cAAW,AAAE,CAAD,KAAK,KAAK,CAAC,IAA+B,eAAxB,cAAW,AAAE,CAAD,KAAK,KAAK,CAAC;;AAElF,YAAO,4CAA6C,eAAzB,cAAW,AAAE,CAAD,KAAK,AAAE,CAAD,KAAK,CAAC,IAAgC,eAAzB,cAAW,AAAE,CAAD,KAAK,AAAE,CAAD,KAAK,CAAC;IACpF;;AAIE,YAAO,uBAAoB,AAAG,0BAAgB,KAAG,OACtB,AAAG,0BAAgB,KAAG;IACnD;;qDA9I8B,IAAW;UAC9B,AAAG,EAAD;UACF,AAAG,EAAD;AACT,gEAAM,AAAG,AAAM,EAAP,GAAG,MAAM,KAAK,AAAG,AAAM,EAAP,GAAG,MAAM;;EAAI;;;;;;;;;;;;;;;;;;;;;MAiDX,0CAAO;;;MAGP,4CAAS;;;MAGT,2CAAQ;;;MAGR,6CAAU;;;MAGV,yCAAM;;;MAGN,8CAAW;;;MAGX,6CAAU;;;MAGV,+CAAY;;;MAGZ,8CAAW","file":"../../../../../../../../../../packages/flutter/src/painting/fractional_offset.dart.lib.js"}');
  // Exports:
  return {
