define(['dart_sdk', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__painting__alignment_dart(dart_sdk, packages__flutter__src__foundation__object$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/alignment.dart",
  ...
  alignment.AlignmentGeometry = class AlignmentGeometry extends core.Object {
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 90, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
      ...
      if (alignment.Alignment.is(a) && alignment.Alignment.is(b)) {
        return alignment.Alignment.lerp(a, b, t);
      }
      if (alignment.AlignmentDirectional.is(a) && alignment.AlignmentDirectional.is(b)) {
  ...
  alignment.Alignment = class Alignment extends alignment.AlignmentGeometry {
    ...
    add(other) {
      if (alignment.Alignment.is(other)) {
        return this['+'](other);
      }
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 343, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
  ...
  (alignment.Alignment.new = function(x, y) {
    this[x$] = x;
    this[y$] = y;
    if (!(x !== null)) dart.assertFailed(null, I[0], 192, 14, "x != null");
    if (!(y !== null)) dart.assertFailed(null, I[0], 193, 14, "y != null");
  ...
  alignment.AlignmentDirectional = class AlignmentDirectional extends alignment.AlignmentGeometry {
    ...
    add(other) {
      if (alignment.AlignmentDirectional.is(other)) {
        return this['+'](other);
      }
      return super.add(other);
    }
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 537, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
    ...
    resolve(direction) {
      if (!(direction != null)) dart.assertFailed("Cannot resolve " + dart.str(this[$runtimeType]) + " without a TextDirection.", I[0], 552, 12, "direction != null");
  ...
  (alignment.AlignmentDirectional.new = function(start, y) {
    this[start$] = start;
    this[y$0] = y;
    if (!(start !== null)) dart.assertFailed(null, I[0], 411, 14, "start != null");
    if (!(y !== null)) dart.assertFailed(null, I[0], 412, 14, "y != null");
  ...
  alignment._MixedAlignment = class _MixedAlignment extends alignment.AlignmentGeometry {
    ...
    resolve(direction) {
      if (!(direction != null)) dart.assertFailed("Cannot resolve " + dart.str(this[$runtimeType]) + " without a TextDirection.", I[0], 656, 12, "direction != null");
      switch (dart.nullCheck(direction)) {
        case C[9] || CT.C9:
          {
  ...
  (alignment.TextAlignVertical.new = function(opts) {
    let y = opts && 'y' in opts ? opts.y : null;
    this[y$1] = y;
    if (!(y !== null)) dart.assertFailed(null, I[0], 685, 15, "y != null");
    if (!(y >= -1.0 && y <= 1.0)) dart.assertFailed(null, I[0], 686, 15, "y >= -1.0 && y <= 1.0");
    ;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["alignment.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;QAyC0C;AACtC,YAAO,mCACL,AAAG,WAAE,AAAM,KAAD,MACV,AAAO,eAAE,AAAM,KAAD,UACd,AAAG,WAAE,AAAM,KAAD;IAEd;gBAyCkD,GAAsB,GAAU;AAChF,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAQ,AAAE,gBAAH,CAAC,OAAI,CAAC;;AAEf,UAAI,AAAE,CAAD;AACH,cAAO,AAAE,EAAD,MAAI,AAAI,MAAE,CAAC;;AAErB,UAAM,uBAAF,CAAC,KAAmB,uBAAF,CAAC;AACrB,cAAiB,0BAAK,CAAC,EAAE,CAAC,EAAE,CAAC;;AAE/B,UAAM,kCAAF,CAAC,KAA8B,kCAAF,CAAC;AAChC,cAA4B,qCAAK,CAAC,EAAE,CAAC,EAAE,CAAC;;AAE1C,YAAO,mCACuB,eAAzB,cAAW,AAAE,CAAD,MAAK,AAAE,CAAD,MAAK,CAAC,IACS,eAAjC,cAAW,AAAE,CAAD,UAAS,AAAE,CAAD,UAAS,CAAC,IACP,eAAzB,cAAW,AAAE,CAAD,MAAK,AAAE,CAAD,MAAK,CAAC;IAE/B;;AAeE,UAAI,AAAO,iBAAG;AACZ,cAAiB,gCAAW,UAAI;;AAElC,UAAI,AAAG,aAAG;AACR,cAA4B,2CAAW,cAAQ;;AAEjD,YAAoB,AAAsE,gCAA3D,UAAI,YAAI,QAA0B,0CAAW,cAAQ;IACtF;YAGwB;;AACtB,YAAa,AAGT,gCAHG,KAAK,KACL,AAAM,AAAG,KAAJ,SAAO,YACZ,AAAM,AAAO,KAAR,aAAW,gBAChB,AAAM,AAAG,KAAJ,SAAO;IACrB;;AAGoB,YAAO,kBAAK,UAAI,cAAQ;IAAG;;;;EAzHtB;;;;;;;;;;;;;;IAmLZ;;;;;;IAQA;;;;;;;;;;AAGI;IAAC;;AAGG;IAAG;;AAGP;IAAC;QA8BsB;AACtC,UAAU,uBAAN,KAAK;AACP,cAAO,AAAK,WAAE,KAAK;;AAErB,YAAa,WAAI,KAAK;IACxB;UAG+B;AAC7B,YAAO,6BAAU,AAAE,SAAE,AAAM,KAAD,IAAI,AAAE,SAAE,AAAM,KAAD;IACzC;UAG+B;AAC7B,YAAO,6BAAU,AAAE,SAAE,AAAM,KAAD,IAAI,AAAE,SAAE,AAAM,KAAD;IACzC;;AAKE,YAAO,6BAAU,CAAC,QAAG,CAAC;IACxB;UAI4B;AAC1B,YAAO,6BAAU,AAAE,SAAE,KAAK,EAAE,AAAE,SAAE,KAAK;IACvC;UAI4B;AAC1B,YAAO,6BAAU,AAAE,SAAE,KAAK,EAAE,AAAE,SAAE,KAAK;IACvC;WAI6B;AAC3B,YAAO,6BAAa,AAAU,CAAZ,SAAK,KAAK,6BAAiB,AAAU,CAAZ,SAAK,KAAK;IACvD;UAI4B;AAC1B,YAAO,6BAAU,AAAE,gBAAE,KAAK,GAAE,AAAE,gBAAE,KAAK;IACvC;gBAG0B;AACX,oBAAU,AAAM,AAAG,KAAJ,MAAM;AACrB,oBAAU,AAAM,AAAG,KAAJ,MAAM;AAClC,YAAO,mBAAO,AAAQ,OAAD,GAAG,AAAE,SAAE,OAAO,EAAE,AAAQ,OAAD,GAAG,AAAE,SAAE,OAAO;IAC5D;cAGsB;AACP,oBAAU,AAAM,AAAM,KAAP,SAAS;AACxB,oBAAU,AAAM,AAAO,KAAR,UAAU;AACtC,YAAO,mBAAO,AAAQ,OAAD,GAAG,AAAE,SAAE,OAAO,EAAE,AAAQ,OAAD,GAAG,AAAE,SAAE,OAAO;IAC5D;eAGuB;AACR,sBAAY,AAAK,AAAM,IAAP,SAAS;AACzB,uBAAa,AAAK,AAAO,IAAR,UAAU;AACxC,YAAO,mBACL,AAAK,AAAK,AAAY,IAAlB,QAAQ,SAAS,GAAG,AAAE,SAAE,SAAS,EACrC,AAAK,AAAI,AAAa,IAAlB,OAAO,UAAU,GAAG,AAAE,SAAE,UAAU;IAE1C;aAQmB,MAAW;AACf,2BAA2C,CAAzB,AAAK,AAAM,IAAP,SAAS,AAAK,IAAD,UAAU;AAC7C,4BAA8C,CAA3B,AAAK,AAAO,IAAR,UAAU,AAAK,IAAD,WAAW;AAC7D,YAAY,sBACV,AAAK,AAAK,AAAiB,IAAvB,QAAQ,cAAc,GAAG,AAAE,SAAE,cAAc,EAC/C,AAAK,AAAI,AAAkB,IAAvB,OAAO,eAAe,GAAG,AAAE,SAAE,eAAe,EAChD,AAAK,IAAD,QACJ,AAAK,IAAD;IAER;gBAOkC,GAAc,GAAU;AACxD,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAO,6BAAqC,eAAxB,cAAW,KAAM,AAAE,eAAH,CAAC,KAAK,CAAC,IAA8B,eAAvB,cAAW,KAAK,AAAE,CAAD,IAAI,CAAC;;AAE1E,UAAI,AAAE,CAAD;AACH,cAAO,6BAAoC,eAAvB,cAAW,AAAE,CAAD,IAAI,KAAK,CAAC,IAA8B,eAAvB,cAAW,AAAE,CAAD,IAAI,KAAK,CAAC;;AAEzE,YAAO,6BAAoC,eAAvB,cAAW,AAAE,CAAD,IAAI,AAAE,CAAD,IAAI,CAAC,IAA8B,eAAvB,cAAW,AAAE,CAAD,IAAI,AAAE,CAAD,IAAI,CAAC;IACzE;YAGiC;AAAc;IAAI;sBAEnB,GAAU;AACxC,UAAI,AAAE,CAAD,KAAI,CAAC,OAAO,AAAE,CAAD,KAAI,CAAC;AACrB,cAAO;;AAET,UAAI,AAAE,CAAD,KAAI,OAAO,AAAE,CAAD,KAAI,CAAC;AACpB,cAAO;;AAET,UAAI,AAAE,CAAD,KAAI,OAAO,AAAE,CAAD,KAAI,CAAC;AACpB,cAAO;;AAET,UAAI,AAAE,CAAD,KAAI,CAAC,OAAO,AAAE,CAAD,KAAI;AACpB,cAAO;;AAET,UAAI,AAAE,CAAD,KAAI,OAAO,AAAE,CAAD,KAAI;AACnB,cAAO;;AAET,UAAI,AAAE,CAAD,KAAI,OAAO,AAAE,CAAD,KAAI;AACnB,cAAO;;AAET,UAAI,AAAE,CAAD,KAAI,CAAC,OAAO,AAAE,CAAD,KAAI;AACpB,cAAO;;AAET,UAAI,AAAE,CAAD,KAAI,OAAO,AAAE,CAAD,KAAI;AACnB,cAAO;;AAET,UAAI,AAAE,CAAD,KAAI,OAAO,AAAE,CAAD,KAAI;AACnB,cAAO;;AAET,YAAO,gBAAa,AAAE,CAAD,mBAAiB,KAAG,OACrB,AAAE,CAAD,mBAAiB,KAAG;IAC3C;;AAGqB,4CAAW,QAAG;IAAE;;sCAzMhB,GAAQ;IAAR;IAAQ;UAClB,AAAE,CAAD;UACD,AAAE,CAAD;AAFN;;EAEe;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA6BE,2BAAO;;;MAGP,6BAAS;;;MAGT,4BAAQ;;;MAGR,8BAAU;;;MAGV,0BAAM;;;MAGN,+BAAW;;;MAGX,8BAAU;;;MAGV,gCAAY;;;MAGZ,+BAAW;;;;;;;;;IAmLrB;;;;;;IAWA;;;;;;;;;;AAGI;IAAG;;AAGC;IAAK;;AAGT;IAAC;QAuCsB;AACtC,UAAU,kCAAN,KAAK;AACP,cAAO,AAAK,WAAE,KAAK;;AAErB,YAAa,WAAI,KAAK;IACxB;UAGqD;AACnD,YAAO,wCAAqB,AAAM,aAAE,AAAM,KAAD,QAAQ,AAAE,SAAE,AAAM,KAAD;IAC5D;UAGqD;AACnD,YAAO,wCAAqB,AAAM,aAAE,AAAM,KAAD,QAAQ,AAAE,SAAE,AAAM,KAAD;IAC5D;;AAKE,YAAO,wCAAqB,CAAC,YAAO,CAAC;IACvC;UAIuC;AACrC,YAAO,wCAAqB,AAAM,aAAE,KAAK,EAAE,AAAE,SAAE,KAAK;IACtD;UAIuC;AACrC,YAAO,wCAAqB,AAAM,aAAE,KAAK,EAAE,AAAE,SAAE,KAAK;IACtD;WAIwC;AACtC,YAAO,wCAA4B,AAAU,CAAhB,aAAS,KAAK,6BAAiB,AAAU,CAAZ,SAAK,KAAK;IACtE;UAIuC;AACrC,YAAO,wCAAqB,AAAM,oBAAE,KAAK,GAAE,AAAE,gBAAE,KAAK;IACtD;gBAOwD,GAAyB,GAAU;AACzF,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAO,wCAAoD,eAA5B,cAAW,KAAM,AAAE,eAAH,CAAC,SAAS,CAAC,IAA8B,eAAvB,cAAW,KAAK,AAAE,CAAD,IAAI,CAAC;;AAEzF,UAAI,AAAE,CAAD;AACH,cAAO,wCAAmD,eAA3B,cAAW,AAAE,CAAD,QAAQ,KAAK,CAAC,IAA8B,eAAvB,cAAW,AAAE,CAAD,IAAI,KAAK,CAAC;;AAExF,YAAO,wCAAuD,eAA/B,cAAW,AAAE,CAAD,QAAQ,AAAE,CAAD,QAAQ,CAAC,IAA8B,eAAvB,cAAW,AAAE,CAAD,IAAI,AAAE,CAAD,IAAI,CAAC;IAC5F;YAGiC;AAC/B,YAAO,AAAU,SAAD,6BAAU,AAAsD,6BAArC,sBAAW;AACtD,cAAiB,eAAT,SAAS;;;AAEb,kBAAO,6BAAU,CAAC,YAAO;;;;AAEzB,kBAAO,6BAAU,YAAO;;;IAE9B;sBAEgC,OAAc;AAC5C,UAAI,AAAM,KAAD,KAAI,CAAC,OAAO,AAAE,CAAD,KAAI,CAAC;AACzB,cAAO;;AAET,UAAI,AAAM,KAAD,KAAI,OAAO,AAAE,CAAD,KAAI,CAAC;AACxB,cAAO;;AAET,UAAI,AAAM,KAAD,KAAI,OAAO,AAAE,CAAD,KAAI,CAAC;AACxB,cAAO;;AAET,UAAI,AAAM,KAAD,KAAI,CAAC,OAAO,AAAE,CAAD,KAAI;AACxB,cAAO;;AAET,UAAI,AAAM,KAAD,KAAI,OAAO,AAAE,CAAD,KAAI;AACvB,cAAO;;AAET,UAAI,AAAM,KAAD,KAAI,OAAO,AAAE,CAAD,KAAI;AACvB,cAAO;;AAET,UAAI,AAAM,KAAD,KAAI,CAAC,OAAO,AAAE,CAAD,KAAI;AACxB,cAAO;;AAET,UAAI,AAAM,KAAD,KAAI,OAAO,AAAE,CAAD,KAAI;AACvB,cAAO;;AAET,UAAI,AAAM,KAAD,KAAI,OAAO,AAAE,CAAD,KAAI;AACvB,cAAO;;AAET,YAAO,2BAAwB,AAAM,KAAD,mBAAiB,KAAG,OACzB,AAAE,CAAD,mBAAiB,KAAG;IACtD;;AAGqB,uDAAW,YAAO;IAAE;;iDAxLT,OAAY;IAAZ;IAAY;UACjC,AAAM,KAAD;UACL,AAAE,CAAD;AAFN;;EAEe;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAoCa,uCAAQ;;;MAMR,wCAAS;;;MAGT,qCAAM;;;MAGN,0CAAW;;;MAMX,qCAAM;;;MAGN,wCAAS;;;MAGT,0CAAW;;;MAMX,2CAAY;;;MAGZ,wCAAS;;;;;;;;IAwH9B;;;;;;IAGA;;;;;;IAGA;;;;;;;;;;AAIX,YAAO,mCACL,CAAC,UACD,CAAC,cACD,CAAC;IAEL;UAGkC;AAChC,YAAO,mCACL,AAAG,WAAE,KAAK,EACV,AAAO,eAAE,KAAK,EACd,AAAG,WAAE,KAAK;IAEd;UAGkC;AAChC,YAAO,mCACL,AAAG,WAAE,KAAK,EACV,AAAO,eAAE,KAAK,EACd,AAAG,WAAE,KAAK;IAEd;WAGmC;AACjC,YAAO,mCACD,AAAU,CAAb,WAAM,KAAK,6BACJ,AAAU,CAAjB,eAAU,KAAK,6BACZ,AAAU,CAAb,WAAM,KAAK;IAEhB;UAGkC;AAChC,YAAO,mCACL,AAAG,kBAAE,KAAK,GACV,AAAO,sBAAE,KAAK,GACd,AAAG,kBAAE,KAAK;IAEd;YAGiC;AAC/B,YAAO,AAAU,SAAD,6BAAU,AAAsD,6BAArC,sBAAW;AACtD,cAAiB,eAAT,SAAS;;;AAEb,kBAAO,6BAAU,AAAG,WAAE,cAAQ;;;;AAE9B,kBAAO,6BAAU,AAAG,WAAE,cAAQ;;;IAEpC;;4CAjE2B,IAAS,QAAa;IAAtB;IAAS;IAAa;AAA3C;;EAA8C;;;;;;;;;;;;;;;;;;;;;IA4FvC;;;;;;;;;;;AAaX,YAAU,AAAqD,0BAAnC,MAAM,uBAAqB,kBAAK,UAAC;IAC/D;;;QApBgB;;UACJ,AAAE,CAAD;UACD,AAAE,AAAQ,CAAT,IAAI,CAAC,OAAO,AAAE,CAAD,IAAI;;EAAI;;;;;;;;;;;MAQH,+BAAG;;;MAEH,kCAAM;;;MAGN,kCAAM","file":"../../../../../../../../../../packages/flutter/src/painting/alignment.dart.lib.js"}');
  // Exports:
  return {
