define(['dart_sdk', 'packages/flutter/src/foundation/math.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/foundation/collections.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__painting__colors_dart(dart_sdk, packages__flutter__src__foundation__math$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__foundation__collections$46dart, packages__flutter__src__foundation__debug$46dart) {
  'use strict';
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/colors.dart",
  ...
  colors.HSVColor = class HSVColor extends core.Object {
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 201, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
      ...
      return new colors.HSVColor.fromAHSV(math$.clampDouble(dart.nullCheck(ui.lerpDouble(a.alpha, b.alpha, t)), 0.0, 1.0), dart.nullCheck(ui.lerpDouble(a.hue, b.hue, t))[$modulo](360.0), math$.clampDouble(dart.nullCheck(ui.lerpDouble(a.saturation, b.saturation, t)), 0.0, 1.0), math$.clampDouble(dart.nullCheck(ui.lerpDouble(a.value, b.value, t)), 0.0, 1.0));
    }
    _equals(other) {
  ...
  (colors.HSVColor.fromAHSV = function(alpha, hue, saturation, value) {
    ...
    this[value$] = value;
    if (!(alpha !== null)) dart.assertFailed(null, I[0], 92, 14, "alpha != null");
    if (!(hue !== null)) dart.assertFailed(null, I[0], 93, 14, "hue != null");
    if (!(saturation !== null)) dart.assertFailed(null, I[0], 94, 14, "saturation != null");
    if (!(value !== null)) dart.assertFailed(null, I[0], 95, 14, "value != null");
    if (!(alpha >= 0.0)) dart.assertFailed(null, I[0], 96, 14, "alpha >= 0.0");
    if (!(alpha <= 1.0)) dart.assertFailed(null, I[0], 97, 14, "alpha <= 1.0");
    if (!(hue >= 0.0)) dart.assertFailed(null, I[0], 98, 14, "hue >= 0.0");
    if (!(hue <= 360.0)) dart.assertFailed(null, I[0], 99, 14, "hue <= 360.0");
    if (!(saturation >= 0.0)) dart.assertFailed(null, I[0], 100, 14, "saturation >= 0.0");
    if (!(saturation <= 1.0)) dart.assertFailed(null, I[0], 101, 14, "saturation <= 1.0");
    if (!(value >= 0.0)) dart.assertFailed(null, I[0], 102, 14, "value >= 0.0");
    if (!(value <= 1.0)) dart.assertFailed(null, I[0], 103, 14, "value <= 1.0");
    ;
  ...
  colors.HSLColor = class HSLColor extends core.Object {
    ...
    static fromColor(color) {
      ...
      let saturation = lightness === 1.0 ? 0.0 : math$.clampDouble(delta / (1.0 - (2.0 * lightness - 1.0)[$abs]()), 0.0, 1.0);
      return new colors.HSLColor.fromAHSL(alpha, hue, saturation, lightness);
    }
    static ['_#fromColor#tearOff'](color) {
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 389, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
      ...
      return new colors.HSLColor.fromAHSL(math$.clampDouble(dart.nullCheck(ui.lerpDouble(a.alpha, b.alpha, t)), 0.0, 1.0), dart.nullCheck(ui.lerpDouble(a.hue, b.hue, t))[$modulo](360.0), math$.clampDouble(dart.nullCheck(ui.lerpDouble(a.saturation, b.saturation, t)), 0.0, 1.0), math$.clampDouble(dart.nullCheck(ui.lerpDouble(a.lightness, b.lightness, t)), 0.0, 1.0));
    }
    _equals(other) {
      if (other == null) return false;
      if (this === other) {
  ...
  (colors.HSLColor.fromAHSL = function(alpha, hue, saturation, lightness) {
    ...
    if (!(alpha !== null)) dart.assertFailed(null, I[0], 265, 14, "alpha != null");
    if (!(hue !== null)) dart.assertFailed(null, I[0], 266, 14, "hue != null");
    if (!(saturation !== null)) dart.assertFailed(null, I[0], 267, 14, "saturation != null");
    if (!(lightness !== null)) dart.assertFailed(null, I[0], 268, 14, "lightness != null");
    if (!(alpha >= 0.0)) dart.assertFailed(null, I[0], 269, 14, "alpha >= 0.0");
    if (!(alpha <= 1.0)) dart.assertFailed(null, I[0], 270, 14, "alpha <= 1.0");
    if (!(hue >= 0.0)) dart.assertFailed(null, I[0], 271, 14, "hue >= 0.0");
    if (!(hue <= 360.0)) dart.assertFailed(null, I[0], 272, 14, "hue <= 360.0");
    if (!(saturation >= 0.0)) dart.assertFailed(null, I[0], 273, 14, "saturation >= 0.0");
    if (!(saturation <= 1.0)) dart.assertFailed(null, I[0], 274, 14, "saturation <= 1.0");
    if (!(lightness >= 0.0)) dart.assertFailed(null, I[0], 275, 14, "lightness >= 0.0");
    if (!(lightness <= 1.0)) dart.assertFailed(null, I[0], 276, 14, "lightness <= 1.0");
    ;
  ...
  colors.ColorSwatch$ = dart.generic(T => {
    var __t$ColorSwatchOfT = () => (__t$ColorSwatchOfT = dart.constFn(colors.ColorSwatch$(T)))();
    class ColorSwatch extends ui.Color {
      ...
      _equals(other) {
        ...
        return super._equals(other) && __t$ColorSwatchOfT().is(other) && collections.mapEquals(T, ui.Color, other[_swatch], this[_swatch]);
      }
      get hashCode() {
        return core.Object.hash(this[$runtimeType], this.value, this[_swatch]);
      }
      toString() {
      ...
      static lerp(T, a, b, t) {
        ...
        if (b == null) {
          if (a == null) {
            ...
            swatch = a[_swatch][$map](T, ui.Color, dart.fn((key, color) => new (core.MapEntry$(T, ui.Color)).__(key, dart.nullCheck(ui.Color.lerp(color, null, t))), dart.fnType(core.MapEntry$(T, ui.Color), [T, ui.Color])));
          }
        } else {
          if (a == null) {
            swatch = b[_swatch][$map](T, ui.Color, dart.fn((key, color) => new (core.MapEntry$(T, ui.Color)).__(key, dart.nullCheck(ui.Color.lerp(null, color, t))), dart.fnType(core.MapEntry$(T, ui.Color), [T, ui.Color])));
          } else {
            swatch = a[_swatch][$map](T, ui.Color, dart.fn((key, color) => new (core.MapEntry$(T, ui.Color)).__(key, dart.nullCheck(ui.Color.lerp(color, b._get(key), t))), dart.fnType(core.MapEntry$(T, ui.Color), [T, ui.Color])));
          }
        }
  ...
  (colors.ColorProperty.new = function(name, value, opts) {
    ...
    if (!(showName !== null)) dart.assertFailed(null, I[0], 522, 15, "showName != null");
    if (!(style !== null)) dart.assertFailed(null, I[0], 523, 15, "style != null");
    if (!(level !== null)) dart.assertFailed(null, I[0], 524, 15, "level != null");
    colors.ColorProperty.__proto__.new.call(this, name, value, {showName: showName, defaultValue: defaultValue, style: style, level: level});
    ;
  ...
  colors._getHue = function _getHue(red, green, blue, max, delta) {
    ...
    function hue$35set(hue$35param) {
