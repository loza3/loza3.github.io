define(['dart_sdk'], (function load__packages__flutter__src__painting__clip_dart(dart_sdk) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/clip.dart",
  ...
  clip.ClipContext = class ClipContext extends core.Object {
    [_clipAndPaint](canvasClipCall, clipBehavior, bounds, painter) {
      if (!(canvasClipCall !== null)) dart.assertFailed(null, I[0], 13, 12, "canvasClipCall != null");
      this.canvas.save();
      switch (clipBehavior) {
        case C[0] || CT.C0:
          {
