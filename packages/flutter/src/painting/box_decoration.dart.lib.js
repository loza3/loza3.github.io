define(['dart_sdk', 'packages/flutter/src/painting/box_border.dart', 'packages/flutter/src/painting/border_radius.dart', 'packages/flutter/src/painting/box_shadow.dart', 'packages/flutter/src/painting/gradient.dart', 'packages/flutter/src/foundation/collections.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/colors.dart', 'packages/flutter/src/painting/decoration_image.dart', 'packages/flutter/src/painting/decoration.dart', 'packages/flutter/src/painting/_network_image_web.dart'], (function load__packages__flutter__src__painting__box_decoration_dart(dart_sdk, packages__flutter__src__painting__box_border$46dart, packages__flutter__src__painting__border_radius$46dart, packages__flutter__src__painting__box_shadow$46dart, packages__flutter__src__painting__gradient$46dart, packages__flutter__src__foundation__collections$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__colors$46dart, packages__flutter__src__painting__decoration_image$46dart, packages__flutter__src__painting__decoration$46dart, packages__flutter__src__painting___network_image_web$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/painting/box_decoration.dart",
  ...
  box_decoration.BoxDecoration = class BoxDecoration extends decoration.Decoration {
    ...
    debugAssertIsValid() {
      if (!(this.shape !== box_border.BoxShape.circle || this.borderRadius == null)) dart.assertFailed(null, I[0], 129, 12, "shape != BoxShape.circle || borderRadius == null");
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[0], 292, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
    ...
    hitTest(size, position, opts) {
      ...
      if (!(this.shape !== null)) dart.assertFailed(null, I[0], 368, 12, "shape != null");
      if (!ui.Offset.zero['&'](size).contains(position)) dart.assertFailed(null, I[0], 369, 12, "(Offset.zero & size).contains(position)");
      switch (this.shape) {
        case C[0] || CT.C0:
          {
            if (this.borderRadius != null) {
    ...
    createBoxPainter(onChanged = null) {
      if (!(onChanged != null || this.image == null)) dart.assertFailed(null, I[0], 387, 12, "onChanged != null || image == null");
  ...
  (box_decoration.BoxDecoration.new = function(opts) {
    ...
    this[shape$] = shape;
    if (!(shape !== null)) dart.assertFailed(null, I[0], 96, 15, "shape != null");
    if (!(backgroundBlendMode == null || color != null || gradient != null)) dart.assertFailed("backgroundBlendMode applies to BoxDecoration's background color or " + "gradient, but no color or gradient was provided.", I[0], 98, 10, "backgroundBlendMode == null || color != null || gradient != null");
  ...
  box_decoration._BoxDecorationPainter = class _BoxDecorationPainter extends decoration.BoxPainter {
    ...
    [_getBackgroundPaint](rect, textDirection) {
      if (!(rect !== null)) dart.assertFailed(null, I[0], 403, 12, "rect != null");
      if (!(this[_decoration$].gradient != null || this[_rectForCachedBackgroundPaint] == null)) dart.assertFailed(null, I[0], 404, 12, "_decoration.gradient != null || _rectForCachedBackgroundPaint == null");
    ...
    [_paintBox](canvas, rect, paint, textDirection) {
      switch (this[_decoration$].shape) {
        case C[1] || CT.C1:
          {
            if (!(this[_decoration$].borderRadius == null)) dart.assertFailed(null, I[0], 428, 16, "_decoration.borderRadius == null");
            let center = rect.center;
            let radius = rect.shortestSide / 2.0;
    ...
    [_paintBackgroundImage](canvas, rect, configuration) {
      ...
      switch (this[_decoration$].shape) {
        case C[1] || CT.C1:
          {
            if (!(this[_decoration$].borderRadius == null)) dart.assertFailed(null, I[0], 469, 16, "_decoration.borderRadius == null");
            let center = rect.center;
            let radius = rect.shortestSide / 2.0;
            let square = new ui.Rect.fromCircle({center: center, radius: radius});
    ...
    paint(canvas, offset, configuration) {
      let t1, t0;
      if (!(configuration !== null)) dart.assertFailed(null, I[0], 493, 12, "configuration != null");
      if (!(configuration.size != null)) dart.assertFailed(null, I[0], 494, 12, "configuration.size != null");
  ...
  (box_decoration._BoxDecorationPainter.new = function(_decoration, onChanged) {
    ...
    if (!(_decoration !== null)) dart.assertFailed(null, I[0], 395, 14, "_decoration != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["box_decoration.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA4Ie;;;;;;IAOU;;;;;;IAYN;;;;;;IAQW;;;;;;IAWL;;;;;;IAOP;;;;;;IAQC;;;;;;IAeF;;;;;;;;;;;;;;;;;;;UAvGN;UACU;UACN;UACW;UACL;UACP;UACC;UACD;AAEV,YAAO,+CACQ,KAAN,KAAK,EAAL,aAAc,0BACR,MAAN,KAAK,EAAL,cAAc,4BACN,OAAP,MAAM,EAAN,eAAe,oCACI,OAAb,YAAY,EAAZ,eAAqB,uCACd,OAAV,SAAS,EAAT,eAAkB,mCACV,OAAT,QAAQ,EAAR,eAAiB,6CACc,OAApB,mBAAmB,EAAnB,eAA4B,0CACpC,OAAN,KAAK,EAAL,eAAc;IAEzB;;AAIE,YAAO,AAAyB,eAAP,8BAAU,AAAa;AAChD,YAAa;IACf;;;AAiFmC;iCAAQ;IAAU;gBAG/B,MAAoB;;AACxC,cAAQ;;;AAES,yBAAS,AAAK,IAAD;AACb,yBAAS,AAAK,AAAa,IAAd,gBAAgB;AAC/B,yBAAc,gCAAmB,MAAM,UAAU,MAAM;AAClE,iBAAO;;AAAQ,yBAAQ,MAAM;;;;;;AAE7B,gBAAI;AACF,oBAAO;;AAAQ,6BAAqB,AAAE,AAAuB,eAArC,2BAAsB,aAAa,UAAU,IAAI;;;;AAE3E,mBAAO;;AAAQ,2BAAQ,IAAI;;;;;IAEjC;UAG2B;;AACzB,YAAO,8CACQ,cAAK,MAAM,YAAO,MAAM,UAC9B,oBACW,0BAAK,MAAM,aAAQ,MAAM,iBACR,wCAAK,MAAM,mBAAc,MAAM,cAC7C,8BAAS,MAAM,gBAAW,MAAM,+CAC3C,OAAU,SAAM,MAAM,WACzB;IAEX;;AAGsB,YAAA,AAAU;IAAO;aAGH,GAAU;AAC5C,UAAI,AAAE,CAAD;AACH,cAAO,YAAM,CAAC;;AAEhB,UAAM,gCAAF,CAAC;AACH,cAAqB,mCAAK,CAAC,EAAE,MAAM,CAAC;;AAEtC,YAA4B,uBAAf,eAAS,CAAC,EAAE,CAAC;IAC5B;WAGkC,GAAU;AAC1C,UAAI,AAAE,CAAD;AACH,cAAO,YAAM,AAAI,MAAE,CAAC;;AAEtB,UAAM,gCAAF,CAAC;AACH,cAAqB,mCAAK,MAAM,CAAC,EAAE,CAAC;;AAEtC,YAA0B,uBAAb,aAAO,CAAC,EAAE,CAAC;IAC1B;gBAyB0C,GAAkB,GAAU;AACpE,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAQ,AAAE,gBAAH,CAAC,QAAQ,CAAC;;AAEnB,UAAI,AAAE,CAAD;AACH,cAAO,AAAE,EAAD,OAAO,AAAI,MAAE,CAAC;;AAExB,UAAI,AAAE,CAAD,KAAI;AACP,cAAO,EAAC;;AAEV,UAAI,AAAE,CAAD,KAAI;AACP,cAAO,EAAC;;AAEV,YAAO,8CACQ,cAAK,AAAE,CAAD,QAAQ,AAAE,CAAD,QAAQ,CAAC,UAC9B,AAAE,CAAD,GAAG,MAAM,AAAE,CAAD,SAAS,AAAE,CAAD,gBACV,0BAAK,AAAE,CAAD,SAAS,AAAE,CAAD,SAAS,CAAC,iBACT,wCAAK,AAAE,CAAD,eAAe,AAAE,CAAD,eAAe,CAAC,cACpD,8BAAS,AAAE,CAAD,YAAY,AAAE,CAAD,YAAY,CAAC,aACtC,uBAAK,AAAE,CAAD,WAAW,AAAE,CAAD,WAAW,CAAC,UAC1C,AAAE,CAAD,GAAG,MAAM,AAAE,CAAD,SAAS,AAAE,CAAD;IAEhC;YAGwB;;AACtB,UAAI,AAAU,SAAM,KAAK;AACvB,cAAO;;AAET,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAQT,iCARG,KAAK,KACO,YAAZ,AAAM,KAAD,QAAU,eACH,YAAZ,AAAM,KAAD,QAAU,eACF,YAAb,AAAM,KAAD,SAAW,gBACG,YAAnB,AAAM,KAAD,eAAiB,sBACtB,6CAAsB,AAAM,KAAD,YAAY,mBACxB,YAAf,AAAM,KAAD,WAAa,kBAClB,AAAM,AAAoB,KAArB,wBAAwB,4BAC7B,AAAM,AAAM,KAAP,WAAU;IACxB;;AAGoB,YAAO,kBACzB,YACA,YACA,aACA,mBACA,AAAU,yBAAU,OAAc,oBAAiB,eAAT,kBAC1C,eACA,0BACA;IACD;wBAGoD;;AACd,MAA/B,0BAAoB,UAAU;AAGmB,WAFvD,UAAU;MAAV;AACI,yCAAmD;AACnD,kCAAuB;;;AAEsC,MAAjE,AAAW,UAAD,KAAK,6BAAc,SAAS,2BAAqB;AAC6B,MAAxF,AAAW,UAAD,KAAK,mDAAqC,SAAS,2BAAqB;AACE,MAApF,AAAW,UAAD,KAAK,6CAA+B,UAAU,4BAAsB;AAC6B,MAA3G,AAAW,UAAD,KAAK,wDAA0C,gBAAgB,kCAA4B;AAC0B,MAA/H,AAAW,UAAD,KAAK,0CAA4B,aAAa,+BAAyB,aAAkC;AAC5B,MAAvF,AAAW,UAAD,KAAK,4CAA8B,YAAY,8BAAwB;AACO,MAAxF,AAAW,UAAD,KAAK,qCAAuB,SAAS,2BAA8B;IAC/E;YAGkB,MAAa;UAA2B;AACxD,YAAO,AAAM;AACb,WAAe,AAAK,AAAQ,oBAAN,IAAI,WAAW,QAAQ;AAC7C,cAAQ;;;AAEJ,gBAAI;AACU,2BAAqB,AAAE,AAAuB,eAArC,2BAAsB,aAAa,UAAiB,AAAK,oBAAE,IAAI;AACpF,oBAAO,AAAO,OAAD,UAAU,QAAQ;;AAEjC,kBAAO;;;;AAGM,yBAAS,AAAK,IAAD,QAAe;AAC5B,2BAAY,AAAS,AAAU,QAAX,MAAG,MAAM;AAC1C,kBAAO,AAAS,SAAD,IAAS,AAA6B,sBAAzB,AAAK,IAAD,QAAQ,AAAK,IAAD,WAAW;;;IAE7D;qBAG4C;AAC1C,YAAO,AAAkB,SAAT,YAAY,AAAM;AAClC,YAAO,8CAAsB,MAAM,SAAS;IAC9C;;;QA7SO;QACA;QACA;QACA;QACA;QACA;QACA;QACA;IAPA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;UACK,AAAM,KAAD;UAEV,AAAoB,AAAyB,mBAA1B,YAAY,KAAK,YAAY,QAAQ,6BAAQ,AAChE,wEACA;AAbD;;EAcA;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;0BA6SyB,MAAqB;AAClD,YAAO,AAAK,IAAD;AACX,YAAO,AAAY,AAAiB,uCAAG,AAA8B;AAErE,UAAI,AAAuB,wCACtB,AAAY,oDAAoB,qCAAiC,IAAI;AAC5D,oBAAQ;AACpB,YAAI,AAAY;AACoC,UAAlD,AAAM,KAAD,aAA4C,eAA/B,AAAY;;AAEhC,YAAI,AAAY;AACkB,UAAhC,AAAM,KAAD,SAA0B,eAAjB,AAAY;;AAE5B,YAAI,AAAY;AACuE,UAArF,AAAM,KAAD,UAA8B,AAAE,eAAtB,AAAY,0CAAuB,IAAI,kBAAiB,aAAa;AAChD,UAApC,sCAAgC,IAAI;;AAER,QAA9B,+BAAyB,KAAK;;AAGhC,YAA6B,gBAAtB;IACT;gBAEsB,QAAa,MAAY,OAAsB;AACnE,cAAQ,AAAY;;;AAEhB,kBAAO,AAAY,AAAa;AACnB,yBAAS,AAAK,IAAD;AACb,yBAAS,AAAK,AAAa,IAAd,gBAAgB;AACF,YAAxC,AAAO,MAAD,YAAY,MAAM,EAAE,MAAM,EAAE,KAAK;AACvC;;;;AAEA,gBAAI,AAAY,AAAa;AACC,cAA5B,AAAO,MAAD,UAAU,IAAI,EAAE,KAAK;;AAE4D,cAAvF,AAAO,MAAD,WAAmC,AAAE,AAAuB,eAAjD,AAAY,yCAAsB,aAAa,UAAU,IAAI,GAAG,KAAK;;AAExF;;;IAEN;oBAE0B,QAAa,MAAqB;AAC1D,UAAI,AAAY,AAAU;AACxB;;AAEF,eAAqB,YAAkC,gBAArB,AAAY;AAChC,oBAAQ,AAAU,SAAD;AAClB,qBAAS,AAAK,AAAwB,IAAzB,OAAO,AAAU,SAAD,iBAAiB,AAAU,SAAD;AACnB,QAA/C,gBAAU,MAAM,EAAE,MAAM,EAAE,KAAK,EAAE,aAAa;;IAElD;4BAEkC,QAAa,MAAqB;AAClE,UAAI,AAAY,oCAAiB,AAAY;AACqC,QAAhF,gBAAU,MAAM,EAAE,IAAI,EAAE,0BAAoB,IAAI,EAAE,aAAa,GAAG,aAAa;;IAEnF;4BAGkC,QAAa,MAAyB;;AACtE,UAAI,AAAY,AAAM;AACpB;;AAE4D,MAAhD,8BAAd,sBAAmC,AAAE,eAAnB,AAAY,wCAA8B,eAAT,mBAArC;AACR;AACN,cAAQ,AAAY;;;AAEhB,kBAAO,AAAY,AAAa;AACnB,yBAAS,AAAK,IAAD;AACb,yBAAS,AAAK,AAAa,IAAd,gBAAgB;AAC/B,yBAAc,gCAAmB,MAAM,UAAU,MAAM;AAChC,YAAlC,gCAAW;AAAQ,yBAAQ,MAAM;;;AACjC;;;;AAEA,gBAAI,AAAY;AAC2F,cAAzG,iCAAW;AAAQ,6BAAiC,AAAE,AAAqC,eAA/D,AAAY,yCAAsB,AAAc,aAAD,wBAAwB,IAAI;;;;AAEzG;;;AAEuD,MAA9C,AAAE,eAAf,2BAAqB,MAAM,EAAE,IAAI,EAAE,QAAQ,EAAE,aAAa;IAC5D;;;AAI0B,WAAxB;0BAAe;AACA,MAAT;IACR;UAIkB,QAAe,QAA2B;;AAC1D,YAAO,AAAc,aAAD;AACpB,YAAO,AAAc,AAAK,aAAN;AACT,iBAAO,AAAO,MAAD,MAAqB,eAAlB,AAAc,aAAD;AACnB,0BAAgB,AAAc,aAAD;AACR,MAA1C,oBAAc,MAAM,EAAE,IAAI,EAAE,aAAa;AACS,MAAlD,4BAAsB,MAAM,EAAE,IAAI,EAAE,aAAa;AACC,MAAlD,4BAAsB,MAAM,EAAE,IAAI,EAAE,aAAa;AAOhD,WAND,AAAY;mBAAA,OAAQ,SAClB,MAAM,EACN,IAAI,UACG,AAAY,8CACL,AAAY,8CAAA,OAAc,WAAQ,aAAa,mBAC9C,AAAc,aAAD;IAEhC;;AAIE,YAAO,AAA6B,8BAAZ;IAC1B;;uDAtH2B,aAA2B;IAM/C;IACD;IA2DkB;IAlEG;UAChB,AAAY,WAAD;AAClB,kEAAM,SAAS;;EAAC","file":"../../../../../../../../../../packages/flutter/src/painting/box_decoration.dart.lib.js"}');
  // Exports:
  return {
