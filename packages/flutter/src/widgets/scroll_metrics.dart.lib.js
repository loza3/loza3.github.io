define(['dart_sdk', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/foundation/math.dart', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__widgets__scroll_metrics_dart(dart_sdk, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__foundation__math$46dart, packages__flutter__src__foundation__object$46dart) {
  'use strict';
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/scroll_metrics.dart",
  ...
  scroll_metrics.ScrollMetrics[dart.mixinOn] = Object => class ScrollMetrics extends Object {
    ...
    get extentInside() {
      ...
      return this.viewportDimension - math$.clampDouble(this.minScrollExtent - this.pixels, 0.0, this.viewportDimension) - math$.clampDouble(this.pixels - this.maxScrollExtent, 0.0, this.viewportDimension);
    }
    get extentAfter() {
