define(['dart_sdk', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__widgets__icon_data_dart(dart_sdk, packages__flutter__src__foundation__debug$46dart) {
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/icon_data.dart"
  ];
  ...
  icon_data.IconData = class IconData extends core.Object {
    ...
    get hashCode() {
      return core.Object.hash(this.codePoint, this.fontFamily, this.fontPackage, this.matchTextDirection);
    }
    toString() {
  ...
  (icon_data.IconDataProperty.new = function(name, value, opts) {
    ...
    if (!(showName !== null)) dart.assertFailed(null, I[1], 81, 15, "showName != null");
    if (!(style !== null)) dart.assertFailed(null, I[1], 82, 15, "style != null");
    if (!(level !== null)) dart.assertFailed(null, I[1], 83, 15, "level != null");
    icon_data.IconDataProperty.__proto__.new.call(this, name, value, {ifNull: ifNull, showName: showName, style: style, level: level});
    ;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["icon_data.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA2BY;;;;;;IAGI;;;;;;IAUA;;;;;;IAOH;;;;;;;;;;;;YAGa;;AACtB,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AAIT,uBAJG,KAAK,KACL,AAAM,AAAU,KAAX,eAAc,kBACnB,AAAM,AAAW,KAAZ,eAAe,mBACpB,AAAM,AAAY,KAAb,gBAAgB,oBACrB,AAAM,AAAmB,KAApB,wBAAuB;IACrC;;AAGoB,YAAO,kBAAK,gBAAW,iBAAY,kBAAa;IAAmB;;AAGlE,YAAA,AAA0E,iBAA5D,AAAU,AAAkB,AAAc,+BAAlB,8BAA0B,GAAG,OAAK;IAAE;;qCA7CxF;QACA;QACA;QACA;IAHA;IACA;IACA;IACA;;EACL;;;;;;;;;;;;;;;;;;;;;;;cA6D8D;AACnC,iBAAa,gBAAU,QAAQ;AAC1D,UAAI;AAGD,QAFD,AAAI,IAAA,QAAC,mBAAqC,2CACxC,aAAkB,AAAE,eAAP;;AAGjB,YAAO,KAAI;IACb;;6CAnBe,MACP;QACA;QACA;QACA;QACA;UACI,AAAS,QAAD;UACR,AAAM,KAAD;UACL,AAAM,KAAD;AATjB,wDACe,IAAI,EACX,KAAK,WACL,MAAM,YACN,QAAQ,SACR,KAAK,SACL,KAAK;;EAGa","file":"../../../../../../../../../../packages/flutter/src/widgets/icon_data.dart.lib.js"}');
  // Exports:
  return {
