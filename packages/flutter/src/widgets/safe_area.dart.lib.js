define(['dart_sdk', 'packages/flutter/src/painting/edge_insets.dart', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__widgets__safe_area_dart(dart_sdk, packages__flutter__src__painting__edge_insets$46dart, packages__flutter__src__widgets__title$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 41,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/safe_area.dart"
      });
    },
    get C2() {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/safe_area.dart",
  ...
  safe_area.SafeArea = class SafeArea extends framework.StatelessWidget {
    ...
    build(context) {
      if (!debug.debugCheckHasMediaQuery(context)) dart.assertFailed(null, I[0], 95, 12, "debugCheckHasMediaQuery(context)");
  ...
  safe_area.SliverSafeArea = class SliverSafeArea extends framework.StatelessWidget {
    ...
    build(context) {
      if (!debug.debugCheckHasMediaQuery(context)) dart.assertFailed(null, I[0], 194, 12, "debugCheckHasMediaQuery(context)");
  ...
  (safe_area.SliverSafeArea.new = function(opts) {
    ...
    this[sliver$] = sliver;
    if (!(left !== null)) dart.assertFailed(null, I[0], 163, 15, "left != null");
    if (!(top !== null)) dart.assertFailed(null, I[0], 164, 15, "top != null");
    if (!(right !== null)) dart.assertFailed(null, I[0], 165, 15, "right != null");
    if (!(bottom !== null)) dart.assertFailed(null, I[0], 166, 15, "bottom != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["safe_area.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAuDa;;;;;;IAIA;;;;;;IAGA;;;;;;IAGA;;;;;;IAKM;;;;;;IAYN;;;;;;IAQE;;;;;;;;;;;;;;;;;UAGa;AACxB,WAAO,8BAAwB,OAAO;AACjB,iBAAkB,0BAAG,OAAO;AACtC,oBAAU,AAAK,IAAD;AAEzB,UAAI;AACyD,QAA3D,UAAU,AAAQ,OAAD,mBAAkB,AAAK,AAAY,IAAb;;AAGzC,YAAO,iCACe,uCACP,sBAAI,YAAO,AAAQ,OAAD,QAAQ,KAAK,AAAQ,yBACxC,sBAAI,WAAM,AAAQ,OAAD,OAAO,KAAK,AAAQ,0BACnC,sBAAI,aAAQ,AAAQ,OAAD,SAAS,KAAK,AAAQ,6BACxC,sBAAI,cAAS,AAAQ,OAAD,UAAU,KAAK,AAAQ,+BAExC,+CACP,OAAO,cACJ,sBACD,uBACE,0BACC,oBACP;IAGb;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AAC2C,MAA/E,AAAW,UAAD,KAAK,iCAAa,gBAAe,mBAAc;AACmB,MAA5E,AAAW,UAAD,KAAK,iCAAa,eAAc,kBAAa;AAC2B,MAAlF,AAAW,UAAD,KAAK,iCAAa,iBAAgB,oBAAe;AAC0B,MAArF,AAAW,UAAD,KAAK,iCAAa,kBAAiB,qBAAgB;IAC/D;;;QAtFQ;QACD;QACA;QACA;QACA;QACA;QACA;QACS;;IANT;IACA;IACA;IACA;IACA;IACA;IACS;UACJ,AAAK,IAAD;UACJ,AAAI,GAAD;UACH,AAAM,KAAD;UACL,AAAO,MAAD;AAZZ,sDACE,GAAG;;EAWgB;;;;;;;;;;;;;;;;;;;;;;;;;IAoHhB;;;;;;IAIA;;;;;;IAGA;;;;;;IAGA;;;;;;IAKM;;;;;;IAMJ;;;;;;;;;;;;;;;;UAGa;AACxB,WAAO,8BAAwB,OAAO;AACrB,oBAAqB,AAAY,0BAAT,OAAO;AAChD,YAAO,uCACe,uCACP,sBAAI,YAAO,AAAQ,OAAD,QAAQ,KAAK,AAAQ,yBACxC,sBAAI,WAAM,AAAQ,OAAD,OAAO,KAAK,AAAQ,0BACnC,sBAAI,aAAQ,AAAQ,OAAD,SAAS,KAAK,AAAQ,6BACxC,sBAAI,cAAS,AAAQ,OAAD,UAAU,KAAK,AAAQ,gCAEvC,+CACR,OAAO,cACJ,sBACD,uBACE,0BACC,oBACP;IAGb;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AAC2C,MAA/E,AAAW,UAAD,KAAK,iCAAa,gBAAe,mBAAc;AACmB,MAA5E,AAAW,UAAD,KAAK,iCAAa,eAAc,kBAAa;AAC2B,MAAlF,AAAW,UAAD,KAAK,iCAAa,iBAAgB,oBAAe;AAC0B,MAArF,AAAW,UAAD,KAAK,iCAAa,kBAAiB,qBAAgB;IAC/D;;;QAjEQ;QACD;QACA;QACA;QACA;QACA;QACS;;IALT;IACA;IACA;IACA;IACA;IACS;UACJ,AAAK,IAAD;UACJ,AAAI,GAAD;UACH,AAAM,KAAD;UACL,AAAO,MAAD;AAXZ,4DACE,GAAG;;EAUgB","file":"../../../../../../../../../../packages/flutter/src/widgets/safe_area.dart.lib.js"}');
  // Exports:
  return {
