define(['dart_sdk', 'packages/flutter/src/physics/tolerance.dart', 'packages/flutter/src/physics/friction_simulation.dart', 'packages/flutter/src/physics/spring_simulation.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/physics/simulation.dart', 'packages/flutter/src/foundation/math.dart'], (function load__packages__flutter__src__widgets__scroll_simulation_dart(dart_sdk, packages__flutter__src__physics__tolerance$46dart, packages__flutter__src__physics__friction_simulation$46dart, packages__flutter__src__physics__spring_simulation$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__physics__simulation$46dart, packages__flutter__src__foundation__math$46dart) {
  'use strict';
  ...
  var C = [void 0];
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/scroll_simulation.dart",
  ...
  scroll_simulation.BouncingScrollSimulation = class BouncingScrollSimulation extends simulation.Simulation {
    ...
    set [_frictionSimulation](library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_frictionSimulation$35param) {
      this[__BouncingScrollSimulation__frictionSimulation] = library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_frictionSimulation$35param;
    }
    get [_springSimulation]() {
      let t0;
      t0 = this[__BouncingScrollSimulation__springSimulation];
      return t0 == null ? dart.throw(new _internal.LateError.fieldNI("_springSimulation")) : t0;
    }
    set [_springSimulation](library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_springSimulation$35param) {
      this[__BouncingScrollSimulation__springSimulation] = library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_springSimulation$35param;
    }
    get [_springTime]() {
      let t0;
      t0 = this[__BouncingScrollSimulation__springTime];
      return t0 == null ? dart.throw(new _internal.LateError.fieldNI("_springTime")) : t0;
    }
    set [_springTime](library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_springTime$35param) {
      this[__BouncingScrollSimulation__springTime] = library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_springTime$35param;
    }
  ...
  (scroll_simulation.BouncingScrollSimulation.new = function(opts) {
    ...
    if (position < this.leadingExtent) {
      ...
      if (velocity > 0.0 && finalX > this.trailingExtent) {
        ...
        if (!this[_springTime][$isFinite]) dart.assertFailed(null, I[0], 61, 16, "_springTime.isFinite");
        ...
        if (!this[_springTime][$isFinite]) dart.assertFailed(null, I[0], 68, 16, "_springTime.isFinite");
      } else {
        this[_springTime] = 1 / 0;
      }
    }
    if (!(this[_springTime] !== null)) dart.assertFailed(null, I[0], 73, 12, "_springTime != null");
  ...
  scroll_simulation.ClampingScrollSimulation = class ClampingScrollSimulation extends simulation.Simulation {
    ...
    get [_duration]() {
      let t0;
      t0 = this[__ClampingScrollSimulation__duration];
      return t0 == null ? dart.throw(new _internal.LateError.fieldNI("_duration")) : t0;
    }
    set [_duration](library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_duration$35param) {
      this[__ClampingScrollSimulation__duration] = library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_duration$35param;
    }
    get [_distance]() {
      let t0;
      t0 = this[__ClampingScrollSimulation__distance];
      return t0 == null ? dart.throw(new _internal.LateError.fieldNI("_distance")) : t0;
    }
    set [_distance](library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_distance$35param) {
      this[__ClampingScrollSimulation__distance] = library$32package$58flutter$47src$47widgets$47scroll_simulation$46dart$58$58_distance$35param;
    }
    ...
    x(time) {
      let t = math$.clampDouble(time / this[_duration], 0.0, 1.0);
  ...
  (scroll_simulation.ClampingScrollSimulation.new = function(opts) {
    ...
    if (!(scroll_simulation.ClampingScrollSimulation._flingVelocityPenetration(0.0) === 3.065)) dart.assertFailed(null, I[0], 149, 15, "_flingVelocityPenetration(0.0) == _initialVelocityPenetration");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["scroll_simulation.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAiFe;;;;;;IAIA;;;;;;IAGW;;;;;;;;;;;;;;;;;AAEA;;IAAmB;8BAAnB;;IAAmB;;;AAC3B;;IAAiB;4BAAjB;;IAAiB;;;AACrB;;IAAW;sBAAX;;IAAW;6BAGkB,GAAU;AACjD,YAAO,kDAAuB,aAAQ,CAAC,EAAE,oBAAe,EAAE;IAC5D;4BAEwC,GAAU;AAChD,YAAO,kDAAuB,aAAQ,CAAC,EAAE,qBAAgB,EAAE;IAC7D;kBAE8B;;AACX;AACjB,UAAI,AAAK,IAAD,GAAG;AAC6C,QAAtD,oBAAc,AAAY,+BAAW,oBAAc;AACrB,QAA9B,aAAa;;AAEI,QAAjB,oBAAc;AACkB,QAAhC,aAAa;;AAEf,WAAO,UAAU;YAAV;AAAY,uBAAY;;;IACjC;MAGgB;AAAS,YAAA,AAAkB,mBAAN,IAAI,IAAI,AAAK,IAAD,GAAG;IAAY;OAG/C;AAAS,YAAA,AAAkB,mBAAN,IAAI,KAAK,AAAK,IAAD,GAAG;IAAY;WAG/C;AAAS,YAAA,AAAkB,mBAAN,IAAI,SAAS,AAAK,IAAD,GAAG;IAAY;;AAItE,YAAU,AAAqH,0BAAnG,MAAM,8BAA4B,8BAAiB,sBAAa,gCAAmB,uBAAc;IAC/H;;;QAhGkB;QACA;QACF;QACA;QACA;QACR;2DAsDgB;yDACR;mDACJ;IACL,oBAAc;IA5DL;IACA;IACA;UAEJ,AAAS,QAAD;UACR,AAAS,QAAD;UACR,AAAc,aAAD;UACb,AAAe,cAAD;UACd,AAAc,aAAD,IAAI,cAAc;UAC/B,AAAO,MAAD;AAZlB,oFAMQ,SAAS;AAOf,QAAI,AAAS,QAAD,GAAG;AACiD,MAA9D,0BAAoB,6BAAuB,QAAQ,EAAE,QAAQ;AACxB,MAArC;UACK,KAAI,AAAS,QAAD,GAAG;AACyC,MAA7D,0BAAoB,4BAAsB,QAAQ,EAAE,QAAQ;AACvB,MAArC;;AAImE,MAAnE,4BAAsB,+CAAmB,OAAO,QAAQ,EAAE,QAAQ;AACrD,mBAAS,AAAoB;AAC1C,UAAI,AAAS,QAAD,GAAG,OAAO,AAAO,MAAD,GAAG;AAC4B,QAAzD,oBAAc,AAAoB,kCAAQ;AAIzC,QAHD,0BAAoB,4BAClB,qBACK,sBAAI,AAAoB,6BAAG;AAElC,aAAO,AAAY;YACd,KAAI,AAAS,QAAD,GAAG,OAAO,AAAO,MAAD,GAAG;AACoB,QAAxD,oBAAc,AAAoB,kCAAQ;AAIzC,QAHD,0BAAoB,6BAClB,oBACK,sBAAI,AAAoB,6BAAG;AAElC,aAAO,AAAY;;AAEU,QAA7B;;;AAGJ,UAAO,AAAY;EACrB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAIoB,oEAAyB;;;;;;;;;;;;;IA6EhC;;;;;;IAIA;;;;;;IAKA;;;;;;;;;;;;;;;AAED;;IAAS;oBAAT;;IAAS;;;AACT;;IAAS;oBAAT;;IAAS;oCAMyB;AAC5C,YAAO,AAAS,SAAD,GAAG;IACpB;qBAG6B;AAEd,2BAAiB,AAAS,gBAAE,oEAAyB;AAGrD,yBAAoB,SAAI,AAAK,AAAiB,OAAf,AAAS,QAAD,WAAS,cAAc;AAE3E,YAAY,UAAI,AAAa,YAAD,IAAI,AAAmB,gEAAE;IACvD;qCAkB+C;AAC7C,YAAQ,AAAI,AAAI,AAAI,AAAK,AAAiB,OAA5B,CAAC,GAAG,CAAC,GAAG,CAAC,GAAK,AAAK,AAAI,OAAF,CAAC,GAAG,CAAC,GAAiC,QAAE,CAAC;IAC9E;qCAG+C;AAC7C,YAAQ,AAAI,AAAI,AAAK,AAAa,OAApB,CAAC,GAAG,CAAC,GAAK,AAAK,OAAE,CAAC;IAClC;MAGgB;AACD,cAAI,kBAAY,AAAK,IAAD,GAAG,iBAAW,KAAK;AACpD,YAAO,AAAS,iBAAE,AAAU,AAA+B,kBAA7B,qEAA0B,CAAC,IAAI,AAAS;IACxE;OAGiB;AACF,cAAI,kBAAY,AAAK,IAAD,GAAG,iBAAW,KAAK;AACpD,YAAO,AAAU,AAA+B,AAAgB,mBAA7C,qEAA0B,CAAC,IAAI,AAAS,uBAAO;IACpE;WAGmB;AACjB,YAAO,AAAK,KAAD,IAAI;IACjB;;;QAnFgB;QACA;QACT;QACC;iDAkBI;iDACA;IAtBI;IACA;IACT;UAEK,AAA+B,qEAAL;AALtC,oFAIQ,SAAS;AAEqB,IAApC,kBAAY,qBAAe;AAC2C,IAAtE,kBAAiE,CAApD,AAAS,AAAY,gBAAV;EAC1B;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAkBoB,6DAAkB;YAAQ,AAAU,UAAN,QAAa,SAAI;;MAiC/C,sEAA2B","file":"../../../../../../../../../../packages/flutter/src/widgets/scroll_simulation.dart.lib.js"}');
  // Exports:
  return {
