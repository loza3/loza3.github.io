define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/widgets/icon_theme_data.dart', 'packages/flutter/src/foundation/key.dart'], (function load__packages__flutter__src__widgets__icon_theme_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__widgets__icon_theme_data$46dart, packages__flutter__src__foundation__key$46dart) {
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 20,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/icon_theme.dart"
      });
    },
    get C1() {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/icon_theme.dart",
  ...
  icon_theme.IconTheme = class IconTheme extends inherited_theme.InheritedTheme {
    ...
    static of(context) {
      ...
      return iconThemeData.isConcrete ? iconThemeData : iconThemeData.copyWith({size: (t0 = iconThemeData.size, t0 == null ? (C[3] || CT.C3).size : t0), color: (t0$ = iconThemeData.color, t0$ == null ? (C[3] || CT.C3).color : t0$), opacity: (t0$0 = iconThemeData.opacity, t0$0 == null ? (C[3] || CT.C3).opacity : t0$0), shadows: (t0$1 = iconThemeData.shadows, t0$1 == null ? (C[3] || CT.C3).shadows : t0$1)});
    }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["icon_theme.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA+CsB;;;;;;;;;;;;;UAhBb;UACkB;UACP;AAEhB,YAAO,iCACI,QAAc,WACd,mCACA,GAAG,QACF,AAAoC,gDAAT,OAAO,QAAQ,IAAI,UAC7C,KAAK;IAIpB;cAwBqC;;AACf,0BAAgB,AAAoC,gDAAT,OAAO,UAAU,OAAO;AACvF,YAAO,AAAc,cAAD,cAChB,aAAa,GACb,AAAc,aAAD,kBACY,KAAnB,AAAc,aAAD,OAAC,aAAuC,oCAChC,MAApB,AAAc,aAAD,QAAC,cAAwC,wCAC9B,OAAtB,AAAc,aAAD,UAAC,eAA0C,2CAClC,OAAtB,AAAc,aAAD,UAAC,eAA0C;IAEvE;sCAE6D;;AAC1C,sBAAY,AAAQ,OAAD;AACpC,kBAAO,SAAS,eAAT,OAAW;YAAX;IACT;uBAGkC;;AAAc,YAAK,EAAL,kBAAQ,AAAU,SAAD;IAAK;SAG7C,SAAgB;AACvC,YAAO,qCAAgB,kBAAa,KAAK;IAC3C;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AACA,MAApC,AAAK,8BAAoB,UAAU;IACrC;;;QA7EQ;QACQ;QACC;;IADD;UAEJ,AAAK,IAAD;UACJ,AAAM,KAAD;AALX,wDACE,GAAG,SAEM,KAAK;;EAEI","file":"../../../../../../../../../../packages/flutter/src/widgets/icon_theme.dart.lib.js"}');
  // Exports:
  return {
