define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/widgets/will_pop_scope.dart', 'packages/flutter/src/services/text_editing_delta.dart'], (function load__packages__flutter__src__widgets__form_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__widgets__will_pop_scope$46dart, packages__flutter__src__services__text_editing_delta$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 40,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/form.dart"
      });
    },
    get C1() {
    ...
    get C8() {
      return C[8] = dart.constList([C[3] || CT.C3, C[1] || CT.C1, C[2] || CT.C2], form.AutovalidateMode);
    }
  }, false);
  var C = Array(9).fill(void 0);
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/form.dart",
  ...
  form.Form = class Form extends framework.StatefulWidget {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new form.Form.new({key: key, child: child, onWillPop: onWillPop, onChanged: onChanged, autovalidateMode: autovalidateMode, $creationLocationd_0dea112b090073317d4: C[0] || CT.C0});
    }
    static of(context) {
      let t0;
  ...
  (form.Form.new = function(opts) {
    ...
    if (!(child !== null)) dart.assertFailed(null, I[0], 46, 15, "child != null");
    this[autovalidateMode$] = (t0 = autovalidateMode, t0 == null ? form.AutovalidateMode.disabled : t0);
  ...
  dart.setStaticMethodSignature(form.Form, () => ['of']);
  ...
  form.FormState = class FormState extends framework.State$(form.Form) {
    [_fieldDidChange]() {
      ...
      t0 == null ? null : t0();
      this[_hasInteractedByUser] = this[_fields][$any](dart.fn(field => field[_hasInteractedByUser].value, T$.FormFieldStateTobool()));
      this[_forceRebuild]();
    }
    [_forceRebuild]() {
    ...
    build(context) {
      ...
      return new will_pop_scope.WillPopScope.new({onWillPop: this.widget.onWillPop, child: new form._FormScope.new({formState: this, generation: this[_generation], child: this.widget.child, $creationLocationd_0dea112b090073317d4: C[4] || CT.C4}), $creationLocationd_0dea112b090073317d4: C[5] || CT.C5});
    }
    save() {
  ...
  form._FormScope = class _FormScope extends framework.InheritedWidget {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new form._FormScope.new({child: child, formState: formState, generation: generation, $creationLocationd_0dea112b090073317d4: C[6] || CT.C6});
    }
    get form() {
  ...
  (form._FormScope.new = function(opts) {
    ...
    form._FormScope.__proto__.new.call(this, {child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  form.FormField$ = dart.generic(T => {
    ...
    class FormField extends framework.StatefulWidget {
      ...
      static ['_#new#tearOff'](T, opts) {
        ...
        return new (form.FormField$(T)).new({key: key, builder: builder, onSaved: onSaved, validator: validator, initialValue: initialValue, enabled: enabled, autovalidateMode: autovalidateMode, restorationId: restorationId, $creationLocationd_0dea112b090073317d4: C[7] || CT.C7});
      }
      createState() {
    ...
    (FormField.new = function(opts) {
      ...
      if (!(builder !== null)) dart.assertFailed(null, I[0], 271, 15, "builder != null");
      this[autovalidateMode$0] = (t0 = autovalidateMode, t0 == null ? form.AutovalidateMode.disabled : t0);
  ...
  form.FormFieldState$ = dart.generic(T => {
    ...
    class FormFieldState extends State_RestorationMixin$36 {
      get [_value]() {
        if (!this[__FormFieldState__value_isSet]) {
      ...
      set [_value](library$32package$58flutter$47src$47widgets$47form$46dart$58$58_value$35param) {
        this[__FormFieldState__value_isSet] = true;
        this[__FormFieldState__value] = library$32package$58flutter$47src$47widgets$47form$46dart$58$58_value$35param;
      }
      get value() {
        return this[_value];
      }
      ...
      get isValid() {
        let t0;
        return (t0 = __t$TNToNStringN().as(this.widget.validator), t0 == null ? null : t0(this[_value])) == null;
      }
      save() {
        let t0;
        t0 = __t$TNToNvoid().as(this.widget.onSaved);
      ...
      [_validate]() {
        if (__t$TNToNStringN().as(this.widget.validator) != null) {
          this[_errorText].value = dart.nullCheck(__t$TNToNStringN().as(this.widget.validator))(this[_value]);
        }
      }
      didChange(value) {
        let t0;
      ...
      build(context) {
        ...
        t0$ = this.widget;
        return __t$FormFieldStateOfTToWidget().as(t0$.builder)(this);
      }
      static ['_#new#tearOff'](T) {
        return new (form.FormFieldState$(T)).new();
      }
    }
  ...
  form.AutovalidateMode = class AutovalidateMode extends core._Enum {
    toString() {
      return "AutovalidateMode." + this[_name];
    }
  };
  (form.AutovalidateMode.new = function(index, name) {
    form.AutovalidateMode.__proto__.new.call(this, index, name);
    ;
  ...
  dart.setStaticFieldSignature(form.AutovalidateMode, () => ['values', 'disabled', 'always', 'onUserInteraction']);
  dart.defineExtensionMethods(form.AutovalidateMode, ['toString']);
  dart.defineLazy(form.AutovalidateMode, {
    /*form.AutovalidateMode.values*/get values() {
      return C[8] || CT.C8;
    },
    /*form.AutovalidateMode.disabled*/get disabled() {
      return C[3] || CT.C3;
    },
    /*form.AutovalidateMode.always*/get always() {
      return C[1] || CT.C1;
    },
    /*form.AutovalidateMode.onUserInteraction*/get onUserInteraction() {
      return C[2] || CT.C2;
    }
  }, false);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["form.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAkEe;;;;;;IAYU;;;;;;IAMH;;;;;;IAMG;;;;;;;;;;;;;;cAlCW;;AACd,kBAAQ,AAAQ,OAAD;AACjC,WAAO,KAAK;0BAAL,OAAO;IAChB;;AAkC2B;IAAW;;;;QArD9B;QACQ;QACT;QACA;QACa;;IAHJ;IACT;IACA;UAEK,AAAM,KAAD;IACK,2BAAmB,KAAjB,gBAAgB,EAAhB,aAAqC;AAPvD,6CACE,GAAG;;EAM0D;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAgE3C,WAAxB,AAAO;mBAAA,OAAW;AAG2D,MAD7E,6BAAuB,AAClB,oBAAI,QAAyB,SAAU,AAAM,AAAqB,KAAtB;AAClC,MAAf;IACF;;AAKI,MAFF,cAAS;AACM,QAAX,oBAAF,AAAE,oBAAF;;IAEJ;gBAEuC;AACnB,MAAlB,AAAQ,kBAAI,KAAK;IACnB;kBAEyC;AAClB,MAArB,AAAQ,qBAAO,KAAK;IACtB;UAG0B;AACxB,cAAQ,AAAO;;;AAEA,YAAX;AACA;;;;AAEA,gBAAI;AACS,cAAX;;AAEF;;;;AAEA;;;AAGJ,YAAO,iDACM,AAAO,8BACX,oCACM,kBACC,0BACL,AAAO;IAGpB;;AAIE,eAAmC,QAAS;AAC9B,QAAZ,AAAM,KAAD;;IAET;;AAUE,eAAmC,QAAS;AAC7B,QAAb,AAAM,KAAD;;AAEqB,MAA5B,6BAAuB;AACN,MAAjB;IACF;;AAO6B,MAA3B,6BAAuB;AACR,MAAf;AACA,YAAO;IACT;;AAGO,qBAAW;AAChB,eAAmC,QAAS;AACF,QAAxC,WAA6B,CAAjB,AAAM,KAAD,eAAe,QAAQ;;AAE1C,cAAQ,QAAQ;IAClB;;;;;;IA3FI,oBAAc;IACb,6BAAuB;IACO,gBAAmC;;;EA0FxE;;;;;;;;;;;;;;;;;;;;;;;;;IAUkB;;;;;;IAIN;;;;;;;;;;;;;AAGO,YAAA,AAAW;IAAM;uBAGC;;AAAQ,YAAA,AAAY,uBAAG,AAAI,GAAD;IAAY;;;QAhBxD;QACI;QACN;;IACC,oBAAE,SAAS;IACV,qBAAE,UAAU;AALvB,qDACW,KAAK;;EAIO;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAwEH;;;;;;MAeG;;;;;;MAKH;;;;;;MAGjB;;;;;;MAOE;;;;;;MAaY;;;;;;MAcT;;;;;;;;;;;;;;;;;;AAGqB;MAAmB;;;;UAzE9C;UACQ;UACT;UACA;UACA;UACA;UACa;UACb;;MANS;MACT;MACA;MACA;MACA;MAEA;YACK,AAAQ,OAAD;MACG,4BAAmB,KAAjB,gBAAgB,EAAhB,aAAqC;AAVvD,+CACE,GAAG;;IAS0D;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAsE7D;0CAAS,AAAO;AAAhB;;;MAA4B;mBAA5B;;;MAA4B;;AAKpB;MAAM;;AAKG,cAAA,AAAW;MAAK;;AAGpB,cAAA,AAAW,AAAM;MAAO;;;AAUzB,cAA+B,6BAA/B,AAAO,qCAAA,OAAW,GAAK;MAAe;;;AAI7B,gCAA3B,AAAO;qBAAA,OAAS,GAAK;MACvB;;;AAQI,QAJF,cAAS;AACqB,UAA5B,eAAS,AAAO;AACkB,UAAlC,AAAqB,mCAAQ;AACN,UAAvB,AAAW,yBAAQ;;AAEc,aAA9B,aAAG;qBAAH,OAAa;MACpB;;AAYI,QAFF,cAAS;AACI,UAAX;;AAEF,gBAAQ;MACV;;AAGE,kCAAI,AAAO;AACmC,UAA5C,AAAW,yBAAwB,AAAC,qCAAjB,AAAO,wBAAW;;MAEzC;gBAQkB;;;AAId,QAHF,cAAS;AACO,UAAd,eAAS,KAAK;AACmB,UAAjC,AAAqB,mCAAQ;;AAEI,aAA9B,aAAG;qBAAH,OAAa;MACpB;eAWiB;;AACD,QAAd,eAAS,KAAK;MAChB;;AAG6B,cAAA,AAAO;MAAa;mBAGZ,WAAgB;AACH,QAAhD,4BAAuB,kBAAY;AACmC,QAAtE,4BAAuB,4BAAsB;MAC/C;;;AAIqC,aAA9B,aAAG;qBAAH,OAAa,gBAAY;AACZ,QAAZ;MACR;YAG0B;;AACxB,YAAI,AAAO;AACT,kBAAQ,AAAO;;;AAEA,gBAAX;AACA;;;;AAEA,oBAAI,AAAqB;AACZ,kBAAX;;AAEF;;;;AAEA;;;;AAG2B,aAA5B,aAAG,OAAO;qBAAV,OAAa,cAAU;AAC5B,cAAO;cAAc,oCAAP,aAAQ;MACxB;;;;;;sCAxHQ;;MACgB,mBAAa,iDAAkB;MAClC,6BAAuB,8CAAe;;;IAuH7D;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAaA;;;;;;;;;;;;MAVK,4BAAM;;;MAET,8BAAQ;;;MAGR,4BAAM;;;MAIN,uCAAiB","file":"../../../../../../../../../../packages/flutter/src/widgets/form.dart.lib.js"}');
  // Exports:
  return {
