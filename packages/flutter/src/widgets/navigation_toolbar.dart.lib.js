define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/rendering/box.dart', 'packages/flutter/src/rendering/custom_layout.dart'], (function load__packages__flutter__src__widgets__navigation_toolbar_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__rendering__box$46dart, packages__flutter__src__rendering__custom_layout$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 26,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/navigation_toolbar.dart"
      });
    },
    get C1() {
    ...
    get C5() {
      return C[5] = dart.constList([C[6] || CT.C6, C[7] || CT.C7, C[8] || CT.C8], navigation_toolbar._ToolbarSlot);
    },
    get C9() {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/navigation_toolbar.dart",
  ...
  navigation_toolbar.NavigationToolbar = class NavigationToolbar extends framework.StatelessWidget {
    ...
    build(context) {
      if (!debug.debugCheckHasDirectionality(context)) dart.assertFailed(null, I[0], 60, 12, "debugCheckHasDirectionality(context)");
  ...
  dart.defineLazy(navigation_toolbar._ToolbarSlot, {
    /*navigation_toolbar._ToolbarSlot.values*/get values() {
      return C[5] || CT.C5;
    },
    /*navigation_toolbar._ToolbarSlot.leading*/get leading() {
      return C[6] || CT.C6;
    },
    /*navigation_toolbar._ToolbarSlot.middle*/get middle() {
      return C[7] || CT.C7;
    },
    /*navigation_toolbar._ToolbarSlot.trailing*/get trailing() {
      return C[8] || CT.C8;
    }
  }, false);
  ...
  (navigation_toolbar._ToolbarLayout.new = function(opts) {
    ...
    if (!(middleSpacing !== null)) dart.assertFailed(null, I[0], 88, 15, "middleSpacing != null");
    if (!(textDirection !== null)) dart.assertFailed(null, I[0], 89, 15, "textDirection != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["navigation_toolbar.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAuCgB;;;;;;IAIA;;;;;;IAGA;;;;;;IAIH;;;;;;IAKE;;;;;;;;;;;;;;;UAGa;AACxB,WAAO,kCAA4B,OAAO;AACtB,0BAA+B,wBAAG,OAAO;AAC7D,YAAO,iDACK,yDACM,kCACC,mCACA,aAAa,cAEZ;;AAChB,cAAI,sBAAiB,oCAA0B,gDAAuB,eAAP;AAC/D,cAAI,qBAAgB,oCAA0B,+CAAqB,eAAN;AAC7D,cAAI,uBAAkB,oCAA0B,iDAAyB,eAAR;;;IAGvE;;;QA/CQ;QACD;QACA;QACA;QACA;QACA;;IAJA;IACA;IACA;IACA;IACA;UACK,AAAa,YAAD;UACZ,AAAc,aAAD;AARnB,wEACE,GAAG;;EAOuB;;;;;;;;;;;;;;;;;;MAGd,mDAAc;;;;;;;;;;IA4CpC;;;;;;;;;;;;MAJK,sCAAM;;;MACT,uCAAO;;;MACP,sCAAM;;;MACN,wCAAQ;;;;;;;;;;;kBAuBgB;AACf,yBAAe;AACf,0BAAgB;AAEvB,UAAI,cAAsB;AACH,0BAAc,sCACvB,AAAK,AAAM,IAAP,SAAS,gBACZ,AAAK,IAAD,oBACJ,AAAK,IAAD;AAEkD,QAAnE,eAAe,AAA+C,iBAAtB,yCAAS,WAAW;AAC/C;AACb,gBAAQ;;;AAEgC,cAApC,WAAW,AAAK,AAAM,IAAP,SAAS,YAAY;AACpC;;;;AAEc,cAAd,WAAW;AACX;;;AAEsD,QAA1D,mBAA2B,yCAAS,kBAAO,QAAQ,EAAE;;AAGvD,UAAI,cAAsB;AACH,0BAA6B,6BAAM,IAAI;AACjD,2BAAe,iBAAyB,0CAAU,WAAW;AAC3D;AACb,gBAAQ;;;AAEW,cAAf,YAAY;AACZ;;;;AAE2C,cAA3C,YAAY,AAAK,AAAM,IAAP,SAAS,AAAa,YAAD;AACrC;;;AAES,wBAAgD,CAAnC,AAAK,AAAO,IAAR,UAAU,AAAa,YAAD,WAAW;AAC7B,QAAlC,gBAAgB,AAAa,YAAD;AACsC,QAAlE,mBAA2B,0CAAU,kBAAO,SAAS,EAAE,SAAS;;AAGlE,UAAI,cAAsB;AACX,uBAAgB,sBAAI,AAAK,AAAM,AAAe,AAAgB,IAAtC,SAAS,YAAY,GAAG,aAAa,GAAG,AAAc,qBAAE,KAAK;AAC7E,0BAA6B,AAAY,6BAAN,IAAI,sBAAqB,QAAQ;AAC9E,yBAAa,iBAAyB,wCAAQ,WAAW;AAEvD,gCAAoB,AAAa,YAAD,GAAG;AACzC,0BAAc,iBAAiB;AACzB,sBAA4C,CAAjC,AAAK,AAAO,IAAR,UAAU,AAAW,UAAD,WAAW;AAG3D,YAAI;AACiD,UAAnD,cAA8C,CAA/B,AAAK,AAAM,IAAP,SAAS,AAAW,UAAD,UAAU;AAChD,cAAI,AAAY,AAAmB,WAApB,GAAG,AAAW,UAAD,SAAS,AAAK,AAAM,IAAP,SAAS,aAAa;AACF,YAA3D,cAAc,AAAK,AAAM,AAAgB,IAAvB,SAAS,aAAa,GAAG,AAAW,UAAD;gBAChD,KAAI,AAAY,WAAD,GAAG,iBAAiB;AACT,YAA/B,cAAc,iBAAiB;;;AAItB;AACb,gBAAQ;;;AAEiD,cAArD,UAAU,AAAK,AAAM,AAAmB,IAA1B,SAAS,AAAW,UAAD,SAAS,WAAW;AACrD;;;;AAEqB,cAArB,UAAU,WAAW;AACrB;;;AAGwD,QAA5D,mBAA2B,wCAAQ,kBAAO,OAAO,EAAE,OAAO;;IAE9D;mBAGmC;;AACjC,YAAO,AAAY,AAEf,YAFc,kBAAiB,qBAC5B,AAAY,WAAD,mBAAkB,sBAC7B,AAAY,WAAD,mBAAkB;IACtC;;;QAhGgB;QACA;QACA;IAFA;IACA;IACA;UACJ,AAAc,aAAD;UACb,AAAc,aAAD;AALzB;;EAKkC","file":"../../../../../../../../../../packages/flutter/src/widgets/navigation_toolbar.dart.lib.js"}');
  // Exports:
  return {
