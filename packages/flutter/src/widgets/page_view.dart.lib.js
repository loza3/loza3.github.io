define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/animation/curves.dart', 'packages/flutter/src/foundation/math.dart', 'packages/flutter/src/widgets/scroll_metrics.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/physics/spring_simulation.dart', 'packages/flutter/src/physics/tolerance.dart', 'packages/flutter/src/gestures/recognizer.dart', 'packages/flutter/src/rendering/sliver.dart', 'packages/flutter/src/widgets/sliver_fill.dart', 'packages/flutter/src/rendering/viewport_offset.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__widgets__page_view_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__animation__curves$46dart, packages__flutter__src__foundation__math$46dart, packages__flutter__src__widgets__scroll_metrics$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__physics__spring_simulation$46dart, packages__flutter__src__physics__tolerance$46dart, packages__flutter__src__gestures__recognizer$46dart, packages__flutter__src__rendering__sliver$46dart, packages__flutter__src__widgets__sliver_fill$46dart, packages__flutter__src__rendering__viewport_offset$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  const page_storage = packages__flutter__src__widgets__title$46dart.src__widgets__page_storage;
  ...
  dart.defineLazy(CT, {
    ...
    get C11() {
      return C[11] = dart.const({
        ...
        [_Location_column]: 3,
        [_Location_line]: 645,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/page_view.dart"
      });
    },
    get C12() {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/page_view.dart",
  ...
  page_view.PageController = class PageController extends scroll_controller.ScrollController {
    ...
    get page() {
      if (!this.positions[$isNotEmpty]) dart.assertFailed("PageController.page cannot be accessed before a PageView is built with it.", I[0], 173, 7, "positions.isNotEmpty");
      if (!(this.positions[$length] === 1)) dart.assertFailed("The page property cannot be read when multiple PageViews are attached to " + "the same PageController.", I[0], 177, 7, "positions.length == 1");
  ...
  (page_view.PageController.new = function(opts) {
    ...
    if (!(initialPage !== null)) dart.assertFailed(null, I[0], 121, 15, "initialPage != null");
    if (!(keepPage !== null)) dart.assertFailed(null, I[0], 122, 15, "keepPage != null");
    if (!(viewportFraction !== null)) dart.assertFailed(null, I[0], 123, 15, "viewportFraction != null");
    if (!(viewportFraction > 0.0)) dart.assertFailed(null, I[0], 124, 15, "viewportFraction > 0.0");
  ...
  page_view.PageMetrics = class PageMetrics extends scroll_metrics.FixedScrollMetrics {
    ...
    get page() {
      return math.max(core.double, 0.0, math$.clampDouble(this.pixels, this.minScrollExtent, this.maxScrollExtent)) / math.max(core.num, 1.0, this.viewportDimension * this.viewportFraction);
    }
  };
  ...
  page_view._PagePosition = class _PagePosition extends scroll_position_with_single_context.ScrollPositionWithSingleContext {
    ...
    getPageFromPixels(pixels, viewportDimension) {
      if (!(viewportDimension > 0.0)) dart.assertFailed(null, I[0], 380, 12, "viewportDimension > 0.0");
    ...
    get page() {
      let t0;
      if (!(!this.hasPixels || this.hasContentDimensions)) dart.assertFailed("Page value is only available after content dimensions are established.", I[0], 396, 7, "!hasPixels || hasContentDimensions");
      return !this.hasPixels || !this.hasContentDimensions ? null : (t0 = this[_cachedPage], t0 == null ? this.getPageFromPixels(math$.clampDouble(this.pixels, this.minScrollExtent, this.maxScrollExtent), this.viewportDimension) : t0);
    }
    saveScrollOffset() {
      let t1, t0;
    ...
    restoreOffset(offset, opts) {
      ...
      if (!(initialRestore !== null)) dart.assertFailed(null, I[0], 426, 12, "initialRestore != null");
      if (!(offset !== null)) dart.assertFailed(null, I[0], 427, 12, "offset != null");
      if (initialRestore) {
    ...
    absorb(other) {
      super.absorb(other);
      if (!(this[_cachedPage] == null)) dart.assertFailed(null, I[0], 468, 12, "_cachedPage == null");
      if (!page_view._PagePosition.is(other)) {
        return;
      }
      if (other[_cachedPage] != null) {
        this[_cachedPage] = other[_cachedPage];
      }
    }
  ...
  (page_view._PagePosition.new = function(opts) {
    ...
    this.initialPage = initialPage;
    if (!(initialPage !== null)) dart.assertFailed(null, I[0], 317, 15, "initialPage != null");
    if (!(keepPage !== null)) dart.assertFailed(null, I[0], 318, 15, "keepPage != null");
    if (!(viewportFraction !== null)) dart.assertFailed(null, I[0], 319, 15, "viewportFraction != null");
    if (!(viewportFraction > 0.0)) dart.assertFailed(null, I[0], 320, 15, "viewportFraction > 0.0");
    this[_viewportFraction] = viewportFraction;
    this[_pageToUseOnStartup] = initialPage[$toDouble]();
    page_view._PagePosition.__proto__.new.call(this, {initialPixels: null, keepScrollOffset: keepPage, physics: physics, context: context, oldPosition: oldPosition});
    ;
  ...
  (page_view._ForceImplicitScrollPhysics.new = function(opts) {
    ...
    if (!(allowImplicitScrolling !== null)) dart.assertFailed(null, I[0], 512, 15, "allowImplicitScrolling != null");
  ...
  page_view.PageScrollPhysics = class PageScrollPhysics extends scroll_physics.ScrollPhysics {
    ...
    [_getPage](position) {
      if (page_view._PagePosition.is(position)) {
        return dart.nullCheck(position.page);
      }
    ...
    createBallisticSimulation(position, velocity) {
      ...
      if (target !== position.pixels) {
        return new spring_simulation.ScrollSpringSimulation.new(this.spring, position.pixels, target, velocity, {tolerance: tolerance});
      }
      return null;
    }
    get allowImplicitScrolling() {
  ...
  page_view.PageView = class PageView extends framework.StatefulWidget {
    ...
    static ['_#builder#tearOff'](opts) {
      ...
      let scrollBehavior = opts && 'scrollBehavior' in opts ? opts.scrollBehavior : null;
      let padEnds = opts && 'padEnds' in opts ? opts.padEnds : true;
      return new page_view.PageView.builder({key: key, scrollDirection: scrollDirection, reverse: reverse, controller: controller, physics: physics, pageSnapping: pageSnapping, onPageChanged: onPageChanged, itemBuilder: itemBuilder, findChildIndexCallback: findChildIndexCallback, itemCount: itemCount, dragStartBehavior: dragStartBehavior, allowImplicitScrolling: allowImplicitScrolling, restorationId: restorationId, clipBehavior: clipBehavior, scrollBehavior: scrollBehavior, padEnds: padEnds, $creationLocationd_0dea112b090073317d4: C[12] || CT.C12});
    }
  ...
  (page_view.PageView.new = function(opts) {
    ...
    if (!(allowImplicitScrolling !== null)) dart.assertFailed(null, I[0], 660, 15, "allowImplicitScrolling != null");
    if (!(clipBehavior !== null)) dart.assertFailed(null, I[0], 661, 15, "clipBehavior != null");
  ...
  (page_view.PageView.builder = function(opts) {
    ...
    this[scrollBehavior$] = scrollBehavior;
    this[padEnds$] = padEnds;
    if (!(allowImplicitScrolling !== null)) dart.assertFailed(null, I[0], 705, 15, "allowImplicitScrolling != null");
    if (!(clipBehavior !== null)) dart.assertFailed(null, I[0], 706, 15, "clipBehavior != null");
    this[controller$] = (t0 = controller, t0 == null ? page_view._defaultPageController : t0);
    this[childrenDelegate$] = new sliver.SliverChildBuilderDelegate.new(itemBuilder, {findChildIndexCallback: findChildIndexCallback, childCount: itemCount});
    page_view.PageView.__proto__.new.call(this, {key: key, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  }).prototype = page_view.PageView.prototype;
  (page_view.PageView.custom = function(opts) {
    ...
    this[scrollBehavior$] = scrollBehavior;
    this[padEnds$] = padEnds;
    if (!(childrenDelegate !== null)) dart.assertFailed(null, I[0], 813, 15, "childrenDelegate != null");
    if (!(allowImplicitScrolling !== null)) dart.assertFailed(null, I[0], 814, 15, "allowImplicitScrolling != null");
    if (!(clipBehavior !== null)) dart.assertFailed(null, I[0], 815, 15, "clipBehavior != null");
    this[controller$] = (t0 = controller, t0 == null ? page_view._defaultPageController : t0);
    page_view.PageView.__proto__.new.call(this, {key: key, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  }).prototype = page_view.PageView.prototype;
  ...
  page_view._PageViewState = class _PageViewState extends framework.State$(page_view.PageView) {
    ...
    [_getDirection](context) {
      switch (this.widget.scrollDirection) {
        case C[7] || CT.C7:
          {
            if (!debug.debugCheckHasDirectionality(context)) dart.assertFailed(null, I[0], 936, 16, "debugCheckHasDirectionality(context)");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["page_view.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA8HY;;;;;;IAiBC;;;;;;IAQE;;;;;;;;;;;;;AAoBX,WACE,AAAU,+CACV;AAEF,YACE,AAAU,AAAO,4BAAG,sBAAC,AACrB,8EACA;AAEkB,qBAAyB,2BAAT;AACpC,YAAO,AAAS,SAAD;IACjB;kBASM;UACc;UACH;AAEK,qBAAyB,2BAAT;AACpC,UAAI,AAAS,QAAD;AAC4B,QAAtC,AAAS,QAAD,gBAAe,AAAK,IAAD;AAC3B,cAAO;;AAGT,YAAO,AAAS,SAAD,WACb,AAAS,QAAD,mBAAmB,AAAK,IAAD,2BACrB,QAAQ,SACX,KAAK;IAEhB;eAMoB;AACE,qBAAyB,2BAAT;AACpC,UAAI,AAAS,QAAD;AAC4B,QAAtC,AAAS,QAAD,gBAAe,AAAK,IAAD;AAC3B;;AAG0D,MAA5D,AAAS,QAAD,QAAQ,AAAS,QAAD,mBAAmB,AAAK,IAAD;IACjD;;UAQ0C;UAAyB;AACjE,YAAO,oBAAkB,AAAE,AAAQ,eAAd,uBAAgB,cAAa,QAAQ,SAAS,KAAK;IAC1E;;UAQ8C;UAAyB;AACrE,YAAO,oBAAkB,AAAE,AAAQ,eAAd,uBAAgB,cAAa,QAAQ,SAAS,KAAK;IAC1E;yBAGkD,SAAuB,SAAyB;AAChG,YAAO,2CACI,OAAO,WACP,OAAO,eACH,4BACH,iCACQ,oCACL,WAAW;IAE5B;WAG2B;AACH,MAAhB,aAAO,QAAQ;AACD,yBAAwB,2BAAT,QAAQ;AACK,MAAhD,AAAa,YAAD,oBAAoB;IAClC;;;QA9IO;QACA;QACA;IAFA;IACA;IACA;UACK,AAAY,WAAD;UACX,AAAS,QAAD;UACR,AAAiB,gBAAD;UAChB,AAAiB,gBAAD,GAAG;AAP/B;;EAOmC;;;;;;;;;;;;;;;;;;;;;;;IAsLtB;;;;;;;;;;;;;;;;;UA1BH;UACA;UACA;UACA;UACO;UACP;AAER,YAAO,kDAC4B,KAAhB,eAAe,EAAf,aAAoB,4BAA4B,uBAAkB,8BAClD,MAAhB,eAAe,EAAf,cAAoB,4BAA4B,uBAAkB,sBACpE,OAAP,MAAM,EAAN,eAAW,iBAAiB,cAAS,kCACR,OAAlB,iBAAiB,EAAjB,eAAsB,4BAA4B,yBAAoB,8BAC5D,OAAd,aAAa,EAAb,eAAsB,+CACF,OAAjB,gBAAgB,EAAhB,eAAyB;IAE/C;;AAIE,YAAY,AAAgE,uBAA5D,KAAK,kBAAY,aAAQ,sBAAiB,yBAC9C,mBAAI,KAAK,AAAkB,yBAAE;IAC3C;;;QA/BiB;QACA;QACA;QACA;QACA;QACD;;AANhB,qEACiB,eAAe,mBACf,eAAe,UACf,MAAM,qBACN,iBAAiB,iBACjB,aAAa;;EAE5B;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;kBA6Da;UACN;UACE;UACH;UACwB;UAChB;AAMd,YAAa,qBACX,MAAM,cACK,SAAS,YACV,QAAQ,SACX,KAAK,mBACK,eAAe;IAEpC;;AAG+B;IAAiB;yBAEpB;AAC1B,UAAI,AAAkB,4BAAG,KAAK;AAC5B;;AAEY,oBAAU;AACC,MAAzB,0BAAoB,KAAK;AACzB,UAAI,OAAO;AAC8B,QAAvC,iBAAY,uBAAkB,OAAO;;IAEzC;;AAQiC,YAAK,uBAAI,KAAG,AAAkB,AAAyB,0BAAtB,AAAiB,wBAAE,KAAK;IAAE;sBAE5D,QAAe;AAC7C,YAAO,AAAkB,iBAAD,GAAG;AACd,mBAAc,AAAsC,sBAAlC,KAAK,AAAO,MAAD,GAAG,6BAAuB,AAAkB,iBAAD,GAAG;AAC3E,kBAAQ,AAAO,MAAD;AAC3B,UAAqB,AAAM,CAAtB,AAAO,MAAD,GAAG,KAAK;AACjB,cAAO,MAAK;;AAEd,YAAO,OAAM;IACf;sBAEgC;AAC9B,YAAO,AAAK,AAAoB,AAAmB,KAAxC,GAAG,yBAAoB,wBAAmB;IACvD;;;AAIE,YACa,CAAV,kBAAa,8CACd;AAEF,YAAkB,EAAV,mBAAc,4BAClB,QACY,wBAAZ,aAAe,uBAAkB,kBAAY,aAAQ,sBAAiB,uBAAkB;IAC9F;;;AAIyI,WAA3H,4BAAG,AAAQ;mBAAX,OAA4B,cAAW,AAAQ,8BAA4B,wBAAZ,aAAe,uBAAkB,aAAQ;IACtH;;;AAIE,WAAK;AACW,oBAAkF,qBAA9D,4BAAG,AAAQ,2CAAX,OAA4B,aAAU,AAAQ;AAChF,YAAI,KAAK;AACoB,UAA3B,4BAAsB,KAAK;;;IAGjC;;;AAIiF,MAA/E,AAAQ,yBAAuB,wBAAZ,aAAe,uBAAkB,aAAQ;IAC9D;kBAG0B;UAAc;AACtC,YAAO,AAAe,cAAD;AACrB,YAAO,AAAO,MAAD;AACb,UAAI,cAAc;AACY,QAA5B,4BAAsB,MAAM;;AAEK,QAAjC,YAAO,uBAAkB,MAAM;;IAEnC;2BAGmC;AACnB,kCAAwB,4BAA4B,yBAAoB;AACtF,UAAI,AAAkB,iBAAD,KAAI,qBAAqB;AAC5C,cAAO;;AAEE,mBAAe,6BAAuB,iBAAiB;AACpD,sBAAY,iBAAY,cAAS;AACxC;AACP,UAAI,AAAU,SAAD;AACe,QAA1B,OAAO;YACF,KAAI,AAAsB,qBAAD,KAAI;AAEf,QAAnB,OAAkB,eAAX;;AAEoD,QAA3D,OAAO,uBAAkB,SAAS,EAAuB,eAArB,qBAAqB;;AAE9C,sBAAY,uBAAkB,IAAI;AAIO,MAAtD,oBAAe,AAAkB,iBAAD,KAAI,MAAO,IAAI,GAAG;AAElD,UAAI,SAAS,KAAI,SAAS;AACA,QAAxB,mBAAc,SAAS;AACvB,cAAO;;AAET,YAAO,OAAM;IACf;WAG2B;AACN,MAAb,aAAO,KAAK;AAClB,YAAO,AAAY;AAEnB,WAAU,2BAAN,KAAK;AACP;;AAGF,UAAI,AAAM,KAAD;AACwB,QAA/B,oBAAc,AAAM,KAAD;;IAEvB;2BAGmC,iBAAwB;AAC5C,+BAAqB,AAAgB,eAAD,GAAG;AACpD,YAAa,8BACX,kBAAkB,EACb,sBAAI,kBAAkB,EAAE,AAAgB,eAAD,GAAG;IAEnD;;;UAIU;UACA;UACA;UACA;UACO;UACP;AAER,YAAO,kDAC4B,KAAhB,eAAe,EAAf,aAAoB,4BAA4B,uBAAkB,8BAClD,MAAhB,eAAe,EAAf,cAAoB,4BAA4B,uBAAkB,sBACpE,OAAP,MAAM,EAAN,eAAW,iBAAiB,cAAS,kCACR,OAAlB,iBAAiB,EAAjB,eAAsB,4BAA4B,yBAAoB,8BAC5D,OAAd,aAAa,EAAb,eAAsB,+CACF,OAAjB,gBAAgB,EAAhB,eAAyB;IAE/C;;;;;;;;;;;;;;;QAlMiB;QACA;QACV;QACA;QACE;QACD;IAiBA;IApBD;UAIK,AAAY,WAAD;UACX,AAAS,QAAD;UACR,AAAiB,gBAAD;UAChB,AAAiB,gBAAD,GAAG;IACR,0BAAE,gBAAgB;IAChB,4BAAE,AAAY,WAAD;AACjC,qEACiB,wBACG,QAAQ,WAdhB,OAAO,WACP,OAAO,eAIhB,WAAW;;EAUb;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAqMK;;;;;;;;;;;YARwC;AACjD,YAAO,wEACmB,qCAChB,iBAAY,QAAQ;IAEhC;;;QAVgB;QACR;IADQ;UAEJ,AAAuB,sBAAD;AAH5B,4EAEE,MAAM;;EAC6B;;;;;;;;;;;;;;;;;;;;YA4BF;AACvC,YAAO,8CAA0B,iBAAY,QAAQ;IACvD;eAE8B;AAC5B,UAAa,2BAAT,QAAQ;AACV,cAAoB,gBAAb,AAAS,QAAD;;AAEjB,YAAO,AAAS,AAAO,SAAR,UAAU,AAAS,QAAD;IACnC;iBAEgC,UAAiB;AAC/C,UAAa,2BAAT,QAAQ;AACV,cAAO,AAAS,SAAD,mBAAmB,IAAI;;AAExC,YAAO,AAAK,KAAD,GAAG,AAAS,QAAD;IACxB;uBAEsC,UAAoB,WAAkB;AACnE,iBAAO,eAAS,QAAQ;AAC/B,UAAI,AAAS,QAAD,GAAG,CAAC,AAAU,SAAD;AACZ,QAAX,OAAA,AAAK,IAAD,GAAI;YACH,KAAI,AAAS,QAAD,GAAG,AAAU,SAAD;AAClB,QAAX,OAAA,AAAK,IAAD,GAAI;;AAEV,YAAO,kBAAW,QAAQ,EAAE,AAAK,IAAD;IAClC;8BAGoD,UAAiB;AAGnE,UAAK,AAAS,QAAD,IAAI,OAAO,AAAS,AAAO,QAAR,WAAW,AAAS,QAAD,oBAC9C,AAAS,QAAD,IAAI,OAAO,AAAS,AAAO,QAAR,WAAW,AAAS,QAAD;AACjD,cAAa,iCAA0B,QAAQ,EAAE,QAAQ;;AAE3C,sBAAiB;AACpB,mBAAS,uBAAiB,QAAQ,EAAE,SAAS,EAAE,QAAQ;AACpE,UAAI,MAAM,KAAI,AAAS,QAAD;AACpB,cAAO,kDAAuB,aAAQ,AAAS,QAAD,SAAS,MAAM,EAAE,QAAQ,cAAa,SAAS;;AAE/F,YAAO;IACT;;AAGmC;IAAK;;;QAhDR;AAA1B,kEAA0B,MAAM;;EAAG;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAoS9B;;;;;;IAGG;;;;;;IAKH;;;;;;IAcA;;;;;;IAIU;;;;;;IAeA;;;;;;IAOV;;;;;;IAGc;;;;;;IAQC;;;;;;IAGF;;;;;;IAKb;;;;;;IAWW;;;;;;IAWX;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAGsB;IAAgB;;;;QAnRzC;QACD;QACA;QACW;QACX;QACA;QACA;QACQ;QACR;QACA;QACA;QACA;QACA;QACA;;IAZA;IACA;IAEA;IACA;IACA;IAEA;IACA;IACA;IACA;IACA;IACA;UACK,AAAuB,sBAAD;UACtB,AAAa,YAAD;IACR,qBAAa,KAAX,UAAU,EAAV,aAAc;IACV,0BAAE,uCAAwB,QAAQ;AAlBxD,sDACQ,GAAG;;EAiB8C;;;QA0BjD;QACD;QACA;QACW;QACX;QACA;QACA;QACyB;QACZ;QACb;QACA;QACA;QACA;QACA;QACA;QACA;;IAdA;IACA;IAEA;IACA;IACA;IAIA;IACA;IACA;IACA;IACA;IACA;UACK,AAAuB,sBAAD;UACtB,AAAa,YAAD;IACR,qBAAa,KAAX,UAAU,EAAV,aAAc;IACV,0BAAE,0CACjB,WAAW,2BACa,sBAAsB,cAClC,SAAS;AAvB5B,sDACQ,GAAG;;EAuBL;;;QAuFE;QACD;QACA;QACW;QACX;QACA;QACA;QACS;QACT;QACA;QACA;QACA;QACA;QACA;;IAZA;IACA;IAEA;IACA;IACA;IACS;IACT;IACA;IACA;IACA;IACA;IACA;UACK,AAAiB,gBAAD;UAChB,AAAuB,sBAAD;UACtB,AAAa,YAAD;IACR,qBAAa,KAAX,UAAU,EAAV,aAAc;AAlBhC,sDACQ,GAAG;;EAiB2C;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAiHnC,MAAX;AAC2C,MAAjD,0BAAoB,AAAO,AAAW;IACxC;oBAEyC;AACvC,cAAQ,AAAO;;;AAEX,iBAAO,kCAA4B,OAAO;AACtB,gCAA+B,wBAAG,OAAO;AACzC,gCAAgB,yCAA6B,aAAa;AAC9E,kBAAO,AAAO,uBAAU,8BAAkB,aAAa,IAAI,aAAa;;;;AAExE,kBAAO,AAAO,uBAAwB,+BAAmB;;;IAE/D;UAG0B;;AACJ,0BAAgB,oBAAc,OAAO;AACrC,oBAAU,AAE5B,uEADwB,AAAO,6CAE/B,AAAO,2BACH,AAAc,iCAAuB,KAAf,AAAO,qBAAA,mBAAW,AAAO,yCAAA,OAAgB,oBAAiB,OAAO,aACxE,MAAf,AAAO,qBAAA,qBAAW,AAAO,0CAAA,OAAgB,qBAAiB,OAAO;AAGvE,YAAO,yEACW,QAAoB;AAClC,cAAI,AAAa,AAAM,YAAP,WAAU,KAAK,AAAO,qCAAsC,gDAAb,YAAY;AACvD,0BAA+B,yBAArB,AAAa,YAAD;AAC9B,8BAA0B,AAAE,eAAd,AAAQ,OAAD;AAC/B,gBAAI,WAAW,KAAI;AACc,cAA/B,0BAAoB,WAAW;AACG,cAAd,AAAC,eAArB,AAAO,2BAAe,WAAW;;;AAGrC,gBAAO;iDAEF,kDACc,AAAO,8CACX,aAAa,cAChB,AAAO,iCACV,OAAO,iBACD,AAAO,4CACgB,OAAtB,AAAO,4BAAA,eAAsC,AAAY,4CAAT,OAAO,wBAAuB,kCAC7E,SAAc,SAAwB,aAC9C,wCAIQ,AAAO,qCAAyB,MAAM,uBAChB,oDACpB,aAAa,UACpB,QAAQ,gBACF,AAAO,mCACJ,wBACf,0DACoB,AAAO,AAAW,mDAC1B,AAAO,uCACR,AAAO;IAO9B;wBAGqD;AACb,MAAhC,0BAAoB,WAAW;AACyC,MAA9E,AAAY,WAAD,KAAK,iCAAmB,mBAAmB,AAAO;AACsB,MAAnF,AAAY,WAAD,KAAK,iCAAa,mBAAkB,AAAO,6BAAiB;AAC+B,MAAtG,AAAY,WAAD,KAAK,kDAAoC,cAAc,AAAO,mCAAsB;AACA,MAA/F,AAAY,WAAD,KAAK,iDAAmC,WAAW,AAAO,gCAAmB;AACe,MAAvG,AAAY,WAAD,KAAK,iCAAa,wBAAuB,AAAO,mCAAuB;AAC+C,MAAjI,AAAY,WAAD,KAAK,iCAAa,kCAAiC,AAAO,4CAAgC;IACvG;;;;;;IAlFI,0BAAoB;;;EAmF1B;;;;;;;;;;;;;;;MAhaqB,gCAAsB;YAAG;;MACtB,uBAAa","file":"../../../../../../../../../../packages/flutter/src/widgets/page_view.dart.lib.js"}');
  // Exports:
  return {
