define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/rendering/sliver_multi_box_adaptor.dart', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/rendering/box.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/rendering/sliver_fixed_extent_list.dart'], (function load__packages__flutter__src__widgets__sliver_prototype_extent_list_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__rendering__sliver_multi_box_adaptor$46dart, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__rendering__box$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__rendering__sliver_fixed_extent_list$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 37,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/sliver_prototype_extent_list.dart"
      });
    }
  }, false);
  var C = [void 0];
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/sliver_prototype_extent_list.dart",
  ...
  sliver_prototype_extent_list._SliverPrototypeExtentListElement = class _SliverPrototypeExtentListElement extends sliver.SliverMultiBoxAdaptorElement {
    ...
    insertRenderObjectChild(child, slot) {
      ...
      if (slot[$_equals](sliver_prototype_extent_list._SliverPrototypeExtentListElement._prototypeSlot)) {
        if (!box.RenderBox.is(child)) dart.assertFailed(null, I[0], 73, 14, "child is RenderBox");
    ...
    didAdoptChild(child) {
      if (!child[$_equals](this.renderObject.child)) {
    ...
    moveRenderObjectChild(child, oldSlot, newSlot) {
      ...
      if (newSlot[$_equals](sliver_prototype_extent_list._SliverPrototypeExtentListElement._prototypeSlot)) {
        if (!false) dart.assertFailed(null, I[0], 91, 14, "false");
      } else {
    ...
    visitChildren(visitor) {
      if (this[_prototype] != null) {
        visitor(dart.nullCheck(this[_prototype]));
      }
      super.visitChildren(visitor);
    }
    mount(parent, newSlot) {
      super.mount(parent, newSlot);
      this[_prototype] = this.updateChild(this[_prototype], sliver_prototype_extent_list.SliverPrototypeExtentList.as(this.widget).prototypeItem, sliver_prototype_extent_list._SliverPrototypeExtentListElement._prototypeSlot);
    }
    update(newWidget) {
      sliver_prototype_extent_list.SliverPrototypeExtentList.as(newWidget);
      super.update(newWidget);
      if (!this.widget._equals(newWidget)) dart.assertFailed(null, I[0], 123, 12, "widget == newWidget");
      this[_prototype] = this.updateChild(this[_prototype], sliver_prototype_extent_list.SliverPrototypeExtentList.as(this.widget).prototypeItem, sliver_prototype_extent_list._SliverPrototypeExtentListElement._prototypeSlot);
    }
  };
  ...
  sliver_prototype_extent_list._RenderSliverPrototypeExtentList = class _RenderSliverPrototypeExtentList extends sliver_fixed_extent_list.RenderSliverFixedExtentBoxAdaptor {
    ...
    get itemExtent() {
      if (!(this.child != null && dart.nullCheck(this.child).hasSize)) dart.assertFailed(null, I[0], 186, 12, "child != null && child!.hasSize");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["sliver_prototype_extent_list.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAgDe;;;;;;;;;;;;uBAG+C;AAClB,oBAAkB,kEAAR,OAAO;AACzD,YAAO,sFAA+C,OAAO;IAC/D;;AAGgD,oFAAkC;IAAK;;;QApB/E;QACS;QACD;;;UACJ,AAAc,aAAD;AAJnB,0FACE,GAAG,YACM,QAAQ;;EAES;;;;;;;;;;;;;;;;;;AAwBmB,YAAmB,kEAAb;IAAgD;4BAMvD,OAAwB;;;AAC1E,UAAI,AAAK,IAAD,WAAI;AACV,aAAa,iBAAN,KAAK;AAC2B,QAAvC,AAAa,0BAAc,iBAAN,KAAK;;AAEuB,QAA3C,8BAAwB,KAAK,EAAO,YAAL,IAAI;;IAE7C;kBAG6B;AAC3B,WAAI,KAAK,WAAI,AAAa;AACE,QAApB,oBAAc,KAAK;;IAE7B;0BAGqC,OAAc,SAAgB;;;;AACjE,UAAI,AAAQ,OAAD,WAAI;AAEb,aAAO;;AAE2D,QAA5D,4BAAsB,KAAK,EAAU,YAAR,OAAO,GAAiB,YAAR,OAAO;;IAE9D;4BAGuC,OAAc;;;AACnD,UAAuB,YAAnB,AAAa,yBAAS,KAAK;AACJ,QAAzB,AAAa,0BAAQ;;AAE4B,QAA3C,8BAAwB,KAAK,EAAO,YAAL,IAAI;;IAE7C;kBAGkC;AAChC,UAAI;AACkB,QAApB,AAAO,OAAA,CAAW,eAAV;;AAEkB,MAAtB,oBAAc,OAAO;IAC7B;UAGoB,QAAgB;AACN,MAAtB,YAAM,MAAM,EAAE,OAAO;AAC8E,MAAzG,mBAAa,iBAAY,kBAAoB,AAA8B,0DAArC,4BAAoD;IAC5F;WAGsC;;AACb,MAAjB,aAAO,SAAS;AACtB,WAAO,AAAO,oBAAG,SAAS;AAC+E,MAAzG,mBAAa,iBAAY,kBAAoB,AAA8B,0DAArC,4BAAoD;IAC5F;;iFA/DkE;IAKzD;AALT,4FAAkE,MAAM;;EAAC;;;;;;;;;;;;;;MAMrD,6EAAc;YAAG;;;;;;;;;;AAkEb;IAAM;cACT;AACnB,UAAI;AACgB,QAAlB,eAAgB,eAAN;;AAEE,MAAd,eAAS,KAAK;AACd,UAAI;AACiB,QAAnB,gBAAiB,eAAN;;AAEI,MAAjB;IACF;;AAIqE,MAA9D,AAAE,eAAP,mBAAc,AAAY,sDAAoC;AACzC,MAAf;IACR;WAG0B;;AACL,MAAb,aAAO,KAAK;AAClB,UAAI;AACmB,QAAf,AAAE,eAAR,qBAAe,KAAK;;IAExB;;AAIgB,MAAR;AACN,UAAI;AACc,QAAV,AAAE,eAAR;;IAEJ;;AAIE,UAAI;AACmB,QAArB,kBAAmB,eAAN;;AAEQ,MAAjB;IACR;kBAGuC;AACrC,UAAI;AACc,QAAhB,AAAO,OAAA,CAAO,eAAN;;AAEkB,MAAtB,oBAAc,OAAO;IAC7B;;AAIE,YAAO,AAAc,sBAAQ,AAAE,eAAP;AACxB,YAAO,AAAY,AAAK,2BAAQ,4BAAgB,AAAE,AAAK,eAAZ,0BAA0B,AAAE,AAAK,eAAZ;IAClE;;;QA1D6C;IAGlC;AAFN,0GAAoB,YAAY;;EAAC","file":"../../../../../../../../../../packages/flutter/src/widgets/sliver_prototype_extent_list.dart.lib.js"}');
  // Exports:
  return {
