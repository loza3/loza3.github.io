define(['dart_sdk', 'packages/flutter/src/scheduler/ticker.dart', 'packages/flutter/src/rendering/sliver_persistent_header.dart', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/rendering/box.dart', 'packages/flutter/src/rendering/layer.dart'], (function load__packages__flutter__src__widgets__sliver_persistent_header_dart(dart_sdk, packages__flutter__src__scheduler__ticker$46dart, packages__flutter__src__rendering__sliver_persistent_header$46dart, packages__flutter__src__widgets__title$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__rendering__box$46dart, packages__flutter__src__rendering__layer$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 122,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/sliver_persistent_header.dart"
      });
    },
    get C1() {
    ...
    get C9() {
      return C[9] = dart.const({
        ...
        [PersistentHeaderShowOnScreenConfiguration_maxShowOnScreenExtent]: 1 / 0,
        [PersistentHeaderShowOnScreenConfiguration_minShowOnScreenExtent]: -1 / 0
      });
    },
    get C10() {
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/sliver_persistent_header.dart"
  ];
  ...
  sliver_persistent_header$.SliverPersistentHeader = class SliverPersistentHeader extends framework.StatelessWidget {
    ...
    build(context) {
      if (this.floating && this.pinned) {
        return new sliver_persistent_header$._SliverFloatingPinnedPersistentHeader.new({delegate: this.delegate, $creationLocationd_0dea112b090073317d4: C[1] || CT.C1});
      }
      if (this.pinned) {
        return new sliver_persistent_header$._SliverPinnedPersistentHeader.new({delegate: this.delegate, $creationLocationd_0dea112b090073317d4: C[2] || CT.C2});
      }
      if (this.floating) {
        return new sliver_persistent_header$._SliverFloatingPersistentHeader.new({delegate: this.delegate, $creationLocationd_0dea112b090073317d4: C[3] || CT.C3});
      }
  ...
  sliver_persistent_header$._FloatingHeader = class _FloatingHeader extends framework.StatefulWidget {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new sliver_persistent_header$._FloatingHeader.new({child: child, $creationLocationd_0dea112b090073317d4: C[5] || CT.C5});
    }
    createState() {
  ...
  (sliver_persistent_header$._FloatingHeader.new = function(opts) {
    ...
    let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    this[child$] = child;
    sliver_persistent_header$._FloatingHeader.__proto__.new.call(this, {$creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  sliver_persistent_header$._FloatingHeaderState = class _FloatingHeaderState extends framework.State$(sliver_persistent_header$._FloatingHeader) {
    didChangeDependencies() {
      ...
      if (this[_position] != null) {
        dart.nullCheck(this[_position]).isScrollingNotifier.removeListener(dart.bind(this, _isScrollingListener));
      }
      this[_position] = (t1 = scrollable.Scrollable.of(this.context), t1 == null ? null : t1.position);
      if (this[_position] != null) {
        dart.nullCheck(this[_position]).isScrollingNotifier.addListener(dart.bind(this, _isScrollingListener));
      }
    }
    dispose() {
      if (this[_position] != null) {
    ...
    [_isScrollingListener]() {
      let t1, t1$, t1$0;
      if (!(this[_position] != null)) dart.assertFailed(null, I[1], 234, 12, "_position != null");
  ...
  sliver_persistent_header$._SliverPersistentHeaderElement = class _SliverPersistentHeaderElement extends framework.RenderObjectElement {
    ...
    update(newWidget) {
      ...
      let oldWidget = sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget.as(this.widget);
    ...
    [_build](shrinkOffset, overlapsContent) {
      dart.nullCheck(this.owner).buildScope(this, dart.fn(() => {
        let sliverPersistentHeaderRenderObjectWidget = sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget.as(this.widget);
        this.child = this.updateChild(this.child, this.floating ? new sliver_persistent_header$._FloatingHeader.new({child: sliverPersistentHeaderRenderObjectWidget.delegate.build(this, shrinkOffset, overlapsContent), $creationLocationd_0dea112b090073317d4: C[6] || CT.C6}) : sliverPersistentHeaderRenderObjectWidget.delegate.build(this, shrinkOffset, overlapsContent), null);
      }, T.VoidTovoid()));
    }
    forgetChild(child) {
      if (!child._equals(this.child)) dart.assertFailed(null, I[1], 316, 12, "child == this.child");
      this.child = null;
      super.forgetChild(child);
    }
    insertRenderObjectChild(child, slot) {
      box.RenderBox.as(child);
      if (!this.renderObject.debugValidateChild(child)) dart.assertFailed(null, I[1], 323, 12, "renderObject.debugValidateChild(child)");
      this.renderObject.child = child;
    }
    moveRenderObjectChild(child, oldSlot, newSlot) {
      object.RenderObject.as(child);
      if (!false) dart.assertFailed(null, I[1], 329, 12, "false");
    }
  ...
  (sliver_persistent_header$._SliverPersistentHeaderElement.new = function(widget, opts) {
    ...
    this.child = null;
    this.floating = floating;
    if (!(floating !== null)) dart.assertFailed(null, I[1], 258, 15, "floating != null");
  ...
  (sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget.new = function(opts) {
    ...
    if (!(delegate !== null)) dart.assertFailed(null, I[1], 349, 15, "delegate != null");
    if (!(floating !== null)) dart.assertFailed(null, I[1], 350, 15, "floating != null");
    sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget.__proto__.new.call(this, {$creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  sliver_persistent_header$._RenderSliverPersistentHeaderForWidgetsMixin[dart.mixinOn] = RenderSliverPersistentHeader => class _RenderSliverPersistentHeaderForWidgetsMixin extends RenderSliverPersistentHeader {
    ...
    get minExtent() {
      return sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget.as(dart.nullCheck(this[_element]).widget).delegate.minExtent;
    }
    get maxExtent() {
      return sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget.as(dart.nullCheck(this[_element]).widget).delegate.maxExtent;
    }
    updateChild(shrinkOffset, overlapsContent) {
      if (!(this[_element] != null)) dart.assertFailed(null, I[1], 384, 12, "_element != null");
  ...
  sliver_persistent_header$._SliverScrollingPersistentHeader = class _SliverScrollingPersistentHeader extends sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget {
    static ['_#new#tearOff'](opts) {
      let delegate = opts && 'delegate' in opts ? opts.delegate : null;
      return new sliver_persistent_header$._SliverScrollingPersistentHeader.new({delegate: delegate, $creationLocationd_0dea112b090073317d4: C[7] || CT.C7});
    }
  ...
  (sliver_persistent_header$._SliverScrollingPersistentHeader.new = function(opts) {
    let delegate = opts && 'delegate' in opts ? opts.delegate : null;
    let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    sliver_persistent_header$._SliverScrollingPersistentHeader.__proto__.new.call(this, {delegate: delegate, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  sliver_persistent_header$._RenderSliverScrollingPersistentHeaderForWidgets = class _RenderSliverScrollingPersistentHeaderForWidgets extends RenderSliverScrollingPersistentHeader__RenderSliverPersistentHeaderForWidgetsMixin$36 {
    static ['_#new#tearOff'](opts) {
      ...
      return new sliver_persistent_header$._RenderSliverScrollingPersistentHeaderForWidgets.new({stretchConfiguration: stretchConfiguration});
    }
  };
  (sliver_persistent_header$._RenderSliverScrollingPersistentHeaderForWidgets.new = function(opts) {
    let stretchConfiguration = opts && 'stretchConfiguration' in opts ? opts.stretchConfiguration : null;
    sliver_persistent_header$._RenderSliverScrollingPersistentHeaderForWidgets.__proto__.new.call(this, {stretchConfiguration: stretchConfiguration});
    ;
  ...
  sliver_persistent_header$._SliverPinnedPersistentHeader = class _SliverPinnedPersistentHeader extends sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget {
    static ['_#new#tearOff'](opts) {
      let delegate = opts && 'delegate' in opts ? opts.delegate : null;
      return new sliver_persistent_header$._SliverPinnedPersistentHeader.new({delegate: delegate, $creationLocationd_0dea112b090073317d4: C[8] || CT.C8});
    }
    createRenderObject(context) {
  ...
  (sliver_persistent_header$._SliverPinnedPersistentHeader.new = function(opts) {
    let delegate = opts && 'delegate' in opts ? opts.delegate : null;
    let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    sliver_persistent_header$._SliverPinnedPersistentHeader.__proto__.new.call(this, {delegate: delegate, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  var PersistentHeaderShowOnScreenConfiguration_maxShowOnScreenExtent = dart.privateName(sliver_persistent_header, "PersistentHeaderShowOnScreenConfiguration.maxShowOnScreenExtent");
  var PersistentHeaderShowOnScreenConfiguration_minShowOnScreenExtent = dart.privateName(sliver_persistent_header, "PersistentHeaderShowOnScreenConfiguration.minShowOnScreenExtent");
  ...
  sliver_persistent_header$._RenderSliverPinnedPersistentHeaderForWidgets = class _RenderSliverPinnedPersistentHeaderForWidgets extends RenderSliverPinnedPersistentHeader__RenderSliverPersistentHeaderForWidgetsMixin$36 {
    static ['_#new#tearOff'](opts) {
      ...
      return new sliver_persistent_header$._RenderSliverPinnedPersistentHeaderForWidgets.new({stretchConfiguration: stretchConfiguration, showOnScreenConfiguration: showOnScreenConfiguration});
    }
  };
  (sliver_persistent_header$._RenderSliverPinnedPersistentHeaderForWidgets.new = function(opts) {
    let stretchConfiguration = opts && 'stretchConfiguration' in opts ? opts.stretchConfiguration : null;
    let showOnScreenConfiguration = opts && 'showOnScreenConfiguration' in opts ? opts.showOnScreenConfiguration : C[9] || CT.C9;
    sliver_persistent_header$._RenderSliverPinnedPersistentHeaderForWidgets.__proto__.new.call(this, {stretchConfiguration: stretchConfiguration, showOnScreenConfiguration: showOnScreenConfiguration});
    ;
  ...
  sliver_persistent_header$._SliverFloatingPersistentHeader = class _SliverFloatingPersistentHeader extends sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget {
    static ['_#new#tearOff'](opts) {
      let delegate = opts && 'delegate' in opts ? opts.delegate : null;
      return new sliver_persistent_header$._SliverFloatingPersistentHeader.new({delegate: delegate, $creationLocationd_0dea112b090073317d4: C[10] || CT.C10});
    }
    createRenderObject(context) {
  ...
  (sliver_persistent_header$._SliverFloatingPersistentHeader.new = function(opts) {
    let delegate = opts && 'delegate' in opts ? opts.delegate : null;
    let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    sliver_persistent_header$._SliverFloatingPersistentHeader.__proto__.new.call(this, {floating: true, delegate: delegate, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  sliver_persistent_header$._RenderSliverFloatingPinnedPersistentHeaderForWidgets = class _RenderSliverFloatingPinnedPersistentHeaderForWidgets extends RenderSliverFloatingPinnedPersistentHeader__RenderSliverPersistentHeaderForWidgetsMixin$36 {
    static ['_#new#tearOff'](opts) {
      ...
      let stretchConfiguration = opts && 'stretchConfiguration' in opts ? opts.stretchConfiguration : null;
      let showOnScreenConfiguration = opts && 'showOnScreenConfiguration' in opts ? opts.showOnScreenConfiguration : null;
      return new sliver_persistent_header$._RenderSliverFloatingPinnedPersistentHeaderForWidgets.new({vsync: vsync, snapConfiguration: snapConfiguration, stretchConfiguration: stretchConfiguration, showOnScreenConfiguration: showOnScreenConfiguration});
    }
  };
  (sliver_persistent_header$._RenderSliverFloatingPinnedPersistentHeaderForWidgets.new = function(opts) {
    ...
    let stretchConfiguration = opts && 'stretchConfiguration' in opts ? opts.stretchConfiguration : null;
    let showOnScreenConfiguration = opts && 'showOnScreenConfiguration' in opts ? opts.showOnScreenConfiguration : null;
    sliver_persistent_header$._RenderSliverFloatingPinnedPersistentHeaderForWidgets.__proto__.new.call(this, {vsync: vsync, snapConfiguration: snapConfiguration, stretchConfiguration: stretchConfiguration, showOnScreenConfiguration: showOnScreenConfiguration});
    ;
  ...
  sliver_persistent_header$._SliverFloatingPinnedPersistentHeader = class _SliverFloatingPinnedPersistentHeader extends sliver_persistent_header$._SliverPersistentHeaderRenderObjectWidget {
    static ['_#new#tearOff'](opts) {
      let delegate = opts && 'delegate' in opts ? opts.delegate : null;
      return new sliver_persistent_header$._SliverFloatingPinnedPersistentHeader.new({delegate: delegate, $creationLocationd_0dea112b090073317d4: C[11] || CT.C11});
    }
    createRenderObject(context) {
  ...
  (sliver_persistent_header$._SliverFloatingPinnedPersistentHeader.new = function(opts) {
    let delegate = opts && 'delegate' in opts ? opts.delegate : null;
    let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    sliver_persistent_header$._SliverFloatingPinnedPersistentHeader.__proto__.new.call(this, {floating: true, delegate: delegate, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  sliver_persistent_header$._RenderSliverFloatingPersistentHeaderForWidgets = class _RenderSliverFloatingPersistentHeaderForWidgets extends RenderSliverFloatingPersistentHeader__RenderSliverPersistentHeaderForWidgetsMixin$36 {
    static ['_#new#tearOff'](opts) {
      ...
      let stretchConfiguration = opts && 'stretchConfiguration' in opts ? opts.stretchConfiguration : null;
      let showOnScreenConfiguration = opts && 'showOnScreenConfiguration' in opts ? opts.showOnScreenConfiguration : null;
      return new sliver_persistent_header$._RenderSliverFloatingPersistentHeaderForWidgets.new({vsync: vsync, snapConfiguration: snapConfiguration, stretchConfiguration: stretchConfiguration, showOnScreenConfiguration: showOnScreenConfiguration});
    }
  };
  (sliver_persistent_header$._RenderSliverFloatingPersistentHeaderForWidgets.new = function(opts) {
    ...
    let stretchConfiguration = opts && 'stretchConfiguration' in opts ? opts.stretchConfiguration : null;
    let showOnScreenConfiguration = opts && 'showOnScreenConfiguration' in opts ? opts.showOnScreenConfiguration : null;
    sliver_persistent_header$._RenderSliverFloatingPersistentHeaderForWidgets.__proto__.new.call(this, {vsync: vsync, snapConfiguration: snapConfiguration, stretchConfiguration: stretchConfiguration, showOnScreenConfiguration: showOnScreenConfiguration});
    ;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["sliver_persistent_header.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAkE+B;IAAI;;AAWyB;IAAI;;AAWI;IAAI;;AAMM;IAAI;;;;EA9E1C;;;;;;;;;;;;;;;;;;;IA2HD;;;;;;IAO1B;;;;;;IAUA;;;;;;;;;;;;;UAGe;AACxB,UAAI,iBAAY;AACd,cAAO,oFAAgD;;AAEzD,UAAI;AACF,cAAO,4EAAwC;;AAEjD,UAAI;AACF,cAAO,8EAA0C;;AAEnD,YAAO,+EAA2C;IACpD;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AAMnC,MALD,AAAW,UAAD,KACR,kEACE,YACA;AAGe,kBAAgB;;AACjC,YAAI,aAAQ;AACZ,YAAI,eAAU;;;AAEhB,UAAI,AAAM,KAAD;AACY,QAAnB,AAAM,KAAD,OAAK;;AAE2C,MAAvD,AAAW,UAAD,KAAK,uCAAyB,QAAQ,KAAK;IACvD;;;QAnEQ;QACQ;QACT;QACA;;IAFS;IACT;IACA;UACK,AAAS,QAAD;UACR,AAAO,MAAD;UACN,AAAS,QAAD;AAPd,oFACE,GAAG;;EAMkB;;;;;;;;;;;;;;;;IAmEhB;;;;;;;;;;;AAGyB;IAAsB;;;QALtB;;;AAAhC;;EAAwC;;;;;;;;;;;;;;;;;;AAiBf,MAAvB;AACN,UAAI;AACiE,QAA1D,AAAE,AAAoB,eAA/B,8DAA8C;;AAEJ,MAA5C,wBAAuB,yBAAG,4BAAH,OAAa;AACpC,UAAI;AAC8D,QAAvD,AAAE,AAAoB,eAA/B,2DAA2C;;IAE/C;;AAIE,UAAI;AACiE,QAA1D,AAAE,AAAoB,eAA/B,8DAA8C;;AAEjC,MAAT;IACR;;AAGE,YAAO,AAAQ;IACjB;;;AAGE,YAAO,AAAU;AAK2B,mBAAS;AACrD,UAAa,AAAE,AAAoB,eAA/B;AACgE,aAAlE,MAAM;qBAAN,OAAQ,8BAAoC,AAAE,eAAX;AAE2B,cAA9D,MAAM;sBAAN,OAAQ,2BAAgC,AAAE,eAAX;;AAGgC,eAA/D,MAAM;uBAAN,OAAQ,6BAAiC,AAAE,eAAX;;IAEpC;UAG0B;AAAY,YAAA,AAAO;IAAK;;;;;;IA5ClC;;;EA6ClB;;;;;;;;;;;;;;;;;;;;;;AAWmE,YAAmB,2EAAb;IAA4D;UAG/G,QAAgB;AACN,MAAtB,YAAM,MAAM,EAAE,OAAO;AACC,MAA5B,AAAa,8BAAW;IAC1B;;AAI8B,MAA5B,AAAa,8BAAW;AACT,MAAT;IACR;WAGsD;;AACJ,sBAAmB,uEAAP;AACrC,MAAjB,aAAO,SAAS;AACe,wBAAc,AAAU,SAAD;AACvB,wBAAc,AAAU,SAAD;AAC5D,WAAI,WAAW,WAAI,WAAW,OACzB,AAAY,WAAD,uBAAgB,AAAY,WAAD,mBAAgB,AAAY,WAAD,eAAe,WAAW;AACjE,QAA7B,AAAa;;IAEjB;;AAIwB,MAAhB;AACuB,MAA7B,AAAa;IACf;aAImB,cAAmB;AAclC,MAbG,AAAE,eAAP,uBAAkB,MAAM;AAC0B,uDAAkD,uEAAP;AAW1F,QAVD,aAAQ,iBACN,YACA,gBACI,0DAAuB,AAAyC,AAAS,wCAAV,gBAC/D,MACA,YAAY,EACZ,eAAe,6DAEf,AAAyC,AAAS,wCAAV,gBAAgB,MAAM,YAAY,EAAE,eAAe,GAC/F;;IAGN;gBAGyB;AACvB,WAAO,AAAM,KAAD,SAAS;AACJ,MAAZ,aAAQ;AACW,MAAlB,kBAAY,KAAK;IACzB;4BAGiD,OAAe;;AAC9D,WAAO,AAAa,qCAAmB,KAAK;AAClB,MAA1B,AAAa,0BAAQ,KAAK;IAC5B;0BAGkD,OAAe,SAAiB;;AAChF,WAAO;IACT;4BAGoD,OAAe;;AACxC,MAAzB,AAAa,0BAAQ;IACvB;kBAGkC;AAChC,UAAI;AACa,QAAf,AAAO,OAAA,CAAM,eAAL;;IAEZ;;2EAtFkD;QAC3C;IAsCE;IAtCF;UACK,AAAS,QAAD;AAHpB,sFACkD,MAAM;;EAE3B;;;;;;;;;;;;;;;;;;;;IA8FQ;;;;;;IAC1B;;;;;;;AAGuC,8EAA+B,iBAAgB;IAAS;wBAMrD;AACb,MAAhC,0BAAoB,WAAW;AAMpC,MALD,AAAY,WAAD,KACT,kEACE,YACA;IAGN;;;QAvBgB;QACT;;IADS;IACT;UACK,AAAS,QAAD;UACR,AAAS,QAAD;AAJd;;EAIuB;;;;;;;;;;;;;;;;IAwBG;;;;;;;AAGR,YAAkB,AAA8C,AAAS,wEAAhE,AAAE,eAAV;IAAiF;;AAGlF,YAAkB,AAA8C,AAAS,wEAAhE,AAAE,eAAV;IAAiF;gBAGlF,cAAmB;AACzC,YAAO,AAAS;AAC+B,MAAvC,AAAE,eAAV,wBAAiB,YAAY,EAAE,eAAe;IAChD;;AAImB,MAAjB;IACF;;;IAjBgC;;;;;;;;;;;;;;;;;;;;;;;;uBA0B6C;AAC3E,YAAO,2GACiB,AAAS;IAEnC;;;QARiB;;AADX,mGACW,QAAQ;;EACvB;;;;;;;;;;;;;;;;;;;;;QAaM;AADR,+HACQ,oBAAoB;;EAC1B;;;;;;;;;uBAS2E;AAC3E,YAAO,wGACiB,AAAS,+DACJ,AAAS;IAExC;;;QATiB;;AADX,gGACW,QAAQ;;EACvB;;;;;;;;;;;;;;;;;;;;;;;;QAcM;QACA;AAFR,4HACQ,oBAAoB,6BACpB,yBAAyB;;EAC/B;;;;;;;;;uBAW2E;AAC3E,YAAO,2FACE,AAAS,wCACG,AAAS,uDACN,AAAS,+DACJ,AAAS;IAExC;uBAGqC,SAAyD;;AACzD,MAAnC,AAAa,YAAD,SAAS,AAAS;AAC6B,MAA3D,AAAa,YAAD,qBAAqB,AAAS;AACuB,MAAjE,AAAa,YAAD,wBAAwB,AAAS;AAC8B,MAA3E,AAAa,YAAD,6BAA6B,AAAS;IACpD;;;QArBiB;;AACZ,kGACO,gBAFK,QAAQ;;EAGxB;;;;;;;;;;;;;;;;;;;;;;;;QAwBgB;QACT;QACA;QACA;AAJR,qHACiB,KAAK,qBACd,iBAAiB,wBACjB,oBAAoB,6BACpB,yBAAyB;;EAC/B;;;;;;;;;uBAW2E;AAC3E,YAAO,iGACE,AAAS,wCACG,AAAS,uDACN,AAAS,+DACJ,AAAS;IAExC;uBAGqC,SAA+D;;AAC/D,MAAnC,AAAa,YAAD,SAAS,AAAS;AAC6B,MAA3D,AAAa,YAAD,qBAAqB,AAAS;AACuB,MAAjE,AAAa,YAAD,wBAAwB,AAAS;AAC8B,MAA3E,AAAa,YAAD,6BAA6B,AAAS;IACpD;;;QArBiB;;AACZ,wGACO,gBAFK,QAAQ;;EAGxB;;;;;;;;;;;;;;;;;;;;;;;;QAwBgB;QACT;QACA;QACA;AAJR,+GACiB,KAAK,qBACd,iBAAiB,wBACjB,oBAAoB,6BACpB,yBAAyB;;EAC/B","file":"../../../../../../../../../../packages/flutter/src/widgets/sliver_persistent_header.dart.lib.js"}');
  // Exports:
  return {
