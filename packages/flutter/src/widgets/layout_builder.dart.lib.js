define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/rendering/box.dart'], (function load__packages__flutter__src__widgets__layout_builder_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__rendering__box$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 267,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/layout_builder.dart"
      });
    }
  }, false);
  var C = [void 0];
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/layout_builder.dart",
  ...
  layout_builder._LayoutBuilderElement$ = dart.generic(ConstraintType => {
    ...
    class _LayoutBuilderElement extends framework.RenderObjectElement {
      ...
      forgetChild(child) {
        if (!child._equals(this[_child])) dart.assertFailed(null, I[0], 73, 12, "child == _child");
        this[_child] = null;
      ...
      update(newWidget) {
        ...
        if (!!this.widget._equals(newWidget)) dart.assertFailed(null, I[0], 86, 12, "widget != newWidget");
        super.update(newWidget);
        if (!this.widget._equals(newWidget)) dart.assertFailed(null, I[0], 88, 12, "widget == newWidget");
        this.renderObject.updateCallback(dart.bind(this, _layout));
      ...
      [_layout](constraints) {
        ...
        const layoutCallback = () => {
          ...
          let built = null;
          try {
            built = (t0 = __t$ConstrainedLayoutBuilderOfConstraintType().as(this.widget), t1 = constraints, __t$BuildContextAndConstraintTypeToWidget().as(t0.builder)(this, t1));
            ...
            if (core.Object.is(e)) {
              built = framework.ErrorWidget.builder(layout_builder._debugReportException(new assertions.ErrorDescription.new("building " + dart.str(this.widget)), e, stack, {informationCollector: dart.fn(() => (() => {
                  ...
                  t1.push(new object.DiagnosticsDebugCreator.new(new framework.DebugCreator.new(this)));
                  return t1;
          ...
          try {
            ...
            if (!(this[_child] != null)) dart.assertFailed(null, I[0], 136, 16, "_child != null");
          } catch (e$0) {
            ...
            if (core.Object.is(e)) {
              built = framework.ErrorWidget.builder(layout_builder._debugReportException(new assertions.ErrorDescription.new("building " + dart.str(this.widget)), e, stack, {informationCollector: dart.fn(() => (() => {
                  ...
                  t3.push(new object.DiagnosticsDebugCreator.new(new framework.DebugCreator.new(this)));
                  return t3;
                })(), T.VoidToListOfDiagnosticsNode())}));
      ...
      insertRenderObjectChild(child, slot) {
        ...
        if (!(slot == null)) dart.assertFailed(null, I[0], 159, 12, "slot == null");
        if (!renderObject.debugValidateChild(child)) dart.assertFailed(null, I[0], 160, 12, "renderObject.debugValidateChild(child)");
        renderObject.child = child;
        if (!renderObject[$_equals](this.renderObject)) dart.assertFailed(null, I[0], 162, 12, "renderObject == this.renderObject");
      }
      moveRenderObjectChild(child, oldSlot, newSlot) {
        object.RenderObject.as(child);
        if (!false) dart.assertFailed(null, I[0], 167, 12, "false");
      }
      removeRenderObjectChild(child, slot) {
        object.RenderObject.as(child);
        let renderObject = this.renderObject;
        if (!dart.equals(renderObject.child, child)) dart.assertFailed(null, I[0], 173, 12, "renderObject.child == child");
        renderObject.child = null;
        if (!renderObject[$_equals](this.renderObject)) dart.assertFailed(null, I[0], 175, 12, "renderObject == this.renderObject");
      }
    }
  ...
  layout_builder.RenderConstrainedLayoutBuilder$ = dart.generic((ConstraintType, ChildType) => {
    ...
    RenderConstrainedLayoutBuilder[dart.mixinOn] = RenderObjectWithChildMixin => class RenderConstrainedLayoutBuilder extends RenderObjectWithChildMixin {
      ...
      updateCallback(value) {
        if (dart.equals(value, this[_callback$])) {
          return;
        }
        this[_callback$] = value;
      ...
      rebuildIfNecessary() {
        if (!(this[_callback$] != null)) dart.assertFailed(null, I[0], 224, 12, "_callback != null");
  ...
  (layout_builder.LayoutBuilder.new = function(opts) {
    ...
    let builder = opts && 'builder' in opts ? opts.builder : null;
    let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    if (!(builder !== null)) dart.assertFailed(null, I[0], 270, 15, "builder != null");
  ...
  layout_builder._RenderLayoutBuilder = class _RenderLayoutBuilder extends RenderBox_RenderConstrainedLayoutBuilder$36 {
    computeMinIntrinsicWidth(height) {
      if (!this[_debugThrowIfNotCheckingIntrinsics]()) dart.assertFailed(null, I[0], 282, 12, "_debugThrowIfNotCheckingIntrinsics()");
      return 0.0;
    }
    computeMaxIntrinsicWidth(height) {
      if (!this[_debugThrowIfNotCheckingIntrinsics]()) dart.assertFailed(null, I[0], 288, 12, "_debugThrowIfNotCheckingIntrinsics()");
      return 0.0;
    }
    computeMinIntrinsicHeight(width) {
      if (!this[_debugThrowIfNotCheckingIntrinsics]()) dart.assertFailed(null, I[0], 294, 12, "_debugThrowIfNotCheckingIntrinsics()");
      return 0.0;
    }
    computeMaxIntrinsicHeight(width) {
      if (!this[_debugThrowIfNotCheckingIntrinsics]()) dart.assertFailed(null, I[0], 300, 12, "_debugThrowIfNotCheckingIntrinsics()");
      return 0.0;
    }
    computeDryLayout(constraints) {
      if (!this.debugCannotComputeDryLayout({reason: "Calculating the dry layout would require running the layout callback " + "speculatively, which might mutate the live render object tree."})) dart.assertFailed(null, I[0], 306, 12, "debugCannotComputeDryLayout(reason:\n      'Calculating the dry layout would require running the layout callback '\n      'speculatively, which might mutate the live render object tree.',\n    )");
      return ui.Size.zero;
    }
    performLayout() {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["layout_builder.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAkDsD;;;;;;;AALb,qEAAsC;MAAK;;;UAL1E;UACQ;;;YACJ,AAAQ,OAAD;AAHb,8DACE,GAAG;;IAEiB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAiBqD,cAAmB,sEAAb;MAA4E;oBAKjI;AAChC,YAAI;AACc,UAAhB,AAAO,OAAA,CAAO,eAAN;;MAEZ;kBAGyB;AACvB,aAAO,AAAM,KAAD,SAAI;AACH,QAAb,eAAS;AACe,QAAlB,kBAAY,KAAK;MACzB;YAGoB,QAAgB;AACN,QAAtB,YAAM,MAAM,EAAE,OAAO;AACS,QAApC,AAAa,2CAAe;MAC9B;aAGqD;;AACnD,aAAc,CAAP,oBAAU,SAAS;AACH,QAAjB,aAAO,SAAS;AACtB,aAAO,AAAO,oBAAG,SAAS;AAEU,QAApC,AAAa,2CAAe;AAGC,QAA7B,AAAa;MACf;;AAU+B,QAA7B,AAAa;AACS,QAAhB;MACR;;AAImC,QAAjC,AAAa,iCAAe;AACb,QAAT;MACR;gBAE4B;;AAC1B,cACK;;AACI;AACP;AACyF,YAAvF,cAAgB,kDAAP,mBAAkE,WAAW,EAAlB,+CAAP,YAAQ;AAC/B,YAAtC,8BAAwB,aAAQ,KAAK;;gBAC9B;gBAAG;AAAV;AAWC,cAVD,QAAoB,AAAO,8BACzB,qCACE,oCAAiB,AAAkB,uBAAP,eAC5B,CAAC,EACD,KAAK,yBACiB,cAAuB;;AAC3C,0BACE,uCAAwB,+BAAa;;;;;;AAK/C;AAC2C,YAAzC,eAAS,iBAAY,cAAQ,KAAK,EAAE;AACpC,kBAAO,AAAO;;gBACP;gBAAG;AAAV;AAWC,cAVD,QAAoB,AAAO,8BACzB,qCACE,oCAAiB,AAAkB,uBAAP,eAC5B,CAAC,EACD,KAAK,yBACiB,cAAuB;;AAC3C,0BACE,uCAAwB,+BAAa;;;AAIN,cAAvC,eAAS,iBAAY,MAAM,KAAK,EAAE;;;;;;AAIC,QAAlC,AAAE,eAAP,uBAAkB,MAAM,cAAc;MACxC;8BAG0C,OAAe;;AACR,2BAAoB;AACnE,cAAO,AAAK,IAAD;AACX,aAAO,AAAa,YAAD,oBAAoB,KAAK;AAClB,QAA1B,AAAa,YAAD,SAAS,KAAK;AAC1B,aAAO,AAAa,YAAD,WAAS;MAC9B;4BAGwC,OAAe,SAAiB;;AACtE,aAAO;MACT;8BAG0C,OAAe;;AACY,2BAAoB;AACvF,aAA0B,YAAnB,AAAa,YAAD,QAAU,KAAK;AACT,QAAzB,AAAa,YAAD,SAAS;AACrB,aAAO,AAAa,YAAD,WAAS;MAC9B;;0CAvHqE;MAK5D;AALT,qDAAqE,MAAM;;IAAC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA+H5C;;;;;;MAU3B;;;;;;MAuBQ;;;;;;qBA/BuC;AAClD,YAAU,YAAN,KAAK,EAAI;AACX;;AAEe,QAAjB,mBAAY,KAAK;AACA,QAAjB;MACF;;AAkBoB,QAAlB,qBAAc;AACG,QAAjB;MACF;;AAYE,cAAO,AAAU;AACjB,YAAI,uBAAe,2BAAe;AACE,UAAlC,8BAAuB;AACJ,UAAnB,qBAAc;AACkB,UAAhC,0CAA8B,eAAT;;MAEzB;;;MA9CgC;MAU3B,oBAAc;MAuBN;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAwDsB,YAAM;IAAO;uBAGH;AAAY;IAAsB;;;QARvE;QACS;;UACL,AAAQ,OAAD;AAHb,gEACE,GAAG,WACM,OAAO;;EACI;;;;;;;;;;;;;;;;;;;;;;;;;;6BAWW;AACrC,WAAO;AACP,YAAO;IACT;6BAGuC;AACrC,WAAO;AACP,YAAO;IACT;8BAGwC;AACtC,WAAO;AACP,YAAO;IACT;8BAGwC;AACtC,WAAO;AACP,YAAO;IACT;qBAGqC;AACnC,WAAO,0CAAkC,AACvC,0EACA;AAEF,YAAY;IACd;;AAIuB,wBAAmB;AACpB,MAApB;AACA,UAAI;AAC8C,QAA3C,AAAE,eAAP,mBAAc,WAAW,mBAAkB;AACF,QAAzC,YAAO,AAAY,WAAD,WAAgB,AAAE,eAAP;;AAEH,QAA1B,YAAO,AAAY,WAAD;;IAEtB;oCAGqD;AACnD,UAAI;AACF,cAAY,AAAE,gBAAP,wCAAmC,QAAQ;;AAEpD,YAAa,uCAAgC,QAAQ;IACvD;oBAGsC;;UAA0B;AAC9D,2CAAO,OAAO,WAAQ,MAAM,aAAY,QAAQ;YAAzC,eAA8C;IACvD;UAG2B,SAAgB;AACzC,UAAI;AACgC,QAAlC,AAAQ,OAAD,YAAiB,eAAL,aAAQ,MAAM;;IAErC;;AAGE,WAAO,AASN;AARC,aAAkB;AAKf,UAJD,WAAM,4BAAY,AAChB,qEACA,2EACA;;AAGJ,cAAO;;AAGT,YAAO;IACT;;;;;;;;EACF;;;;;;;;wEAGkB,SACT,WACI;QACW;AAEI,kBAAU,mDACvB,SAAS,SACb,KAAK,WACH,4BACA,OAAO,wBACM,oBAAoB;AAEX,IAApB,oCAAY,OAAO;AAChC,UAAO,QAAO;EAChB","file":"../../../../../../../../../../packages/flutter/src/widgets/layout_builder.dart.lib.js"}');
  // Exports:
  return {
