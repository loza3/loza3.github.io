define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/animation/listener_helpers.dart'], (function load__packages__flutter__src__widgets__dual_transition_builder_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__animation__listener_helpers$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 38,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/dual_transition_builder.dart"
      });
    },
    get C1() {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/dual_transition_builder.dart",
  ...
  dual_transition_builder._DualTransitionBuilderState = class _DualTransitionBuilderState extends framework.State$(dual_transition_builder.DualTransitionBuilder) {
    ...
    set [_effectiveAnimationStatus](library$32package$58flutter$47src$47widgets$47dual_transition_builder$46dart$58$58_effectiveAnimationStatus$35param) {
      this[___DualTransitionBuilderState__effectiveAnimationStatus] = library$32package$58flutter$47src$47widgets$47dual_transition_builder$46dart$58$58_effectiveAnimationStatus$35param;
    }
    initState() {
      super.initState();
    ...
    [_calculateEffectiveAnimationStatus](opts) {
      ...
      if (!(current !== null)) dart.assertFailed(null, I[0], 137, 12, "current != null");
      if (!(lastEffective !== null)) dart.assertFailed(null, I[0], 138, 12, "lastEffective != null");
      switch (current) {
        case C[1] || CT.C1:
        case C[2] || CT.C2:
          {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["dual_transition_builder.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAoD0B;;;;;;IAeQ;;;;;;IAeA;;;;;;IAMlB;;;;;;;;;;;;;;;AAGgC;IAA6B;;;QArDnE;QACQ;QACA;QACA;QACT;;IAHS;IACA;IACA;IACT;UACK,AAAU,SAAD;UACT,AAAe,cAAD;UACd,AAAe,cAAD;AARpB,iFACE,GAAG;;EAOwB;;;;;;;;;;;;;;;;;;;;;;;;;;;AAkDd;;IAAyB;oCAAzB;;IAAyB;;AAM3B,MAAX;AAC6C,MAAnD,kCAA4B,AAAO,AAAU;AACS,MAAtD,AAAO,AAAU,kDAAkB;AAChB,MAAnB;IACF;yBAEwC;AAChB,yBAAe;AAIpC,MAHD,kCAA4B,yDACX,0CACN,eAAe;AAE1B,UAAI,YAAY,KAAI;AACC,QAAnB;;IAEJ;oBAG2C;;AACT,MAA1B,sBAAgB,SAAS;AAC/B,WAAI,AAAU,SAAD,qBAAc,AAAO;AAC4B,QAA5D,AAAU,AAAU,SAAX,0CAAgC;AACa,QAAtD,AAAO,AAAU,kDAAkB;AACQ,QAA3C,yBAAmB,AAAO,AAAU;;IAExC;;UAO2B;UACA;AAEzB,YAAO,AAAQ,OAAD;AACd,YAAO,AAAc,aAAD;AACpB,cAAQ,OAAO;;;;AAGX,kBAAO,QAAO;;;;AAEd,oBAAQ,aAAa;;;;;AAIjB,wBAAO,QAAO;;;;AAEd,wBAAO,cAAa;;;;;;AAGxB,oBAAQ,aAAa;;;;;AAIjB,wBAAO,QAAO;;;;AAEd,wBAAO,cAAa;;;;;IAG9B;;AAGE,cAAQ;;;;AAGuC,YAA3C,AAAkB,iCAAS,AAAO;AACkB,YAApD,AAAkB,iCAAS;AAC3B;;;;;AAGmD,YAAnD,AAAkB,iCAAS;AACkC,YAA7D,AAAkB,iCAAS,oCAAiB,AAAO;AACnD;;;IAEN;;AAI2D,MAAzD,AAAO,AAAU,qDAAqB;AACvB,MAAT;IACR;UAG0B;;AACxB,YAAO;YACL,OAAO;YACP;kBACA,kBACE,OAAO,OACP,8BACA,AAAO,mBAHY;YAHK;IAS9B;;;;;;oEApGqB;IACA,0BAAoB;IACpB,0BAAoB;;;EAmG3C","file":"../../../../../../../../../../packages/flutter/src/widgets/dual_transition_builder.dart.lib.js"}');
  // Exports:
  return {
