define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__widgets__scroll_notification_observer_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__foundation__debug$46dart) {
  'use strict';
  ...
  var T = {
    ...
    NotificationListenerOfScrollMetricsNotification: () => (T.NotificationListenerOfScrollMetricsNotification = dart.constFn(notification_listener.NotificationListener$(scroll_position.ScrollMetricsNotification)))(),
    ScrollMetricsNotificationTobool: () => (T.ScrollMetricsNotificationTobool = dart.constFn(dart.fnType(core.bool, [scroll_position.ScrollMetricsNotification])))(),
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 23,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/scroll_notification_observer.dart"
      });
    },
    get C1() {
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/widgets/scroll_notification_observer.dart"
  ];
  ...
  scroll_notification_observer._ScrollNotificationObserverScope = class _ScrollNotificationObserverScope extends framework.InheritedWidget {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new scroll_notification_observer._ScrollNotificationObserverScope.new({child: child, scrollNotificationObserverState: scrollNotificationObserverState, $creationLocationd_0dea112b090073317d4: C[0] || CT.C0});
    }
  ...
  (scroll_notification_observer._ScrollNotificationObserverScope.new = function(opts) {
    ...
    scroll_notification_observer._ScrollNotificationObserverScope.__proto__.new.call(this, {child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  (scroll_notification_observer.ScrollNotificationObserver.new = function(opts) {
    ...
    let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    this[child$] = child;
    if (!(child !== null)) dart.assertFailed(null, I[1], 68, 15, "child != null");
  ...
  scroll_notification_observer.ScrollNotificationObserverState = class ScrollNotificationObserverState extends framework.State$(scroll_notification_observer.ScrollNotificationObserver) {
    [_debugAssertNotDisposed]() {
      if (!dart.fn(() => {
        ...
        return true;
      }, T.VoidTobool())()) dart.assertFailed(null, I[1], 95, 12, "() {\n      if (_listeners == null) {\n        throw FlutterError(\n          'A $runtimeType was used after being disposed.\\n'\n          'Once you have called dispose() on a $runtimeType, it can no longer be used.',\n        );\n      }\n      return true;\n    }()");
      return true;
    }
    addListener(listener) {
      if (!this[_debugAssertNotDisposed]()) dart.assertFailed(null, I[1], 110, 12, "_debugAssertNotDisposed()");
    ...
    [_notifyListeners](notification) {
      let t1, t0;
      if (!this[_debugAssertNotDisposed]()) dart.assertFailed(null, I[1], 126, 12, "_debugAssertNotDisposed()");
      if (dart.nullCheck(this[_listeners]).isEmpty) {
        return;
      }
    ...
    build(context) {
      return new (T.NotificationListenerOfScrollMetricsNotification()).new({onNotification: dart.fn(notification => {
          this[_notifyListeners](new scroll_notification_observer._ConvertedScrollMetricsNotification.new({metrics: notification.metrics, context: notification.context, depth: notification.depth}));
          return false;
        }, T.ScrollMetricsNotificationTobool()), child: new (T.NotificationListenerOfScrollNotification()).new({onNotification: dart.fn(notification => {
            this[_notifyListeners](notification);
            return false;
          }, T.ScrollNotificationTobool()), child: new scroll_notification_observer._ScrollNotificationObserverScope.new({scrollNotificationObserverState: this, child: this.widget.child, $creationLocationd_0dea112b090073317d4: C[2] || CT.C2}), $creationLocationd_0dea112b090073317d4: C[3] || CT.C3}), $creationLocationd_0dea112b090073317d4: C[4] || CT.C4});
    }
    dispose() {
      if (!this[_debugAssertNotDisposed]()) dart.assertFailed(null, I[1], 184, 12, "_debugAssertNotDisposed()");
  ...
  scroll_notification_observer._ConvertedScrollMetricsNotification = class _ConvertedScrollMetricsNotification extends scroll_notification.ScrollUpdateNotification {
    static ['_#new#tearOff'](opts) {
      let metrics = opts && 'metrics' in opts ? opts.metrics : null;
      let context = opts && 'context' in opts ? opts.context : null;
      let depth = opts && 'depth' in opts ? opts.depth : null;
      return new scroll_notification_observer._ConvertedScrollMetricsNotification.new({metrics: metrics, context: context, depth: depth});
    }
  };
  (scroll_notification_observer._ConvertedScrollMetricsNotification.new = function(opts) {
    let metrics = opts && 'metrics' in opts ? opts.metrics : null;
    let context = opts && 'context' in opts ? opts.context : null;
    let depth = opts && 'depth' in opts ? opts.depth : null;
    scroll_notification_observer._ConvertedScrollMetricsNotification.__proto__.new.call(this, {metrics: metrics, context: context, depth: depth});
    ;
  }).prototype = scroll_notification_observer._ConvertedScrollMetricsNotification.prototype;
  dart.addTypeTests(scroll_notification_observer._ConvertedScrollMetricsNotification);
  dart.addTypeCaches(scroll_notification_observer._ConvertedScrollMetricsNotification);
  dart.setLibraryUri(scroll_notification_observer._ConvertedScrollMetricsNotification, I[0]);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["scroll_notification_observer.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA2ByC;;;;;;;;;;;uBAGkB;;AAAQ,YAAiC,EAAjC,kDAAoC,AAAI,GAAD;IAAiC;;;QAPxH;QAC0B;;IACL,yCAAE,+BAA+B;AAHjE,mGACW,KAAK;;EAEiD;;;;;;;;;;;;;;;;;;IASnD;AAApB;;EAA6B;;;;;;;;;;IAoChB;;;;;;;;;;;cAK2C;;AACtD,WAAO,AAAQ,OAAD;0BAAC,OAAwE;IACzF;;AAGiD;IAAiC;;;QAf1E;QACQ;;;UACJ,AAAM,KAAD;AAHX,2FACE,GAAG;;EAEe;;;;;;;;;;;;;;;;;;AA2BxB,WAAO,AAQN;AAPC,YAAI,AAAW;AAIZ,UAHD,WAAM,4BAAY,AAChB,gBAAI,sBAAW,sCACf,kDAAsC,sBAAW;;AAGrD,cAAO;;AAET,YAAO;IACT;gBAI4C;AAC1C,WAAO;AACkC,MAA/B,AAAE,eAAZ,sBAAgB,oDAAe,QAAQ;IACzC;mBAG+C;AAC7C,WAAO;AACP,eAA0B,QAAmB,gBAAV;AACjC,YAAI,AAAM,AAAS,KAAV,oBAAa,QAAQ;AACd,UAAd,AAAM,KAAD;AACL;;;IAGN;uBAEyC;;AACvC,WAAO;AACP,UAAc,AAAE,eAAZ;AACF;;AAGyB,2BAAiB,4BAAkC,eAAV;AACpE,eAA0B,QAAS,eAAc;AAC/C;AACE,cAAI,AAAM,KAAD;AACqB,iBAA5B,KAAK;iBAAU,YAAY;YAAb;;;cAET;cAAW;AAAlB;AAaE,YAZW,oCAAY,mDACZ,SAAS,SACb,KAAK,WACH,2BACA,oCAAiB,AAAkD,kDAAZ,4CAC1C,cAAuB,iCAC3C,mEACE,AAA2C,kBAArC,sBAAW,6BACjB,cAC4B;;;;;IAMxC;UAG0B;AAIxB,YAAO,gFACW,QAA2B;AAKvC,UAJF,uBAAiB,mFACN,AAAa,YAAD,mBACZ,AAAa,YAAD,iBACd,AAAa,YAAD;AAErB,gBAAO;wDAEF,wEACW,QAAoB;AACJ,YAA9B,uBAAiB,YAAY;AAC7B,kBAAO;mDAEF,wGAC4B,aAC1B,AAAO;IAItB;;AAIE,WAAO;AACU,MAAjB,mBAAa;AACE,MAAT;IACR;;;;;;IA/F4B,mBAAa;;;EAgG3C;;;;;;;;;;;;;;;;;;;;;;;;;QAImB;QACA;QACA;AAHjB,wGACiB,OAAO,WACP,OAAO,SACP,KAAK;;EACpB","file":"../../../../../../../../../../packages/flutter/src/widgets/scroll_notification_observer.dart.lib.js"}');
  // Exports:
  return {
