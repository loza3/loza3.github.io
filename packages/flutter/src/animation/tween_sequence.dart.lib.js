define(['dart_sdk', 'packages/flutter/src/animation/listener_helpers.dart'], (function load__packages__flutter__src__animation__tween_sequence_dart(dart_sdk, packages__flutter__src__animation__listener_helpers$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/animation/tween_sequence.dart",
  ...
  tween_sequence.TweenSequence$ = dart.generic(T => {
    ...
    (TweenSequence.new = function(items) {
      ...
      if (!(totalWeight > 0.0)) dart.assertFailed(null, I[0], 62, 12, "totalWeight > 0.0");
      let start = 0.0;
  ...
  (tween_sequence.FlippedTweenSequence.new = function(items) {
    if (!(items !== null)) dart.assertFailed(null, I[0], 117, 14, "items != null");
  ...
  tween_sequence.TweenSequenceItem$ = dart.generic(T => {
    ...
    (TweenSequenceItem.new = function(opts) {
      ...
      this[tween$] = tween;
      this[weight$] = weight;
      if (!(tween !== null)) dart.assertFailed(null, I[0], 131, 15, "tween != null");
      if (!(weight !== null)) dart.assertFailed(null, I[0], 132, 15, "weight != null");
      if (!(weight > 0.0)) dart.assertFailed(null, I[0], 133, 15, "weight > 0.0");
      ;
  ...
  (tween_sequence._Interval.new = function(start, end) {
    this[start$] = start;
    this[end$] = end;
    if (!(end > start)) dart.assertFailed(null, I[0], 160, 50, "end > start");
    ;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["tween_sequence.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;oBA0EuB,GAAO;AACC,sBAAU,AAAM,oBAAC,KAAK;AACpC,wBAAY,AAAU,AAAQ,wBAAP,KAAK,QAAQ,CAAC;AAClD,cAAO,AAAQ,AAAM,QAAP,iBAAiB,SAAS;MAC1C;gBAGmB;AACjB,cAAO,AAAE,AAAO,CAAR,IAAI,OAAO,AAAE,CAAD,IAAI;AACxB,YAAI,AAAE,CAAD,KAAI;AACP,gBAAO,mBAAY,CAAC,EAAE,AAAO,AAAO,wBAAE;;AAExC,iBAAS,QAAQ,GAAG,AAAM,KAAD,GAAG,AAAO,uBAAQ,QAAA,AAAK,KAAA;AAC9C,cAAI,AAAU,AAAQ,wBAAP,KAAK,WAAW,CAAC;AAC9B,kBAAO,mBAAY,CAAC,EAAE,KAAK;;;AAI+C,QAA9E,WAAM,wBAAW,AAA4D,sEAAF,CAAC;MAC9E;;AAGqB,cAAA,AAAuC,6BAAtB,AAAO,yBAAO;MAAQ;;kCA5CnB;MAmBR,eAA+B;MAC1C,mBAAwB;YAnBjC,AAAM,KAAD;WACL,AAAM,KAAD;AAFlB;AAGsB,MAApB,AAAO,sBAAO,KAAK;AAEZ,wBAAc;AACrB,eAAgC,OAAQ;AACZ,QAA1B,cAAA,AAAY,WAAD,GAAI,AAAK,IAAD;;AAErB,YAAO,AAAY,WAAD,GAAG;AAEd,kBAAQ;AACf,eAAS,IAAI,GAAG,AAAE,CAAD,GAAG,AAAO,uBAAQ,IAAA,AAAE,CAAD,GAAI;AACzB,kBAAM,AAAE,CAAD,KAAI,AAAO,AAAO,wBAAE,IAAI,MAAM,AAAM,KAAD,GAAG,AAAM,AAAI,AAAO,oBAAV,CAAC,WAAW,WAAW;AACnD,QAArC,AAAW,uBAAI,iCAAU,KAAK,EAAE,GAAG;AACxB,QAAX,QAAQ,GAAG;;IAEf;;;;;;;;;;;;;;;;;;;;;;;;cAkDwB;AAAM,YAAA,AAAE,KAAQ,gBAAU,AAAE,IAAE,CAAC;IAAC;;sDAJ7B;UAChB,AAAM,KAAD;AADhB,iEAA2B,KAAK;;EACP;;;;;;;;;MAgCL;;;;;;MAOP;;;;;;;;;;;;;UA3BG;UACA;MADA;MACA;YACJ,AAAM,KAAD;YACL,AAAO,MAAD;YACN,AAAO,MAAD,GAAG;;IAAI;;;;;;;;;;;;;;;;;IA6BZ;;;;;;IACA;;;;;;;;;aAEQ;AAAM,YAAA,AAAE,AAAS,EAAV,IAAI,cAAS,AAAE,CAAD,GAAG;IAAG;UAE5B;AAAM,YAAY,EAAX,AAAE,CAAD,GAAG,eAAU,AAAI,WAAE;IAAM;;AAGhC,YAAA,AAAgB,gBAAb,cAAK,gBAAG,YAAG;IAAE;;2CAVhB,OAAY;IAAZ;IAAY;UAAc,AAAI,GAAD,GAAG,KAAK;;EAAC","file":"../../../../../../../../../../packages/flutter/src/animation/tween_sequence.dart.lib.js"}');
  // Exports:
  return {
