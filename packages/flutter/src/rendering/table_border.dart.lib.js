define(['dart_sdk', 'packages/flutter/src/painting/borders.dart', 'packages/flutter/src/painting/border_radius.dart', 'packages/flutter/src/painting/edge_insets.dart'], (function load__packages__flutter__src__rendering__table_border_dart(dart_sdk, packages__flutter__src__painting__borders$46dart, packages__flutter__src__painting__border_radius$46dart, packages__flutter__src__painting__edge_insets$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/rendering/table_border.dart",
  ...
  table_border.TableBorder = class TableBorder extends core.Object {
    ...
    get isUniform() {
      ...
      if (!this.right.color._equals(topColor) || !this.bottom.color._equals(topColor) || !this.left.color._equals(topColor) || !this.horizontalInside.color._equals(topColor) || !this.verticalInside.color._equals(topColor)) {
        return false;
      }
      let topWidth = this.top.width;
      if (this.right.width !== topWidth || this.bottom.width !== topWidth || this.left.width !== topWidth || this.horizontalInside.width !== topWidth || this.verticalInside.width !== topWidth) {
        return false;
      }
      let topStyle = this.top.style;
      if (this.right.style !== topStyle || this.bottom.style !== topStyle || this.left.style !== topStyle || this.horizontalInside.style !== topStyle || this.verticalInside.style !== topStyle) {
        return false;
      }
      return true;
    }
    ...
    paint(canvas, rect, opts) {
      ...
      if (!(this.top !== null)) dart.assertFailed(null, I[0], 213, 12, "top != null");
      if (!(this.right !== null)) dart.assertFailed(null, I[0], 214, 12, "right != null");
      if (!(this.bottom !== null)) dart.assertFailed(null, I[0], 215, 12, "bottom != null");
      if (!(this.left !== null)) dart.assertFailed(null, I[0], 216, 12, "left != null");
      if (!(this.horizontalInside !== null)) dart.assertFailed(null, I[0], 217, 12, "horizontalInside != null");
      if (!(this.verticalInside !== null)) dart.assertFailed(null, I[0], 218, 12, "verticalInside != null");
      if (!(canvas !== null)) dart.assertFailed(null, I[0], 221, 12, "canvas != null");
      if (!(rect !== null)) dart.assertFailed(null, I[0], 222, 12, "rect != null");
      if (!(rows !== null)) dart.assertFailed(null, I[0], 223, 12, "rows != null");
      if (!(rows[$isEmpty] || rows[$first] >= 0.0 && rows[$last] <= rect.height)) dart.assertFailed(null, I[0], 224, 12, "rows.isEmpty || (rows.first >= 0.0 && rows.last <= rect.height)");
      if (!(columns !== null)) dart.assertFailed(null, I[0], 225, 12, "columns != null");
      if (!(columns[$isEmpty] || columns[$first] >= 0.0 && columns[$last] <= rect.width)) dart.assertFailed(null, I[0], 226, 12, "columns.isEmpty || (columns.first >= 0.0 && columns.last <= rect.width)");
    ...
    get hashCode() {
      return core.Object.hash(this.top, this.right, this.bottom, this.left, this.horizontalInside, this.verticalInside, this.borderRadius);
    }
    toString() {
