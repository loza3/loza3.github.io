define(['dart_sdk', 'packages/flutter/src/rendering/box.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/rendering/layer.dart'], (function load__packages__flutter__src__rendering__list_body_dart(dart_sdk, packages__flutter__src__rendering__box$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__rendering__layer$46dart) {
  'use strict';
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/rendering/list_body.dart"
  ];
  ...
  list_body.RenderListBody = class RenderListBody extends RenderBox_RenderBoxContainerDefaultsMixin$36 {
    ...
    setupParentData(child) {
      ...
      if (!list_body.ListBodyParentData.is(child.parentData)) {
        child.parentData = new list_body.ListBodyParentData.new();
      }
    }
    get axisDirection() {
    ...
    set axisDirection(value) {
      if (!(value !== null)) dart.assertFailed(null, I[1], 54, 12, "value != null");
    ...
    computeDryLayout(constraints) {
      if (!this[_debugCheckConstraints](constraints)) dart.assertFailed(null, I[1], 68, 12, "_debugCheckConstraints(constraints)");
    ...
    performLayout() {
        ...
        case C[1] || CT.C1:
          {
            ...
            while (child != null) {
              ...
              if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, I[1], 171, 18, "child.parentData == childParentData");
        ...
        case C[2] || CT.C2:
          {
            ...
            while (child != null) {
              ...
              let childParentData = list_body.ListBodyParentData.as(dart.nullCheck(child.parentData));
              mainAxisExtent = mainAxisExtent + child.size.width;
              if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, I[1], 182, 18, "child.parentData == childParentData");
              child = childParentData.nextSibling;
            }
            let position = 0.0;
            ...
            while (child != null) {
              ...
              if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, I[1], 191, 18, "child.parentData == childParentData");
              child = childParentData.nextSibling;
            }
            this.size = constraints.constrain(new ui.Size.new(mainAxisExtent, constraints.maxHeight));
            break;
        ...
        case C[0] || CT.C0:
          {
            ...
            while (child != null) {
              ...
              if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, I[1], 203, 18, "child.parentData == childParentData");
              child = childParentData.nextSibling;
            }
        ...
        case C[3] || CT.C3:
          {
            ...
            while (child != null) {
              ...
              let childParentData = list_body.ListBodyParentData.as(dart.nullCheck(child.parentData));
              mainAxisExtent = mainAxisExtent + child.size.height;
              if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, I[1], 214, 18, "child.parentData == childParentData");
              child = childParentData.nextSibling;
            }
            let position = 0.0;
            child = this.firstChild;
            while (child != null) {
              ...
              if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, I[1], 223, 18, "child.parentData == childParentData");
              child = childParentData.nextSibling;
            }
            this.size = constraints.constrain(new ui.Size.new(constraints.maxWidth, mainAxisExtent));
            break;
      ...
      if (!this.size.isFinite) dart.assertFailed(null, I[1], 229, 12, "size.isFinite");
    }
    ...
    computeMinIntrinsicWidth(height) {
      if (!(this.mainAxis !== null)) dart.assertFailed(null, I[1], 262, 12, "mainAxis != null");
      switch (this.mainAxis) {
        case C[4] || CT.C4:
          {
    ...
    computeMaxIntrinsicWidth(height) {
      if (!(this.mainAxis !== null)) dart.assertFailed(null, I[1], 273, 12, "mainAxis != null");
      switch (this.mainAxis) {
        case C[4] || CT.C4:
          {
    ...
    computeMinIntrinsicHeight(width) {
      if (!(this.mainAxis !== null)) dart.assertFailed(null, I[1], 284, 12, "mainAxis != null");
      switch (this.mainAxis) {
        case C[4] || CT.C4:
          {
    ...
    computeMaxIntrinsicHeight(width) {
      if (!(this.mainAxis !== null)) dart.assertFailed(null, I[1], 295, 12, "mainAxis != null");
      switch (this.mainAxis) {
        case C[4] || CT.C4:
          {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["list_body.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;EAUqE;;;;;;;;;;;;;;;;;;;;;;;;;;;oBA8BpC;;AAC7B,WAAqB,gCAAjB,AAAM,KAAD;AACgC,QAAvC,AAAM,KAAD,cAAc;;IAEvB;;AAMmC;IAAc;sBAEjB;AAC9B,YAAO,AAAM,KAAD;AACZ,UAAI,AAAe,yBAAG,KAAK;AACzB;;AAEoB,MAAtB,uBAAiB,KAAK;AACL,MAAjB;IACF;;AAIqB,6CAAoB;IAAc;qBAGlB;AACnC,WAAO,6BAAuB,WAAW;AAClC,2BAAiB;AACb,kBAAQ;AACnB,cAAQ;;;;AAGiB,mCAAkC,yCAAiB,AAAY,WAAD;AACnF,mBAAO,KAAK;AACC,8BAAY,AAAM,KAAD,cAAc,gBAAgB;AACzB,cAAjC,iBAAA,AAAe,cAAD,GAAI,AAAU,SAAD;AACF,cAAzB,QAAQ,gBAAW,KAAK;;AAE1B,kBAAO,AAAY,YAAD,WAAW,gBAAK,cAAc,EAAE,AAAY,WAAD;;;;;AAGxC,mCAAkC,wCAAgB,AAAY,WAAD;AAClF,mBAAO,KAAK;AACC,8BAAY,AAAM,KAAD,cAAc,gBAAgB;AACxB,cAAlC,iBAAA,AAAe,cAAD,GAAI,AAAU,SAAD;AACF,cAAzB,QAAQ,gBAAW,KAAK;;AAE1B,kBAAO,AAAY,YAAD,WAAW,gBAAK,AAAY,WAAD,WAAW,cAAc;;;IAE5E;6BAE2C;AACzC,WAAO,AAyBN;AAxBC,gBAAQ;;;AAEJ,mBAAK,AAAY,WAAD;AACd,sBAAO;;AAET;;;;AAEA,mBAAK,AAAY,WAAD;AACd,sBAAO;;AAET;;;AAaF,QAXF,WAAmB,sCAA2B,iCAC5C,gCAAa,kEACb,oCAAgB,AACd,wEACA,yDACA,UAEF,6BAAS,AACP,0DACA;;AAIN,WAAO,AAiCN;AAhCC,gBAAQ;;;AAEJ,kBAAI,AAAY,WAAD;AACb,sBAAO;;AAET;;;;AAEA,kBAAI,AAAY,WAAD;AACb,sBAAO;;AAET;;;AAqBF,QAhBF,WAAmB,sCAA2B,iCAC5C,gCAAa,sEACb,oCAAgB,AACd,yFACA,gEACA,gCAIF,6BAAS,AACP,yDACA,qEACA,iFACA,0EACA;;AAIN,YAAO;IACT;;AAIuB,wBAAmB;AACxC,WAAO,6BAAuB,WAAW;AAClC,2BAAiB;AACb,kBAAQ;AACnB,cAAQ;;;AAEiB,mCAAkC,yCAAiB,AAAY,WAAD;AACnF,mBAAO,KAAK;AAC0C,cAApD,AAAM,KAAD,QAAQ,gBAAgB,mBAAkB;AACtB,oCAAoC,gCAAF,eAAhB,AAAM,KAAD;AACI,cAApD,AAAgB,eAAD,UAAU,kBAAO,cAAc,EAAE;AACd,cAAlC,iBAAA,AAAe,cAAD,GAAI,AAAM,AAAK,KAAN;AACvB,mBAAwB,YAAjB,AAAM,KAAD,aAAe,eAAe;AACP,cAAnC,QAAQ,AAAgB,eAAD;;AAEgD,YAAzE,YAAO,AAAY,WAAD,WAAW,gBAAK,cAAc,EAAE,AAAY,WAAD;AAC7D;;;;AAEqB,mCAAkC,yCAAiB,AAAY,WAAD;AACnF,mBAAO,KAAK;AAC0C,cAApD,AAAM,KAAD,QAAQ,gBAAgB,mBAAkB;AACtB,oCAAoC,gCAAF,eAAhB,AAAM,KAAD;AACd,cAAlC,iBAAA,AAAe,cAAD,GAAI,AAAM,AAAK,KAAN;AACvB,mBAAwB,YAAjB,AAAM,KAAD,aAAe,eAAe;AACP,cAAnC,QAAQ,AAAgB,eAAD;;AAElB,2BAAW;AACA,YAAlB,QAAQ;AACR,mBAAO,KAAK;AACe,oCAAoC,gCAAF,eAAhB,AAAM,KAAD;AACpB,cAA5B,WAAA,AAAS,QAAD,GAAI,AAAM,AAAK,KAAN;AAC8C,cAA/D,AAAgB,eAAD,UAAU,kBAAO,AAAe,cAAD,GAAG,QAAQ,EAAE;AAC3D,mBAAwB,YAAjB,AAAM,KAAD,aAAe,eAAe;AACP,cAAnC,QAAQ,AAAgB,eAAD;;AAEgD,YAAzE,YAAO,AAAY,WAAD,WAAW,gBAAK,cAAc,EAAE,AAAY,WAAD;AAC7D;;;;AAEqB,mCAAkC,wCAAgB,AAAY,WAAD;AAClF,mBAAO,KAAK;AAC0C,cAApD,AAAM,KAAD,QAAQ,gBAAgB,mBAAkB;AACtB,oCAAoC,gCAAF,eAAhB,AAAM,KAAD;AACI,cAApD,AAAgB,eAAD,UAAU,kBAAO,KAAK,cAAc;AAChB,cAAnC,iBAAA,AAAe,cAAD,GAAI,AAAM,AAAK,KAAN;AACvB,mBAAwB,YAAjB,AAAM,KAAD,aAAe,eAAe;AACP,cAAnC,QAAQ,AAAgB,eAAD;;AAE+C,YAAxE,YAAO,AAAY,WAAD,WAAW,gBAAK,AAAY,WAAD,WAAW,cAAc;AACtE;;;;AAEqB,mCAAkC,wCAAgB,AAAY,WAAD;AAClF,mBAAO,KAAK;AAC0C,cAApD,AAAM,KAAD,QAAQ,gBAAgB,mBAAkB;AACtB,oCAAoC,gCAAF,eAAhB,AAAM,KAAD;AACb,cAAnC,iBAAA,AAAe,cAAD,GAAI,AAAM,AAAK,KAAN;AACvB,mBAAwB,YAAjB,AAAM,KAAD,aAAe,eAAe;AACP,cAAnC,QAAQ,AAAgB,eAAD;;AAElB,2BAAW;AACA,YAAlB,QAAQ;AACR,mBAAO,KAAK;AACe,oCAAoC,gCAAF,eAAhB,AAAM,KAAD;AACnB,cAA7B,WAAA,AAAS,QAAD,GAAI,AAAM,AAAK,KAAN;AAC8C,cAA/D,AAAgB,eAAD,UAAU,kBAAO,KAAK,AAAe,cAAD,GAAG,QAAQ;AAC9D,mBAAwB,YAAjB,AAAM,KAAD,aAAe,eAAe;AACP,cAAnC,QAAQ,AAAgB,eAAD;;AAE+C,YAAxE,YAAO,AAAY,WAAD,WAAW,gBAAK,AAAY,WAAD,WAAW,cAAc;AACtE;;;AAEJ,WAAO,AAAK;IACd;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AACuC,MAA3E,AAAW,UAAD,KAAK,0CAA4B,iBAAiB;IAC9D;6BAEmD;AAC1C,mBAAS;AACL,kBAAQ;AACnB,aAAO,KAAK;AACiC,QAA3C,SAAc,sBAAI,MAAM,EAAE,AAAS,SAAA,CAAC,KAAK;AAChB,8BAAoC,gCAAF,eAAhB,AAAM,KAAD;AACb,QAAnC,QAAQ,AAAgB,eAAD;;AAEzB,YAAO,OAAM;IACf;4BAEkD;AACzC,mBAAS;AACL,kBAAQ;AACnB,aAAO,KAAK;AACgB,QAA1B,SAAA,AAAO,MAAD,GAAI,AAAS,SAAA,CAAC,KAAK;AACA,8BAAoC,gCAAF,eAAhB,AAAM,KAAD;AACb,QAAnC,QAAQ,AAAgB,eAAD;;AAEzB,YAAO,OAAM;IACf;6BAGuC;AACrC,YAAO,AAAS;AAChB,cAAQ;;;AAEJ,kBAAO,6BAAsB,QAAW,SAAU,AAAM,KAAD,sBAAsB,MAAM;;;;AAEnF,kBAAO,8BAAuB,QAAW,SAAU,AAAM,KAAD,sBAAsB,MAAM;;;IAE1F;6BAGuC;AACrC,YAAO,AAAS;AAChB,cAAQ;;;AAEJ,kBAAO,6BAAsB,QAAW,SAAU,AAAM,KAAD,sBAAsB,MAAM;;;;AAEnF,kBAAO,8BAAuB,QAAW,SAAU,AAAM,KAAD,sBAAsB,MAAM;;;IAE1F;8BAGwC;AACtC,YAAO,AAAS;AAChB,cAAQ;;;AAEJ,kBAAO,6BAAsB,QAAW,SAAU,AAAM,KAAD,uBAAuB,KAAK;;;;AAEnF,kBAAO,8BAAuB,QAAW,SAAU,AAAM,KAAD,uBAAuB,KAAK;;;IAE1F;8BAGwC;AACtC,YAAO,AAAS;AAChB,cAAQ;;;AAEJ,kBAAO,6BAAsB,QAAW,SAAU,AAAM,KAAD,uBAAuB,KAAK;;;;AAEnF,kBAAO,8BAAuB,QAAW,SAAU,AAAM,KAAD,uBAAuB,KAAK;;;IAE1F;oCAGqD;AACnD,YAAO,kDAA4C,QAAQ;IAC7D;UAG2B,SAAgB;AACZ,MAA7B,kBAAa,OAAO,EAAE,MAAM;IAC9B;oBAGsC;UAA0B;AAC9D,YAAO,6BAAuB,MAAM,aAAY,QAAQ;IAC1D;;;QA5RmB;QACH;UACJ,AAAc,aAAD;IACL,uBAAE,aAAa;AAJnC;AAKkB,IAAhB,YAAO,QAAQ;EACjB","file":"../../../../../../../../../../packages/flutter/src/rendering/list_body.dart.lib.js"}');
  // Exports:
  return {
