define(['dart_sdk', 'packages/flutter/src/rendering/box.dart', 'packages/flutter/src/rendering/sliver.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/rendering/sliver_multi_box_adaptor.dart', 'packages/flutter/src/rendering/layer.dart'], (function load__packages__flutter__src__rendering__sliver_grid_dart(dart_sdk, packages__flutter__src__rendering__box$46dart, packages__flutter__src__rendering__sliver$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__rendering__sliver_multi_box_adaptor$46dart, packages__flutter__src__rendering__layer$46dart) {
  'use strict';
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/rendering/sliver_grid.dart"
  ];
  ...
  sliver_grid.SliverGridRegularTileLayout = class SliverGridRegularTileLayout extends sliver_grid.SliverGridLayout {
    ...
    computeMaxScrollOffset(childCount) {
      if (!(childCount !== null)) dart.assertFailed(null, I[1], 229, 12, "childCount != null");
  ...
  sliver_grid.SliverGridDelegateWithFixedCrossAxisCount = class SliverGridDelegateWithFixedCrossAxisCount extends sliver_grid.SliverGridDelegate {
    ...
    [_debugAssertIsValid]() {
      if (!(this.crossAxisCount > 0)) dart.assertFailed(null, I[1], 344, 12, "crossAxisCount > 0");
      if (!(this.mainAxisSpacing >= 0.0)) dart.assertFailed(null, I[1], 345, 12, "mainAxisSpacing >= 0.0");
      if (!(this.crossAxisSpacing >= 0.0)) dart.assertFailed(null, I[1], 346, 12, "crossAxisSpacing >= 0.0");
      if (!(this.childAspectRatio > 0.0)) dart.assertFailed(null, I[1], 347, 12, "childAspectRatio > 0.0");
      return true;
    }
    getLayout(constraints) {
      let t0;
      if (!this[_debugAssertIsValid]()) dart.assertFailed(null, I[1], 353, 12, "_debugAssertIsValid()");
  ...
  (sliver_grid.SliverGridDelegateWithFixedCrossAxisCount.new = function(opts) {
    ...
    if (!(crossAxisCount !== null && crossAxisCount > 0)) dart.assertFailed(null, I[1], 320, 15, "crossAxisCount != null && crossAxisCount > 0");
    if (!(mainAxisSpacing !== null && mainAxisSpacing >= 0)) dart.assertFailed(null, I[1], 321, 15, "mainAxisSpacing != null && mainAxisSpacing >= 0");
    if (!(crossAxisSpacing !== null && crossAxisSpacing >= 0)) dart.assertFailed(null, I[1], 322, 15, "crossAxisSpacing != null && crossAxisSpacing >= 0");
    if (!(childAspectRatio !== null && childAspectRatio > 0)) dart.assertFailed(null, I[1], 323, 15, "childAspectRatio != null && childAspectRatio > 0");
  ...
  sliver_grid.SliverGridDelegateWithMaxCrossAxisExtent = class SliverGridDelegateWithMaxCrossAxisExtent extends sliver_grid.SliverGridDelegate {
    ...
    [_debugAssertIsValid](crossAxisExtent) {
      if (!(crossAxisExtent > 0.0)) dart.assertFailed(null, I[1], 453, 12, "crossAxisExtent > 0.0");
      if (!(this.maxCrossAxisExtent > 0.0)) dart.assertFailed(null, I[1], 454, 12, "maxCrossAxisExtent > 0.0");
      if (!(this.mainAxisSpacing >= 0.0)) dart.assertFailed(null, I[1], 455, 12, "mainAxisSpacing >= 0.0");
      if (!(this.crossAxisSpacing >= 0.0)) dart.assertFailed(null, I[1], 456, 12, "crossAxisSpacing >= 0.0");
      if (!(this.childAspectRatio > 0.0)) dart.assertFailed(null, I[1], 457, 12, "childAspectRatio > 0.0");
      return true;
    }
    getLayout(constraints) {
      let t0;
      if (!this[_debugAssertIsValid](constraints.crossAxisExtent)) dart.assertFailed(null, I[1], 463, 12, "_debugAssertIsValid(constraints.crossAxisExtent)");
  ...
  (sliver_grid.SliverGridDelegateWithMaxCrossAxisExtent.new = function(opts) {
    ...
    if (!(maxCrossAxisExtent !== null && maxCrossAxisExtent > 0)) dart.assertFailed(null, I[1], 419, 15, "maxCrossAxisExtent != null && maxCrossAxisExtent > 0");
    if (!(mainAxisSpacing !== null && mainAxisSpacing >= 0)) dart.assertFailed(null, I[1], 420, 15, "mainAxisSpacing != null && mainAxisSpacing >= 0");
    if (!(crossAxisSpacing !== null && crossAxisSpacing >= 0)) dart.assertFailed(null, I[1], 421, 15, "crossAxisSpacing != null && crossAxisSpacing >= 0");
    if (!(childAspectRatio !== null && childAspectRatio > 0)) dart.assertFailed(null, I[1], 422, 15, "childAspectRatio != null && childAspectRatio > 0");
  ...
  sliver_grid.RenderSliverGrid = class RenderSliverGrid extends sliver_multi_box_adaptor.RenderSliverMultiBoxAdaptor {
    ...
    setupParentData(child) {
      ...
      if (!sliver_grid.SliverGridParentData.is(child.parentData)) {
        child.parentData = new sliver_grid.SliverGridParentData.new();
      }
    }
    get gridDelegate() {
    ...
    set gridDelegate(value) {
      if (!(value !== null)) dart.assertFailed(null, I[1], 539, 12, "value != null");
      if (this[_gridDelegate][$_equals](value)) {
        return;
      }
      if (!value[$runtimeType]._equals(this[_gridDelegate][$runtimeType]) || value.shouldRelayout(this[_gridDelegate])) {
    ...
    performLayout() {
      ...
      if (!(scrollOffset >= 0.0)) dart.assertFailed(null, I[1], 563, 12, "scrollOffset >= 0.0");
      let remainingExtent = constraints.remainingCacheExtent;
      if (!(remainingExtent >= 0.0)) dart.assertFailed(null, I[1], 565, 12, "remainingExtent >= 0.0");
      ...
      for (let index = this.indexOf(dart.nullCheck(this.firstChild)) - 1; index >= firstIndex; index = index - 1) {
        ...
        if (!(childParentData.index === index)) dart.assertFailed(null, I[1], 613, 14, "childParentData.index == index");
      ...
      for (let index = this.indexOf(dart.nullCheck(trailingChildWithLayout)) + 1; targetLastIndex == null || index <= dart.notNull(targetLastIndex); index = index + 1) {
        ...
        if (!(child != null)) dart.assertFailed(null, I[1], 640, 14, "child != null");
        let childParentData = sliver_grid.SliverGridParentData.as(dart.nullCheck(child.parentData));
        childParentData.layoutOffset = gridGeometry.scrollOffset;
        childParentData.crossAxisOffset = gridGeometry.crossAxisOffset;
        if (!(childParentData.index === index)) dart.assertFailed(null, I[1], 644, 14, "childParentData.index == index");
        trailingScrollOffset = math.max(core.double, trailingScrollOffset, gridGeometry.trailingScrollOffset);
      }
      let lastIndex = this.indexOf(dart.nullCheck(this.lastChild));
      if (!this.debugAssertChildListIsNonEmptyAndContiguous()) dart.assertFailed(null, I[1], 650, 12, "debugAssertChildListIsNonEmptyAndContiguous()");
      if (!(this.indexOf(dart.nullCheck(this.firstChild)) === firstIndex)) dart.assertFailed(null, I[1], 651, 12, "indexOf(firstChild!) == firstIndex");
      if (!(targetLastIndex == null || lastIndex <= dart.notNull(targetLastIndex))) dart.assertFailed(null, I[1], 652, 12, "targetLastIndex == null || lastIndex <= targetLastIndex");
      ...
      this.geometry = new sliver.SliverGeometry.new({scrollExtent: estimatedTotalExtent, paintExtent: paintExtent, maxPaintExtent: estimatedTotalExtent, cacheExtent: cacheExtent, hasVisualOverflow: estimatedTotalExtent > paintExtent || constraints.scrollOffset > 0.0 || constraints.overlap !== 0.0});
  ...
  (sliver_grid.RenderSliverGrid.new = function(opts) {
    let childManager = opts && 'childManager' in opts ? opts.childManager : null;
    let gridDelegate = opts && 'gridDelegate' in opts ? opts.gridDelegate : null;
    if (!(gridDelegate !== null)) dart.assertFailed(null, I[1], 525, 15, "gridDelegate != null");
