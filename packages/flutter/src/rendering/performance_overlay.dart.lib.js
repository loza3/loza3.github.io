define(['dart_sdk', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/rendering/box.dart'], (function load__packages__flutter__src__rendering__performance_overlay_dart(dart_sdk, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__rendering__box$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C[0] = dart.constList([C[1] || CT.C1, C[2] || CT.C2, C[3] || CT.C3, C[4] || CT.C4], performance_overlay.PerformanceOverlayOption);
    }
  }, false);
  var C = Array(5).fill(void 0);
  var I = [
    "package:flutter/src/rendering/performance_overlay.dart",
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/rendering/performance_overlay.dart"
  ];
  ...
  dart.defineLazy(performance_overlay.PerformanceOverlayOption, {
    /*performance_overlay.PerformanceOverlayOption.values*/get values() {
      return C[0] || CT.C0;
    },
    /*performance_overlay.PerformanceOverlayOption.displayRasterizerStatistics*/get displayRasterizerStatistics() {
      return C[1] || CT.C1;
    },
    /*performance_overlay.PerformanceOverlayOption.visualizeRasterizerStatistics*/get visualizeRasterizerStatistics() {
      return C[2] || CT.C2;
    },
    /*performance_overlay.PerformanceOverlayOption.displayEngineStatistics*/get displayEngineStatistics() {
      return C[3] || CT.C3;
    },
    /*performance_overlay.PerformanceOverlayOption.visualizeEngineStatistics*/get visualizeEngineStatistics() {
      return C[4] || CT.C4;
    }
  }, false);
  ...
  performance_overlay.RenderPerformanceOverlay = class RenderPerformanceOverlay extends box.RenderBox {
    ...
    set rasterizerThreshold(value) {
      if (!(value !== null)) dart.assertFailed(null, I[1], 98, 12, "value != null");
    ...
    set checkerboardRasterCacheImages(value) {
      if (!(value !== null)) dart.assertFailed(null, I[1], 110, 12, "value != null");
      if (value === this[_checkerboardRasterCacheImages]) {
        return;
      }
    ...
    set checkerboardOffscreenLayers(value) {
      ...
      if (value === this[_checkerboardOffscreenLayers]) {
        return;
      }
    ...
    get [_intrinsicHeight]() {
      let result = 0.0;
      if ((this.optionsMask | (1)[$leftShift](performance_overlay.PerformanceOverlayOption.displayRasterizerStatistics.index)) >>> 0 > 0 || (this.optionsMask | (1)[$leftShift](performance_overlay.PerformanceOverlayOption.visualizeRasterizerStatistics.index)) >>> 0 > 0) {
        result = result + 80;
      }
      if ((this.optionsMask | (1)[$leftShift](performance_overlay.PerformanceOverlayOption.displayEngineStatistics.index)) >>> 0 > 0 || (this.optionsMask | (1)[$leftShift](performance_overlay.PerformanceOverlayOption.visualizeEngineStatistics.index)) >>> 0 > 0) {
        result = result + 80;
      }
      return result;
    }
    ...
    paint(context, offset) {
      if (!this.needsCompositing) dart.assertFailed(null, I[1], 177, 12, "needsCompositing");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["performance_overlay.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA0CA;;;;;;;;;;;;MAhCK,mDAAM;;;MAWT,wEAA2B;;;MAM3B,0EAA6B;;;MAQ7B,oEAAuB;;;MAMvB,sEAAyB;;;;;;;;;;;;;;;;;;AAuCF;IAAY;oBAEf;AAClB,YAAO,AAAM,KAAD;AACZ,UAAI,AAAM,KAAD,KAAI;AACX;;AAEkB,MAApB,qBAAe,KAAK;AACJ,MAAhB;IACF;;AAK+B;IAAoB;4BAEvB;AAC1B,YAAO,AAAM,KAAD;AACZ,UAAI,AAAM,KAAD,KAAI;AACX;;AAE0B,MAA5B,6BAAuB,KAAK;AACZ,MAAhB;IACF;;AAG0C;IAA8B;sCAEjC;AACrC,YAAO,AAAM,KAAD;AACZ,UAAI,AAAM,KAAD,KAAI;AACX;;AAEoC,MAAtC,uCAAiC,KAAK;AACtB,MAAhB;IACF;;AAGwC;IAA4B;oCAE/B;AACnC,YAAO,AAAM,KAAD;AACZ,UAAI,AAAM,KAAD,KAAI;AACX;;AAEkC,MAApC,qCAA+B,KAAK;AACpB,MAAhB;IACF;;AAG0B;IAAI;;AAGK;IAAI;6BAGA;AACrC,YAAO;IACT;6BAGuC;AACrC,YAAO;IACT;;AAIS,mBAAS;AAChB,UAAiB,AAAoE,CAAhF,mBAAiB,CAAF,eAA8B,AAA4B,yFAAS,KACtE,AAAsE,CAAlF,mBAAiB,CAAF,eAA8B,AAA8B,2FAAS;AAC1D,QAA7B,SAAA,AAAO,MAAD;;AAER,UAAiB,AAAgE,CAA5E,mBAAiB,CAAF,eAA8B,AAAwB,qFAAS,KAClE,AAAkE,CAA9E,mBAAiB,CAAF,eAA8B,AAA0B,uFAAS;AACtD,QAA7B,SAAA,AAAO,MAAD;;AAER,YAAO,OAAM;IACf;8BAGwC;AACtC,YAAO;IACT;8BAGwC;AACtC,YAAO;IACT;qBAGqC;AACnC,YAAO,AAAY,YAAD,WAAW,uBAAsB;IACrD;UAG2B,SAAgB;AACzC,WAAO;AAOL,MANF,AAAQ,OAAD,UAAU,oDACG,qBAAS,AAAO,MAAD,KAAK,AAAO,MAAD,KAAK,AAAK,iBAAO,AAAK,gCACrD,uCACQ,yDACU,iEACF;IAEjC;;;QAvHM;QACA;QACC;QACA;UACK,AAAY,WAAD;UACX,AAAoB,mBAAD;UACnB,AAA8B,6BAAD;UAC7B,AAA4B,2BAAD;IACrB,qBAAE,WAAW;IACL,6BAAE,mBAAmB;IACX,uCAAE,6BAA6B;IACjC,qCAAE,2BAA2B;AAZ/D;;EAY+D","file":"../../../../../../../../../../packages/flutter/src/rendering/performance_overlay.dart.lib.js"}');
  // Exports:
  return {
