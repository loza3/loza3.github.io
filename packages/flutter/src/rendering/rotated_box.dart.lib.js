define(['dart_sdk', 'packages/flutter/src/rendering/layer.dart', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/rendering/box.dart'], (function load__packages__flutter__src__rendering__rotated_box_dart(dart_sdk, packages__flutter__src__rendering__layer$46dart, packages__vector_math__vector_math_64$46dart, packages__flutter__src__rendering__box$46dart) {
  'use strict';
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/rendering/rotated_box.dart",
  ...
  rotated_box.RenderRotatedBox = class RenderRotatedBox extends RenderBox_RenderObjectWithChildMixin$36 {
    ...
    hitTestChildren(result, opts) {
      ...
      if (!(this[_paintTransform] != null || this.debugNeedsLayout || this.child == null)) dart.assertFailed(null, I[0], 106, 12, "_paintTransform != null || debugNeedsLayout || child == null");
    ...
    applyPaintTransform(child, transform) {
      ...
      if (this[_paintTransform] != null) {
        transform.multiply(dart.nullCheck(this[_paintTransform]));
      }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["rotated_box.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAgC0B;IAAa;qBAEhB;AACnB,YAAO,AAAM,KAAD;AACZ,UAAI,AAAc,wBAAG,KAAK;AACxB;;AAEmB,MAArB,sBAAgB,KAAK;AACJ,MAAjB;IACF;;AAEwB,YAAA,AAAa;IAAK;6BAGH;AACrC,UAAI,AAAM;AACR,cAAO;;AAET,YAAO,qBAAmB,AAAE,eAAP,kCAA6B,MAAM,IAAS,AAAE,eAAP,iCAA4B,MAAM;IAChG;6BAGuC;AACrC,UAAI,AAAM;AACR,cAAO;;AAET,YAAO,qBAAmB,AAAE,eAAP,kCAA6B,MAAM,IAAS,AAAE,eAAP,iCAA4B,MAAM;IAChG;8BAGwC;AACtC,UAAI,AAAM;AACR,cAAO;;AAET,YAAO,qBAAmB,AAAE,eAAP,iCAA4B,KAAK,IAAS,AAAE,eAAP,kCAA6B,KAAK;IAC9F;8BAGwC;AACtC,UAAI,AAAM;AACR,cAAO;;AAET,YAAO,qBAAmB,AAAE,eAAP,iCAA4B,KAAK,IAAS,AAAE,eAAP,kCAA6B,KAAK;IAC9F;qBAKqC;AACnC,UAAI,AAAM;AACR,cAAO,AAAY,YAAD;;AAET,sBAAiB,AAAE,eAAP,yBAAoB,oBAAc,AAAY,WAAD,WAAW,WAAW;AAC1F,YAAO,qBAAc,gBAAK,AAAU,SAAD,SAAS,AAAU,SAAD,UAAU,SAAS;IAC1E;;;AAIwB,MAAtB,wBAAkB;AAClB,UAAI;AACkF,QAA/E,AAAE,eAAP,mBAAc,oBAAc,AAAY,2BAAU,mCAA6B;AACD,QAA9E,YAAO,oBAAc,gBAAU,AAAE,AAAK,eAAZ,yBAAyB,AAAE,AAAK,eAAZ,0BAA0B,AAAE,eAAP;AAID,QAHlE,iEAA0B;AACtB,uBAAU,AAAK,AAAM,kBAAE,KAAK,AAAK,AAAO,mBAAE;AAC1C,qBAAgC,qBAAG,AAAa,2BAAE;AAClD,uBAAU,AAAmB,CAAb,AAAE,AAAK,eAAZ,yBAAoB,KAAK,AAAoB,CAAd,AAAE,AAAK,eAAZ,0BAAqB;;;;AAEnC,QAA3B,YAAO,AAAY;;IAEvB;oBAGsC;UAA0B;AAC9D,YAAO,AAA4C,iCAAjB,yBAAoB,AAAM;AAC5D,UAAI,AAAM,sBAAW,AAAgB;AACnC,cAAO;;AAET,YAAO,AAAO,OAAD,mCACA,iCACD,QAAQ,WACT,SAAkB,QAAe,aAC5B,AAAE,eAAP,oBAAe,MAAM,aAAY,QAAQ;IAGtD;kBAEiC,SAAgB;AACb,MAAlC,AAAQ,OAAD,YAAiB,eAAL,aAAQ,MAAM;IACnC;UAG2B,SAAgB;AACzC,UAAI;AAOD,QAND,AAAgB,8BAAQ,AAAQ,OAAD,eAC7B,uBACA,MAAM,EACS,eAAf,kCACA,+BACU,AAAgB;;AAGA,QAA5B,AAAgB,8BAAQ;;IAE5B;;AAM8B,MAA5B,AAAgB,8BAAQ;AACT,MAAT;IACR;wBAGmC,OAAe;;AAChD,UAAI;AACkC,QAApC,AAAU,SAAD,UAAyB,eAAf;;AAEsB,MAArC,0BAAoB,KAAK,EAAE,SAAS;IAC5C;;;QA/He;QACF;IAoDJ;IA4DyB,wBAAkB;UA/GxC,AAAa,YAAD;IACL,sBAAE,YAAY;AAJjC;AAKoB,IAAb,aAAQ,KAAK;EACpB;;;;;;;;;;;;;;;;;;;;;;;;MAjBW,mCAAuB","file":"../../../../../../../../../../packages/flutter/src/rendering/rotated_box.dart.lib.js"}');
  // Exports:
  return {
