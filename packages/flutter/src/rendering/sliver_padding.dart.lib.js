define(['dart_sdk', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/rendering/sliver.dart', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/edge_insets.dart'], (function load__packages__flutter__src__rendering__sliver_padding_dart(dart_sdk, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__rendering__sliver$46dart, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__edge_insets$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/rendering/sliver_padding.dart",
  ...
  sliver_padding.RenderSliverEdgeInsetsPadding = class RenderSliverEdgeInsetsPadding extends RenderSliver_RenderObjectWithChildMixin$36 {
    ...
    performLayout() {
      ...
      if (!(this.resolvedPadding != null)) dart.assertFailed(null, I[0], 116, 12, "resolvedPadding != null");
      ...
      if (this.child == null) {
        let paintExtent = this.calculatePaintOffset(constraints, {from: 0.0, to: mainAxisPadding});
        let cacheExtent = this.calculateCacheOffset(constraints, {from: 0.0, to: mainAxisPadding});
        this.geometry = new sliver.SliverGeometry.new({scrollExtent: mainAxisPadding, paintExtent: math.min(core.double, paintExtent, constraints.remainingPaintExtent), maxPaintExtent: mainAxisPadding, cacheExtent: cacheExtent});
        return;
      }
      ...
      if (!(constraints.axisDirection !== null)) dart.assertFailed(null, I[0], 204, 12, "constraints.axisDirection != null");
      if (!(constraints.growthDirection !== null)) dart.assertFailed(null, I[0], 205, 12, "constraints.growthDirection != null");
      ...
      if (!(childParentData.paintOffset !== null)) dart.assertFailed(null, I[0], 220, 12, "childParentData.paintOffset != null");
      if (!(beforePadding === this.beforePadding)) dart.assertFailed(null, I[0], 221, 12, "beforePadding == this.beforePadding");
      if (!(afterPadding === this.afterPadding)) dart.assertFailed(null, I[0], 222, 12, "afterPadding == this.afterPadding");
      if (!(mainAxisPadding === this.mainAxisPadding)) dart.assertFailed(null, I[0], 223, 12, "mainAxisPadding == this.mainAxisPadding");
      if (!(crossAxisPadding === this.crossAxisPadding)) dart.assertFailed(null, I[0], 224, 12, "crossAxisPadding == this.crossAxisPadding");
    }
    ...
    childMainAxisPosition(child) {
      ...
      if (!(child !== null)) dart.assertFailed(null, I[0], 245, 12, "child != null");
      if (!child[$_equals](this.child)) dart.assertFailed(null, I[0], 246, 12, "child == this.child");
      return this.calculatePaintOffset(this.constraints, {from: 0.0, to: this.beforePadding});
    }
    childCrossAxisPosition(child) {
      sliver.RenderSliver.as(child);
      if (!(child !== null)) dart.assertFailed(null, I[0], 252, 12, "child != null");
      if (!child[$_equals](this.child)) dart.assertFailed(null, I[0], 253, 12, "child == this.child");
      if (!(this.constraints !== null)) dart.assertFailed(null, I[0], 254, 12, "constraints != null");
      if (!(this.constraints.axisDirection !== null)) dart.assertFailed(null, I[0], 255, 12, "constraints.axisDirection != null");
      if (!(this.constraints.growthDirection !== null)) dart.assertFailed(null, I[0], 256, 12, "constraints.growthDirection != null");
      if (!(this.resolvedPadding != null)) dart.assertFailed(null, I[0], 257, 12, "resolvedPadding != null");
      switch (sliver.applyGrowthDirectionToAxisDirection(this.constraints.axisDirection, this.constraints.growthDirection)) {
        case C[0] || CT.C0:
        case C[2] || CT.C2:
          {
    ...
    childScrollOffset(child) {
      object.RenderObject.as(child);
      if (!dart.equals(child.parent, this)) dart.assertFailed(null, I[0], 270, 12, "child.parent == this");
      return this.beforePadding;
    }
    applyPaintTransform(child, transform) {
      object.RenderObject.as(child);
      if (!(child !== null)) dart.assertFailed(null, I[0], 276, 12, "child != null");
      if (!child[$_equals](this.child)) dart.assertFailed(null, I[0], 277, 12, "child == this.child");
      ...
      if (!dart.fn(() => {
        if (debug.debugPaintSizeEnabled) {
          ...
          if (this.child != null) {
            ...
            if (!(innerRect.top >= outerRect.top)) dart.assertFailed(null, I[0], 302, 18, "innerRect.top >= outerRect.top");
            if (!(innerRect.left >= outerRect.left)) dart.assertFailed(null, I[0], 303, 18, "innerRect.left >= outerRect.left");
            if (!(innerRect.right <= outerRect.right)) dart.assertFailed(null, I[0], 304, 18, "innerRect.right <= outerRect.right");
            if (!(innerRect.bottom <= outerRect.bottom)) dart.assertFailed(null, I[0], 305, 18, "innerRect.bottom <= outerRect.bottom");
          }
          debug.debugPaintPadding(context.canvas, outerRect, innerRect);
        }
        return true;
      }, T.VoidTobool())()) dart.assertFailed(null, I[0], 293, 12, "() {\n      if (debugPaintSizeEnabled) {\n        final Size parentSize = getAbsoluteSize();\n        final Rect outerRect = offset & parentSize;\n        Rect? innerRect;\n        if (child != null) {\n          final Size childSize = child!.getAbsoluteSize();\n          final SliverPhysicalParentData childParentData = child!.parentData! as SliverPhysicalParentData;\n          innerRect = (offset + childParentData.paintOffset) & childSize;\n          assert(innerRect.top >= outerRect.top);\n          assert(innerRect.left >= outerRect.left);\n          assert(innerRect.right <= outerRect.right);\n          assert(innerRect.bottom <= outerRect.bottom);\n        }\n        debugPaintPadding(context.canvas, outerRect, innerRect);\n      }\n      return true;\n    }()");
    }
  };
  ...
  sliver_padding.RenderSliverPadding = class RenderSliverPadding extends sliver_padding.RenderSliverEdgeInsetsPadding {
    ...
    [_resolve]() {
      if (this.resolvedPadding != null) {
        return;
      }
      this[_resolvedPadding] = this.padding.resolve(this.textDirection);
      if (!dart.nullCheck(this.resolvedPadding).isNonNegative) dart.assertFailed(null, I[0], 345, 12, "resolvedPadding!.isNonNegative");
    }
    ...
    set padding(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 360, 12, "value != null");
      if (!this.padding.isNonNegative) dart.assertFailed(null, I[0], 361, 12, "padding.isNonNegative");
  ...
  (sliver_padding.RenderSliverPadding.new = function(opts) {
    ...
    let child = opts && 'child' in opts ? opts.child : null;
    this[_resolvedPadding] = null;
    if (!(padding !== null)) dart.assertFailed(null, I[0], 329, 15, "padding != null");
    if (!padding.isNonNegative) dart.assertFailed(null, I[0], 330, 15, "padding.isNonNegative");
