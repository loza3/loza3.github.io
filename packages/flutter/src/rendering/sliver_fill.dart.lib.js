define(['dart_sdk', 'packages/flutter/src/rendering/sliver_fixed_extent_list.dart', 'packages/flutter/src/rendering/sliver.dart', 'packages/flutter/src/painting/basic_types.dart'], (function load__packages__flutter__src__rendering__sliver_fill_dart(dart_sdk, packages__flutter__src__rendering__sliver_fixed_extent_list$46dart, packages__flutter__src__rendering__sliver$46dart, packages__flutter__src__painting__basic_types$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/rendering/sliver_fill.dart",
  ...
  (sliver_fill.RenderSliverFillViewport.new = function(opts) {
    let childManager = opts && 'childManager' in opts ? opts.childManager : null;
    let viewportFraction = opts && 'viewportFraction' in opts ? opts.viewportFraction : 1;
    if (!(viewportFraction !== null)) dart.assertFailed(null, I[0], 35, 15, "viewportFraction != null");
    if (!(viewportFraction > 0.0)) dart.assertFailed(null, I[0], 36, 15, "viewportFraction > 0.0");
  ...
  sliver_fill.RenderSliverFillRemaining = class RenderSliverFillRemaining extends sliver.RenderSliverSingleBoxAdapter {
    ...
    performLayout() {
      ...
      if (!extent[$isFinite]) dart.assertFailed("The calculated extent for the child of SliverFillRemaining is not finite. " + "This can happen if the child is a scrollable, in which case, the " + "hasScrollBody property of SliverFillRemaining should not be set to " + "false.", I[0], 165, 12, "extent.isFinite");
      let paintedChildSize = this.calculatePaintOffset(constraints, {from: 0.0, to: extent});
      if (!paintedChildSize[$isFinite]) dart.assertFailed(null, I[0], 172, 12, "paintedChildSize.isFinite");
      if (!(paintedChildSize >= 0.0)) dart.assertFailed(null, I[0], 173, 12, "paintedChildSize >= 0.0");
  ...
  sliver_fill.RenderSliverFillRemainingAndOverscroll = class RenderSliverFillRemainingAndOverscroll extends sliver.RenderSliverSingleBoxAdapter {
    ...
    performLayout() {
      ...
      if (!extent[$isFinite]) dart.assertFailed("The calculated extent for the child of SliverFillRemaining is not finite. " + "This can happen if the child is a scrollable, in which case, the " + "hasScrollBody property of SliverFillRemaining should not be set to " + "false.", I[0], 243, 12, "extent.isFinite");
      let paintedChildSize = this.calculatePaintOffset(constraints, {from: 0.0, to: extent});
      if (!paintedChildSize[$isFinite]) dart.assertFailed(null, I[0], 250, 12, "paintedChildSize.isFinite");
      if (!(paintedChildSize >= 0.0)) dart.assertFailed(null, I[0], 251, 12, "paintedChildSize >= 0.0");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["sliver_fill.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAuC2B,YAAA,AAAY,AAAuB,2CAAE;IAAgB;;AAO/C;IAAiB;yBAEpB;AAC1B,YAAO,AAAM,KAAD;AACZ,UAAI,AAAkB,4BAAG,KAAK;AAC5B;;AAEuB,MAAzB,0BAAoB,KAAK;AACR,MAAjB;IACF;;;QAvBiB;QACR;UACG,AAAiB,gBAAD;UAChB,AAAiB,gBAAD,GAAG;IACR,0BAAE,gBAAgB;AALzC,iFACiB,YAAY;;EAIY;;;;;;;;;;;;;;;;;;;;;;;AAkDf,wBAAmB;AAC9B,mBAAS,AAAY,AAAqB,WAAtB,wBAA6B,mBAAI,AAAY,WAAD,UAAU;AAEvF,UAAI;AAIA,QAHG,AAAE,eAAP,mBAAc,AAAY,WAAD,8BACZ,MAAM,aACN,MAAM;;AAIR,6BAAmB,0BAAqB,WAAW,SAAQ,SAAS,MAAM;AACvF,WAAO,AAAiB,gBAAD;AACvB,YAAO,AAAiB,gBAAD,IAAI;AAM1B,MALD,gBAAW,6CACK,AAAY,WAAD,sCACZ,gBAAgB,kBACb,gBAAgB,qBACb,AAAO,AAAmC,MAApC,GAAG,AAAY,WAAD,yBAAyB,AAAY,AAAa,WAAd,gBAAgB;AAE7F,UAAI;AACgD,QAAlD,wBAAwB,eAAL,aAAQ,WAAW,EAAU,eAAR;;IAE5C;;;QA1BgD;AAAhD,yFAAgD,KAAK;;EAAG;;;;;;;;;;;;;;;;AAwD9B,wBAAmB;AAGpC,mBAAS,AAAY,AAAuB,WAAxB,0BAA0B,AAAY,WAAD;AAEhE,UAAI;AACW;AACb,gBAAQ,AAAY,WAAD;;;AAEuD,cAAtE,cAAmB,AAAE,eAAP,iCAA4B,AAAY,WAAD;AACrD;;;;AAEuE,cAAvE,cAAmB,AAAE,eAAP,kCAA6B,AAAY,WAAD;AACtD;;;AAMkC,QAAtC,SAAc,sBAAI,MAAM,EAAE,WAAW;AAInC,QAHG,AAAE,eAAP,mBAAc,AAAY,WAAD,8BACZ,MAAM,aACN,MAAM;;AAIrB,WAAO,AAAO,MAAD,+BAAS,AACpB,+EACA,sEACA,wEACA;AAEW,6BAAmB,0BAAqB,WAAW,SAAQ,SAAS,MAAM;AACvF,WAAO,AAAiB,gBAAD;AACvB,YAAO,AAAiB,gBAAD,IAAI;AAM1B,MALD,gBAAW,6CACK,MAAM,eACP,gBAAgB,kBACb,gBAAgB,qBACb,AAAO,AAAmC,MAApC,GAAG,AAAY,WAAD,yBAAyB,AAAY,AAAa,WAAd,gBAAgB;AAE7F,UAAI;AACgD,QAAlD,wBAAwB,eAAL,aAAQ,WAAW,EAAU,eAAR;;IAE5C;;;QAhDkC;AAAlC,2EAAkC,KAAK;;EAAG;;;;;;;;;;;;;;AA8EhB,wBAAmB;AAGpC,mBAAS,AAAY,AAAuB,WAAxB,0BAA0B,AAAY,WAAD;AAGzD,sBAAY,AAAY,AAAqB,WAAtB,wBAA6B,mBAAI,AAAY,WAAD,UAAU;AAEpF,UAAI;AACW;AACb,gBAAQ,AAAY,WAAD;;;AAEuD,cAAtE,cAAmB,AAAE,eAAP,iCAA4B,AAAY,WAAD;AACrD;;;;AAEuE,cAAvE,cAAmB,AAAE,eAAP,kCAA6B,AAAY,WAAD;AACtD;;;AAMkC,QAAtC,SAAc,sBAAI,MAAM,EAAE,WAAW;AAIE,QAAvC,YAAiB,sBAAI,MAAM,EAAE,SAAS;AAC8C,QAA/E,AAAE,eAAP,mBAAc,AAAY,WAAD,8BAA6B,MAAM,aAAa,SAAS;;AAGpF,WAAO,AAAO,MAAD,+BAAS,AACpB,+EACA,sEACA,wEACA;AAEW,6BAAmB,0BAAqB,WAAW,SAAQ,SAAS,MAAM;AACvF,WAAO,AAAiB,gBAAD;AACvB,YAAO,AAAiB,gBAAD,IAAI;AAM1B,MALD,gBAAW,6CACK,MAAM,eACF,sBAAI,SAAS,EAAE,AAAY,WAAD,wCAC5B,SAAS,qBACN,AAAO,AAAmC,MAApC,GAAG,AAAY,WAAD,yBAAyB,AAAY,AAAa,WAAd,gBAAgB;AAE7F,UAAI;AACgD,QAAlD,wBAAwB,eAAL,aAAQ,WAAW,EAAU,eAAR;;IAE5C;;;QApD+C;AAA/C,wFAA+C,KAAK;;EAAG","file":"../../../../../../../../../../packages/flutter/src/rendering/sliver_fill.dart.lib.js"}');
  // Exports:
  return {
