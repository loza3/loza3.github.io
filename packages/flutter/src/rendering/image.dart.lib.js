define(['dart_sdk', 'packages/flutter/src/painting/alignment.dart', 'packages/flutter/src/painting/decoration_image.dart', 'packages/flutter/src/rendering/box.dart', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/colors.dart', 'packages/flutter/src/animation/listener_helpers.dart', 'packages/flutter/src/painting/box_fit.dart'], (function load__packages__flutter__src__rendering__image_dart(dart_sdk, packages__flutter__src__painting__alignment$46dart, packages__flutter__src__painting__decoration_image$46dart, packages__flutter__src__rendering__box$46dart, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__colors$46dart, packages__flutter__src__animation__listener_helpers$46dart, packages__flutter__src__painting__box_fit$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/rendering/image.dart",
  ...
  image$.RenderImage = class RenderImage extends box.RenderBox {
    ...
    set opacity(value) {
      let t0, t0$;
      if (dart.equals(value, this[_opacity])) {
        return;
      }
      if (this.attached) {
        t0 = this[_opacity];
    ...
    set filterQuality(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 203, 12, "value != null");
    ...
    set alignment(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 252, 12, "value != null");
    ...
    set repeat(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 264, 12, "value != null");
    ...
    set matchTextDirection(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 321, 12, "value != null");
    ...
    set isAntiAlias(value) {
      ...
      if (!(value !== null)) dart.assertFailed(null, I[0], 353, 12, "value != null");
    ...
    computeMinIntrinsicWidth(height) {
      if (!(height >= 0.0)) dart.assertFailed(null, I[0], 385, 12, "height >= 0.0");
      if (this[_width] == null && this[_height] == null) {
        return 0.0;
      }
    ...
    computeMaxIntrinsicWidth(height) {
      if (!(height >= 0.0)) dart.assertFailed(null, I[0], 394, 12, "height >= 0.0");
      return this[_sizeForConstraints](new box.BoxConstraints.tightForFinite({height: height})).width;
    }
    computeMinIntrinsicHeight(width) {
      if (!(width >= 0.0)) dart.assertFailed(null, I[0], 400, 12, "width >= 0.0");
      if (this[_width] == null && this[_height] == null) {
        return 0.0;
      }
    ...
    computeMaxIntrinsicHeight(width) {
      if (!(width >= 0.0)) dart.assertFailed(null, I[0], 409, 12, "width >= 0.0");
      return this[_sizeForConstraints](new box.BoxConstraints.tightForFinite({width: width})).height;
    }
    ...
    paint(context, offset) {
      ...
      this[_resolve]();
      if (!(this[_resolvedAlignment] != null)) dart.assertFailed(null, I[0], 444, 12, "_resolvedAlignment != null");
      if (!(this[_flipHorizontally] != null)) dart.assertFailed(null, I[0], 445, 12, "_flipHorizontally != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["image.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA8GU;;;;;;;;;;;;;;;;;;;;;;;;;;;AAnCN,UAAI;AACF;;AAEmD,MAArD,2BAAqB,AAAU,uBAAQ;AACqC,MAA5E,0BAAoB,AAAmB,2BAAG,AAAc,uBAAiB;IAC3E;;AAG2B,MAAzB,2BAAqB;AACG,MAAxB,0BAAoB;AACJ,MAAhB;IACF;;AAGuB;IAAM;cAET;;AAClB,UAAU,YAAN,KAAK,EAAI;AACX;;AAIF,UAAI,KAAK,YAAY,wBAAkB,AAAM,KAAD,WAAiB,eAAN;AACtC,QAAf,AAAM,KAAD;AACL;;AAEe,WAAjB;0BAAQ;AACM,MAAd,eAAS,KAAK;AACE,MAAhB;AACA,UAAI,AAAO,wBAAW,AAAQ;AACX,QAAjB;;IAEJ;;AASqB;IAAM;cAET;AAChB,UAAI,AAAM,KAAD,IAAI;AACX;;AAEY,MAAd,eAAS,KAAK;AACG,MAAjB;IACF;;AAMsB;IAAO;eAEV;AACjB,UAAI,AAAM,KAAD,IAAI;AACX;;AAEa,MAAf,gBAAU,KAAK;AACE,MAAjB;IACF;;AAKoB;IAAM;cAET;AACf,YAAO,AAAM,KAAD;AACZ,UAAI,AAAM,KAAD,KAAI;AACX;;AAEY,MAAd,eAAS,KAAK;AACG,MAAjB;IACF;;;AAKE,UAAI,AAAO;AACU,QAAnB,qBAAe;;AAE6D,QAA5E,qBAA2B,uCAAW,eAAN,gBAAyB,4BAAhB,aAA6B;;IAE1E;;AAGoB;IAAM;cAET;AACf,UAAU,YAAN,KAAK,EAAI;AACX;;AAEY,MAAd,eAAS,KAAK;AACM,MAApB;AACgB,MAAhB;IACF;;AAIkC;IAAQ;gBAEX;;AAC7B,UAAU,YAAN,KAAK,EAAI;AACX;;AAGF,UAAI;AACsC,aAAxC;4BAAU,4BAAe;;AAEX,MAAhB,iBAAW,KAAK;AAChB,UAAI;AACgC,cAAlC,KAAK;sBAAL,OAAO,0BAAY;;IAEvB;;AAOmC;IAAc;sBAEjB;AAC9B,YAAO,AAAM,KAAD;AACZ,UAAI,AAAM,KAAD,KAAI;AACX;;AAEoB,MAAtB,uBAAiB,KAAK;AACN,MAAhB;IACF;;AAWiC;IAAe;uBAElB;AAC5B,UAAI,AAAM,KAAD,IAAI;AACX;;AAEqB,MAAvB,wBAAkB,KAAK;AACH,MAApB;AACgB,MAAhB;IACF;;AAMmB;IAAI;YAEP;AACd,UAAI,AAAM,KAAD,IAAI;AACX;;AAEU,MAAZ,aAAO,KAAK;AACI,MAAhB;IACF;;AAMmC;IAAU;kBAEb;AAC9B,YAAO,AAAM,KAAD;AACZ,UAAI,AAAM,KAAD,SAAI;AACX;;AAEgB,MAAlB,mBAAa,KAAK;AACG,MAArB;IACF;;AAG0B;IAAO;eAEV;AACrB,YAAO,AAAM,KAAD;AACZ,UAAI,AAAM,KAAD,KAAI;AACX;;AAEa,MAAf,gBAAU,KAAK;AACC,MAAhB;IACF;;AASyB;IAAY;oBAEf;AACpB,UAAU,YAAN,KAAK,EAAI;AACX;;AAEkB,MAApB,qBAAe,KAAK;AACJ,MAAhB;IACF;;AAOyB;IAAa;qBAEhB;AACpB,UAAI,AAAM,KAAD,KAAI;AACX;;AAEmB,MAArB,sBAAgB,KAAK;AACL,MAAhB;IACF;;AAgB+B;IAAmB;2BAEtB;AAC1B,YAAO,AAAM,KAAD;AACZ,UAAI,AAAM,KAAD,KAAI;AACX;;AAEyB,MAA3B,4BAAsB,KAAK;AACN,MAArB;IACF;;AAOoC;IAAc;sBAEjB;AAC/B,UAAI,AAAe,wBAAG,KAAK;AACzB;;AAEoB,MAAtB,uBAAiB,KAAK;AACD,MAArB;IACF;;AAKwB;IAAY;oBAEf;AACnB,UAAI,AAAa,uBAAG,KAAK;AACvB;;AAEF,YAAO,AAAM,KAAD;AACQ,MAApB,qBAAe,KAAK;AACJ,MAAhB;IACF;0BASwC;AAMhB,MAHtB,cAA6B,AAG3B,wCAFO,sBACC,wBACA,WAAW;AAErB,UAAI,AAAO;AACT,cAAO,AAAY,YAAD;;AAGpB,YAAO,AAAY,YAAD,8CAA8C,gBACxD,AAAE,AAAM,AAAW,eAAzB,mCAA2B,cACrB,AAAE,AAAO,AAAW,eAA1B,oCAA4B;IAEhC;6BAGuC;AACrC,YAAO,AAAO,MAAD,IAAI;AACjB,UAAI,AAAO,wBAAW,AAAQ;AAC5B,cAAO;;AAET,YAAO,AAAmE,2BAAhC,+CAAuB,MAAM;IACzE;6BAGuC;AACrC,YAAO,AAAO,MAAD,IAAI;AACjB,YAAO,AAAmE,2BAAhC,+CAAuB,MAAM;IACzE;8BAGwC;AACtC,YAAO,AAAM,KAAD,IAAI;AAChB,UAAI,AAAO,wBAAW,AAAQ;AAC5B,cAAO;;AAET,YAAO,AAAiE,2BAA9B,8CAAsB,KAAK;IACvE;8BAGwC;AACtC,YAAO,AAAM,KAAD,IAAI;AAChB,YAAO,AAAiE,2BAA9B,8CAAsB,KAAK;IACvE;gBAGwB;AAAa;IAAI;qBAGJ;AACnC,YAAO,2BAAoB,WAAW;IACxC;;AAIyC,MAAvC,YAAO,0BAAoB;IAC7B;WAGoC;;;AACf,MAAb,aAAO,KAAK;AACmB,WAArC;0BAAU,yBAAY;IACxB;;;AAI0C,WAAxC;0BAAU,4BAAe;AACX,MAAR;IACR;UAG2B,SAAgB;;AACzC,UAAI,AAAO;AACT;;AAEQ,MAAV;AACA,YAAO,AAAmB;AAC1B,YAAO,AAAkB;AAiBxB,MAhBD,qCACU,AAAQ,OAAD,eACT,AAAO,MAAD,MAAG,mBACF,eAAN,gCACU,6BACV,wBACkB,yCAAhB,OAAU,WAAV,cAAmB,yBACf,yBACR,uBACwB,eAAlB,wCACE,4BACL,iCAC2B,eAAjB,wCACJ,kCACC,mCACF;IAEjB;;;AAImB,WAAjB;0BAAQ;AACK,MAAb,eAAS;AACM,MAAT;IACR;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AACyB,MAA7D,AAAW,UAAD,KAAK,yCAA8B,SAAS;AACY,MAAlE,AAAW,UAAD,KAAK,mCAAe,SAAS,2BAAqB;AACQ,MAApE,AAAW,UAAD,KAAK,mCAAe,UAAU,4BAAsB;AACG,MAAjE,AAAW,UAAD,KAAK,mCAAe,SAAS,2BAAqB;AACK,MAAjE,AAAW,UAAD,KAAK,6BAAc,SAAS,2BAAqB;AACoC,MAA/F,AAAW,UAAD,KAAK,sDAAwC,WAAW,6BAAuB;AACI,MAA7F,AAAW,UAAD,KAAK,sCAAwB,kBAAkB,oCAA8B;AACnB,MAApE,AAAW,UAAD,KAAK,mCAAqB,OAAO,yBAAmB;AACoC,MAAlG,AAAW,UAAD,KAAK,qDAAuC,aAAa,+BAAyB;AACG,MAA/F,AAAW,UAAD,KAAK,wCAA0B,UAAU,4BAAkC;AACI,MAAzF,AAAW,UAAD,KAAK,wCAA0B,eAAe,iCAA2B;AAC0B,MAA7G,AAAW,UAAD,KAAK,iCAAa,8BAA6B,iCAA4B;AACU,MAA/F,AAAW,UAAD,KAAK,0CAA4B,iBAAiB,mCAA6B;AAClB,MAAvE,AAAW,UAAD,KAAK,wCAA0B,gBAAgB;AACkB,MAA3E,AAAW,UAAD,KAAK,0CAA4B,iBAAiB;IAC9D;;;QA5cY;QACL;QACG;QACA;QACD;QACA;QACY;QACR;QACH;QACU;QACN;QACN;QACD;QACU;QACV;QACA;QACS;IA0BL;IACL;IAkFO;IA5HN;UAgBK,AAAM,KAAD;UACL,AAAO,MAAD;UACN,AAAU,SAAD;UACT,AAAc,aAAD;UACb,AAAmB,kBAAD;UAClB,AAAY,WAAD;IACX,eAAE,KAAK;IACP,eAAE,KAAK;IACN,gBAAE,MAAM;IACT,eAAE,KAAK;IACP,eAAE,KAAK;IACL,iBAAE,OAAO;IACF,wBAAE,cAAc;IAC3B,aAAE,GAAG;IACC,mBAAE,SAAS;IACd,gBAAE,MAAM;IACH,qBAAE,WAAW;IACN,4BAAE,kBAAkB;IAC1B,sBAAE,YAAY;IACb,uBAAE,aAAa;IACjB,qBAAE,WAAW;IACX,uBAAE,aAAa;AAvCnC;AAwCsB,IAApB;EACF","file":"../../../../../../../../../../packages/flutter/src/rendering/image.dart.lib.js"}');
  // Exports:
  return {
