define(['dart_sdk', 'packages/flutter/src/animation/curves.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/foundation/change_notifier.dart'], (function load__packages__flutter__src__rendering__viewport_offset_dart(dart_sdk, packages__flutter__src__animation__curves$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__foundation__change_notifier$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C[0] = dart.constList([C[1] || CT.C1, C[2] || CT.C2, C[3] || CT.C3], viewport_offset.ScrollDirection);
    }
  }, false);
  var C = Array(4).fill(void 0);
  var I = [
    "package:flutter/src/rendering/viewport_offset.dart",
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/rendering/viewport_offset.dart"
  ];
  ...
  dart.defineLazy(viewport_offset.ScrollDirection, {
    /*viewport_offset.ScrollDirection.values*/get values() {
      return C[0] || CT.C0;
    },
    /*viewport_offset.ScrollDirection.idle*/get idle() {
      return C[1] || CT.C1;
    },
    /*viewport_offset.ScrollDirection.forward*/get forward() {
      return C[2] || CT.C2;
    },
    /*viewport_offset.ScrollDirection.reverse*/get reverse() {
      return C[3] || CT.C3;
    }
  }, false);
  viewport_offset.ViewportOffset = class ViewportOffset extends change_notifier.ChangeNotifier {
    ...
    moveTo(to, opts) {
      ...
      if (duration == null || dart.equals(duration, core.Duration.zero)) {
        ...
        return this.animateTo(to, {duration: duration, curve: (t2 = curve, t2 == null ? curves.Curves.ease : t2)});
      }
    }
    toString() {
