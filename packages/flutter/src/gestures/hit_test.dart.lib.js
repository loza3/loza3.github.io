define(['dart_sdk', 'packages/flutter/src/foundation/debug.dart', 'packages/vector_math/vector_math_64.dart'], (function load__packages__flutter__src__gestures__hit_test_dart(dart_sdk, packages__flutter__src__foundation__debug$46dart, packages__vector_math__vector_math_64$46dart) {
  ...
  var T = {
    ...
    JSArrayOfHitTestEntryOfHitTestTarget: () => (T.JSArrayOfHitTestEntryOfHitTestTarget = dart.constFn(_interceptors.JSArray$(T.HitTestEntryOfHitTestTarget())))(),
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/gestures/hit_test.dart"
  ];
  ...
  hit_test.HitTestEntry$ = dart.generic(T => {
    ...
    dart.setGetterSignature(HitTestEntry, () => ({
      __proto__: dart.getGetters(HitTestEntry.__proto__),
      transform: dart.nullable(vector_math_64.Matrix4)
    }));
    dart.setLibraryUri(HitTestEntry, I[0]);
    dart.setFieldSignature(HitTestEntry, () => ({
      __proto__: dart.getFields(HitTestEntry.__proto__),
      target: dart.finalFieldType(T),
  ...
  hit_test.HitTestResult = class HitTestResult extends core.Object {
    ...
    popTransform() {
      ...
      if (!this[_transforms][$isNotEmpty]) dart.assertFailed(null, I[1], 282, 12, "_transforms.isNotEmpty");
    }
  ...
  (hit_test.HitTestResult.new = function() {
    this[_path] = T.JSArrayOfHitTestEntryOfHitTestTarget().of([]);
  ...
  dart.setMethodSignature(hit_test.HitTestResult, () => ({
    ...
    add: dart.fnType(dart.void, [hit_test.HitTestEntry$(hit_test.HitTestTarget)]),
  ...
  dart.setGetterSignature(hit_test.HitTestResult, () => ({
    ...
    path: core.Iterable$(hit_test.HitTestEntry$(hit_test.HitTestTarget)),
  ...
  dart.setFieldSignature(hit_test.HitTestResult, () => ({
    ...
    [_path]: dart.finalFieldType(core.List$(hit_test.HitTestEntry$(hit_test.HitTestTarget))),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["hit_test.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;EAoBiB;;;;;;;EAaM;;;;;;;EAUJ;;;;;;;;;MAgBT;;;;;;;;;;AAGa,cAAG,AAAiC,8BAAhB,QAAM,eAAE,eAAM;MAAE;;AAU/B;MAAU;;iCAhBlB;MAiBT;MAjBS;;IAAO;;;;;;;;;;;;;;;;;;;;;;EAuBH;;;;;;IAgBR;;;;;;;;;aAGW;AACvB,YAAO,AAAO,wBAAW,GAAG;IAC9B;;;IAPgC;AAA1B;;EAAiC;;;;;;;;;;;;;;IAa1B;;;;;;;;;aAGY;;AACvB,WAAO,AAAI,GAAD;YAAC;AAAS,yBAAc,AAAO,gBAAI,AAAO;;;IACtD;;;IAPgC;AAA1B;;EAAiC;;;;;;;;;;;;;;;;;;;;;;;;;;AAkCJ;IAAK;;AAqBtC,UAAI,AAAiB;AACnB;;AAEM,iBAAO,AAAY;AAC3B,eAA0B,OAAQ;AACN,QAA1B,OAAO,AAAK,IAAD,UAAU,IAAI;AACJ,QAArB,AAAY,wBAAI,IAAI;;AAEE,MAAxB,AAAiB;IACnB;;AAGwB,MAAtB;AACA,WAAO,AAAiB;AACxB,YAAO,AAAY;IACrB;QAOsB;AACpB,YAAO,AAAM,AAAW,KAAZ;AACqB,MAAjC,AAAM,KAAD,eAAc;AACH,MAAhB,AAAM,kBAAI,KAAK;IACjB;kBA+B2B;AACzB,YAAO,AAAU,SAAD;AAChB,YACE,AAAuE,mCAA1C,AAAU,SAAD,QAAQ,IAAI,2BAAQ,KAAG,KAAG,KAAG,SACnE,mCAA6B,AAAU,SAAD,WAAW,IAAI,2BAAQ,KAAG,KAAG,KAAG,0BAAG,AACzE,sEACA,qEACA,kFACA,6DACA,uCAA2B,SAAS;AAEe,MAArD,AAAiB,6BAAI,sCAAqB,SAAS;IACrD;eA4BuB;AACrB,YAAO,AAAO,MAAD;AACqC,MAAlD,AAAiB,6BAAI,sCAAqB,MAAM;IAClD;;AAiBE,UAAI,AAAiB;AACU,QAA7B,AAAiB;;AAEO,QAAxB,AAAY;;AAEd,WAAO,AAAY;IACrB;mCAE0C,GAAW;UAAY;AAC1D,mBAAS;AACd,WAAO,AAIN;AAHe,yBAAa,AAAE,CAAD,MAAG,CAAC;AACkD,QAAlF,SAAS,AAAW,AAAQ,UAAT,iBAAe,QAAQ,aAAc,AAAU,AAAM,SAAP,WAAS,OAAO;AACjF,cAAO;;AAET,YAAO,OAAM;IACf;;AAGqB,YAAA,AAAqE,qBAApD,AAAM,wBAAU,iBAAiB,AAAM,mBAAK,SAAM;IAAE;;;IAjL/E,cAAgB;IACV,oBAAW,yBAAS;IACf,yBAAkB;;EAAE;0CAQT;IACtB,cAAE,AAAO,MAAD;IACF,oBAAE,AAAO,MAAD;IACH,yBAAE,AAAO,MAAD;;EAAiB","file":"../../../../../../../../../../packages/flutter/src/gestures/hit_test.dart.lib.js"}');
  // Exports:
  return {
