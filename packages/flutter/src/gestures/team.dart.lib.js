define(['dart_sdk', 'packages/flutter/src/gestures/arena.dart', 'packages/flutter/src/gestures/binding.dart'], (function load__packages__flutter__src__gestures__team_dart(dart_sdk, packages__flutter__src__gestures__arena$46dart, packages__flutter__src__gestures__binding$46dart) {
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/gestures/team.dart"
  ];
  ...
  team._CombiningGestureArenaMember = class _CombiningGestureArenaMember extends arena.GestureArenaMember {
    ...
    acceptGesture(pointer) {
      let t0;
      if (!(this[_pointer$] === pointer)) dart.assertFailed(null, I[1], 36, 12, "_pointer == pointer");
      if (!(this[_winner] != null || this[_members][$isNotEmpty])) dart.assertFailed(null, I[1], 37, 12, "_winner != null || _members.isNotEmpty");
      this[_close]();
      this[_winner] == null ? this[_winner] = (t0 = this[_owner$].captain, t0 == null ? this[_members][$_get](0) : t0) : null;
      for (let member of this[_members]) {
        if (!member[$_equals](this[_winner])) {
    ...
    rejectGesture(pointer) {
      if (!(this[_pointer$] === pointer)) dart.assertFailed(null, I[1], 50, 12, "_pointer == pointer");
      this[_close]();
      for (let member of this[_members]) {
        member.rejectGesture(pointer);
      }
    ...
    [_close]() {
      if (!!this[_resolved]) dart.assertFailed(null, I[1], 58, 12, "!_resolved");
      this[_resolved] = true;
      let combiner = this[_owner$][_combiners][$remove](this[_pointer$]);
      if (!dart.equals(combiner, this)) dart.assertFailed(null, I[1], 61, 12, "combiner == this");
    }
    [_add](pointer, member) {
      if (!!this[_resolved]) dart.assertFailed(null, I[1], 65, 12, "!_resolved");
      if (!(this[_pointer$] === pointer)) dart.assertFailed(null, I[1], 66, 12, "_pointer == pointer");
    ...
    [_resolve](member, disposition) {
      ...
      if (disposition === arena.GestureDisposition.rejected) {
        ...
        if (!(disposition === arena.GestureDisposition.accepted)) dart.assertFailed(null, I[1], 83, 14, "disposition == GestureDisposition.accepted");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["team.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAc2B;;;;;;;;;YAGO;AACU,MAAxC,AAAU,2BAAS,eAAS,WAAW;IACzC;;;;;;;;;;;mDARiC,WAAgB;IAAhB;IAAgB;;EAAQ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;kBAuBlC;;AACrB,YAAO,AAAS,oBAAG,OAAO;AAC1B,YAAO,AAAgB,yBAAG,AAAS;AAC3B,MAAR;AACyC,MAAjC,wBAAR,iBAA2B,KAAf,AAAO,uBAAA,aAAW,AAAQ,sBAAC,WAA/B;AACR,eAA8B,SAAU;AACtC,aAAI,MAAM,WAAI;AACiB,UAA7B,AAAO,MAAD,eAAe,OAAO;;;AAGD,MAAxB,AAAE,eAAT,6BAAuB,OAAO;IAChC;kBAGuB;AACrB,YAAO,AAAS,oBAAG,OAAO;AAClB,MAAR;AACA,eAA8B,SAAU;AACT,QAA7B,AAAO,MAAD,eAAe,OAAO;;IAEhC;;AAGE,YAAQ;AACQ,MAAhB,kBAAY;AACwB,qBAAW,AAAO,AAAW,mCAAO;AACxE,WAAgB,YAAT,QAAQ,EAAI;IACrB;WAE2B,SAA4B;AACrD,YAAQ;AACR,YAAO,AAAS,oBAAG,OAAO;AACN,MAApB,AAAS,qBAAI,MAAM;AAC+C,MAA3D,uBAAP,eAA0B,AAAS,AAAa,iDAAI,OAAO,EAAE,QAAtD;AACP,YAAO,0CAA4B,MAAM,MAAM;IACjD;eAEiC,QAA2B;;AAC1D,UAAI;AACF;;AAEF,UAAI,AAAY,WAAD,KAAuB;AACb,QAAvB,AAAS,wBAAO,MAAM;AACQ,QAA9B,AAAO,MAAD,eAAe;AACrB,YAAI,AAAS;AACiB,UAAtB,AAAE,eAAR,sBAAgB,WAAW;;;AAG7B,cAAO,AAAY,WAAD,KAAuB;AACL,QAA5B,wBAAR,iBAA2B,KAAf,AAAO,uBAAA,aAAW,MAAM,SAA5B;AACoB,QAAtB,AAAE,eAAR,sBAAgB,WAAW;;IAE/B;;oDA/DkC,QAAa;IAGhB,iBAA+B;IAGzD,kBAAY;IACG;IACD;IARe;IAAa;;EAAS;;;;;;;;;;;;;;;;;;;;;;;IAqHpC;;;;;;QASM,SAA4B;AACjB,qBAAW,AAAW,+BACvD,OAAO,EACP,cAAM,0CAA6B,MAAM,OAAO;AAElD,YAAO,AAAS,SAAD,OAAM,OAAO,EAAE,MAAM;IACtC;;;;;;IAtB6C,mBAAgD;IAOzE;;EAgBtB","file":"../../../../../../../../../../packages/flutter/src/gestures/team.dart.lib.js"}');
  // Exports:
  return {
