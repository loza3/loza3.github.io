define(['dart_sdk', 'packages/flutter/src/gestures/resampler.dart', 'packages/flutter/src/scheduler/binding.dart', 'packages/flutter/src/gestures/debug.dart', 'packages/flutter/src/foundation/print.dart', 'packages/flutter/src/gestures/events.dart', 'packages/flutter/src/gestures/pointer_router.dart', 'packages/flutter/src/gestures/arena.dart', 'packages/flutter/src/gestures/pointer_signal_resolver.dart', 'packages/flutter/src/gestures/hit_test.dart', 'packages/flutter/src/foundation/binding.dart', 'packages/flutter/src/gestures/converter.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__gestures__binding_dart(dart_sdk, packages__flutter__src__gestures__resampler$46dart, packages__flutter__src__scheduler__binding$46dart, packages__flutter__src__gestures__debug$46dart, packages__flutter__src__foundation__print$46dart, packages__flutter__src__gestures__events$46dart, packages__flutter__src__gestures__pointer_router$46dart, packages__flutter__src__gestures__arena$46dart, packages__flutter__src__gestures__pointer_signal_resolver$46dart, packages__flutter__src__gestures__hit_test$46dart, packages__flutter__src__foundation__binding$46dart, packages__flutter__src__gestures__converter$46dart, packages__flutter__src__foundation__debug$46dart) {
  'use strict';
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/gestures/binding.dart"
  ];
  ...
  binding$0._Resampler = class _Resampler extends core.Object {
    ...
    addOrDispatch(event) {
      ...
      if (!(scheduler !== null)) dart.assertFailed(null, I[1], 87, 12, "scheduler != null");
    ...
    sample(samplingOffset, clock) {
      let t0, t0$;
      let scheduler = binding.SchedulerBinding.instance;
      if (!(scheduler !== null)) dart.assertFailed(null, I[1], 111, 12, "scheduler != null");
  ...
  binding$0.GestureBinding = class GestureBinding extends binding$.BindingBase {
    static get instance() {
      return binding$.BindingBase.checkInstance(binding$0.GestureBinding, binding$0.GestureBinding._instance);
    }
  };
  binding$0.GestureBinding[dart.mixinOn] = BindingBase => class GestureBinding extends BindingBase {
    ...
    [_flushPointerEventQueue]() {
      if (!!this.locked) dart.assertFailed(null, I[1], 311, 12, "!locked");
      while (this[_pendingPointerEvents][$isNotEmpty]) {
        this.handlePointerEvent(this[_pendingPointerEvents].removeFirst());
      }
    }
    handlePointerEvent(event) {
      if (!!this.locked) dart.assertFailed(null, I[1], 346, 12, "!locked");
    ...
    [_handlePointerEventImmediately](event) {
      ...
      if (events.PointerDownEvent.is(event) || events.PointerSignalEvent.is(event) || events.PointerHoverEvent.is(event) || events.PointerPanZoomStartEvent.is(event)) {
        if (!!this[_hitTests][$containsKey](event.pointer)) dart.assertFailed(null, I[1], 363, 14, "!_hitTests.containsKey(event.pointer)");
        hitTestResult = new hit_test.HitTestResult.new();
        this.hitTest(hitTestResult, event.position);
        if (events.PointerDownEvent.is(event) || events.PointerPanZoomStartEvent.is(event)) {
          this[_hitTests][$_set](event.pointer, hitTestResult);
        }
        if (!dart.fn(() => {
          if (debug.debugPrintHitTestResults) {
            print.debugPrint(dart.str(event) + ": " + dart.str(hitTestResult));
          }
          return true;
        }, T.VoidTobool())()) dart.assertFailed(null, I[1], 369, 14, "() {\n        if (debugPrintHitTestResults) {\n          debugPrint('$event: $hitTestResult');\n        }\n        return true;\n      }()");
      } else if (events.PointerUpEvent.is(event) || events.PointerCancelEvent.is(event) || events.PointerPanZoomEndEvent.is(event)) {
        hitTestResult = this[_hitTests][$remove](event.pointer);
      } else if (event.down || events.PointerPanZoomUpdateEvent.is(event)) {
        hitTestResult = this[_hitTests][$_get](event.pointer);
      }
      if (!dart.fn(() => {
        if (debug.debugPrintMouseHoverEvents && events.PointerHoverEvent.is(event)) {
      ...
      if (hitTestResult != null || events.PointerAddedEvent.is(event) || events.PointerRemovedEvent.is(event)) {
        if (!(event.position !== null)) dart.assertFailed(null, I[1], 394, 14, "event.position != null");
    ...
    dispatchEvent(event, hitTestResult) {
      if (!!this.locked) dart.assertFailed(null, I[1], 416, 12, "!locked");
      if (hitTestResult == null) {
        if (!(events.PointerAddedEvent.is(event) || events.PointerRemovedEvent.is(event))) dart.assertFailed(null, I[1], 421, 14, "event is PointerAddedEvent || event is PointerRemovedEvent");
        try {
          ...
          if (core.Object.is(exception)) {
            assertions.FlutterError.reportError(new binding$0.FlutterErrorDetailsForPointerEventDispatcher.new({exception: exception, stack: stack, library: "gesture library", context: new assertions.ErrorDescription.new("while dispatching a non-hit-tested pointer event"), event: event, informationCollector: dart.fn(() => T.JSArrayOfDiagnosticsNode().of([new (T.DiagnosticsPropertyOfPointerEvent()).new("Event", event, {style: diagnostics.DiagnosticsTreeStyle.errorProperty})]), T.VoidToListOfDiagnosticsNode())}));
          } else
            throw e;
        }
        return;
      ...
      for (let entry of hitTestResult.path) {
        try {
          ...
          let stack = dart.stackTrace(e$);
          if (core.Object.is(exception)) {
            assertions.FlutterError.reportError(new binding$0.FlutterErrorDetailsForPointerEventDispatcher.new({exception: exception, stack: stack, library: "gesture library", context: new assertions.ErrorDescription.new("while dispatching a pointer event"), event: event, hitTestEntry: entry, informationCollector: dart.fn(() => T.JSArrayOfDiagnosticsNode().of([new (T.DiagnosticsPropertyOfPointerEvent()).new("Event", event, {style: diagnostics.DiagnosticsTreeStyle.errorProperty}), new (T.DiagnosticsPropertyOfHitTestTarget()).new("Target", entry.target, {style: diagnostics.DiagnosticsTreeStyle.errorProperty})]), T.VoidToListOfDiagnosticsNode())}));
          } else
            throw e$;
        }
      }
    ...
    handleEvent(event, entry) {
      ...
      } else if (events.PointerUpEvent.is(event) || events.PointerPanZoomEndEvent.is(event)) {
  ...
  dart.setFieldSignature(binding$0.FlutterErrorDetailsForPointerEventDispatcher, () => ({
    ...
    hitTestEntry: dart.finalFieldType(dart.nullable(hit_test.HitTestEntry$(hit_test.HitTestTarget)))
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["binding.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAoCoB,YAAS;IAAK;;AAGP;IAAW;;;;;;;EACtC;;;;;;;;;;;;;;;;;;;;;;;;kBA4CkC;;AACP,sBAA6B;AACpD,YAAO,AAAU,SAAD;AAEhB,UAAI,AAAM,AAAK,KAAN,UAA2B;AAEF,QAAhC,uBAAiB,AAAM,KAAD;AAEM,wBAAY,AAAY,gCAClD,AAAM,KAAD,SACL,cAAM;AAEiB,QAAzB,AAAU,SAAD,UAAU,KAAK;;AAEE,aAAN,KAAK;QAAzB,AAAmB;;IAEvB;WAQqB,gBAA8B;;AAC1B,sBAA6B;AACpD,YAAO,AAAU,SAAD;AAIhB,UAAI,AAAW,yBAAY;AAC8C,QAAvE,mBAAa,qCAAuB,AAAM,AAAM,KAAP;AACC,QAA1C,4BAAgB,AAAM,KAAD,cAAC;AAAa;;;;AAIrC,6CAAI,OAAQ,kBAAY;AACmD,QAAzE,eAAe,qBAAS,0BAAmB,QAAC,KAAM;;AAO1C,+BAAqB,AAAkB;AACvC,6BAAqD,CAAlC,AAAc,0CAAuB,kBAAkB;AAC1E,sBAAY,AAAiB,gBAAD,GAAG,kBAAkB;AAC5C,sBAAY,AAAW,sBAAE,qCAAuB,SAAS;AAMzD,uBAAa,AAAU,SAAD,MAAG,cAAc;AAIvC,2BAAiB,AAAW,UAAD,MAAG;AAI7C,eAAiC,YAAa,AAAY;AACS,QAAjE,AAAU,SAAD,QAAQ,UAAU,EAAE,cAAc,EAAE;;AAM7C,MAFF,AAAY,gCAAY,SAAK,KAA2B,cACnB,CAA3B,AAAU,SAAD,sBAAsB,AAAU,SAAD;AAItB,MAA5B,wBAAkB,UAAU;AAG5B,UAAI,AAAY;AACE,QAAV,AAAE,eAAR;AACA;;AAIF,WAAK;AAC2B,QAA9B,gCAA0B;AAgBxB,QAZF,AAAU,SAAD,sBAAsB,QAAC;;AACC,UAA/B,gCAA0B;AAIwB,UAAlD,mBAAa,AAAU,SAAD;AACD,UAArB,AAAc;AAEE,eAAhB;8BAAQ;AACiE,UAAzE,eAAe,qBAAS,0BAAmB,QAAC,KAAM;AAE5B,UAAtB;;;IAGN;;;AAIE,eAAiC,YAAa,AAAY;AACrB,QAAnC,AAAU,SAAD,MAAM;;AAEE,MAAnB,AAAY;AACc,MAA1B,mBAAsB;AACN,WAAhB;0BAAQ;IACV;;AAGE,WAAO,AAMN;AALC,YAAI;AACa,iCAAmB,AAAe,0BAAE;AACpB,UAA/B,AAAU,iBAAoB,SAAjB,gBAAgB;;AAE/B,cAAO;;AAEiB,MAA1B,AAAwB;IAC1B;;uCA1JgB,qBAA0B,0BAA+B;IAGnC,oBAA0C;IAG3E,gCAA0B;IAGtB,mBAAsB;IAGrB,sBAAgB;IAKjB,wBAA2B;IAC3B,uBAA0B;IAY5B;IA9BS;IAA0B;IAA+B;;EAAkB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAoOrD,YAAY,8DAAc;IAAU;;;IAwCtD;;;;;;IAIM;;;;;;IAIE;;;;;;IAyMvB;;;;;;IAMI;;;;;;;AAzQc,MAAf;AACU,MAAhB,qCAAY;AACqD,MAAjE,AAAmB,wDAAsB;IAC3C;;AAYkB,MAAV;AACmB,MAAzB;IACF;+BAImD;AAG+C,MAAhG,AAAsB,mCAA6B,uCAAO,AAAO,MAAD,OAAO,AAAO;AAC9E,WAAK;AACsB,QAAzB;;IAEJ;kBAMuB;AACrB,UAAI,AAAsB,0CAAY;AACM,QAA1C,kCAAkB;;AAEgD,MAApE,AAAsB,qCAAS,4CAA4B,OAAO;IACpE;;AAGE,YAAQ;AAER,aAAO,AAAsB;AAC4B,QAAvD,wBAAmB,AAAsB;;IAE7C;uBA6BqC;AACnC,YAAQ;AAER,UAAI;AAC6B,QAA/B,AAAW,+BAAc,KAAK;AACmB,QAAjD,AAAW,wBAAO,qBAAgB;AAClC;;AAKe,MAAjB,AAAW;AAC0B,MAArC,qCAA+B,KAAK;IACtC;qCAEiD;AAChC;AACf,UAAU,2BAAN,KAAK,KAA8B,6BAAN,KAAK,KAAgC,4BAAN,KAAK,KAA+B,mCAAN,KAAK;AACjG,cAAQ,AAAU,8BAAY,AAAM,KAAD;AACJ,QAA/B,gBAAgB;AACsB,QAAtC,aAAQ,aAAa,EAAE,AAAM,KAAD;AAC5B,YAAU,2BAAN,KAAK,KAA8B,mCAAN,KAAK;AACI,UAAxC,AAAS,uBAAC,AAAM,KAAD,UAAY,aAAa;;AAE1C,aAAO,AAKN;AAJC,cAAI;AACkC,YAApC,AAAU,iBAAyB,SAAtB,KAAK,oBAAG,aAAa;;AAEpC,gBAAO;;YAEJ,KAAU,yBAAN,KAAK,KAA4B,6BAAN,KAAK,KAAgC,iCAAN,KAAK;AACzB,QAA/C,gBAAgB,AAAU,yBAAO,AAAM,KAAD;YACjC,KAAI,AAAM,KAAD,SAAe,oCAAN,KAAK;AAMY,QAAxC,gBAAgB,AAAS,uBAAC,AAAM,KAAD;;AAEjC,WAAO,AAKN;AAJC,YAAI,oCAAoC,4BAAN,KAAK;AACjB,UAApB,AAAU,iBAAS,SAAN,KAAK;;AAEpB,cAAO;;AAET,UAAI,aAAa,YACP,4BAAN,KAAK,KACC,8BAAN,KAAK;AACP,cAAO,AAAM,AAAS,KAAV;AACuB,QAAnC,mBAAc,KAAK,EAAE,aAAa;;IAEtC;YAI2B,QAAe;AACV,MAA9B,AAAO,MAAD,KAAK,0CAAa;IAC1B;kBAYgC,OAAsB;AACpD,YAAQ;AAIR,UAAI,AAAc,aAAD;AACf,cAAa,AAAqB,4BAA3B,KAAK,KAA+B,8BAAN,KAAK;AAC1C;AAC4B,UAA1B,AAAc,yBAAM,KAAK;;cAClB;cAAW;AAAlB;AAUE,YATW,oCAAY,2EACZ,SAAS,SACb,KAAK,WACH,4BACA,oCAAiB,4DACnB,KAAK,wBACU,cAAuB,iCAC3C,gDAAkC,SAAS,KAAK,UAA8B;;;;AAIpF;;AAEF,eAAwB,QAAS,AAAc,cAAD;AAC5C;AACqE,UAAnE,AAAM,AAAO,KAAR,oBAAoB,AAAM,KAAD,aAAa,AAAM,KAAD,aAAa,KAAK;;cAC3D;cAAW;AAAlB;AAYE,YAXW,oCAAY,2EACZ,SAAS,SACb,KAAK,WACH,4BACA,oCAAiB,6CACnB,KAAK,gBACE,KAAK,wBACG,cAAuB,iCAC3C,gDAAkC,SAAS,KAAK,UAA8B,kDAC9E,iDAAmC,UAAU,AAAM,KAAD,iBAAqC;;;;;IAKjG;gBAG8B,OAAoB;AACtB,MAA1B,AAAc,yBAAM,KAAK;AACzB,UAAU,2BAAN,KAAK,KAA8B,mCAAN,KAAK;AACH,QAAjC,AAAa,wBAAM,AAAM,KAAD;YACnB,KAAU,yBAAN,KAAK,KAA4B,iCAAN,KAAK;AACR,QAAjC,AAAa,wBAAM,AAAM,KAAD;YACnB,KAAU,6BAAN,KAAK;AACsB,QAApC,AAAsB,mCAAQ,KAAK;;IAEvC;;AASmB,MAAjB,AAAU;IACZ;;AAMyC;IAAI;;AAG3C,WAAK;AACH,YAAI;AAC+C,UAAjD,AAAW,wBAAO,qBAAgB;;AAGjB,UAAjB,AAAW;;;IAGjB;;AAGgB,kBAAQ;AACtB,WAAO,AAMN;AALsB,yBAAa;AAClC,YAAI,UAAU;AACM,UAAlB,QAAQ,UAAU;;AAEpB,cAAO;;AAET,YAAO,MAAK;IACd;;;AAIsB;gCAAa,uCACjC,iDACA,kCACA,+JAHoB;IAIrB;;;IAnOyB,8BAAwB;IA+B9B,sBAAgB;IAIV,qBAAe;IAIb,8BAAwB;IAMtB,kBAAgC;wCAkLxC;IAiBjB,0BAAoB;IAMhB,uBAAiB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA9PH,kCAAS;;;;;;;;IAqRZ;;;;;;IASA;;;;;;;;;;;;;;;;;;;QApBH;QACT;QACA;QACA;QACD;QACA;QACC;QACA;IAHD;IACA;AAND,gGACW,SAAS,SAClB,KAAK,WACL,OAAO,WACP,OAAO,wBAGP,oBAAoB,UACpB,MAAM;;EACZ;;;;;;;;;;;MApVW,gCAAsB;;;MAQtB,2BAAiB","file":"../../../../../../../../../../packages/flutter/src/gestures/binding.dart.lib.js"}');
  // Exports:
  return {
