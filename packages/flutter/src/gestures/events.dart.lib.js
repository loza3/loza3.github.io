define(['dart_sdk', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__gestures__events_dart(dart_sdk, packages__vector_math__vector_math_64$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  var T = {
    ...
    PointerPanZoomStartEventN: () => (T.PointerPanZoomStartEventN = dart.constFn(dart.nullable(events.PointerPanZoomStartEvent)))(),
    PointerPanZoomUpdateEventN: () => (T.PointerPanZoomUpdateEventN = dart.constFn(dart.nullable(events.PointerPanZoomUpdateEvent)))(),
    PointerPanZoomEndEventN: () => (T.PointerPanZoomEndEventN = dart.constFn(dart.nullable(events.PointerPanZoomEndEvent)))(),
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/gestures/events.dart"
  ];
  ...
  (events.PointerAddedEvent.new = function(opts) {
    ...
    let tilt = opts && 'tilt' in opts ? opts.tilt : 0;
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    events.PointerAddedEvent.__proto__.new.call(this, {pressure: 0.0, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, obscured: obscured, pressureMin: pressureMin, pressureMax: pressureMax, distance: distance, distanceMax: distanceMax, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, embedderId: embedderId});
    ;
  ...
  (events._TransformedPointerAddedEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 846, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 846, 40, "transform != null");
  ...
  (events.PointerRemovedEvent.new = function(opts) {
    ...
    let original = opts && 'original' in opts ? opts.original : null;
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    events.PointerRemovedEvent.__proto__.new.call(this, {pressure: 0.0, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, obscured: obscured, pressureMin: pressureMin, pressureMax: pressureMax, distanceMax: distanceMax, radiusMin: radiusMin, radiusMax: radiusMax, original: original, embedderId: embedderId});
    ;
  ...
  (events._TransformedPointerRemovedEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 937, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 937, 40, "transform != null");
  ...
  (events.PointerHoverEvent.new = function(opts) {
    ...
    let synthesized = opts && 'synthesized' in opts ? opts.synthesized : false;
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    events.PointerHoverEvent.__proto__.new.call(this, {down: false, pressure: 0.0, timeStamp: timeStamp, kind: kind, pointer: pointer, device: device, position: position, delta: delta, buttons: buttons, obscured: obscured, pressureMin: pressureMin, pressureMax: pressureMax, distance: distance, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, synthesized: synthesized, embedderId: embedderId});
    ;
  ...
  (events._TransformedPointerHoverEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 1054, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 1054, 40, "transform != null");
  ...
  (events.PointerEnterEvent.new = function(opts) {
    ...
    let synthesized = opts && 'synthesized' in opts ? opts.synthesized : false;
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    events.PointerEnterEvent.__proto__.new.call(this, {pressure: 0.0, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, delta: delta, buttons: buttons, obscured: obscured, pressureMin: pressureMin, pressureMax: pressureMax, distance: distance, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, down: down, synthesized: synthesized, embedderId: embedderId});
    ;
  ...
  (events._TransformedPointerEnterEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 1198, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 1198, 40, "transform != null");
  ...
  (events.PointerExitEvent.new = function(opts) {
    ...
    let synthesized = opts && 'synthesized' in opts ? opts.synthesized : false;
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    events.PointerExitEvent.__proto__.new.call(this, {pressure: 0.0, timeStamp: timeStamp, kind: kind, pointer: pointer, device: device, position: position, delta: delta, buttons: buttons, obscured: obscured, pressureMin: pressureMin, pressureMax: pressureMax, distance: distance, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, down: down, synthesized: synthesized, embedderId: embedderId});
    ;
  ...
  (events._TransformedPointerExitEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 1343, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 1343, 40, "transform != null");
  ...
  (events.PointerDownEvent.new = function(opts) {
    ...
    let tilt = opts && 'tilt' in opts ? opts.tilt : 0;
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    events.PointerDownEvent.__proto__.new.call(this, {down: true, distance: 0.0, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, buttons: buttons, obscured: obscured, pressure: pressure, pressureMin: pressureMin, pressureMax: pressureMax, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, embedderId: embedderId});
    ;
  ...
  (events._TransformedPointerDownEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 1451, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 1451, 40, "transform != null");
  ...
  events.PointerMoveEvent = class PointerMoveEvent extends PointerEvent__CopyPointerMoveEvent$36 {
    static ['_#new#tearOff'](opts) {
      ...
      let orientation = opts && 'orientation' in opts ? opts.orientation : null;
      let tilt = opts && 'tilt' in opts ? opts.tilt : null;
      let platformData = opts && 'platformData' in opts ? opts.platformData : null;
      let synthesized = opts && 'synthesized' in opts ? opts.synthesized : null;
      let embedderId = opts && 'embedderId' in opts ? opts.embedderId : null;
  ...
  (events.PointerMoveEvent.new = function(opts) {
    ...
    let synthesized = opts && 'synthesized' in opts ? opts.synthesized : false;
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    events.PointerMoveEvent.__proto__.new.call(this, {down: true, distance: 0.0, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, delta: delta, buttons: buttons, obscured: obscured, pressure: pressure, pressureMin: pressureMin, pressureMax: pressureMax, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, platformData: platformData, synthesized: synthesized, embedderId: embedderId});
    ;
  ...
  (events._TransformedPointerMoveEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 1568, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 1568, 40, "transform != null");
  ...
  (events.PointerUpEvent.new = function(opts) {
    ...
    let tilt = opts && 'tilt' in opts ? opts.tilt : 0;
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    events.PointerUpEvent.__proto__.new.call(this, {down: false, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, buttons: buttons, obscured: obscured, pressure: pressure, pressureMin: pressureMin, pressureMax: pressureMax, distance: distance, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, embedderId: embedderId});
    ;
  ...
  (events._TransformedPointerUpEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 1680, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 1680, 40, "transform != null");
  ...
  (events.PointerScrollEvent.new = function(opts) {
    ...
    if (!(timeStamp !== null)) dart.assertFailed(null, I[1], 1779, 15, "timeStamp != null");
    if (!(kind !== null)) dart.assertFailed(null, I[1], 1780, 15, "kind != null");
    if (!(device !== null)) dart.assertFailed(null, I[1], 1781, 15, "device != null");
    if (!(position !== null)) dart.assertFailed(null, I[1], 1782, 15, "position != null");
    if (!(scrollDelta !== null)) dart.assertFailed(null, I[1], 1783, 15, "scrollDelta != null");
  ...
  (events._TransformedPointerScrollEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 1805, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 1805, 40, "transform != null");
  ...
  events._CopyPointerPanZoomStartEvent[dart.mixinOn] = PointerEvent => class _CopyPointerPanZoomStartEvent extends PointerEvent {
    copyWith(opts) {
      ...
      let synthesized = opts && 'synthesized' in opts ? opts.synthesized : null;
      let embedderId = opts && 'embedderId' in opts ? opts.embedderId : null;
      return new events.PointerPanZoomStartEvent.new({timeStamp: (t0 = timeStamp, t0 == null ? this.timeStamp : t0), kind: (t0$ = kind, t0$ == null ? this.kind : t0$), device: (t0$0 = device, t0$0 == null ? this.device : t0$0), position: (t0$1 = position, t0$1 == null ? this.position : t0$1), embedderId: (t0$2 = embedderId, t0$2 == null ? this.embedderId : t0$2)}).transformed(this.transform);
    }
  };
  dart.addTypeTests(events._CopyPointerPanZoomStartEvent);
  dart.addTypeCaches(events._CopyPointerPanZoomStartEvent);
  events._CopyPointerPanZoomStartEvent[dart.implements] = () => [events.PointerEvent];
  dart.setMethodSignature(events._CopyPointerPanZoomStartEvent, () => ({
    __proto__: dart.getMethods(events._CopyPointerPanZoomStartEvent.__proto__),
    copyWith: dart.fnType(events.PointerPanZoomStartEvent, [], {buttons: dart.nullable(core.int), delta: dart.nullable(ui.Offset), device: dart.nullable(core.int), distance: dart.nullable(core.double), distanceMax: dart.nullable(core.double), embedderId: dart.nullable(core.int), kind: dart.nullable(ui.PointerDeviceKind), obscured: dart.nullable(core.bool), orientation: dart.nullable(core.double), pointer: dart.nullable(core.int), position: dart.nullable(ui.Offset), pressure: dart.nullable(core.double), pressureMax: dart.nullable(core.double), pressureMin: dart.nullable(core.double), radiusMajor: dart.nullable(core.double), radiusMax: dart.nullable(core.double), radiusMin: dart.nullable(core.double), radiusMinor: dart.nullable(core.double), size: dart.nullable(core.double), synthesized: dart.nullable(core.bool), tilt: dart.nullable(core.double), timeStamp: dart.nullable(core.Duration)}, {})
  }));
  ...
  (PointerEvent__CopyPointerPanZoomStartEvent$36.new = function(opts) {
    PointerEvent__CopyPointerPanZoomStartEvent$36.__proto__.new.call(this, opts);
  ...
  events.PointerPanZoomStartEvent = class PointerPanZoomStartEvent extends PointerEvent__CopyPointerPanZoomStartEvent$36 {
    static ['_#new#tearOff'](opts) {
      ...
      let embedderId = opts && 'embedderId' in opts ? opts.embedderId : null;
      let synthesized = opts && 'synthesized' in opts ? opts.synthesized : null;
      return new events.PointerPanZoomStartEvent.new({timeStamp: timeStamp, kind: kind, device: device, pointer: pointer, position: position, embedderId: embedderId, synthesized: synthesized});
    }
    transformed(transform) {
      let t0;
      if (transform == null || dart.equals(transform, this.transform)) {
      ...
      return new events._TransformedPointerPanZoomStartEvent.new((t0 = T.PointerPanZoomStartEventN().as(this.original), t0 == null ? this : t0), transform);
    }
  };
  (events.PointerPanZoomStartEvent.new = function(opts) {
    ...
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    let synthesized = opts && 'synthesized' in opts ? opts.synthesized : false;
    if (!(timeStamp !== null)) dart.assertFailed(null, I[1], 1880, 15, "timeStamp != null");
    if (!(kind !== null)) dart.assertFailed(null, I[1], 1881, 15, "kind != null");
    if (!(device !== null)) dart.assertFailed(null, I[1], 1882, 15, "device != null");
    if (!(pointer !== null)) dart.assertFailed(null, I[1], 1883, 15, "pointer != null");
    if (!(position !== null)) dart.assertFailed(null, I[1], 1884, 15, "position != null");
    if (!(embedderId !== null)) dart.assertFailed(null, I[1], 1885, 15, "embedderId != null");
    if (!(synthesized !== null)) dart.assertFailed(null, I[1], 1886, 15, "synthesized != null");
    events.PointerPanZoomStartEvent.__proto__.new.call(this, {timeStamp: timeStamp, kind: kind, device: device, pointer: pointer, position: position, embedderId: embedderId, synthesized: synthesized});
    ;
  ...
  dart.setMethodSignature(events.PointerPanZoomStartEvent, () => ({
    __proto__: dart.getMethods(events.PointerPanZoomStartEvent.__proto__),
    transformed: dart.fnType(events.PointerPanZoomStartEvent, [dart.nullable(vector_math_64.Matrix4)])
  }));
  dart.setLibraryUri(events.PointerPanZoomStartEvent, I[0]);
  var original$9 = dart.privateName(events, "_TransformedPointerPanZoomStartEvent.original");
  var transform$9 = dart.privateName(events, "_TransformedPointerPanZoomStartEvent.transform");
  ...
  (_TransformedPointerEvent__CopyPointerPanZoomStartEvent$36.new = function() {
    _TransformedPointerEvent__CopyPointerPanZoomStartEvent$36.__proto__.new.call(this);
  ...
  (events._TransformedPointerPanZoomStartEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 1899, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 1899, 40, "transform != null");
    events._TransformedPointerPanZoomStartEvent.__proto__.new.call(this);
    ;
  ...
  events._TransformedPointerPanZoomStartEvent[dart.implements] = () => [events.PointerPanZoomStartEvent];
  dart.setMethodSignature(events._TransformedPointerPanZoomStartEvent, () => ({
    __proto__: dart.getMethods(events._TransformedPointerPanZoomStartEvent.__proto__),
    transformed: dart.fnType(events.PointerPanZoomStartEvent, [dart.nullable(vector_math_64.Matrix4)])
  }));
  dart.setLibraryUri(events._TransformedPointerPanZoomStartEvent, I[0]);
  dart.setFieldSignature(events._TransformedPointerPanZoomStartEvent, () => ({
    __proto__: dart.getFields(events._TransformedPointerPanZoomStartEvent.__proto__),
    original: dart.finalFieldType(events.PointerPanZoomStartEvent),
    transform: dart.finalFieldType(vector_math_64.Matrix4)
  }));
  ...
  events._CopyPointerPanZoomUpdateEvent[dart.mixinOn] = PointerEvent => class _CopyPointerPanZoomUpdateEvent extends PointerEvent {
    copyWith(opts) {
      ...
      return new events.PointerPanZoomUpdateEvent.new({timeStamp: (t0 = timeStamp, t0 == null ? this.timeStamp : t0), kind: (t0$ = kind, t0$ == null ? this.kind : t0$), device: (t0$0 = device, t0$0 == null ? this.device : t0$0), position: (t0$1 = position, t0$1 == null ? this.position : t0$1), embedderId: (t0$2 = embedderId, t0$2 == null ? this.embedderId : t0$2), pan: (t0$3 = pan, t0$3 == null ? this.pan : t0$3), panDelta: (t0$4 = panDelta, t0$4 == null ? this.panDelta : t0$4), scale: (t0$5 = scale, t0$5 == null ? this.scale : t0$5), rotation: (t0$6 = rotation, t0$6 == null ? this.rotation : t0$6)}).transformed(this.transform);
    }
  };
  dart.addTypeTests(events._CopyPointerPanZoomUpdateEvent);
  dart.addTypeCaches(events._CopyPointerPanZoomUpdateEvent);
  events._CopyPointerPanZoomUpdateEvent[dart.implements] = () => [events.PointerEvent];
  dart.setMethodSignature(events._CopyPointerPanZoomUpdateEvent, () => ({
    __proto__: dart.getMethods(events._CopyPointerPanZoomUpdateEvent.__proto__),
    copyWith: dart.fnType(events.PointerPanZoomUpdateEvent, [], {buttons: dart.nullable(core.int), delta: dart.nullable(ui.Offset), device: dart.nullable(core.int), distance: dart.nullable(core.double), distanceMax: dart.nullable(core.double), embedderId: dart.nullable(core.int), kind: dart.nullable(ui.PointerDeviceKind), localPan: dart.nullable(ui.Offset), localPanDelta: dart.nullable(ui.Offset), obscured: dart.nullable(core.bool), orientation: dart.nullable(core.double), pan: dart.nullable(ui.Offset), panDelta: dart.nullable(ui.Offset), pointer: dart.nullable(core.int), position: dart.nullable(ui.Offset), pressure: dart.nullable(core.double), pressureMax: dart.nullable(core.double), pressureMin: dart.nullable(core.double), radiusMajor: dart.nullable(core.double), radiusMax: dart.nullable(core.double), radiusMin: dart.nullable(core.double), radiusMinor: dart.nullable(core.double), rotation: dart.nullable(core.double), scale: dart.nullable(core.double), size: dart.nullable(core.double), synthesized: dart.nullable(core.bool), tilt: dart.nullable(core.double), timeStamp: dart.nullable(core.Duration)}, {})
  }));
  ...
  var scale$ = dart.privateName(events, "PointerPanZoomUpdateEvent.scale");
  ...
  (PointerEvent__PointerEventDescription$36$7.new = function(opts) {
    PointerEvent__PointerEventDescription$36$7.__proto__.new.call(this, opts);
  ...
  (PointerEvent__CopyPointerPanZoomUpdateEvent$36.new = function(opts) {
    PointerEvent__CopyPointerPanZoomUpdateEvent$36.__proto__.new.call(this, opts);
  ...
  events.PointerPanZoomUpdateEvent = class PointerPanZoomUpdateEvent extends PointerEvent__CopyPointerPanZoomUpdateEvent$36 {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      let synthesized = opts && 'synthesized' in opts ? opts.synthesized : null;
      return new events.PointerPanZoomUpdateEvent.new({timeStamp: timeStamp, kind: kind, device: device, pointer: pointer, position: position, embedderId: embedderId, pan: pan, panDelta: panDelta, scale: scale, rotation: rotation, synthesized: synthesized});
    }
    get localPan() {
      return this.pan;
    }
    ...
    transformed(transform) {
      ...
      return new events._TransformedPointerPanZoomUpdateEvent.new((t0 = T.PointerPanZoomUpdateEventN().as(this.original), t0 == null ? this : t0), transform);
    }
  };
  (events.PointerPanZoomUpdateEvent.new = function(opts) {
    ...
    if (!(timeStamp !== null)) dart.assertFailed(null, I[1], 1992, 15, "timeStamp != null");
    if (!(kind !== null)) dart.assertFailed(null, I[1], 1993, 15, "kind != null");
    if (!(device !== null)) dart.assertFailed(null, I[1], 1994, 15, "device != null");
    if (!(pointer !== null)) dart.assertFailed(null, I[1], 1995, 15, "pointer != null");
    if (!(position !== null)) dart.assertFailed(null, I[1], 1996, 15, "position != null");
    if (!(embedderId !== null)) dart.assertFailed(null, I[1], 1997, 15, "embedderId != null");
    if (!(pan !== null)) dart.assertFailed(null, I[1], 1998, 15, "pan != null");
    if (!(panDelta !== null)) dart.assertFailed(null, I[1], 1999, 15, "panDelta != null");
    if (!(scale !== null)) dart.assertFailed(null, I[1], 2000, 15, "scale != null");
    if (!(rotation !== null)) dart.assertFailed(null, I[1], 2001, 15, "rotation != null");
    if (!(synthesized !== null)) dart.assertFailed(null, I[1], 2002, 15, "synthesized != null");
    events.PointerPanZoomUpdateEvent.__proto__.new.call(this, {timeStamp: timeStamp, kind: kind, device: device, pointer: pointer, position: position, embedderId: embedderId, synthesized: synthesized});
    ;
  ...
  dart.setMethodSignature(events.PointerPanZoomUpdateEvent, () => ({
    __proto__: dart.getMethods(events.PointerPanZoomUpdateEvent.__proto__),
    transformed: dart.fnType(events.PointerPanZoomUpdateEvent, [dart.nullable(vector_math_64.Matrix4)])
  }));
  dart.setGetterSignature(events.PointerPanZoomUpdateEvent, () => ({
    __proto__: dart.getGetters(events.PointerPanZoomUpdateEvent.__proto__),
    localPan: ui.Offset,
    localPanDelta: ui.Offset
  }));
  dart.setLibraryUri(events.PointerPanZoomUpdateEvent, I[0]);
  dart.setFieldSignature(events.PointerPanZoomUpdateEvent, () => ({
    __proto__: dart.getFields(events.PointerPanZoomUpdateEvent.__proto__),
    pan: dart.finalFieldType(ui.Offset),
    panDelta: dart.finalFieldType(ui.Offset),
    scale: dart.finalFieldType(core.double),
    rotation: dart.finalFieldType(core.double)
  }));
  var original$10 = dart.privateName(events, "_TransformedPointerPanZoomUpdateEvent.original");
  var transform$10 = dart.privateName(events, "_TransformedPointerPanZoomUpdateEvent.transform");
  ...
  (_TransformedPointerEvent__CopyPointerPanZoomUpdateEvent$36.new = function() {
    _TransformedPointerEvent__CopyPointerPanZoomUpdateEvent$36.__proto__.new.call(this);
  ...
  events._TransformedPointerPanZoomUpdateEvent = class _TransformedPointerPanZoomUpdateEvent extends _TransformedPointerEvent__CopyPointerPanZoomUpdateEvent$36 {
    ...
    get localPan() {
      let t1, t0;
      t0 = this[___TransformedPointerPanZoomUpdateEvent_localPan];
      return t0 == null ? (t1 = events.PointerEvent.transformPosition(this.transform, this.pan), this[___TransformedPointerPanZoomUpdateEvent_localPan] == null ? this[___TransformedPointerPanZoomUpdateEvent_localPan] = t1 : dart.throw(new _internal.LateError.fieldADI("localPan"))) : t0;
    }
    get panDelta() {
    ...
    get localPanDelta() {
      let t1, t0;
      t0 = this[___TransformedPointerPanZoomUpdateEvent_localPanDelta];
      return t0 == null ? (t1 = events.PointerEvent.transformDeltaViaPositions({transform: this.transform, untransformedDelta: this.panDelta, untransformedEndPosition: this.pan, transformedEndPosition: this.localPan}), this[___TransformedPointerPanZoomUpdateEvent_localPanDelta] == null ? this[___TransformedPointerPanZoomUpdateEvent_localPanDelta] = t1 : dart.throw(new _internal.LateError.fieldADI("localPanDelta"))) : t0;
    }
    get scale() {
  ...
  (events._TransformedPointerPanZoomUpdateEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 2027, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 2027, 40, "transform != null");
    events._TransformedPointerPanZoomUpdateEvent.__proto__.new.call(this);
    ;
  ...
  events._TransformedPointerPanZoomUpdateEvent[dart.implements] = () => [events.PointerPanZoomUpdateEvent];
  dart.setMethodSignature(events._TransformedPointerPanZoomUpdateEvent, () => ({
    __proto__: dart.getMethods(events._TransformedPointerPanZoomUpdateEvent.__proto__),
    transformed: dart.fnType(events.PointerPanZoomUpdateEvent, [dart.nullable(vector_math_64.Matrix4)])
  }));
  dart.setGetterSignature(events._TransformedPointerPanZoomUpdateEvent, () => ({
    __proto__: dart.getGetters(events._TransformedPointerPanZoomUpdateEvent.__proto__),
    pan: ui.Offset,
    localPan: ui.Offset,
    panDelta: ui.Offset,
    localPanDelta: ui.Offset,
  ...
  dart.setFieldSignature(events._TransformedPointerPanZoomUpdateEvent, () => ({
    __proto__: dart.getFields(events._TransformedPointerPanZoomUpdateEvent.__proto__),
    [___TransformedPointerPanZoomUpdateEvent_localPan]: dart.fieldType(dart.nullable(ui.Offset)),
    [___TransformedPointerPanZoomUpdateEvent_localPanDelta]: dart.fieldType(dart.nullable(ui.Offset)),
    original: dart.finalFieldType(events.PointerPanZoomUpdateEvent),
    transform: dart.finalFieldType(vector_math_64.Matrix4)
  }));
  ...
  events._CopyPointerPanZoomEndEvent[dart.mixinOn] = PointerEvent => class _CopyPointerPanZoomEndEvent extends PointerEvent {
    copyWith(opts) {
      ...
      let synthesized = opts && 'synthesized' in opts ? opts.synthesized : null;
      let embedderId = opts && 'embedderId' in opts ? opts.embedderId : null;
      return new events.PointerPanZoomEndEvent.new({timeStamp: (t0 = timeStamp, t0 == null ? this.timeStamp : t0), kind: (t0$ = kind, t0$ == null ? this.kind : t0$), device: (t0$0 = device, t0$0 == null ? this.device : t0$0), position: (t0$1 = position, t0$1 == null ? this.position : t0$1), embedderId: (t0$2 = embedderId, t0$2 == null ? this.embedderId : t0$2)}).transformed(this.transform);
    }
  };
  dart.addTypeTests(events._CopyPointerPanZoomEndEvent);
  dart.addTypeCaches(events._CopyPointerPanZoomEndEvent);
  events._CopyPointerPanZoomEndEvent[dart.implements] = () => [events.PointerEvent];
  dart.setMethodSignature(events._CopyPointerPanZoomEndEvent, () => ({
    __proto__: dart.getMethods(events._CopyPointerPanZoomEndEvent.__proto__),
    copyWith: dart.fnType(events.PointerPanZoomEndEvent, [], {buttons: dart.nullable(core.int), delta: dart.nullable(ui.Offset), device: dart.nullable(core.int), distance: dart.nullable(core.double), distanceMax: dart.nullable(core.double), embedderId: dart.nullable(core.int), kind: dart.nullable(ui.PointerDeviceKind), obscured: dart.nullable(core.bool), orientation: dart.nullable(core.double), pointer: dart.nullable(core.int), position: dart.nullable(ui.Offset), pressure: dart.nullable(core.double), pressureMax: dart.nullable(core.double), pressureMin: dart.nullable(core.double), radiusMajor: dart.nullable(core.double), radiusMax: dart.nullable(core.double), radiusMin: dart.nullable(core.double), radiusMinor: dart.nullable(core.double), size: dart.nullable(core.double), synthesized: dart.nullable(core.bool), tilt: dart.nullable(core.double), timeStamp: dart.nullable(core.Duration)}, {})
  }));
  ...
  (PointerEvent__PointerEventDescription$36$8.new = function(opts) {
    PointerEvent__PointerEventDescription$36$8.__proto__.new.call(this, opts);
  ...
  (PointerEvent__CopyPointerPanZoomEndEvent$36.new = function(opts) {
    PointerEvent__CopyPointerPanZoomEndEvent$36.__proto__.new.call(this, opts);
  ...
  events.PointerPanZoomEndEvent = class PointerPanZoomEndEvent extends PointerEvent__CopyPointerPanZoomEndEvent$36 {
    static ['_#new#tearOff'](opts) {
      ...
      let embedderId = opts && 'embedderId' in opts ? opts.embedderId : null;
      let synthesized = opts && 'synthesized' in opts ? opts.synthesized : null;
      return new events.PointerPanZoomEndEvent.new({timeStamp: timeStamp, kind: kind, device: device, pointer: pointer, position: position, embedderId: embedderId, synthesized: synthesized});
    }
    transformed(transform) {
      let t0;
      if (transform == null || dart.equals(transform, this.transform)) {
      ...
      return new events._TransformedPointerPanZoomEndEvent.new((t0 = T.PointerPanZoomEndEventN().as(this.original), t0 == null ? this : t0), transform);
    }
  };
  (events.PointerPanZoomEndEvent.new = function(opts) {
    ...
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    let synthesized = opts && 'synthesized' in opts ? opts.synthesized : false;
    if (!(timeStamp !== null)) dart.assertFailed(null, I[1], 2116, 15, "timeStamp != null");
    if (!(kind !== null)) dart.assertFailed(null, I[1], 2117, 15, "kind != null");
    if (!(device !== null)) dart.assertFailed(null, I[1], 2118, 15, "device != null");
    if (!(pointer !== null)) dart.assertFailed(null, I[1], 2119, 15, "pointer != null");
    if (!(position !== null)) dart.assertFailed(null, I[1], 2120, 15, "position != null");
    if (!(embedderId !== null)) dart.assertFailed(null, I[1], 2121, 15, "embedderId != null");
    if (!(synthesized !== null)) dart.assertFailed(null, I[1], 2122, 15, "synthesized != null");
    events.PointerPanZoomEndEvent.__proto__.new.call(this, {timeStamp: timeStamp, kind: kind, device: device, pointer: pointer, position: position, embedderId: embedderId, synthesized: synthesized});
    ;
  ...
  dart.setMethodSignature(events.PointerPanZoomEndEvent, () => ({
    __proto__: dart.getMethods(events.PointerPanZoomEndEvent.__proto__),
    transformed: dart.fnType(events.PointerPanZoomEndEvent, [dart.nullable(vector_math_64.Matrix4)])
  }));
  dart.setLibraryUri(events.PointerPanZoomEndEvent, I[0]);
  var original$11 = dart.privateName(events, "_TransformedPointerPanZoomEndEvent.original");
  var transform$11 = dart.privateName(events, "_TransformedPointerPanZoomEndEvent.transform");
  ...
  (_TransformedPointerEvent__CopyPointerPanZoomEndEvent$36.new = function() {
    _TransformedPointerEvent__CopyPointerPanZoomEndEvent$36.__proto__.new.call(this);
  ...
  (events._TransformedPointerPanZoomEndEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 2135, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 2135, 40, "transform != null");
    events._TransformedPointerPanZoomEndEvent.__proto__.new.call(this);
    ;
  ...
  events._TransformedPointerPanZoomEndEvent[dart.implements] = () => [events.PointerPanZoomEndEvent];
  dart.setMethodSignature(events._TransformedPointerPanZoomEndEvent, () => ({
    __proto__: dart.getMethods(events._TransformedPointerPanZoomEndEvent.__proto__),
    transformed: dart.fnType(events.PointerPanZoomEndEvent, [dart.nullable(vector_math_64.Matrix4)])
  }));
  dart.setLibraryUri(events._TransformedPointerPanZoomEndEvent, I[0]);
  dart.setFieldSignature(events._TransformedPointerPanZoomEndEvent, () => ({
    __proto__: dart.getFields(events._TransformedPointerPanZoomEndEvent.__proto__),
    original: dart.finalFieldType(events.PointerPanZoomEndEvent),
    transform: dart.finalFieldType(vector_math_64.Matrix4)
  }));
  ...
  (PointerEvent__PointerEventDescription$36$9.new = function(opts) {
    PointerEvent__PointerEventDescription$36$9.__proto__.new.call(this, opts);
  ...
  (events.PointerCancelEvent.new = function(opts) {
    ...
    let tilt = opts && 'tilt' in opts ? opts.tilt : 0;
    let embedderId = opts && 'embedderId' in opts ? opts.embedderId : 0;
    events.PointerCancelEvent.__proto__.new.call(this, {down: false, pressure: 0.0, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, buttons: buttons, obscured: obscured, pressureMin: pressureMin, pressureMax: pressureMax, distance: distance, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, embedderId: embedderId});
    ;
  ...
  var original$12 = dart.privateName(events, "_TransformedPointerCancelEvent.original");
  var transform$12 = dart.privateName(events, "_TransformedPointerCancelEvent.transform");
  ...
  (events._TransformedPointerCancelEvent.new = function(original, transform) {
    ...
    if (!(original !== null)) dart.assertFailed(null, I[1], 2285, 14, "original != null");
    if (!(transform !== null)) dart.assertFailed(null, I[1], 2285, 40, "transform != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["events.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAyRY;;;;;;IAGK;;;;;;IAIL;;;;;;IAGc;;;;;;IAGd;;;;;;IASG;;;;;;IAqBA;;;;;;IAmBH;;;;;;IAMC;;;;;;IAMA;;;;;;IAQE;;;;;;IAMA;;;;;;IAMA;;;;;;IAOA;;;;;;IAWA;;;;;;IAaA;;;;;;IAGA;;;;;;IAGA;;;;;;IAIA;;;;;;IAIA;;;;;;IA6BA;;;;;;IAcA;;;;;;IAGH;;;;;;IAcC;;;;;;IAkBI;;;;;;IAWK;;;;;;;AApMQ;IAAQ;;AAsBX;IAAK;;AAoDJ;IAAG;6BAmLY,WAAkB;AACzD,UAAI,AAAU,SAAD;AACX,cAAO,SAAQ;;AAEH,sBAAY,2BAAQ,AAAS,QAAD,KAAK,AAAS,QAAD,KAAK;AAC9C,yBAAe,AAAU,SAAD,sBAAsB,SAAS;AACrE,YAAO,mBAAO,AAAa,YAAD,IAAI,AAAa,YAAD;IAC5C;;UAUkB;UACR;UACQ;UACE;AAElB,UAAI,AAAU,SAAD;AACX,cAAO,mBAAkB;;AAOsD,MAAjF,AAAuB,sBAAD,WAAtB,yBAA2B,sCAAkB,SAAS,EAAE,wBAAwB,IAAzD;AACV,qCAA2B,sCAAkB,SAAS,EAAE,AAAyB,wBAAD,MAAG,kBAAkB;AAClH,YAAO,AAAuB,uBAAD,MAAG,wBAAwB;IAC1D;sCAUkD;;AAClC,mBAAS,2BAAQ,KAAG,KAAG,KAAG;AACxC,WAAO,AAAU,SAAD;YAAC;AACb,qBAAU,GAAG,MAAM;AACnB,kBAAO,GAAG,MAAM;;;IACtB;;;QAhXO;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;IAzBA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;;EACL;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;wBA8VmD;AACd,MAA/B,0BAAoB,UAAU;AAC6B,MAAjE,AAAW,UAAD,KAAK,0CAA4B,YAAY;AAC0E,MAAjI,AAAW,UAAD,KAAK,0CAA4B,iBAAiB,mCAA6B,sBAAiC;AACN,MAApH,AAAW,UAAD,KAAK,0CAA4B,SAAS,2BAA4B,uBAA6B;AACW,MAAxH,AAAW,UAAD,KAAK,0CAA4B,cAAc,gCAA0B,mBAA8B;AACe,MAAhI,AAAW,UAAD,KAAK,4CAA8B,aAAa,+BAAkC,2BAA6B;AAC5C,MAA7E,AAAW,UAAD,KAAK,gCAAY,WAAW,sBAAgC;AACqB,MAA3F,AAAW,UAAD,KAAK,8CAAgC,QAAQ,mBAA6B;AACQ,MAA5F,AAAW,UAAD,KAAK,gCAAY,UAAU,4BAAsB,UAA0B;AACS,MAA9F,AAAW,UAAD,KAAK,gCAAY,WAAW,6BAAuB,UAA0B;AACF,MAArF,AAAW,UAAD,KAAK,wCAA0B,QAAQ,mBAA6B;AACuB,MAArG,AAAW,UAAD,KAAK,mCAAe,YAAY,8BAAwB,YAA4B;AACa,MAA3G,AAAW,UAAD,KAAK,mCAAe,eAAe,iCAA2B,YAA4B;AACO,MAA3G,AAAW,UAAD,KAAK,mCAAe,eAAe,iCAA2B,YAA4B;AACC,MAArG,AAAW,UAAD,KAAK,mCAAe,YAAY,8BAAwB,YAA4B;AACa,MAA3G,AAAW,UAAD,KAAK,mCAAe,eAAe,iCAA2B,YAA4B;AACO,MAA3G,AAAW,UAAD,KAAK,mCAAe,eAAe,iCAA2B,YAA4B;AACP,MAA7F,AAAW,UAAD,KAAK,mCAAe,QAAQ,0BAAoB,YAA4B;AACqB,MAA3G,AAAW,UAAD,KAAK,mCAAe,eAAe,iCAA2B,YAA4B;AACO,MAA3G,AAAW,UAAD,KAAK,mCAAe,eAAe,iCAA2B,YAA4B;AACG,MAAvG,AAAW,UAAD,KAAK,mCAAe,aAAa,+BAAyB,YAA4B;AACO,MAAvG,AAAW,UAAD,KAAK,mCAAe,aAAa,+BAAyB,YAA4B;AACW,MAA3G,AAAW,UAAD,KAAK,mCAAe,eAAe,iCAA2B,YAA4B;AACP,MAA7F,AAAW,UAAD,KAAK,mCAAe,QAAQ,0BAAoB,YAA4B;AACkB,MAAxG,AAAW,UAAD,KAAK,gCAAY,gBAAgB,kCAA4B,UAA0B;AACU,MAA3G,AAAW,UAAD,KAAK,iCAAa,oBAAmB,uBAAkB,mBAAmC;AACgB,MAApH,AAAW,UAAD,KAAK,iCAAa,uBAAsB,0BAAqB,sBAAsC;AACT,MAApG,AAAW,UAAD,KAAK,gCAAY,cAAc,gCAA0B,UAA0B;IAC/F;;AAIE,YAAO,0BAAmC;IAC5C;;;;;;;;;;;;;EAG6D;;;;;;;;;;;;;;;;;AAgBvC,YAAA,AAAS;IAAU;;AAGf,YAAA,AAAS;IAAS;;AAGzB,YAAA,AAAS;IAAO;;AAGL,YAAA,AAAS;IAAI;;AAGzB,YAAA,AAAS;IAAM;;AAGV,YAAA,AAAS;IAAQ;;AAGpB,YAAA,AAAS;IAAK;;AAGf,YAAA,AAAS;IAAO;;AAGlB,YAAA,AAAS;IAAI;;AAGT,YAAA,AAAS;IAAQ;;AAGf,YAAA,AAAS;IAAQ;;AAGd,YAAA,AAAS;IAAW;;AAGpB,YAAA,AAAS;IAAW;;AAGvB,YAAA,AAAS;IAAQ;;AAGd;IAAG;;AAGH,YAAA,AAAS;IAAW;;AAG3B,YAAA,AAAS;IAAI;;AAGN,YAAA,AAAS;IAAW;;AAGpB,YAAA,AAAS;IAAW;;AAGtB,YAAA,AAAS;IAAS;;AAGlB,YAAA,AAAS;IAAS;;AAGhB,YAAA,AAAS;IAAW;;AAG3B,YAAA,AAAS;IAAI;;AAGR,YAAA,AAAS;IAAY;;AAGrB,YAAA,AAAS;IAAW;;;AAG1B;gCAA6B,sCAAkB,gBAAW,2KAA1D;IAAmE;;;AAGnE;gCAA0B,2DAC/B,oCACS,sCACM,uCACF,2KAJR;IAKjB;;;qDARiB;kDAGA;;EAMpB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;UAKc;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAeL,+CAdqB,KAAV,SAAS,EAAT,aAAkB,6BAClB,MAAL,IAAI,EAAJ,cAAa,2BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,kCACR,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,qCACd,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,sCACZ,OAAV,SAAS,EAAT,eAAkB,oCACR,OAAV,SAAS,EAAT,eAAkB,sCACJ,OAAZ,WAAW,EAAX,eAAoB,iCACtB,QAAL,IAAI,EAAJ,gBAAa,iCACI,QAAX,UAAU,EAAV,gBAAmB,uCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBAgCuC;;AACrC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,+CAA6D,KAAtB,0BAAT,gBAAS,aAAyB,YAAM,SAAS;IACxF;;;QAzBQ;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;AACH,iEACY,gBAhBT,SAAS,WACT,OAAO,QACP,IAAI,UACJ,MAAM,YACN,QAAQ,YACR,QAAQ,eACR,WAAW,eACX,WAAW,YACX,QAAQ,eACR,WAAW,aACX,SAAS,aACT,SAAS,eACT,WAAW,QACX,IAAI,cACJ,UAAU;;EAGZ;;;;;;;;;;;;;;;;IAgBkB;;;;;;IAGV;;;;;;;;;gBAGyB;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;uDAVjD,UAAe;IAAf;IAAe;UACvC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;UAe3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAYL,iDAXqB,KAAV,SAAS,EAAT,aAAkB,6BAClB,MAAL,IAAI,EAAJ,cAAa,2BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,kCACR,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,sCACZ,OAAV,SAAS,EAAT,eAAkB,oCACR,OAAV,SAAS,EAAT,eAAkB,qCACN,OAAX,UAAU,EAAV,eAAmB,sCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBA8ByC;;AACvC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,iDAAiE,KAAxB,4BAAT,gBAAS,aAA2B,YAAM,SAAS;IAC5F;;;QAvBQ;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACqB;QACrB;AACH,mEACY,gBAdT,SAAS,WACT,OAAO,QACP,IAAI,UACJ,MAAM,YACN,QAAQ,YACR,QAAQ,eACR,WAAW,eACX,WAAW,eACX,WAAW,aACX,SAAS,aACT,SAAS,YACY,QAAQ,cAC7B,UAAU;;EAGZ;;;;;;;;;;;;;;;;IAgBoB;;;;;;IAGZ;;;;;;;;;gBAG2B;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;yDAVjD,UAAe;IAAf;IAAe;UACzC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;UAe3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAqBL,+CApBqB,KAAV,SAAS,EAAT,aAAkB,6BAClB,MAAL,IAAI,EAAJ,cAAa,2BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,+BACd,OAAN,KAAK,EAAL,eAAc,8BACJ,OAAR,OAAO,EAAP,eAAgB,iCACN,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,qCACd,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,iCACtB,OAAL,IAAI,EAAJ,eAAa,iCACM,QAAZ,WAAW,EAAX,gBAAoB,yCACR,QAAZ,WAAW,EAAX,gBAAoB,uCACZ,QAAV,SAAS,EAAT,gBAAkB,qCACR,QAAV,SAAS,EAAT,gBAAkB,uCACJ,QAAZ,WAAW,EAAX,gBAAoB,kCACtB,QAAL,IAAI,EAAJ,gBAAa,kCACM,QAAZ,WAAW,EAAX,gBAAoB,wCACV,QAAX,UAAU,EAAV,gBAAmB,uCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBA+CuC;;AACrC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,+CAA6D,KAAtB,0BAAT,gBAAS,aAAyB,YAAM,SAAS;IACxF;;;QAhCQ;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;AACH,6DACQ,iBACI,gBAvBT,SAAS,QACT,IAAI,WACJ,OAAO,UACP,MAAM,YACN,QAAQ,SACR,KAAK,WACL,OAAO,YACP,QAAQ,eACR,WAAW,eACX,WAAW,YACX,QAAQ,eACR,WAAW,QACX,IAAI,eACJ,WAAW,eACX,WAAW,aACX,SAAS,aACT,SAAS,eACT,WAAW,QACX,IAAI,eACJ,WAAW,cACX,UAAU;;EAIZ;;;;;;;;;;;;;;;;IAgBkB;;;;;;IAGV;;;;;;;;;gBAGyB;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;uDAVjD,UAAe;IAAf;IAAe;UACvC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;UAe3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAqBL,+CApBqB,KAAV,SAAS,EAAT,aAAkB,6BAClB,MAAL,IAAI,EAAJ,cAAa,2BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,+BACd,OAAN,KAAK,EAAL,eAAc,8BACJ,OAAR,OAAO,EAAP,eAAgB,iCACN,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,qCACd,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,iCACtB,OAAL,IAAI,EAAJ,eAAa,iCACM,QAAZ,WAAW,EAAX,gBAAoB,yCACR,QAAZ,WAAW,EAAX,gBAAoB,uCACZ,QAAV,SAAS,EAAT,gBAAkB,qCACR,QAAV,SAAS,EAAT,gBAAkB,uCACJ,QAAZ,WAAW,EAAX,gBAAoB,kCACtB,QAAL,IAAI,EAAJ,gBAAa,kCACM,QAAZ,WAAW,EAAX,gBAAoB,wCACV,QAAX,UAAU,EAAV,gBAAmB,uCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;0BAiDsD;AAAU,YAAA,AAsB9D,8CArBW,AAAM,KAAD,qBACP,AAAM,KAAD,gBACR,AAAM,KAAD,eACH,AAAM,KAAD,mBACH,AAAM,KAAD,kBACR,AAAM,KAAD,iBACH,AAAM,KAAD,oBACJ,AAAM,KAAD,wBACF,AAAM,KAAD,2BACL,AAAM,KAAD,wBACR,AAAM,KAAD,wBACF,AAAM,KAAD,oBACZ,AAAM,KAAD,oBACE,AAAM,KAAD,2BACL,AAAM,KAAD,yBACP,AAAM,KAAD,uBACL,AAAM,KAAD,yBACH,AAAM,KAAD,oBACZ,AAAM,KAAD,aACL,AAAM,KAAD,oBACE,AAAM,KAAD,2BACN,AAAM,KAAD;IAAW;;;;gBAGS;;AACrC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,+CAA6D,KAAtB,0BAAT,gBAAS,aAAyB,YAAM,SAAS;IACxF;;;QA3DQ;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;AACH,iEACY,gBAvBT,SAAS,WACT,OAAO,QACP,IAAI,UACJ,MAAM,YACN,QAAQ,SACR,KAAK,WACL,OAAO,YACP,QAAQ,eACR,WAAW,eACX,WAAW,YACX,QAAQ,eACR,WAAW,QACX,IAAI,eACJ,WAAW,eACX,WAAW,aACX,SAAS,aACT,SAAS,eACT,WAAW,QACX,IAAI,QACJ,IAAI,eACJ,WAAW,cACX,UAAU;;EAGZ;;;;;;;;;;;;;;;;;IA2CkB;;;;;;IAGV;;;;;;;;;gBAGyB;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;uDAVjD,UAAe;IAAf;IAAe;UACvC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;UAe3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAqBL,8CApBqB,KAAV,SAAS,EAAT,aAAkB,6BAClB,MAAL,IAAI,EAAJ,cAAa,2BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,+BACd,OAAN,KAAK,EAAL,eAAc,8BACJ,OAAR,OAAO,EAAP,eAAgB,iCACN,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,qCACd,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,iCACtB,OAAL,IAAI,EAAJ,eAAa,iCACM,QAAZ,WAAW,EAAX,gBAAoB,yCACR,QAAZ,WAAW,EAAX,gBAAoB,uCACZ,QAAV,SAAS,EAAT,gBAAkB,qCACR,QAAV,SAAS,EAAT,gBAAkB,uCACJ,QAAZ,WAAW,EAAX,gBAAoB,kCACtB,QAAL,IAAI,EAAJ,gBAAa,kCACM,QAAZ,WAAW,EAAX,gBAAoB,wCACV,QAAX,UAAU,EAAV,gBAAmB,uCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;0BAiDqD;AAAU,YAAA,AAsB7D,6CArBW,AAAM,KAAD,qBACP,AAAM,KAAD,gBACR,AAAM,KAAD,eACH,AAAM,KAAD,mBACH,AAAM,KAAD,kBACR,AAAM,KAAD,iBACH,AAAM,KAAD,oBACJ,AAAM,KAAD,wBACF,AAAM,KAAD,2BACL,AAAM,KAAD,wBACR,AAAM,KAAD,wBACF,AAAM,KAAD,oBACZ,AAAM,KAAD,oBACE,AAAM,KAAD,2BACL,AAAM,KAAD,yBACP,AAAM,KAAD,uBACL,AAAM,KAAD,yBACH,AAAM,KAAD,oBACZ,AAAM,KAAD,aACL,AAAM,KAAD,oBACE,AAAM,KAAD,2BACN,AAAM,KAAD;IAAW;;;;gBAGQ;;AACpC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,8CAA2D,KAArB,yBAAT,gBAAS,aAAwB,YAAM,SAAS;IACtF;;;QA3DQ;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;AACH,gEACY,gBAvBT,SAAS,QACT,IAAI,WACJ,OAAO,UACP,MAAM,YACN,QAAQ,SACR,KAAK,WACL,OAAO,YACP,QAAQ,eACR,WAAW,eACX,WAAW,YACX,QAAQ,eACR,WAAW,QACX,IAAI,eACJ,WAAW,eACX,WAAW,aACX,SAAS,aACT,SAAS,eACT,WAAW,QACX,IAAI,QACJ,IAAI,eACJ,WAAW,cACX,UAAU;;EAGZ;;;;;;;;;;;;;;;;;IA4CiB;;;;;;IAGT;;;;;;;;;gBAGwB;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;sDAVjD,UAAe;IAAf;IAAe;UACtC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;UAe3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAoBL,8CAnBqB,KAAV,SAAS,EAAT,aAAkB,gCACZ,MAAR,OAAO,EAAP,cAAgB,4BACd,OAAL,IAAI,EAAJ,eAAa,4BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,iCACV,OAAR,OAAO,EAAP,eAAgB,iCACN,OAAT,QAAQ,EAAR,eAAiB,kCACR,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,iCACtB,OAAL,IAAI,EAAJ,eAAa,iCACM,QAAZ,WAAW,EAAX,gBAAoB,yCACR,QAAZ,WAAW,EAAX,gBAAoB,uCACZ,QAAV,SAAS,EAAT,gBAAkB,qCACR,QAAV,SAAS,EAAT,gBAAkB,uCACJ,QAAZ,WAAW,EAAX,gBAAoB,kCACtB,QAAL,IAAI,EAAJ,gBAAa,iCACI,QAAX,UAAU,EAAV,gBAAmB,uCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBAuCsC;;AACpC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,8CAA2D,KAArB,yBAAT,gBAAS,aAAwB,YAAM,SAAS;IACtF;;;QA9BQ;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;AACH,4DACQ,gBACI,gBArBT,SAAS,WACT,OAAO,QACP,IAAI,UACJ,MAAM,YACN,QAAQ,WACR,OAAO,YACP,QAAQ,YACR,QAAQ,eACR,WAAW,eACX,WAAW,eACX,WAAW,QACX,IAAI,eACJ,WAAW,eACX,WAAW,aACX,SAAS,aACT,SAAS,eACT,WAAW,QACX,IAAI,cACJ,UAAU;;EAIZ;;;;;;;;;;;;;;;;IAgBiB;;;;;;IAGT;;;;;;;;;gBAGwB;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;sDAVjD,UAAe;IAAf;IAAe;UACtC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;UAe3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAsBL,8CArBqB,KAAV,SAAS,EAAT,aAAkB,gCACZ,MAAR,OAAO,EAAP,cAAgB,4BACd,OAAL,IAAI,EAAJ,eAAa,4BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,+BACd,OAAN,KAAK,EAAL,eAAc,8BACJ,OAAR,OAAO,EAAP,eAAgB,iCACN,OAAT,QAAQ,EAAR,eAAiB,kCACR,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,iCACtB,QAAL,IAAI,EAAJ,gBAAa,kCACM,QAAZ,WAAW,EAAX,gBAAoB,yCACR,QAAZ,WAAW,EAAX,gBAAoB,uCACZ,QAAV,SAAS,EAAT,gBAAkB,qCACR,QAAV,SAAS,EAAT,gBAAkB,uCACJ,QAAZ,WAAW,EAAX,gBAAoB,kCACtB,QAAL,IAAI,EAAJ,gBAAa,kCACM,QAAZ,WAAW,EAAX,gBAAoB,wCACV,QAAX,UAAU,EAAV,gBAAmB,uCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBA6CsC;;AACpC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAGT,YAAO,8CAA2D,KAArB,yBAAT,gBAAS,aAAwB,YAAM,SAAS;IACtF;;;QAlCQ;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;AACH,4DACQ,gBACI,gBAxBT,SAAS,WACT,OAAO,QACP,IAAI,UACJ,MAAM,YACN,QAAQ,SACR,KAAK,WACL,OAAO,YACP,QAAQ,YACR,QAAQ,eACR,WAAW,eACX,WAAW,eACX,WAAW,QACX,IAAI,eACJ,WAAW,eACX,WAAW,aACX,SAAS,aACT,SAAS,eACT,WAAW,QACX,IAAI,gBACJ,YAAY,eACZ,WAAW,cACX,UAAU;;EAIZ;;;;;;;;;;;;;;;;IAiBiB;;;;;;IAGT;;;;;;;;;gBAGwB;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;sDAVjD,UAAe;IAAf;IAAe;UACtC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;UAe3C;UACL;UACc;UACd;UACG;UACA;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAqBL,4CApBqB,KAAV,SAAS,EAAT,aAAkB,gCACZ,MAAR,OAAO,EAAP,cAAgB,4BACd,OAAL,IAAI,EAAJ,eAAa,4BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,iCACV,OAAR,OAAO,EAAP,eAAgB,iCACN,OAAT,QAAQ,EAAR,eAAiB,kCACR,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,qCACd,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,iCACtB,QAAL,IAAI,EAAJ,gBAAa,kCACM,QAAZ,WAAW,EAAX,gBAAoB,yCACR,QAAZ,WAAW,EAAX,gBAAoB,uCACZ,QAAV,SAAS,EAAT,gBAAkB,qCACR,QAAV,SAAS,EAAT,gBAAkB,uCACJ,QAAZ,WAAW,EAAX,gBAAoB,kCACtB,QAAL,IAAI,EAAJ,gBAAa,iCACI,QAAX,UAAU,EAAV,gBAAmB,uCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBAyCoC;;AAClC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,4CAAuD,KAAnB,uBAAT,gBAAS,aAAsB,YAAM,SAAS;IAClF;;;QAhCQ;QACA;QACA;QACA;QACA;QACA;QACA;QAGA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;AACH,0DACQ,kBAvBL,SAAS,WACT,OAAO,QACP,IAAI,UACJ,MAAM,YACN,QAAQ,WACR,OAAO,YACP,QAAQ,YAGR,QAAQ,eACR,WAAW,eACX,WAAW,YACX,QAAQ,eACR,WAAW,QACX,IAAI,eACJ,WAAW,eACX,WAAW,aACX,SAAS,aACT,SAAS,eACT,WAAW,QACX,IAAI,cACJ,UAAU;;EAGZ;;;;;;;;;;;;;;;;IAgBe;;;;;;IAGP;;;;;;;;;gBAGsB;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;oDAVjD,UAAe;IAAf;IAAe;UACpC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;QA4B/C;QACA;QACA;QACA;QACA;QACA;AANF,mEACE,SAAS,WACT,OAAO,QACP,IAAI,UACJ,MAAM,YACN,QAAQ,cACR,UAAU;;EAChB;;;;;;;;UASU;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAOL,gDANqB,KAAV,SAAS,EAAT,aAAkB,6BAClB,MAAL,IAAI,EAAJ,cAAa,2BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,oCACd,+BACU,OAAX,UAAU,EAAV,eAAmB,sCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;IAgCa;;;;;;;;;;;;;;;gBAG2B;;AACtC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,gDAA+D,KAAvB,2BAAT,gBAAS,aAA0B,YAAM,SAAS;IAC1F;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AACmC,MAAvE,AAAW,UAAD,KAAK,0CAA4B,eAAe;IAC5D;;;QA3BQ;QACA;QACA;QACA;QACD;QACC;IADD;UAEK,AAAU,SAAD;UACT,AAAK,IAAD;UACJ,AAAO,MAAD;UACN,AAAS,QAAD;UACR,AAAY,WAAD;AAXjB,mEACE,SAAS,QACT,IAAI,UACJ,MAAM,YACN,QAAQ,cAER,UAAU;;EAKc;;;;;;;;;;;;;;;;;;;;IAyBP;;;;;;IAGX;;;;;;;;;;AAGY,YAAA,AAAS;IAAW;gBAGN;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;wBAGhC;AACd,MAA/B,0BAAoB,UAAU;AACmC,MAAvE,AAAW,UAAD,KAAK,0CAA4B,eAAe;IAC5D;;wDAnBoC,UAAe;IAAf;IAAe;UACxC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;;;;;UAwB3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAML,sDALqB,KAAV,SAAS,EAAT,aAAkB,6BAClB,MAAL,IAAI,EAAJ,cAAa,2BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,oCACJ,OAAX,UAAU,EAAV,eAAmB,sCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBA8B8C;;AAC5C,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,sDAA2E,KAA7B,iCAAT,gBAAS,aAAgC,YAAM,SAAS;IACtG;;;QArBQ;QACA;QACA;QACA;QACA;QACA;QACA;UACI,AAAU,SAAD;UACT,AAAK,IAAD;UACJ,AAAO,MAAD;UACN,AAAQ,OAAD;UACP,AAAS,QAAD;UACR,AAAW,UAAD;UACV,AAAY,WAAD;AAdjB,yEACE,SAAS,QACT,IAAI,UACJ,MAAM,WACN,OAAO,YACP,QAAQ,cACR,UAAU,eACV,WAAW;;EAOa;;;;;;;;;;;;;;;;IAgBD;;;;;;IAGjB;;;;;;;;;gBAGgC;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;8DAVjD,UAAe;IAAf;IAAe;UAC9C,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;UA4B3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;UACG;UACA;UACA;UACA;UACA;UACA;AAER,YAAO,AAUL,uDATqB,KAAV,SAAS,EAAT,aAAkB,6BAClB,MAAL,IAAI,EAAJ,cAAa,2BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,oCACJ,OAAX,UAAU,EAAV,eAAmB,+BACtB,OAAJ,GAAG,EAAH,eAAY,6BACE,OAAT,QAAQ,EAAR,eAAiB,+BACd,OAAN,KAAK,EAAL,eAAc,+BACF,OAAT,QAAQ,EAAR,eAAiB,oCACf;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;IAqCa;;;;;;IAIA;;;;;;IAIA;;;;;;IAEA;;;;;;;;;;;;;;;;;;;;;AARU;IAAG;;AAIE;IAAQ;gBAOW;;AAC7C,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,uDAA6E,KAA9B,kCAAT,gBAAS,aAAiC,YAAM,SAAS;IACxG;;;QAzCQ;QACA;QACA;QACA;QACA;QACA;QACD;QACA;QACA;QACA;QACC;IAJD;IACA;IACA;IACA;UAEK,AAAU,SAAD;UACT,AAAK,IAAD;UACJ,AAAO,MAAD;UACN,AAAQ,OAAD;UACP,AAAS,QAAD;UACR,AAAW,UAAD;UACV,AAAI,GAAD;UACH,AAAS,QAAD;UACR,AAAM,KAAD;UACL,AAAS,QAAD;UACR,AAAY,WAAD;AAtBjB,0EACE,SAAS,QACT,IAAI,UACJ,MAAM,WACN,OAAO,YACP,QAAQ,cACR,UAAU,eAKV,WAAW;;EAWa;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAmDA;;;;;;IAGlB;;;;;;;;;;AA1BI,YAAA,AAAS;IAAG;;;AAGZ;gCAAwB,sCAAkB,gBAAW,sLAArD;IAAyD;;AAGpD,YAAA,AAAS;IAAQ;;;AAGtB;gCAA6B,2DAClC,oCACS,yCACM,kCACF,sMAJR;IAKjB;;AAGmB,YAAA,AAAS;IAAK;;AAGX,YAAA,AAAS;IAAQ;gBASO;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;+DAjCjD,UAAe;6DAOxC;kEAMA;IAbyB;IAAe;UAC/C,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;;;;;;;;;;;;UAsC3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAML,oDALqB,KAAV,SAAS,EAAT,aAAkB,6BAClB,MAAL,IAAI,EAAJ,cAAa,2BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,oCACJ,OAAX,UAAU,EAAV,eAAmB,sCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBA8B4C;;AAC1C,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,oDAAuE,KAA3B,+BAAT,gBAAS,aAA8B,YAAM,SAAS;IAClG;;;QArBQ;QACA;QACA;QACA;QACA;QACA;QACA;UACI,AAAU,SAAD;UACT,AAAK,IAAD;UACJ,AAAO,MAAD;UACN,AAAQ,OAAD;UACP,AAAS,QAAD;UACR,AAAW,UAAD;UACV,AAAY,WAAD;AAdjB,uEACE,SAAS,QACT,IAAI,UACJ,MAAM,WACN,OAAO,YACP,QAAQ,cACR,UAAU,eACV,WAAW;;EAOa;;;;;;;;;;;;;;;;IAgBH;;;;;;IAGf;;;;;;;;;gBAG8B;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;4DAVjD,UAAe;IAAf;IAAe;UAC5C,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;;;;;UAe3C;UACL;UACc;UACd;UACG;UACA;UACH;UACC;UACE;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACA;UACF;UACD;AAEL,YAAO,AAoBL,gDAnBqB,KAAV,SAAS,EAAT,aAAkB,gCACZ,MAAR,OAAO,EAAP,cAAgB,4BACd,OAAL,IAAI,EAAJ,eAAa,4BACJ,OAAP,MAAM,EAAN,eAAe,gCACJ,OAAT,QAAQ,EAAR,eAAiB,iCACV,OAAR,OAAO,EAAP,eAAgB,iCACN,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,wCACR,OAAZ,WAAW,EAAX,eAAoB,qCACd,OAAT,QAAQ,EAAR,eAAiB,qCACF,OAAZ,WAAW,EAAX,eAAoB,iCACtB,OAAL,IAAI,EAAJ,eAAa,iCACM,QAAZ,WAAW,EAAX,gBAAoB,yCACR,QAAZ,WAAW,EAAX,gBAAoB,uCACZ,QAAV,SAAS,EAAT,gBAAkB,qCACR,QAAV,SAAS,EAAT,gBAAkB,uCACJ,QAAZ,WAAW,EAAX,gBAAoB,kCACtB,QAAL,IAAI,EAAJ,gBAAa,iCACI,QAAX,UAAU,EAAV,gBAAmB,uCACnB;IAChB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBAuCwC;;AACtC,UAAI,AAAU,SAAD,YAAsB,YAAV,SAAS,EAAS;AACzC,cAAO;;AAET,YAAO,gDAA+D,KAAvB,2BAAT,gBAAS,aAA0B,YAAM,SAAS;IAC1F;;;QA9BQ;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;AACH,8DACQ,iBACI,gBArBT,SAAS,WACT,OAAO,QACP,IAAI,UACJ,MAAM,YACN,QAAQ,WACR,OAAO,YACP,QAAQ,eACR,WAAW,eACX,WAAW,YACX,QAAQ,eACR,WAAW,QACX,IAAI,eACJ,WAAW,eACX,WAAW,aACX,SAAS,aACT,SAAS,eACT,WAAW,QACX,IAAI,cACJ,UAAU;;EAIZ;;;;;;;;;;;;;;;;IA0DmB;;;;;;IAGX;;;;;;;;;gBAG0B;AAAc,YAAA,AAAS,2BAAY,SAAS;IAAC;;wDAVjD,UAAe;IAAf;IAAe;UACxC,AAAS,QAAD;UAAkB,AAAU,SAAD;AAD9C;;EACuD;;;;;;;;;;;;;;kDAvkElC;AAAW,UAAsC,EAAjB,gBAAI,AAAO,MAAD,GAAG;EAAqB;oDASjE;AAAW,UAAuC,EAAjB,gBAAI,AAAO,MAAD,GAAG;EAAqB;kDAoBpE;AAAY,UAAQ,EAAR,OAAO,GAAI,CAAC,OAAO;EAAC;kDAqB/B;AAAY,UAAA,AAAa,QAAN,KAAI,KAAM,AAAwB,sBAAT,OAAO,MAAK,OAAO;EAAC;kDA0+DhD,MAA6B;;AACnE,YAAQ,IAAI;;;AAER;;;;;;;;AAMA,sBAAO,QAAQ,eAAR,OAAU;gBAAV;;;EAEb;kDAGwC,MAA6B;;AACnE,YAAQ,IAAI;;;AAER;;;;;;;;AAMA,sBAAO,QAAQ,eAAR,OAAU;gBAAV;;;EAEb;sDAG0C;AACxC,YAAQ,IAAI;;;AAER;;;;;;;;AAMA;;;EAEN;;MArsEU,qBAAc;;;MAgBd,uBAAgB;;;MAWhB,0BAAmB;;;MAWnB,4BAAqB;;;MASrB,qBAAc;;;MAWd,2BAAoB;;;MAkBpB,sBAAe;;;MAYf,yBAAkB;;;MAWlB,6BAAsB;;;MAMtB,uBAAgB;;;MAMhB,0BAAmB;;;MASnB,oBAAa","file":"../../../../../../../../../../packages/flutter/src/gestures/events.dart.lib.js"}');
  // Exports:
  return {
