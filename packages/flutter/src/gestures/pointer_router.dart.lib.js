define(['dart_sdk', 'packages/flutter/src/gestures/events.dart', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__gestures__pointer_router_dart(dart_sdk, packages__flutter__src__gestures__events$46dart, packages__vector_math__vector_math_64$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/gestures/pointer_router.dart",
  ...
  pointer_router.PointerRouter = class PointerRouter extends core.Object {
    ...
    get debugGlobalRouteCount() {
      ...
      if (!dart.fn(() => {
        ...
        return true;
      }, T.VoidTobool())()) dart.assertFailed(null, I[0], 84, 12, "() {\n      count = _globalRoutes.length;\n      return true;\n    }()");
      if (count != null) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["pointer_router.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;aA4BoB,SAAsB,OAAiB;AACrB,mBAAS,AAAU,8BACnD,OAAO,EACP,cAA8B;AAEhC,YAAQ,AAAO,MAAD,eAAa,KAAK;AACP,MAAzB,AAAM,MAAA,QAAC,KAAK,EAAI,SAAS;IAC3B;gBASqB,SAAsB;AACzC,WAAO,AAAU,8BAAY,OAAO;AACF,mBAA2B,eAAlB,AAAS,uBAAC,OAAO;AAC5D,WAAO,AAAO,MAAD,eAAa,KAAK;AACX,MAApB,AAAO,MAAD,UAAQ,KAAK;AACnB,UAAI,AAAO,MAAD;AACiB,QAAzB,AAAU,yBAAO,OAAO;;IAE5B;mBAQiC,OAAiB;AAChD,YAAQ,AAAc,kCAAY,KAAK;AACP,MAAhC,AAAa,2BAAC,KAAK,EAAI,SAAS;IAClC;sBASoC;AAClC,WAAO,AAAc,kCAAY,KAAK;AACX,MAA3B,AAAc,6BAAO,KAAK;IAC5B;;AAOO;AACL,WAAO,AAGN;AAF6B,QAA5B,QAAQ,AAAc;AACtB,cAAO;;AAET,UAAI,KAAK;AACP,cAAY,gBAAL,KAAK;;AAEoE,MAAlF,WAAM,8BAAiB;IACzB;gBAG4B,OAAoB,OAAgB;AAC9D;AACsC,QAApC,QAAQ,AAAM,KAAD,aAAa,SAAS;AACvB,QAAZ,AAAK,KAAA,CAAC,KAAK;;YACJ;YAAW;AAAlB;AACsB;AACtB,eAAO,AAON;AAFE,YAJD,YAAY,cAAuB,iCACjC,iDAAmC,UAAU,cAA6B,qCAC1E,sDAAkC,SAAS,KAAK,UAAyB,qCACzE,gDAAkC,SAAS,KAAK,UAAyB;AAE3E,kBAAO;;AAQP,UANW,oCAAY,mDACZ,SAAS,SACb,KAAK,WACH,4BACA,oCAAiB,wDACJ,SAAS;;;;IAGrC;UAMwB;AACa,mBAAS,AAAS,uBAAC,AAAM,KAAD;AACzB,+BAAqB,kDAA+B;AACtF,UAAI,MAAM;AAKP,QAJD,6BACE,KAAK,EACL,MAAM,EACN,kDAA+B,MAAM;;AAGuB,MAAhE,6BAAuB,KAAK,EAAE,qBAAe,kBAAkB;IACjE;6BAGe,OACe,iBACA;AAM1B,MAJF,AAAa,YAAD,WAAS,SAAc,OAAgB;AACjD,YAAI,AAAgB,eAAD,eAAa,KAAK;AACD,UAAlC,gBAAU,KAAK,EAAE,KAAK,EAAE,SAAS;;;IAGvC;;;;;;IA/H4C,kBAA8C;IACxD,sBAAwC;;EA+H5E","file":"../../../../../../../../../../packages/flutter/src/gestures/pointer_router.dart.lib.js"}');
  // Exports:
  return {
