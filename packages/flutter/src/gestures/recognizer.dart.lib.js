define(['dart_sdk', 'packages/flutter/src/gestures/debug.dart', 'packages/flutter/src/foundation/print.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/gestures/arena.dart', 'packages/flutter/src/gestures/events.dart', 'packages/flutter/src/gestures/gesture_settings.dart', 'packages/flutter/src/gestures/binding.dart', 'packages/flutter/src/gestures/team.dart', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__gestures__recognizer_dart(dart_sdk, packages__flutter__src__gestures__debug$46dart, packages__flutter__src__foundation__print$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__gestures__arena$46dart, packages__flutter__src__gestures__events$46dart, packages__flutter__src__gestures__gesture_settings$46dart, packages__flutter__src__gestures__binding$46dart, packages__flutter__src__gestures__team$46dart, packages__vector_math__vector_math_64$46dart, packages__flutter__src__foundation__object$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C[0] = dart.constList([C[1] || CT.C1, C[2] || CT.C2], recognizer.DragStartBehavior);
    },
    get C4() {
    ...
    get C3() {
      return C[3] = dart.constList([C[4] || CT.C4, C[5] || CT.C5, C[6] || CT.C6], recognizer.GestureRecognizerState);
    },
    get C8() {
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/gestures/recognizer.dart"
  ];
  ...
  recognizer.GestureRecognizer = class GestureRecognizer extends GestureArenaMember_DiagnosticableTreeMixin$36 {
    ...
    getKindForPointer(pointer) {
      if (!this[_pointerToKind][$containsKey](pointer)) dart.assertFailed(null, I[1], 211, 12, "_pointerToKind.containsKey(pointer)");
    ...
    invokeCallback(T, name, callback, opts) {
      ...
      if (!(callback !== null)) dart.assertFailed(null, I[1], 240, 12, "callback != null");
      let result = null;
      try {
        if (!dart.fn(() => {
          let t2, t2$;
          if (debug.debugPrintRecognizerCallbacksTrace) {
            ...
            print.debugPrint(prefix + dart.str(this) + " calling " + name + " callback." + (dart.test((t2$ = (t2 = report, t2 == null ? null : t2[$isNotEmpty]), t2$ == null ? false : t2$)) ? " " + dart.str(report) : ""));
          }
          return true;
        }, T$.VoidTobool())()) dart.assertFailed(null, I[1], 243, 14, "() {\n        if (debugPrintRecognizerCallbacksTrace) {\n          final String? report = debugReport != null ? debugReport() : null;\n          // The 19 in the line below is the width of the prefix used by\n          // _debugLogDiagnostic in arena.dart.\n          final String prefix = debugPrintGestureArenaDiagnostics ? '${' ' * 19}❙ ' : '';\n          debugPrint('$prefix$this calling $name callback.${ (report?.isNotEmpty ?? false) ? \" $report\" : \"\" }');\n        }\n        return true;\n      }()");
        result = callback();
      } catch (e) {
  ...
  (recognizer.GestureRecognizer.new = function(opts) {
    ...
    if (!(kind == null || supportedDevices == null)) dart.assertFailed(null, I[1], 82, 15, "kind == null || supportedDevices == null");
  ...
  dart.setMethodSignature(recognizer.GestureRecognizer, () => ({
    ...
    addPointerPanZoom: dart.fnType(dart.void, [events.PointerPanZoomStartEvent]),
    addAllowedPointerPanZoom: dart.fnType(dart.void, [events.PointerPanZoomStartEvent]),
    ...
    handleNonAllowedPointerPanZoom: dart.fnType(dart.void, [events.PointerPanZoomStartEvent]),
    isPointerPanZoomAllowed: dart.fnType(core.bool, [events.PointerPanZoomStartEvent]),
  ...
  recognizer.OneSequenceGestureRecognizer = class OneSequenceGestureRecognizer extends recognizer.GestureRecognizer {
    ...
    dispose() {
      ...
      if (!this[_entries][$isEmpty]) dart.assertFailed(null, I[1], 380, 12, "_entries.isEmpty");
      super.dispose();
    }
    get team() {
      return this[_team];
    ...
    set team(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 398, 12, "value != null");
      if (!this[_entries][$isEmpty]) dart.assertFailed(null, I[1], 399, 12, "_entries.isEmpty");
      if (!this[_trackedPointers][$isEmpty]) dart.assertFailed(null, I[1], 400, 12, "_trackedPointers.isEmpty");
      if (!(this[_team] == null)) dart.assertFailed(null, I[1], 401, 12, "_team == null");
      this[_team] = value;
    }
    ...
    startTrackingPointer(pointer, transform = null) {
      ...
      if (!!this[_entries][$containsValue](pointer)) dart.assertFailed(null, I[1], 430, 12, "!_entries.containsValue(pointer)");
  ...
  recognizer.PrimaryPointerGestureRecognizer = class PrimaryPointerGestureRecognizer extends recognizer.OneSequenceGestureRecognizer {
    ...
    handleEvent(event) {
      if (!(this.state !== recognizer.GestureRecognizerState.ready)) dart.assertFailed(null, I[1], 600, 12, "state != GestureRecognizerState.ready");
    ...
    didExceedDeadline() {
      if (!(this.deadline == null)) dart.assertFailed(null, I[1], 632, 12, "deadline == null");
    }
    ...
    didStopTrackingLastPointer(pointer) {
      if (!(this.state !== recognizer.GestureRecognizerState.ready)) dart.assertFailed(null, I[1], 664, 12, "state != GestureRecognizerState.ready");
      this[_stopTimer]();
  ...
  (recognizer.PrimaryPointerGestureRecognizer.new = function(opts) {
    ...
    if (!(preAcceptSlopTolerance == null || dart.notNull(preAcceptSlopTolerance) >= 0)) dart.assertFailed("The preAcceptSlopTolerance must be positive or null", I[1], 514, 10, "preAcceptSlopTolerance == null || preAcceptSlopTolerance >= 0");
    if (!(postAcceptSlopTolerance == null || dart.notNull(postAcceptSlopTolerance) >= 0)) dart.assertFailed("The postAcceptSlopTolerance must be positive or null", I[1], 518, 10, "postAcceptSlopTolerance == null || postAcceptSlopTolerance >= 0");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["recognizer.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAgDA;;;;;;;;;;;;MARK,mCAAM;;;MAGT,iCAAI;;;MAIJ,kCAAK;;;;;;;;;;;;;IAyCS;;;;;;IAIS;;;;;;sBA8ByB;AACJ,MAA1C,AAAc,4BAAC,AAAM,KAAD,UAAY,AAAM,KAAD;AACrC,UAAI,6BAAwB,KAAK;AACA,QAA/B,8BAAyB,KAAK;;AAEO,QAArC,oCAA+B,KAAK;;IAExC;6BAUuD;IAAS;eAiB/B;AACW,MAA1C,AAAc,4BAAC,AAAM,KAAD,UAAY,AAAM,KAAD;AACrC,UAAI,sBAAiB,KAAK;AACA,QAAxB,uBAAkB,KAAK;;AAEO,QAA9B,6BAAwB,KAAK;;IAEjC;sBAUwC;IAAS;4BASH;IAAS;qBAIhB;AAGrC,YAAO,AAAkB,AAAQ,oCAAoB,AAAE,eAAnB,kCAA4B,AAAM,KAAD;IACvE;mCAM6D;IAAS;4BAIhB;AACpD,YAAO,AAAkB,AAAQ,oCAAoB,AAAE,eAAnB,kCAA4B,AAAM,KAAD;IACvE;sBAOwC;AACtC,WAAO,AAAe,mCAAY,OAAO;AACzC,YAA8B,gBAAvB,AAAc,4BAAC,OAAO;IAC/B;;IASiB;sBAiBW,MAA4B;UAA+B;AACrF,YAAO,AAAS,QAAD;AACZ;AACH;AACE,aAAO,AASN;;AARC,cAAI;AACY,yBAAS,AAAY,WAAD,WAAW,AAAW,WAAA,KAAK;AAGhD,yBAAS,0CAAuC,AAAI,AAAS,YAAP,MAAG,OAAM;AAC0B,YAAtG,AAAU,iBAAG,AAAwF,MAAlF,YAAC,QAAI,cAAU,IAAI,8BAAiC,YAAnB,MAAM,eAAN,OAAQ,kBAAR,cAAsB,gBAAS,AAAW,eAAR,MAAM,IAAI;;AAElG,gBAAO;;AAEU,QAAnB,SAAS,AAAQ,QAAA;;YACV;YAAW;AAAlB;AACsB;AACtB,eAAO,AAMN;AAFE,YAHD,YAAY,cAAuB,kCACjC,mCAAe,WAAW,IAAI,GAC9B,sDAAuC,cAAc,cAAkC;AAEzF,kBAAO;;AAQP,UANW,oCAAY,mDACZ,SAAS,SACb,KAAK,WACH,oBACA,oCAAiB,mDACJ,SAAS;;;;AAGnC,YAAO,OAAM;IACf;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AACqD,MAAzF,AAAW,UAAD,KAAK,2CAA4B,cAAc,gCAA0B;IACrF;;;QA3MO;QAKc;QACK;IAYH;IAUW,uBAAyC;IA5BpE;UAOK,AAAK,AAAQ,IAAT,YAAY,AAAiB,gBAAD;IACrB,0BAAE,AAAK,IAAD,WAAW,gBAAgB,GAAsB,4CAAE,IAAI;;EAAE;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;sBAiO9C;AACc,MAApD,0BAAqB,AAAM,KAAD,UAAU,AAAM,KAAD;IAC3C;4BAI8C;AACR,MAApC,aAA2B;IAC7B;kBAqBuB;IAAW;kBAGX;IAAW;YAaF;AACA,yBAAe,gCAA2B,AAAS;AACjE,MAAhB,AAAS;AACT,eAA6B,QAAS,aAAY;AACtB,QAA1B,AAAM,KAAD,SAAS,WAAW;;IAE7B;mBAMwB,SAA4B;AACzB,kBAAQ,AAAQ,sBAAC,OAAO;AACjD,UAAI,KAAK;AACiB,QAAxB,AAAS,wBAAO,OAAO;AACG,QAA1B,AAAM,KAAD,SAAS,WAAW;;IAE7B;;AAIsC,MAApC,aAA2B;AAC3B,eAAe,UAAW;AAC+C,QAAxD,AAAS,AAAc,0DAAY,OAAO,YAAE;;AAErC,MAAxB,AAAiB;AACjB,WAAO,AAAS;AACD,MAAT;IACR;;AAY8B;IAAK;aAGR;AACzB,YAAO,AAAM,KAAD;AACZ,WAAO,AAAS;AAChB,WAAO,AAAiB;AACxB,YAAO,AAAM;AACA,MAAb,cAAQ,KAAK;IACf;yBAEyC;AACvC,UAAI;AACF,cAAY,AAAE,gBAAP,iBAAW,OAAO,EAAE;;AAE7B,YAAsB,AAAS,AAAa,kDAAI,OAAO,EAAE;IAC3D;yBAiB8B,SAAmB;AACgC,MAAhE,AAAS,AAAc,uDAAS,OAAO,YAAE,sBAAa,SAAS;AACjD,MAA7B,AAAiB,2BAAI,OAAO;AAC5B,YAAQ,AAAS,+BAAc,OAAO;AACS,MAA/C,AAAQ,sBAAC,OAAO,EAAI,yBAAmB,OAAO;IAChD;wBAS6B;AAC3B,UAAI,AAAiB,gCAAS,OAAO;AACoC,QAAxD,AAAS,AAAc,0DAAY,OAAO,YAAE;AAC3B,QAAhC,AAAiB,8BAAO,OAAO;AAC/B,YAAI,AAAiB;AACgB,UAAnC,gCAA2B,OAAO;;;IAGxC;sCAKoD;AAClD,UAAU,yBAAN,KAAK,KAA4B,6BAAN,KAAK,KAAgC,iCAAN,KAAK;AAC/B,QAAlC,yBAAoB,AAAM,KAAD;;IAE7B;;;QApKQ;QAKA;QACA;IAG0B,iBAAmC;IACtD,yBAAmB;IA2FhB;AAtGlB,kFACQ,UAAU,QAKV,IAAI,oBACJ,gBAAgB;;EACtB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA2LJ;;;;;;;;;;;;MAbK,wCAAM;;;MAET,uCAAK;;;MAKL,0CAAQ;;;MAKR,yCAAO;;;;;;;;;;;;;;;IAwCS;;;;;;IASF;;;;;;IAUA;;;;;;;AAKsB;IAAM;;AAYf;IAAe;;AAOP;IAAgB;sBASX;AACR,MAAxB,wBAAkB,KAAK;AAC7B,UAAI,AAAM,eAA0B;AACM,QAAxC,eAAgC;AACD,QAA/B,wBAAkB,AAAM,KAAD;AAC0D,QAAjF,yBAAmB,sCAAkB,AAAM,KAAD,wBAAwB,AAAM,KAAD;AACvE,YAAI;AACgE,UAAlE,eAAS,gBAAc,eAAR,gBAAW,cAAM,gCAA2B,KAAK;;;IAGtE;4BAG8C;AAC5C,WAAK;AACiC,QAA9B,8BAAwB,KAAK;;IAEvC;gBAG8B;AAC5B,YAAO,AAAM,eAA0B;AACvC,UAAI,AAAM,eAA0B,8CAAY,AAAM,AAAQ,KAAT,aAAY;AACpD,2CAEwB,CAD9B,0BACD,uCACA,AAA0B,yBAAP,KAAK,IAA0B,eAAtB;AACrB,4CACP,AACgC,0BAAhC,wCACA,AAA0B,yBAAP,KAAK,IAA2B,eAAvB;AAEhC,YAAU,2BAAN,KAAK,MAAyB,4BAA4B,IAAI,6BAA6B;AACzD,UAApC,aAA2B;AACS,UAApC,yBAAkC,eAAd;;AAEO,UAA3B,0BAAqB,KAAK;;;AAGU,MAAxC,uCAAkC,KAAK;IACzC;;AAaE,YAAO,AAAS;IAClB;+BASiD;AAC5B,MAAnB;IACF;kBAGuB;AACrB,UAAI,AAAQ,OAAD,KAAI;AACD,QAAZ;AACuB,QAAvB,yBAAmB;;IAEvB;kBAGuB;AACrB,UAAI,AAAQ,OAAD,KAAI,uBAAkB,AAAM,eAA0B;AACnD,QAAZ;AACuC,QAAvC,eAAgC;;IAEpC;+BAGoC;AAClC,YAAO,AAAM,eAA0B;AAC3B,MAAZ;AACqC,MAArC,eAAgC;AACT,MAAvB,yBAAmB;AACK,MAAxB,yBAAmB;IACrB;;AAIc,MAAZ;AACe,MAAT;IACR;;AAGE,UAAI;AACc,QAAV,AAAE,eAAR;AACa,QAAb,eAAS;;IAEb;yBAEuC;AACxB,mBAAS,AAAM,AAAS,KAAV,eAA2B,AAAE,eAAjB;AACvC,YAAO,AAAO,OAAD;IACf;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AACgC,MAApE,AAAW,UAAD,KAAK,oDAAqC,SAAS;IAC/D;;;QA9LO;QACA;QACA;QACC;QAKA;QACA;IAwCe,eAAgC;IAYlD;IAOO;IAIP,yBAAmB;IACjB;IAzEA;IACA;IACA;UASA,AAAuB,AAAQ,sBAAT,YAAmC,aAAvB,sBAAsB,KAAI,sBAC5D;UAGA,AAAwB,AAAQ,uBAAT,YAAoC,aAAxB,uBAAuB,KAAI,sBAC9D;AAjBP,qFAIQ,UAAU,QAKV,IAAI,oBACJ,gBAAgB;;EAQlB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA6MO;;;;;;IAIA;;;;;;;;;;;6BAlBqC;AAChD,YAAO,uCAAkB,AAAM,KAAD,wBAAwB,AAAM,KAAD;IAC7D;;;;0BAI+C;AAC7C,YAAO,uCAAkB,AAAM,KAAD,qBAAqB,AAAM,KAAD;IAC1D;;;;UAagC;AAC9B,YAAO,uCACE,AAAM,gBAAE,AAAM,KAAD,iBACZ,AAAO,iBAAE,AAAM,KAAD;IAE1B;UAGgC;AAC9B,YAAO,uCACE,AAAM,gBAAE,AAAM,KAAD,iBACZ,AAAO,iBAAE,AAAM,KAAD;IAE1B;;AAGqB,YAAG,AAAuE,0BAArD,MAAM,gBAAc,sBAAS,cAAK,wBAAW,eAAM;IAAE;;;QA3C/E;QACA;IADA;IACA;;EACd;;;;;;;;;;;;;;;;;;MAesB,0BAAI","file":"../../../../../../../../../../packages/flutter/src/gestures/recognizer.dart.lib.js"}');
  // Exports:
  return {
