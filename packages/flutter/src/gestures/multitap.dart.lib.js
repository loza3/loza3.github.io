define(['dart_sdk', 'packages/flutter/src/gestures/binding.dart', 'packages/flutter/src/gestures/events.dart', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/gestures/gesture_settings.dart', 'packages/flutter/src/gestures/arena.dart', 'packages/flutter/src/gestures/tap.dart', 'packages/flutter/src/gestures/constants.dart', 'packages/flutter/src/gestures/recognizer.dart'], (function load__packages__flutter__src__gestures__multitap_dart(dart_sdk, packages__flutter__src__gestures__binding$46dart, packages__flutter__src__gestures__events$46dart, packages__vector_math__vector_math_64$46dart, packages__flutter__src__gestures__gesture_settings$46dart, packages__flutter__src__gestures__arena$46dart, packages__flutter__src__gestures__tap$46dart, packages__flutter__src__gestures__constants$46dart, packages__flutter__src__gestures__recognizer$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/gestures/multitap.dart",
  ...
  (multitap._CountdownZoned.new = function(opts) {
    let duration = opts && 'duration' in opts ? opts.duration : null;
    this[_timeout] = false;
    if (!(duration !== null)) dart.assertFailed(null, I[0], 47, 17, "duration != null");
  ...
  (multitap._TapTracker.new = function(opts) {
    ...
    if (!(doubleTapMinTime !== null)) dart.assertFailed(null, I[0], 68, 15, "doubleTapMinTime != null");
    if (!(event !== null)) dart.assertFailed(null, I[0], 69, 15, "event != null");
    if (!(event.buttons !== null)) dart.assertFailed(null, I[0], 70, 15, "event.buttons != null");
  ...
  multitap.DoubleTapGestureRecognizer = class DoubleTapGestureRecognizer extends recognizer.GestureRecognizer {
    ...
    [_clearTrackers]() {
      ...
      if (!this[_trackers][$isEmpty]) dart.assertFailed(null, I[0], 351, 12, "_trackers.isEmpty");
    }
    ...
    [_checkUp](buttons) {
      if (!(buttons === 1)) dart.assertFailed(null, I[0], 370, 12, "buttons == kPrimaryButton");
      if (this.onDoubleTap != null) {
        this.invokeCallback(dart.void, "onDoubleTap", dart.nullCheck(this.onDoubleTap));
      }
    }
    [_checkCancel]() {
      if (this.onDoubleTapCancel != null) {
        this.invokeCallback(dart.void, "onDoubleTapCancel", dart.nullCheck(this.onDoubleTapCancel));
      }
    }
  ...
  multitap._TapGesture = class _TapGesture extends multitap._TapTracker {
    ...
    handleEvent(event) {
      if (!(event.pointer === this.pointer)) dart.assertFailed(null, I[0], 420, 12, "event.pointer == pointer");
  ...
  (multitap._TapGesture.new = function(opts) {
    ...
    this[_lastPosition] = recognizer.OffsetPair.fromEventPosition(event);
    multitap._TapGesture.__proto__.new.call(this, {event: events.PointerDownEvent.as(event), entry: binding.GestureBinding.instance.gestureArena.add(event.pointer, gestureRecognizer), doubleTapMinTime: constants.kDoubleTapMinTime, gestureSettings: gestureSettings});
  ...
  multitap.MultiTapGestureRecognizer = class MultiTapGestureRecognizer extends recognizer.GestureRecognizer {
    ...
    addAllowedPointer(event) {
      if (!!this[_gestureMap][$containsKey](event.pointer)) dart.assertFailed(null, I[0], 523, 12, "!_gestureMap.containsKey(event.pointer)");
      ...
      if (this.onTapDown != null) {
        this.invokeCallback(dart.void, "onTapDown", dart.fn(() => {
    ...
    rejectGesture(pointer) {
      if (!this[_gestureMap][$containsKey](pointer)) dart.assertFailed(null, I[0], 549, 12, "_gestureMap.containsKey(pointer)");
      dart.nullCheck(this[_gestureMap][$_get](pointer)).reject();
      if (!!this[_gestureMap][$containsKey](pointer)) dart.assertFailed(null, I[0], 551, 12, "!_gestureMap.containsKey(pointer)");
    }
    [_dispatchCancel](pointer) {
      ...
      if (this.onTapCancel != null) {
        this.invokeCallback(dart.void, "onTapCancel", dart.fn(() => dart.nullCheck(this.onTapCancel)(pointer), T.VoidTovoid()));
      }
    }
    [_dispatchTap](pointer, position) {
      if (!this[_gestureMap][$containsKey](pointer)) dart.assertFailed(null, I[0], 563, 12, "_gestureMap.containsKey(pointer)");
      this[_gestureMap][$remove](pointer);
      if (this.onTapUp != null) {
        this.invokeCallback(dart.void, "onTapUp", dart.fn(() => {
      ...
      if (this.onTap != null) {
        this.invokeCallback(dart.void, "onTap", dart.fn(() => dart.nullCheck(this.onTap)(pointer), T.VoidTovoid()));
      }
    }
    [_dispatchLongTap](pointer, lastPosition) {
      if (!this[_gestureMap][$containsKey](pointer)) dart.assertFailed(null, I[0], 580, 12, "_gestureMap.containsKey(pointer)");
      if (this.onLongTapDown != null) {
        this.invokeCallback(dart.void, "onLongTapDown", dart.fn(() => {
    ...
    dispose() {
      ...
      if (!this[_gestureMap][$isEmpty]) dart.assertFailed(null, I[0], 602, 12, "_gestureMap.isEmpty");
      super.dispose();
    }
    get debugDescription() {
      return "multitap";
  ...
  (multitap.SerialTapDownDetails.new = function(opts) {
    ...
    this[count$] = count;
    if (!(count > 0)) dart.assertFailed(null, I[0], 632, 15, "count > 0");
  ...
  (multitap.SerialTapCancelDetails.new = function(opts) {
    let count = opts && 'count' in opts ? opts.count : 1;
    this[count$0] = count;
    if (!(count !== null)) dart.assertFailed(null, I[0], 682, 15, "count != null");
    if (!(count > 0)) dart.assertFailed(null, I[0], 683, 15, "count > 0");
    ;
  ...
  (multitap.SerialTapUpDetails.new = function(opts) {
    ...
    this[kind$0] = kind;
    this[count$1] = count;
    if (!(count > 0)) dart.assertFailed(null, I[0], 714, 15, "count > 0");
  ...
  multitap.SerialTapGestureRecognizer = class SerialTapGestureRecognizer extends recognizer.GestureRecognizer {
    ...
    [_trackTap](event) {
      ...
      if (!(this[_pendingTap] == null)) dart.assertFailed(null, I[0], 906, 12, "_pendingTap == null");
      this[_pendingTap] = tracker;
      tracker.startTrackingPointer(dart.bind(this, _handleEvent), event.transform);
    }
    [_handleEvent](event) {
      if (!(this[_pendingTap] != null)) dart.assertFailed(null, I[0], 912, 12, "_pendingTap != null");
      if (!(dart.nullCheck(this[_pendingTap]).pointer === event.pointer)) dart.assertFailed(null, I[0], 913, 12, "_pendingTap!.pointer == event.pointer");
    ...
    acceptGesture(pointer) {
      ...
      if (!(dart.nullCheck(this[_pendingTap]).pointer === pointer)) dart.assertFailed(null, I[0], 929, 12, "_pendingTap!.pointer == pointer");
    ...
    [_rejectPendingTap]() {
      if (!(this[_pendingTap] != null)) dart.assertFailed(null, I[0], 940, 12, "_pendingTap != null");
      let tracker = dart.nullCheck(this[_pendingTap]);
    ...
    [_registerTap](event, tracker) {
      if (!tracker[$_equals](this[_pendingTap])) dart.assertFailed(null, I[0], 970, 12, "tracker == _pendingTap");
      if (!(tracker.pointer === event.pointer)) dart.assertFailed(null, I[0], 971, 12, "tracker.pointer == event.pointer");
      this[_startSerialTapTimer]();
      if (!(this[_gestureResolutions][$_get](event.pointer) !== arena.GestureDisposition.rejected)) dart.assertFailed(null, I[0], 973, 12, "_gestureResolutions[event.pointer] != GestureDisposition.rejected");
      if (!this[_gestureResolutions][$containsKey](event.pointer)) {
        tracker.entry.resolve(arena.GestureDisposition.accepted);
      }
      if (!(this[_gestureResolutions][$_get](event.pointer) === arena.GestureDisposition.accepted)) dart.assertFailed(null, I[0], 977, 12, "_gestureResolutions[event.pointer] == GestureDisposition.accepted");
      this[_stopTrackingPointer](tracker);
      this[_pendingTap] = null;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["multitap.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAoDsB;IAAQ;;AAGX,MAAf,iBAAW;IACb;;;QAXoC;IAK/B,iBAAW;UAJF,AAAS,QAAD;AACO,IAA3B,gBAAM,QAAQ,YAAE;EAClB;;;;;;;;;;;;;;;;;;;;;;;;;;;yBAoCuC,OAAgB;AACrD,WAAK;AACsB,QAAzB,2BAAqB;AACoD,QAA1D,AAAS,AAAc,uDAAS,cAAS,KAAK,EAAE,SAAS;;IAE5E;wBAEsC;AACpC,UAAI;AACwB,QAA1B,2BAAqB;AAC4C,QAAlD,AAAS,AAAc,0DAAY,cAAS,KAAK;;IAEpE;4BAE0C,OAAc;AACzC,mBAAS,AAAM,AAAS,KAAV,eAAY;AACvC,YAAO,AAAO,AAAS,OAAV,aAAa,SAAS;IACrC;;AAGE,YAAO,AAA2B;IACpC;kBAEoC;AAClC,YAAO,AAAM,AAAQ,MAAT,aAAY;IAC1B;;;QA9C4B;QACZ;QACI;QACJ;IAgBX,2BAAqB;IAlBV;IAEA;UACJ,AAAiB,gBAAD;UAChB,AAAM,KAAD;UACL,AAAM,AAAQ,KAAT;IACJ,eAAE,AAAM,KAAD;IACQ,+BAAE,AAAM,KAAD;IACf,sBAAE,AAAM,KAAD;IACK,mCAAE,4CAA0B,gBAAgB;;EAAC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAiGrD;;;;;;IAYE;;;;;;IAcA;;;;;;;;;;;;qBAOa;AACrC,UAAI,AAAU;AACZ,gBAAQ,AAAM,KAAD;;;AAET,kBAAI,AAAgB,gCAChB,AAAY,4BACZ,AAAkB;AACpB,sBAAO;;AAET;;;;AAEA,oBAAO;;;;AAGb,YAAa,wBAAiB,KAAK;IACrC;sBAGwC;AACtC,UAAI;AACF,aAAc,AAAE,eAAX,yCAAmC,KAAK;AAE3C;cACK,MAAc,AAAE,eAAX,yCAA4C,AAAE,eAAX,+BAAyB,KAAK;AAGnE,UAAR;AACA,gBAAO,iBAAU,KAAK;cACjB,KAAI;AACY,wBAAU,4CACb,AAAM,KAAD,0BACN,AAAM,KAAD,sBACd,uBAAkB,AAAM,KAAD;AAEyC,UAAxE,+BAAqB,mBAAmB,cAAqB,AAAC,eAAhB,sBAAiB,OAAO;;;AAG1D,MAAhB,gBAAU,KAAK;IACjB;gBAEgC;AACT,MAArB;AACkB,oBAAU,qCACnB,KAAK,SACU,AAAS,AAAa,iDAAI,AAAM,KAAD,UAAU,yBAC7C,8CACD;AAEe,MAAlC,AAAS,uBAAC,AAAM,KAAD,UAAY,OAAO;AACyB,MAA3D,AAAQ,OAAD,gCAAsB,qBAAc,AAAM,KAAD;IAClD;mBAE+B;AACX,oBAAkC,eAAxB,AAAS,uBAAC,AAAM,KAAD;AAC3C,UAAU,yBAAN,KAAK;AACP,YAAI,AAAU;AACc,UAA1B,wBAAkB,OAAO;;AAEE,UAA3B,yBAAmB,OAAO;;YAEvB,KAAU,2BAAN,KAAK;AACd,aAAK,AAAQ,OAAD,yBAAyB,KAAK;AACxB,UAAhB,cAAQ,OAAO;;YAEZ,KAAU,6BAAN,KAAK;AACE,QAAhB,cAAQ,OAAO;;IAEnB;kBAGuB;IAAW;kBAGX;AACR,oBAAU,AAAS,uBAAC,OAAO;AAExC,UAAI,AAAQ,OAAD,YACP,2BACS,AAAE,AAAQ,eAAnB,6BAAsB,OAAO;AACZ,QAAnB,UAAU;;AAGZ,UAAI,OAAO;AACO,QAAhB,cAAQ,OAAO;;IAEnB;cAEyB;AACU,MAAjC,AAAU,yBAAO,AAAQ,OAAD;AAC0B,MAAlD,AAAQ,AAAM,OAAP,eAAkC;AAClB,MAAvB,qBAAe,OAAO;AACtB,UAAI;AACF,YAAI,AAAQ,OAAD,WAAI;AACL,UAAR;;AAEc,UAAd;AACA,cAAI,AAAU;AACJ,YAAR;;;;IAIR;;AAIU,MAAR;AACe,MAAT;IACR;;AAGuB,MAArB;AACA,UAAI;AACF,YAAI,AAAU;AACE,UAAd;;AAIgB,sBAAmB,eAAT;AACZ,QAAhB,kBAAY;AACI,QAAhB,cAAQ,OAAO;AAC8C,QAA9C,AAAS,AAAa,qDAAQ,AAAQ,OAAD;;AAEtC,MAAhB;IACF;wBAEmC;AACX,MAAtB;AAC0D,MAA3C,AAAS,AAAa,kDAAK,AAAQ,OAAD;AAG1B,MAAvB,qBAAe,OAAO;AACW,MAAjC,AAAU,yBAAO,AAAQ,OAAD;AACR,MAAhB;AACmB,MAAnB,kBAAY,OAAO;IACrB;yBAEoC;AACmB,MAA5C,AAAE,AAAM,eAAjB,+BAA4C;AACM,MAAlD,AAAQ,AAAM,OAAP,eAAkC;AAClB,MAAvB,qBAAe,OAAO;AACW,MAAjC,AAAU,yBAAO,AAAQ,OAAD;AACQ,MAAhC,eAAS,AAAQ,OAAD;AACR,MAAR;IACF;;AAG4C,MAA1C,AAAU,AAAO,AAAS,wDAAQ;AAClC,WAAO,AAAU;IACnB;qBAEgC;AACW,MAAzC,AAAQ,OAAD,+BAAqB;IAC9B;;AAGsD,MAApC,gCAAhB,wBAAoB,gBAAM,uCAAmB,iBAA7B;IAClB;;AAGE,UAAI;AACuB,QAAV,AAAE,eAAjB;AACsB,QAAtB,wBAAkB;;IAEtB;eAEkB;AAChB,YAAO,AAAQ,OAAD;AACd,UAAI;AAC+C,QAAjD,+BAAqB,eAA0B,eAAX;;IAExC;;AAGE,UAAI;AAC2D,QAA7D,+BAAqB,qBAAsC,eAAjB;;IAE9C;;AAG+B;IAAY;;;QAnQnC;QAKA;QACA;IAyCgB;IAYE;IAcA;IAEnB;IACM;IACe,kBAA8B;AA9E1D,8EACQ,UAAU,QAKV,IAAI,oBACJ,gBAAgB;;EACtB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBAgS4B;AAC5B,YAAO,AAAM,AAAQ,KAAT,aAAY;AACxB,UAAU,2BAAN,KAAK;AACP,aAAK,6BAAwB,KAAK,EAAE,sBAAe,AAAM,KAAD,OAAO;AACrD,UAAR;;AAEmD,UAAnD,sBAA2B,wCAAkB,KAAK;;YAE/C,KAAU,6BAAN,KAAK;AACN,QAAR;YACK,KAAU,yBAAN,KAAK;AACkB,QAAhC,mCAAoB;AACgC,QAApD,uBAA4B,wCAAkB,KAAK;AAC3C,QAAR;;IAEJ;wBAGsC;;AACpB,WAAhB;0BAAQ;AACK,MAAb,eAAS;AACuB,MAA1B,0BAAoB,KAAK;IACjC;;AAGkB,MAAhB,kBAAY;AACJ,MAAR;IACF;;AAGkC,MAAhC,mCAAoB;AACsB,MAA1C,AAAkB,wCAAgB;IACpC;;AAKE,UAAI;AACM,QAAR;;AAE0C,QAA1C,AAAM,mBAA2B;;IAErC;;AAGE,UAAI,mBAAa;AACyC,QAAxD,AAAkB,qCAAa,cAAuB,eAAd;;IAE5C;;;QA3EgB;QACQ;QACJ;QACH;IAkBZ,kBAAY;IACV;IAGK;IAzBI;IAIG,sBAAa,wCAAkB,KAAK;AAClD,0DACU,2BAAN,KAAK,UACU,AAAS,AAAa,iDAAI,AAAM,KAAD,UAAU,iBAAiB,qBAC9D,8CALH,eAAe;AAOoB,IAAlD,oCAAqB,sBAAa,AAAM,KAAD;AACvC,QAAI,AAAa,YAAD,MAAY;AAIxB,MAHF,eAAS,gBAAM,YAAY,EAAE;AACd,QAAb,eAAS;AACuD,QAAhE,AAAkB,yCAAiB,AAAM,KAAD,UAAU;;;EAGxD;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA0F6B;;;;;;IAIF;;;;;;IAGF;;;;;;IAIM;;;;;;IAGtB;;;;;;IAIoB;;;;;;;;;;;;;sBAKW;AACtC,YAAQ,AAAY,gCAAY,AAAM,KAAD;AAMpC,MALD,AAAW,yBAAC,AAAM,KAAD,UAAY,iDACR,aACZ,KAAK,gBACE,oCACG;AAEnB,UAAI;AAOA,QANF,+BAAqB,aAAa;AAK9B,UAJO,AAAC,eAAV,gBAAW,AAAM,KAAD,UAAU,4CACR,AAAM,KAAD,0BACN,AAAM,KAAD,sBACd,AAAM,KAAD;;;IAInB;kBAGuB;AACrB,WAAO,AAAY,gCAAY,OAAO;AACR,MAAV,AAAE,eAAtB,AAAW,yBAAC,OAAO;IACrB;kBAGuB;AACrB,WAAO,AAAY,gCAAY,OAAO;AACR,MAAV,AAAE,eAAtB,AAAW,yBAAC,OAAO;AACnB,YAAQ,AAAY,gCAAY,OAAO;IACzC;sBAEyB;AACvB,WAAO,AAAY,gCAAY,OAAO;AACX,MAA3B,AAAY,2BAAO,OAAO;AAC1B,UAAI;AAC8D,QAAhE,+BAAqB,eAAe,cAAiB,AAAC,eAAZ,kBAAa,OAAO;;IAElE;mBAEsB,SAAoB;AACxC,WAAO,AAAY,gCAAY,OAAO;AACX,MAA3B,AAAY,2BAAO,OAAO;AAC1B,UAAI;AAOA,QANF,+BAAqB,WAAW;AAK5B,UAJK,AAAC,eAAR,cAAS,OAAO,EAAE,gCACV,uBAAkB,OAAO,kBAChB,AAAS,QAAD,wBACP,AAAS,QAAD;;;AAI9B,UAAI;AACkD,QAApD,+BAAqB,SAAS,cAAW,AAAC,eAAN,YAAO,OAAO;;IAEtD;uBAE0B,SAAoB;AAC5C,WAAO,AAAY,gCAAY,OAAO;AACtC,UAAI;AAUA,QATF,+BAAqB,iBAAiB;AAQnC,UAPY,AAAC,eAAd,oBACE,OAAO,EACP,4CACkB,AAAa,YAAD,wBACb,AAAa,YAAD,cACrB,uBAAkB,OAAO;;;IAKzC;;AAI0B,0BAAgB,yBAAqB,AAAY;AACzE,eAAuB,UAAW,cAAa;AAC7B,QAAhB,AAAQ,OAAD;;AAGT,WAAO,AAAY;AACJ,MAAT;IACR;;AAG+B;IAAU;;;QAxHlC;QACC;QAKA;QACA;IAKqB;IAIF;IAGF;IAIM;IAOF;IAED,oBAAgC;IAhCrD;AADP,6EAEQ,UAAU,QAKV,IAAI,oBACJ,gBAAgB;;EACtB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA6IW;;;;;;IAGA;;;;;;IAGW;;;;;;IAOd;;;;;;IAYA;;;;;;;;;;;;;;;;;QAlCH;QACG;QACM;QACT;QACA;IAJA;IAES;IACT;IACA;UACK,AAAM,KAAD,GAAG;IACD,wBAAgB,KAAd,aAAa,EAAb,aAAiB,cAAc;;;;;;;;;;;;;;;;IA0D1C;;;;;;;;;;;;QAVH;;UACK,AAAM,KAAD;UACL,AAAM,KAAD,GAAG;;EAAE;;;;;;;;;;;;;IAmCT;;;;;;IAGA;;;;;;IAGY;;;;;;IAYf;;;;;;;;;;;;;;;;QA1BH;QACG;QACH;QACA;IAHA;IAEA;IACA;UACK,AAAM,KAAD,GAAG;IACD,yBAAgB,KAAd,aAAa,EAAb,aAAiB,cAAc;;;;;;;;;;;;;;;;;;;;;;;;;;;IAiHtB;;;;;;IAUE;;;;;;IAWJ;;;;;;;;;;;;AAYE,YAAA,AAAY;IAAO;qBAGV;AACrC,UAAI,AAAgB,gCAChB,AAAkB,kCAClB,AAAc;AAChB,cAAO;;AAET,YAAa,wBAAiB,KAAK;IACrC;sBAGwC;AACtC,UAAK,AAAe,sCAAe,4BAAsB,AAAe,6BAAM,KAAK,KAC5E;AACG,QAAR;;AAEc,MAAhB,gBAAU,KAAK;IACjB;4BAEuC,KAAsB;AAC3D,YAAO,AAAI,AAEP,IAFM,wBACH,AAAI,GAAD,eAAe,KAAK,KACvB,AAAI,GAAD,yBAAyB,KAAK;IAC1C;gBAEgC;AACT,MAArB;AACA,UAAI;AACyB,sBAAU,uDACnB,AAAM,KAAD,0BACN,AAAM,KAAD,sBACd,uBAAkB,AAAM,KAAD,oBACpB,AAAM,KAAD,iBACP,AAAe,AAAO,gCAAE;AAEuC,QAAxE,+BAAqB,mBAAmB,cAAqB,AAAC,eAAhB,sBAAiB,OAAO;;AAEtD,oBAAU,+CACT,6BACV,KAAK,SACU,AAAS,AAAa,iDAAI,AAAM,KAAD,UAAU,yBAC7C;AAEpB,YAAO,AAAY;AACE,MAArB,oBAAc,OAAO;AACsC,MAA3D,AAAQ,OAAD,gCAAsB,qBAAc,AAAM,KAAD;IAClD;mBAE+B;AAC7B,YAAO,AAAY;AACnB,YAAkB,AAAE,AAAQ,eAArB,+BAAwB,AAAM,KAAD;AAClB,oBAAqB,eAAX;AAC5B,UAAU,yBAAN,KAAK;AACqB,QAA5B,mBAAa,KAAK,EAAE,OAAO;YACtB,KAAU,2BAAN,KAAK;AACd,aAAK,AAAQ,OAAD,yBAAyB,KAAK;AAChC,UAAR;;YAEG,KAAU,6BAAN,KAAK;AACN,QAAR;;IAEJ;kBAGuB;AACrB,YAAO,AAAY;AACnB,YAAkB,AAAE,AAAQ,eAArB,+BAAwB,OAAO;AACoB,MAA1D,AAAmB,iCAAC,OAAO,EAAuB;IACpD;kBAGuB;AACqC,MAA1D,AAAmB,iCAAC,OAAO,EAAuB;AAC1C,MAAR;IACF;;AAGE,YAAO,AAAY;AACD,oBAAqB,eAAX;AACV,MAAlB,oBAAc;AAIyB,MAAvC,mBAAa,AAAe,AAAO,gCAAE;AACrC,WAAK,AAAoB,wCAAY,AAAQ,OAAD;AACQ,QAAlD,AAAQ,AAAM,OAAP,eAAkC;;AAEd,MAA7B,2BAAqB,OAAO;IAC9B;;AAIU,MAAR;AACe,MAAT;IACR;;AAGE,UAAI;AACiB,QAAnB;;AAEgB,MAAlB,oBAAc;AACQ,MAAtB,AAAe;AACY,MAA3B,AAAoB;AACC,MAArB;IACF;mBAEiC,OAAmB;AAClD,WAAO,AAAQ,OAAD,WAAI;AAClB,YAAO,AAAQ,AAAQ,OAAT,aAAY,AAAM,KAAD;AACT,MAAtB;AACA,YAAO,AAAmB,AAAgB,iCAAf,AAAM,KAAD,cAAgC;AAChE,WAAK,AAAoB,wCAAY,AAAM,KAAD;AACU,QAAlD,AAAQ,AAAM,OAAP,eAAkC;;AAE3C,YAAO,AAAmB,AAAgB,iCAAf,AAAM,KAAD,cAAgC;AACnC,MAA7B,2BAAqB,OAAO;AAGV,MAAlB,oBAAc;AACU,MAAxB,eAAS,KAAK,EAAE,OAAO;AACI,MAA3B,AAAe,2BAAI,OAAO;IAC5B;2BAEsC;AACK,MAAzC,AAAQ,OAAD,+BAAqB;IAC9B;;AAGsD,MAApC,gCAAhB,wBAAoB,gBAAM,uCAAmB,iBAA7B;IAClB;;AAGE,UAAI;AACuB,QAAV,AAAE,eAAjB;AACsB,QAAtB,wBAAkB;;IAEtB;eAE6B,OAAmB;AAC9C,UAAI;AACuB,sBAAU,qDACjB,AAAM,KAAD,0BACN,AAAM,KAAD,sBACd,uBAAkB,AAAQ,OAAD,kBACxB,AAAe,AAAO,gCAAE;AAEmC,QAApE,+BAAqB,iBAAiB,cAAmB,AAAC,eAAd,oBAAe,OAAO;;IAEtE;mBAEsB;AACpB,UAAI;AAC2B,sBAAU,gDAC9B,KAAK;AAE8D,QAA5E,+BAAqB,qBAAqB,cAAuB,AAAC,eAAlB,wBAAmB,OAAO;;IAE9E;;AAG+B;IAAY;;;QAjNnC;QACA;IAasB;IAUE;IAWJ;IAErB;IACiB,uBAA8B;IACnB,4BAA+C;IACrE;AAzCb,8EACQ,UAAU,oBACV,gBAAgB;;EACtB","file":"../../../../../../../../../../packages/flutter/src/gestures/multitap.dart.lib.js"}');
  // Exports:
  return {
