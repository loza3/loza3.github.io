define(['dart_sdk', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/gestures/velocity_tracker.dart'], (function load__packages__flutter__src__gestures__drag_details_dart(dart_sdk, packages__flutter__src__foundation__object$46dart, packages__flutter__src__gestures__velocity_tracker$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/gestures/drag_details.dart",
  ...
  (drag_details.DragStartDetails.new = function(opts) {
    ...
    this[kind$] = kind;
    if (!(globalPosition !== null)) dart.assertFailed(null, I[0], 76, 15, "globalPosition != null");
  ...
  (drag_details.DragUpdateDetails.new = function(opts) {
    ...
    if (!(delta !== null)) dart.assertFailed(null, I[0], 143, 15, "delta != null");
    if (!(primaryDelta == null || primaryDelta === delta.dx && delta.dy === 0.0 || primaryDelta === delta.dy && delta.dx === 0.0)) dart.assertFailed(null, I[0], 145, 10, "primaryDelta == null\n           || (primaryDelta == delta.dx && delta.dy == 0.0)\n           || (primaryDelta == delta.dy && delta.dx == 0.0)");
  ...
  (drag_details.DragEndDetails.new = function(opts) {
    ...
    if (!(velocity !== null)) dart.assertFailed(null, I[0], 222, 15, "velocity != null");
    if (!(primaryVelocity == null || primaryVelocity === velocity.pixelsPerSecond.dx || primaryVelocity === velocity.pixelsPerSecond.dy)) dart.assertFailed(null, I[0], 224, 10, "primaryVelocity == null\n           || primaryVelocity == velocity.pixelsPerSecond.dx\n           || primaryVelocity == velocity.pixelsPerSecond.dy");
    ;
