define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__cupertino__interface_level_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__foundation__debug$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C[0] = dart.constList([C[1] || CT.C1, C[2] || CT.C2], interface_level.CupertinoUserInterfaceLevelData);
    },
    get C3() {
      return C[3] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 43,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/cupertino/interface_level.dart"
      });
    }
  }, false);
  ...
  var I = [
    ...
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/cupertino/interface_level.dart"
  ];
  ...
  dart.defineLazy(interface_level.CupertinoUserInterfaceLevelData, {
    /*interface_level.CupertinoUserInterfaceLevelData.values*/get values() {
      return C[0] || CT.C0;
    },
    /*interface_level.CupertinoUserInterfaceLevelData.base*/get base() {
      return C[1] || CT.C1;
    },
    /*interface_level.CupertinoUserInterfaceLevelData.elevated*/get elevated() {
      return C[2] || CT.C2;
    }
  }, false);
  ...
  interface_level.CupertinoUserInterfaceLevel = class CupertinoUserInterfaceLevel extends framework.InheritedWidget {
    ...
    static of(context) {
      if (!(context !== null)) dart.assertFailed(null, I[1], 67, 12, "context != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["interface_level.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAoBA;;;;;;;;;;;;MANK,sDAAM;;;MAET,oDAAI;;;MAGJ,wDAAQ;;;;;;;;;;;IA8B8B;;;;;;;;;;;;uBAGc;;AAAc,YAAA,AAAU,AAAM,UAAP,aAAU;IAAK;cAanC;AACrD,YAAO,AAAQ,OAAD;AACqB,kBAAQ,AAAQ,OAAD;AAClD,UAAI,KAAK;AACP,cAAO,AAAM,MAAD;;AAUb,MARD,WAAM,4BAAY,AAChB,kHACA,sGACA,kGACA,kGACA,sEACA,4BACA,gBAAI,OAAO;IAEf;mBAe6D;AAC3D,YAAO,AAAQ,OAAD;AACqB,kBAAQ,AAAQ,OAAD;AAClD,UAAI,KAAK;AACP,cAAO,AAAM,MAAD;;AAEd,YAAO;IACT;wBAGqD;AACd,MAA/B,0BAAoB,UAAU;AACwD,MAA5F,AAAW,UAAD,KAAK,4DAA8C,wBAAwB;IACvF;;;QAjEQ;QACmC;QAC1B;;UACL,AAAK,IAAD;IACN,cAAE,IAAI;AALV,+EACE,GAAG,SAEM,KAAK;;EAEN","file":"../../../../../../../../../../packages/flutter/src/cupertino/interface_level.dart.lib.js"}');
  // Exports:
  return {
