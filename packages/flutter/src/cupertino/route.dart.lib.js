define(['dart_sdk', 'packages/flutter/src/foundation/change_notifier.dart', 'packages/flutter/src/animation/listener_helpers.dart', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/animation/curves.dart', 'packages/flutter/src/painting/decoration.dart', 'packages/flutter/src/gestures/monodrag.dart', 'packages/flutter/src/rendering/stack.dart', 'packages/flutter/src/rendering/proxy_box.dart', 'packages/flutter/src/gestures/drag_details.dart', 'packages/flutter/src/gestures/events.dart', 'packages/flutter/src/animation/animation_controller.dart', 'packages/flutter/src/painting/_network_image_web.dart', 'packages/flutter/src/cupertino/text_theme.dart', 'packages/flutter/src/cupertino/interface_level.dart', 'packages/flutter/src/painting/alignment.dart', 'packages/flutter/src/cupertino/debug.dart'], (function load__packages__flutter__src__cupertino__route_dart(dart_sdk, packages__flutter__src__foundation__change_notifier$46dart, packages__flutter__src__animation__listener_helpers$46dart, packages__flutter__src__widgets__title$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__animation__curves$46dart, packages__flutter__src__painting__decoration$46dart, packages__flutter__src__gestures__monodrag$46dart, packages__flutter__src__rendering__stack$46dart, packages__flutter__src__rendering__proxy_box$46dart, packages__flutter__src__gestures__drag_details$46dart, packages__flutter__src__gestures__events$46dart, packages__flutter__src__animation__animation_controller$46dart, packages__flutter__src__painting___network_image_web$46dart, packages__flutter__src__cupertino__text_theme$46dart, packages__flutter__src__cupertino__interface_level$46dart, packages__flutter__src__painting__alignment$46dart, packages__flutter__src__cupertino__debug$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        ...
        [_Location_column]: 27,
        [_Location_line]: 228,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/cupertino/route.dart"
      });
    },
    get C2() {
    ...
    get C21() {
      return C[21] = dart.constList([C[22] || CT.C22, C[23] || CT.C23], ui.Color);
    },
    get C20() {
    ...
    get C24() {
      return C[24] = dart.const({
        ...
        [Color_value]: 0,
        [CupertinoDynamicColor_darkHighContrastElevatedColor]: C[25] || CT.C25,
        [CupertinoDynamicColor_highContrastElevatedColor]: C[26] || CT.C26,
        [CupertinoDynamicColor_darkElevatedColor]: C[25] || CT.C25,
        [CupertinoDynamicColor_elevatedColor]: C[26] || CT.C26,
        [CupertinoDynamicColor_darkHighContrastColor]: C[25] || CT.C25,
        [CupertinoDynamicColor_highContrastColor]: C[26] || CT.C26,
        [CupertinoDynamicColor_darkColor]: C[25] || CT.C25,
        [CupertinoDynamicColor_color]: C[26] || CT.C26,
        [CupertinoDynamicColor__debugResolveContext]: null,
        [CupertinoDynamicColor__debugLabel]: null,
        [CupertinoDynamicColor__effectiveColor]: C[26] || CT.C26
      });
    },
    get C27() {
    ...
    get C29() {
      return C[29] = dart.const({
        __proto__: widget_inspector._Location.prototype,
        [_Location_name]: "DisplayFeatureSubScreen",
        [_Location_column]: 14,
        [_Location_line]: 1096,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/cupertino/route.dart"
      });
    ...
    get C34() {
      return C[34] = dart.fn(route$._buildCupertinoDialogTransitions, T$.BuildContextAndAnimationOfdoubleAndAnimationOfdouble__ToWidget());
    },
    get C35() {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/cupertino/route.dart",
  ...
  route$.CupertinoRouteTransitionMixin$ = dart.generic(T => {
    class CupertinoRouteTransitionMixin extends pages.PageRoute$(T) {
      ...
      static _isPopGestureEnabled(T, route) {
        ...
        if (dart.nullCheck(route.animation).status !== animation$.AnimationStatus.completed) {
          return false;
        }
      ...
      static _startPopGesture(T, route) {
        if (!route$.CupertinoRouteTransitionMixin._isPopGestureEnabled(T, route)) dart.assertFailed(null, I[0], 249, 12, "_isPopGestureEnabled(route)");
    ...
    CupertinoRouteTransitionMixin[dart.mixinOn] = PageRoute => class CupertinoRouteTransitionMixin extends PageRoute {
      ...
      get previousTitle() {
        if (!(this[_previousTitle$] != null)) dart.assertFailed("Cannot read the previousTitle for a route that has not yet been installed", I[0], 118, 7, "_previousTitle != null");
      ...
      get barrierColor() {
        return this.fullscreenDialog ? null : route$._kCupertinoPageTransitionBarrierColor;
      }
      get barrierLabel() {
        return null;
      }
  ...
  route$.CupertinoPageRoute$ = dart.generic(T => {
    ...
    (CupertinoPageRoute.new = function(opts) {
      ...
      if (!(builder !== null)) dart.assertFailed(null, I[0], 345, 15, "builder != null");
      if (!(maintainState !== null)) dart.assertFailed(null, I[0], 346, 15, "maintainState != null");
      if (!(fullscreenDialog !== null)) dart.assertFailed(null, I[0], 347, 15, "fullscreenDialog != null");
      CupertinoPageRoute.__proto__.new.call(this, {settings: settings, fullscreenDialog: fullscreenDialog});
      if (!this.opaque) dart.assertFailed(null, I[0], 348, 12, "opaque");
  ...
  route$._PageBasedCupertinoPageRoute$ = dart.generic(T => {
    ...
    (_PageBasedCupertinoPageRoute.new = function(opts) {
      let page = opts && 'page' in opts ? opts.page : null;
      if (!(page !== null)) dart.assertFailed(null, I[0], 374, 15, "page != null");
      _PageBasedCupertinoPageRoute.__proto__.new.call(this, {settings: page});
      if (!this.opaque) dart.assertFailed(null, I[0], 376, 12, "opaque");
  ...
  route$.CupertinoPage$ = dart.generic(T => {
    ...
    (CupertinoPage.new = function(opts) {
      ...
      if (!(child !== null)) dart.assertFailed(null, I[0], 424, 15, "child != null");
      if (!(maintainState !== null)) dart.assertFailed(null, I[0], 425, 15, "maintainState != null");
      if (!(fullscreenDialog !== null)) dart.assertFailed(null, I[0], 426, 15, "fullscreenDialog != null");
  ...
  route$.CupertinoPageTransition = class CupertinoPageTransition extends framework.StatelessWidget {
    ...
    build(context) {
      if (!debug.debugCheckHasDirectionality(context)) dart.assertFailed(null, I[0], 510, 12, "debugCheckHasDirectionality(context)");
  ...
  (route$.CupertinoPageTransition.new = function(opts) {
    ...
    this[child$0] = child;
    if (!(linearTransition !== null)) dart.assertFailed(null, I[0], 465, 15, "linearTransition != null");
  ...
  route$.CupertinoFullscreenDialogTransition = class CupertinoFullscreenDialogTransition extends framework.StatelessWidget {
    ...
    build(context) {
      if (!debug.debugCheckHasDirectionality(context)) dart.assertFailed(null, I[0], 573, 12, "debugCheckHasDirectionality(context)");
      let textDirection = basic.Directionality.of(context);
  ...
  route$._CupertinoBackGestureDetector$ = dart.generic(T => {
    ...
    (_CupertinoBackGestureDetector.new = function(opts) {
      ...
      this[child$2] = child;
      if (!(enabledCallback !== null)) dart.assertFailed(null, I[0], 604, 15, "enabledCallback != null");
      if (!(onStartPopGesture !== null)) dart.assertFailed(null, I[0], 605, 15, "onStartPopGesture != null");
      if (!(child !== null)) dart.assertFailed(null, I[0], 606, 15, "child != null");
  ...
  route$._CupertinoBackGestureDetectorState$ = dart.generic(T => {
    class _CupertinoBackGestureDetectorState extends framework.State$(route$._CupertinoBackGestureDetector$(T)) {
      ...
      set [_recognizer](library$32package$58flutter$47src$47cupertino$47route$46dart$58$58_recognizer$35param) {
        this[___CupertinoBackGestureDetectorState__recognizer] = library$32package$58flutter$47src$47cupertino$47route$46dart$58$58_recognizer$35param;
      }
      initState() {
        let t0;
        super.initState();
      ...
      [_handleDragStart](details) {
        if (!this.mounted) dart.assertFailed(null, I[0], 640, 12, "mounted");
        if (!(this[_backGestureController] == null)) dart.assertFailed(null, I[0], 641, 12, "_backGestureController == null");
        this[_backGestureController] = this.widget.onStartPopGesture();
      }
      [_handleDragUpdate](details) {
        if (!this.mounted) dart.assertFailed(null, I[0], 646, 12, "mounted");
        if (!(this[_backGestureController] != null)) dart.assertFailed(null, I[0], 647, 12, "_backGestureController != null");
      ...
      [_handleDragEnd](details) {
        if (!this.mounted) dart.assertFailed(null, I[0], 652, 12, "mounted");
        if (!(this[_backGestureController] != null)) dart.assertFailed(null, I[0], 653, 12, "_backGestureController != null");
      ...
      [_handleDragCancel]() {
        let t0;
        if (!this.mounted) dart.assertFailed(null, I[0], 659, 12, "mounted");
      ...
      build(context) {
        if (!debug.debugCheckHasDirectionality(context)) dart.assertFailed(null, I[0], 683, 12, "debugCheckHasDirectionality(context)");
  ...
  route$._CupertinoBackGestureController$ = dart.generic(T => {
      ...
      dragEnd(velocity) {
        ...
        if (this.controller.isAnimating) {
          ...
          function animationStatusCallback$35get() {
            let t1;
            t1 = animationStatusCallback;
            return t1 == null ? dart.throw(new _internal.LateError.localNI("animationStatusCallback")) : t1;
          }
    ...
    (_CupertinoBackGestureController.new = function(opts) {
      ...
      if (!(navigator !== null)) dart.assertFailed(null, I[0], 728, 15, "navigator != null");
      if (!(controller !== null)) dart.assertFailed(null, I[0], 729, 15, "controller != null");
  ...
  route$._CupertinoEdgeShadowDecoration = class _CupertinoEdgeShadowDecoration extends decoration.Decoration {
    ...
    static lerp(a, b, t) {
      let t4, t4$;
      if (!(t !== null)) dart.assertFailed(null, I[0], 851, 12, "t != null");
      if (a == null && b == null) {
        return null;
      }
      if (a == null) {
        return dart.nullCheck(b)[_colors] == null ? b : new route$._CupertinoEdgeShadowDecoration.__(dart.nullCheck(b[_colors])[$map](ui.Color, dart.fn(color => dart.nullCheck(ui.Color.lerp(null, color, t)), T$.ColorToColor()))[$toList]());
      }
      if (b == null) {
        return a[_colors] == null ? a : new route$._CupertinoEdgeShadowDecoration.__(dart.nullCheck(a[_colors])[$map](ui.Color, dart.fn(color => dart.nullCheck(ui.Color.lerp(null, color, 1.0 - t)), T$.ColorToColor()))[$toList]());
      }
      if (!(b[_colors] != null || a[_colors] != null)) dart.assertFailed(null, I[0], 861, 12, "b._colors != null || a._colors != null");
      if (!(b[_colors] == null || a[_colors] == null || dart.nullCheck(a[_colors])[$length] === dart.nullCheck(b[_colors])[$length])) dart.assertFailed(null, I[0], 864, 12, "b._colors == null || a._colors == null || a._colors!.length == b._colors!.length");
      return new route$._CupertinoEdgeShadowDecoration.__((() => {
        let t3 = T$.JSArrayOfColor().of([]);
        for (let i = 0; i < dart.nullCheck(b[_colors])[$length]; i = i + 1)
          t3.push(dart.nullCheck(ui.Color.lerp((t4 = a[_colors], t4 == null ? null : t4[$_get](i)), (t4$ = b[_colors], t4$ == null ? null : t4$[$_get](i)), t)));
        return t3;
      })());
    }
    lerpFrom(a, t) {
      if (route$._CupertinoEdgeShadowDecoration.is(a)) {
        return dart.nullCheck(route$._CupertinoEdgeShadowDecoration.lerp(a, this, t));
      }
      return dart.nullCheck(route$._CupertinoEdgeShadowDecoration.lerp(null, this, t));
    }
    lerpTo(b, t) {
      if (route$._CupertinoEdgeShadowDecoration.is(b)) {
        return dart.nullCheck(route$._CupertinoEdgeShadowDecoration.lerp(this, b, t));
      }
  ...
  route$._CupertinoEdgeShadowPainter = class _CupertinoEdgeShadowPainter extends decoration.BoxPainter {
    ...
    paint(canvas, offset, configuration) {
      ...
      if (!(textDirection != null)) dart.assertFailed(null, I[0], 960, 12, "textDirection != null");
      let start = null;
      ...
      for (let dx = 0; dx < shadowWidth; dx = dx + 1) {
        ...
        let paint = (t4 = ui.Paint.new(), (() => {
          t4.color = dart.nullCheck(ui.Color.lerp(colors[$_get](bandColorIndex), colors[$_get](bandColorIndex + 1), dx[$modulo](bandWidth) / bandWidth));
          return t4;
        })());
  ...
  (route$._CupertinoEdgeShadowPainter.new = function(_decoration, onChange) {
    ...
    if (!(_decoration !== null)) dart.assertFailed(null, I[0], 918, 14, "_decoration != null");
    if (!(_decoration[_colors] == null || dart.nullCheck(_decoration[_colors])[$length] > 1)) dart.assertFailed(null, I[0], 919, 14, "_decoration._colors == null || _decoration._colors!.length > 1");
  ...
  var anchorPoint$ = dart.privateName(route$, "CupertinoModalPopupRoute.anchorPoint");
  ...
  route$.CupertinoModalPopupRoute$ = dart.generic(T => {
    class CupertinoModalPopupRoute extends routes.PopupRoute$(T) {
      ...
      static ['_#new#tearOff'](T, opts) {
        ...
        let barrierColor = opts && 'barrierColor' in opts ? opts.barrierColor : C[24] || CT.C24;
        ...
        return new (route$.CupertinoModalPopupRoute$(T)).new({builder: builder, barrierLabel: barrierLabel, barrierColor: barrierColor, barrierDismissible: barrierDismissible, semanticsDismissible: semanticsDismissible, filter: filter, settings: settings, anchorPoint: anchorPoint});
      }
      get barrierDismissible() {
        let t4;
        t4 = this[_barrierDismissible];
        return t4 == null ? true : t4;
      }
      get semanticsDismissible() {
        let t4;
        t4 = this[_semanticsDismissible];
      ...
      get [_offsetTween]() {
        let t4;
        t4 = this[__CupertinoModalPopupRoute__offsetTween];
        return t4 == null ? dart.throw(new _internal.LateError.fieldNI("_offsetTween")) : t4;
      }
      set [_offsetTween](library$32package$58flutter$47src$47cupertino$47route$46dart$58$58_offsetTween$35param) {
        this[__CupertinoModalPopupRoute__offsetTween] = library$32package$58flutter$47src$47cupertino$47route$46dart$58$58_offsetTween$35param;
      }
      createAnimation() {
        if (!(this[_animation] == null)) dart.assertFailed(null, I[0], 1076, 12, "_animation == null");
        ...
        this[_offsetTween] = new (T$.TweenOfOffset()).new({begin: C[27] || CT.C27, end: ui.Offset.zero});
        return dart.nullCheck(this[_animation]);
      }
      buildPage(context, animation, secondaryAnimation) {
        return new interface_level.CupertinoUserInterfaceLevel.new({data: interface_level.CupertinoUserInterfaceLevelData.elevated, child: new display_feature_sub_screen.DisplayFeatureSubScreen.new({anchorPoint: this.anchorPoint, child: new basic.Builder.new({builder: this.builder, $creationLocationd_0dea112b090073317d4: C[28] || CT.C28}), $creationLocationd_0dea112b090073317d4: C[29] || CT.C29}), $creationLocationd_0dea112b090073317d4: C[30] || CT.C30});
      }
      buildTransitions(context, animation, secondaryAnimation, child) {
        return new basic.Align.new({alignment: alignment.Alignment.bottomCenter, child: new basic.FractionalTranslation.new({translation: this[_offsetTween].evaluate(dart.nullCheck(this[_animation])), child: child, $creationLocationd_0dea112b090073317d4: C[31] || CT.C31}), $creationLocationd_0dea112b090073317d4: C[32] || CT.C32});
      }
    }
  ...
  route$.CupertinoDialogRoute$ = dart.generic(T => {
    class CupertinoDialogRoute extends routes.RawDialogRoute$(T) {
      static ['_#new#tearOff'](T, opts) {
        ...
        let settings = opts && 'settings' in opts ? opts.settings : null;
        let anchorPoint = opts && 'anchorPoint' in opts ? opts.anchorPoint : null;
        return new (route$.CupertinoDialogRoute$(T)).new({builder: builder, context: context, barrierDismissible: barrierDismissible, barrierColor: barrierColor, barrierLabel: barrierLabel, transitionDuration: transitionDuration, transitionBuilder: transitionBuilder, settings: settings, anchorPoint: anchorPoint});
      }
    }
    (CupertinoDialogRoute.new = function(opts) {
      ...
      let barrierColor = opts && 'barrierColor' in opts ? opts.barrierColor : null;
      let barrierLabel = opts && 'barrierLabel' in opts ? opts.barrierLabel : null;
      let transitionDuration = opts && 'transitionDuration' in opts ? opts.transitionDuration : C[33] || CT.C33;
      let transitionBuilder = opts && 'transitionBuilder' in opts ? opts.transitionBuilder : C[34] || CT.C34;
      let settings = opts && 'settings' in opts ? opts.settings : null;
      let anchorPoint = opts && 'anchorPoint' in opts ? opts.anchorPoint : null;
      if (!(barrierDismissible !== null)) dart.assertFailed(null, I[0], 1359, 15, "barrierDismissible != null");
      CupertinoDialogRoute.__proto__.new.call(this, {pageBuilder: dart.fn((context, animation, secondaryAnimation) => builder(context), T$.BuildContextAndAnimationOfdoubleAndAnimationOfdoubleToWidget()), barrierLabel: (t4 = barrierLabel, t4 == null ? localizations.CupertinoLocalizations.of(context).modalBarrierDismissLabel : t4), barrierColor: (t4$ = barrierColor, t4$ == null ? colors.CupertinoDynamicColor.resolve(route$.kCupertinoModalBarrierColor, context) : t4$), barrierDismissible: barrierDismissible, transitionDuration: transitionDuration, transitionBuilder: transitionBuilder, settings: settings, anchorPoint: anchorPoint});
      ;
  ...
  route$._buildCupertinoDialogTransitions = function _buildCupertinoDialogTransitions(context, animation, secondaryAnimation, child) {
    ...
    if (animation.status === animation$.AnimationStatus.reverse) {
      return new transitions.FadeTransition.new({opacity: fadeAnimation, child: child, $creationLocationd_0dea112b090073317d4: C[35] || CT.C35});
    }
    return new transitions.FadeTransition.new({opacity: fadeAnimation, child: new transitions.ScaleTransition.new({scale: animation.drive(core.double, route$._dialogScaleTween), child: child, $creationLocationd_0dea112b090073317d4: C[36] || CT.C36}), $creationLocationd_0dea112b090073317d4: C[37] || CT.C37});
  };
  route$.showCupertinoDialog = function showCupertinoDialog(T, opts) {
    ...
    let routeSettings = opts && 'routeSettings' in opts ? opts.routeSettings : null;
    let anchorPoint = opts && 'anchorPoint' in opts ? opts.anchorPoint : null;
    if (!(builder !== null)) dart.assertFailed(null, I[0], 1295, 10, "builder != null");
    if (!(useRootNavigator !== null)) dart.assertFailed(null, I[0], 1296, 10, "useRootNavigator != null");
    return navigator.Navigator.of(context, {rootNavigator: useRootNavigator}).push(T, new (route$.CupertinoDialogRoute$(T)).new({builder: builder, context: context, barrierDismissible: barrierDismissible, barrierLabel: barrierLabel, barrierColor: colors.CupertinoDynamicColor.resolve(route$.kCupertinoModalBarrierColor, context), settings: routeSettings, anchorPoint: anchorPoint}));
  };
  dart.defineLazy(route$, {
    ...
    /*route$._kCupertinoPageTransitionBarrierColor*/get _kCupertinoPageTransitionBarrierColor() {
      return C[38] || CT.C38;
    },
    ...
    /*route$._kBottomUpTween*/get _kBottomUpTween() {
      return new (T$.TweenOfOffset()).new({begin: C[27] || CT.C27, end: ui.Offset.zero});
    },
  ...
  }, '{"version":3,"sourceRoot":"","sources":["route.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;oCAgKwD;AACpD,cAAsB,AAAE,gBAAjB,AAAM,KAAD;MACd;qCAuBiD;AAG/C,YAAI,AAAM,KAAD;AACP,gBAAO;;AAIT,YAAI,AAAM,KAAD;AACP,gBAAO;;AAIT,YAAI,AAAM,KAAD;AACP,gBAAO;;AAGT,YAAI,AAAM,KAAD;AACP,gBAAO;;AAGT,YAAmB,AAAE,eAAjB,AAAM,KAAD,uBAAsC;AAC7C,gBAAO;;AAKT,YAA4B,AAAE,eAA1B,AAAM,KAAD,gCAA+C;AACtD,gBAAO;;AAGT,YAAI,4DAAuB,KAAK;AAC9B,gBAAO;;AAIT,cAAO;MACT;iCAyB2E;AACzE,aAAO,6DAAqB,KAAK;AAEjC,cAAO,kEACqB,eAAf,AAAM,KAAD,yBACY,eAAhB,AAAM,KAAD;MAErB;qCAiBe,OACA,SACK,WACA,oBACX;AAOI,+BAAmB,4DAAuB,KAAK;AAC1D,YAAI,AAAM,KAAD;AACP,gBAAO,4EACkB,SAAS,2BACP,kBAAkB,oBACzB,gBAAgB,SAC3B,KAAK;;AAGd,gBAAO,gEACkB,SAAS,2BACP,kBAAkB,oBACzB,gBAAgB,SAC3B,qEACY,cAAM,6DAAwB,KAAK,wCACjC,cAAM,yDAAoB,KAAK,wEAC3C,KAAK;;MAIpB;;;MA3MwB;;;;;;;AAiBtB,cACE,AAAe,kDACf;AAEF,cAAqB,gBAAd;MACT;wBAGuC;AACvB,kCAAoC,wCAAd,aAAa,IAC7C,AAAc,aAAD,SACb;AACJ,YAAI,AAAe;AAC2C,UAA5D,wBAAiB,sCAAuB,mBAAmB;;AAEhB,UAA7B,AAAE,eAAhB,+BAAwB,mBAAmB;;AAEP,QAAhC,wBAAkB,aAAa;MACvC;;AAImC;MAAiC;;AAGzC,uCAAmB,OAAO;MAAqC;;AAG9D;MAAI;sBAGc;AAE5C,cAAiB,AAAiC,yCAA3C,SAAS,MAAsC,AAAU,SAAD;MACjE;;AAsBiC,2EAAuB;MAAK;;AAW/B,4EAAqB;MAAK;gBA0C1B,SAA2B,WAA6B;AACvE,oBAAQ,kBAAa,OAAO;AAC5B,qBAAS,sCACP,0BACO,aACb,KAAK;AAEd,aAAO,AAQN;AAPC,cAAI,AAAM,KAAD;AAIL,YAHF,WAAmB,sCAA2B,kCAC5C,gCAAa,AAAyD,sCAA/B,AAAS,sBAAK,sBACrD,oCAAiB;;AAGrB,gBAAO;;AAET,cAAO,OAAM;MACf;uBA+DqC,SAA2B,WAA6B,oBAA2B;AACtH,cAAO,8DAAwB,MAAM,OAAO,EAAE,SAAS,EAAE,kBAAkB,EAAE,KAAK;MACpF;;;MAhNwB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA4PJ;;;;;;MAMN;;;;;;MAGH;;;;;;;;;;;;;;mBANsB;;AAAY,aAAQ,OAAO;cAAf,AAAO;MAAS;;AASpC,cAAS,AAA8B,oBAAnB,eAAG,AAAS,sBAAK;MAAE;;;UAxBhD;UACT;UACC;UACD;UACC;MAJQ;MACT;MAEA;YAEK,AAAQ,OAAD;YACP,AAAc,aAAD;YACb,AAAiB,gBAAD;AAR5B,6DAGQ,QAAQ,oBAER,gBAAgB;AAItB,WAAO;IACT;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA8B8B,cAAS,2BAAT;MAA4B;mBAGzB;AAAY,cAAA,AAAM;MAAK;;AAGnC,cAAA,AAAM;MAAK;;AAGN,cAAA,AAAM;MAAa;;AAGhB,cAAA,AAAM;MAAgB;;AAG1B,cAAS,AAA2B,oBAAhB,eAAG,AAAM,oBAAK;MAAE;;;UArBjC;YAChB,AAAK,IAAD;AACX,uEAAgB,IAAI;AACvB,WAAO;IACT;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAoDa;;;;;;MAGC;;;;;;MAGH;;;;;;MAGA;;;;;;;;;;;;;;;;;kBAGuB;AAChC,cAAO,wDAAsC;MAC/C;;;UA3BgB;UACT;UACA;UACA;UACC;UACA;UACA;UACA;MAPQ;MACT;MACA;MACA;YAKK,AAAM,KAAD;YACL,AAAc,aAAD;YACb,AAAiB,gBAAD;AAXtB,mDAKE,GAAG,QACH,IAAI,aACJ,2BACA,aAAa;;IAGgB;;;;;;;;;;;;;;;;;;;;;;;;;IAgFxB;;;;;;;;;;;;;;UAGa;AACxB,WAAO,kCAA4B,OAAO;AACtB,0BAA+B,wBAAG,OAAO;AAC7D,YAAO,gDACK,kDACK,aAAa,qBACT,cACZ,+CACK,gDACK,aAAa,SACrB,wDACO,sCACL;IAIf;;;QAjEQ;QACqB;QACA;QACb;QACA;;IADA;UAEJ,AAAiB,gBAAD;IACG,kCAcpB,CAbD,gBAAgB,GACb,qBAAqB,GACrB,4CAOU,qBAAqB,SACf,6CACO,8BAXV,mBAaT;IACgB,oCAQtB,CAPD,gBAAgB,GACb,uBAAuB,GACvB,4CACU,uBAAuB,SACjB,6CACO,8BALV,mBAOT;IACY,gCAOlB,CAND,gBAAgB,GACb,qBAAqB,GACrB,4CACU,qBAAqB,SACf,+BAJH,+BAMsB;AAtChD,kEACQ,GAAG;;EAqC4C;;;;;;;;;;;;;;;;;;IAwE1C;;;;;;;;;;;;;;UAGa;AACxB,WAAO,kCAA4B,OAAO;AACtB,0BAA+B,wBAAG,OAAO;AAC7D,YAAO,gDACK,kDACK,aAAa,qBACT,cACZ,+CACK,iCACH;IAGb;;;QA1CQ;QACqB;QACA;QACb;QACA;;IADA;IAEQ,2BAAE,AAMnB,4CALQ,qBAAqB,SACf,6CAGO,AAAgB,yDAC/B;IACoB,oCAQtB,CAPD,gBAAgB,GACb,uBAAuB,GACvB,4CACU,uBAAuB,SACjB,6CACO,8BALV,mBAOT;AArBjB,8EACQ,GAAG;;EAoBwB;;;;;;;;;;;;;;;;;;;;;MA8CtB;;;;;;MAEW;;;;;;MAE8B;;;;;;;;;;;;;;AAGC;MAAuC;;;UAftF;UACQ;UACA;UACA;;MAFA;MACA;MACA;YACJ,AAAgB,eAAD;YACf,AAAkB,iBAAD;YACjB,AAAM,KAAD;AAPX,mEACE,GAAG;;IAMe;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAeW;;MAAW;wBAAX;;MAAW;;;AAI7B,QAAX;AAK0B,QAJhC,0BAAc,8DAA4C,QAA5C;AACV,iCAAU;AACV,kCAAW;AACX,+BAAQ;AACR,kCAAW;;;MACjB;;AAIuB,QAArB,AAAY;AACG,QAAT;MACR;yBAEuC;AACrC,aAAO;AACP,cAAO,AAAuB;AACqB,QAAnD,+BAAyB,AAAwB;MACnD;0BAEyC;AACvC,aAAO;AACP,cAAO,AAAuB;AACoE,QAA5E,AAAE,eAAxB,yCAAmC,wBAAsC,AAAE,eAAtB,AAAQ,OAAD,iBAA6B,AAAE,eAAd,AAAQ;MACvF;uBAEmC;AACjC,aAAO;AACP,cAAO,AAAuB;AAC+E,QAAvF,AAAE,eAAxB,sCAAgC,wBAAkB,AAAQ,AAAS,AAAgB,AAAG,OAA7B,+BAA2C,AAAE,eAAd,AAAQ;AACnE,QAA7B,+BAAyB;MAC3B;;;AAGE,aAAO;AAG6B,aAApC;4BAAwB,WAAQ;AACH,QAA7B,+BAAyB;MAC3B;2BAEyC;AACvC,YAAI,AAAsB;AACK,UAA7B,AAAY,6BAAW,KAAK;;MAEhC;0BAEgC;AAC9B,gBAAuB,wBAAG;;;AAEtB,oBAAO,EAAC,KAAK;;;;AAEb,oBAAO,MAAK;;;MAElB;YAG0B;AACxB,aAAO,kCAA4B,OAAO;AAGnC,4BAA+B,AAAY,wBAAT,OAAO,MAAmB,uBACjC,AAAY,AAAQ,0BAAjB,OAAO,iBACV,AAAY,AAAQ,0BAAjB,OAAO;AACU,QAAtD,gBAAgB,sBAAI,aAAa;AACjC,cAAO,2BACS,sCACI,yBAChB,AAAO,mBACP,4CACS,YACA,aAAa,OACf,aACG,YACD,iDACU,qCACW;MAKpC;;;;;;MAvFoC;+DAEC;;;IAsFvC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;iBA+ByB;;AACI,aAAzB;QAAW,WAAA,AAAM,WAAG,KAAK;MAC3B;cAIoB;AAON;AACD;AAKX,YAAI,AAAS,AAAM,QAAP;AACoB,UAA9B,iBAAiB,AAAS,QAAD,IAAI;;AAEU,UAAvC,iBAAiB,AAAW,AAAM,wBAAE;;AAGtC,YAAI,cAAc;AAIN,gDAAkC,mBACgC,AAAE,eAA5E,mBAAsD,GAAG,AAAW;AAG6C,UAAnH,AAAW,0BAAU,gBAAe,qCAAuB,+BAA+B,WAAU,cAAc;;AAGnG,UAAf,AAAU;AAGV,cAAI,AAAW;AAEH,+CAAyG,AAAE,eAA5E,cAAW,QAA8C,AAAW;AACK,YAAlH,AAAW,4BAAY,gBAAe,qCAAuB,4BAA4B,WAAU,cAAc;;;AAIrH,YAAI,AAAW;AAIgB;;;;;;;;;;;AAI5B,UAHD,8BAA0B,QAAiB;AACX,YAA9B,AAAU;AAC8C,YAAxD,AAAW,qCAAqB;;AAEmB,UAArD,AAAW,kCAAkB;;AAEC,UAA9B,AAAU;;MAEd;;;UAvEgB;UACA;MADA;MACA;YACJ,AAAU,SAAD;YACT,AAAW,UAAD;AACW,MAA/B,AAAU;IACZ;;;;;;;;;;;;;;;;;;;;;;;IAgGmB;;;;;;;;;gBAoBe,GACA,GACzB;;AAEP,YAAO,AAAE,CAAD;AACR,UAAI,AAAE,CAAD,YAAY,AAAE,CAAD;AAChB,cAAO;;AAET,UAAI,AAAE,CAAD;AACH,cAAQ,AAAE,AAAQ,gBAAX,CAAC,qBAAoB,CAAC,GAAkC,6CAAW,AAAE,AAAyD,eAApE,AAAE,CAAD,2BAAqB,QAAO,SAAoC,eAApB,cAAK,MAAM,KAAK,EAAE,CAAC;;AAEnI,UAAI,AAAE,CAAD;AACH,cAAO,AAAE,AAAQ,EAAT,oBAAmB,CAAC,GAAkC,6CAAW,AAAE,AAA+D,eAA1E,AAAE,CAAD,2BAAqB,QAAO,SAA0C,eAA1B,cAAK,MAAM,KAAK,EAAE,AAAI,MAAE,CAAC;;AAExI,YAAO,AAAE,AAAgB,CAAjB,qBAAoB,AAAE,CAAD;AAG7B,YAAO,AAAE,AAAQ,AAA6B,CAAtC,qBAAoB,AAAE,AAAQ,CAAT,qBAA6B,AAAE,AAAO,eAAlB,AAAE,CAAD,wBAA6B,AAAE,eAAX,AAAE,CAAD;AACvE,YAAsC,8CAC7B;;AACL,iBAAS,IAAI,GAAG,AAAE,CAAD,GAAY,AAAE,eAAX,AAAE,CAAD,qBAAkB,IAAA,AAAE,CAAD,GAAI;AACC,iCAArC,oBAAK,AAAE,CAAD,wBAAC,OAAQ,UAAC,CAAC,WAAG,AAAE,CAAD,yBAAC,OAAQ,WAAC,CAAC,IAAG,CAAC;;;IAGlD;aAGoD,GAAU;AAC5D,UAAM,yCAAF,CAAC;AACH,cAAsD,gBAAhB,2CAAK,CAAC,EAAE,MAAM,CAAC;;AAEvD,YAAyD,gBAAnB,2CAAK,MAAM,MAAM,CAAC;IAC1D;WAGkD,GAAU;AAC1D,UAAM,yCAAF,CAAC;AACH,cAAsD,gBAAhB,2CAAK,MAAM,CAAC,EAAE,CAAC;;AAEvD,YAAyD,gBAAnB,2CAAK,MAAM,MAAM,CAAC;IAC1D;qBAG6D;AAC3D,YAAO,4CAA4B,MAAM,SAAS;IACpD;YAGwB;;AACtB,WAAI,AAAM,KAAD,uBAAgB;AACvB,cAAO;;AAET,YAAa,AACT,0CADG,KAAK,KACS,YAAd,AAAM,KAAD,WAAY;IAC1B;;AAGoB,YAAQ,eAAR;IAAgB;wBAGiB;AACd,MAA/B,0BAAoB,UAAU;AACsB,MAA1D,AAAW,UAAD,KAAK,uCAAwB,UAAU;IACnD;;;IA1G6C;AAAvC;;EAAgD;;;;;;;;;;;;;;;;;;;MAE/B,4CAAM;YAAG;;;;;;;;;UAuHd,QAAe,QAA2B;;AACvC,mBAAS,AAAY;AACxC,UAAI,AAAO,MAAD;AACR;;AA2BW,wBAAc,AAAK,OAAoB,AAAE,eAApB,AAAc,aAAD;AAClC,yBAAiC,AAAE,eAApB,AAAc,aAAD;AAC5B,sBAAY,AAAY,WAAD,IAAI,AAAO,AAAO,MAAR,YAAU;AAEnC,0BAAgB,AAAc,aAAD;AAClD,YAAO,AAAc,aAAD;AACP;AACA;AACb,cAAqB,eAAb,aAAa;;;AAE4B,YAA7C,QAAQ,AAAO,AAAG,MAAJ,MAAwB,AAAE,eAApB,AAAc,aAAD;AACd,YAAnB,kBAAkB;AAClB;;;;AAEiB,YAAjB,QAAQ,AAAO,MAAD;AACM,YAApB,kBAAkB;AAClB;;;AAGA,2BAAiB;AACrB,eAAS,KAAK,GAAG,AAAG,EAAD,GAAG,WAAW,EAAE,KAAA,AAAG,EAAD,GAAI;AACvC,YAAO,CAAH,EAAE,GAAI,SAAS,mBAAI,cAAc;AAChB,UAAnB,iBAAA,AAAe,cAAD,GAAI;;AAER,0CAAQ;AAChB,qBAAoG,eAAtF,cAAK,AAAM,MAAA,QAAC,cAAc,GAAG,AAAM,MAAA,QAAC,AAAe,cAAD,GAAG,IAAK,AAAG,AAAa,EAAd,UAAG,SAAS,IAAI,SAAS;;;AAC1F,gBAAI,AAAM,KAAD,GAAG,AAAgB,eAAD,GAAG,EAAE;AAC+B,QAA5E,AAAO,MAAD,UAAe,qBAAS,AAAE,CAAD,GAAG,KAAK,AAAO,MAAD,KAAK,KAAK,YAAY,GAAG,KAAK;;IAE/E;;qDApEO,aACS;IADT;UAEI,AAAY,WAAD;UACX,AAAY,AAAQ,AAAQ,WAAjB,qBAAuC,AAAE,AAAO,eAA5B,AAAY,WAAD,sBAAmB;AACpE,gEAAM,QAAQ;;EAAC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA8HC;;;;;;MAOP;;;;;;MAGA;;;;;;MAgBC;;;;;;;;;;;;;;;;;;;AAbiB;4BAAuB;MAAI;;;AAGzB;4BAAyB;MAAK;;AAG5B;MAA8B;;;AAI9C;;MAAY;yBAAZ;;MAAY;;AAO7B,cAAO,AAAW;AAQjB,QAPD,mBAAa,4CACG,gCAIA,6CACO,AAAgB;AAKtC,QAHD,qBAAe,2DAED;AAEd,cAAiB,gBAAV;MACT;gBAG8B,SAA2B,WAA6B;AACpF,cAAO,4DACiC,iEAC/B,yEACQ,yBACN,gCAAiB;MAG9B;uBAGqC,SAA2B,WAA6B,oBAA2B;AACtH,cAAO,iCACgB,yCACd,kDACQ,AAAa,4BAAmB,eAAV,2BAC5B,KAAK;MAGlB;;;UAvFgB;UACT;UACA;UACA;UACC;UACA;UACA;UACD;MAgBD;MAEA;MAiBa;sDAEA;MA5CH;MACT;MACA;MAKA;AARP,iEAMQ,MAAM,YACN,QAAQ;AAG0B,MAAxC,4BAAsB,kBAAkB;AACI,MAA5C,8BAAwB,oBAAoB;IAC9C;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;UAyTyB;UACD;UAChB;UACC;UACC;UAEF;UACA;UACA;UACA;YACI,AAAmB,kBAAD;AAC1B,kEACe,SAAc,SAA2B,WAA6B,uBAC1E,AAAO,OAAA,CAAC,OAAO,sFAEG,KAAb,YAAY,EAAZ,aAAuC,AAAY,wCAAT,OAAO,iDACpC,MAAb,YAAY,EAAZ,cAAsC,qCAAQ,oCAA6B,OAAO,8BAd9F,kBAAkB,sBAIlB,kBAAkB,qBAClB,iBAAiB,YACjB,QAAQ,eACR,WAAW;;IAQd;;;;;;;;;;QA1LiB;QACC;QACV;QACP;QACD;QACA;QACC;QACS;QACP;AAER,UAAO,AAAiB,gBAAD;AACvB,UAAiB,AAA6C,wBAA1C,OAAO,kBAAiB,gBAAgB,WAC1D,wDACW,OAAO,UACR,MAAM,gBACsB,qCAAQ,YAAY,EAAE,OAAO,uBAC7C,kBAAkB,wBAChB,oBAAoB,YAChC,aAAa,eACV,WAAW;EAG9B;sFAQqD,SAA2B,WAA6B,oBAA2B;AAChH,wBAAgB,4CAC5B,SAAS,SACH;AAEhB,QAAI,AAAU,AAAO,SAAR,YAA2B;AACtC,YAAO,8CACI,aAAa,SACf,KAAK;;AAGhB,UAAO,8CACI,aAAa,SACf,4CACE,AAAU,SAAD,oBAAO,kCAChB,KAAK;EAGlB;;QA2DwB;QACC;QACf;QACH;QACA;QACU;QACP;AAER,UAAO,AAAQ,OAAD;AACd,UAAO,AAAiB,gBAAD;AAEvB,UAAiB,AAA6C,wBAA1C,OAAO,kBAAiB,gBAAgB,WAAU,oDAC3D,OAAO,WACP,OAAO,sBACI,kBAAkB,gBACxB,YAAY,gBACU,qCAAQ,oCAA6B,OAAO,aACtE,aAAa,eACV,WAAW;EAE5B;;MA1wCa,yBAAkB;;;MAClB,yBAAkB;;;MAIrB,gDAAyC;;;MAIzC,iCAA0B;;;MAaxB,4CAAqC;;;MAKrC,kCAA2B;;;MAMxB,qCAA8B;;;MAGpB,yBAAkB;YAAG,4DAEhC;;MAIW,wBAAiB;YAAG,sCAC7B;;MAKS,sBAAe;YAAG,4DAE7B;;MAonCW,wBAAiB;YAAG,AAC1C,sCAD+D,UAAU,YACnE,iCAAyB","file":"../../../../../../../../../../packages/flutter/src/cupertino/route.dart.lib.js"}');
  // Exports:
  return {
