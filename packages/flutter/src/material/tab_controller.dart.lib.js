define(['dart_sdk', 'packages/flutter/src/material/constants.dart', 'packages/flutter/src/animation/animation_controller.dart', 'packages/flutter/src/animation/curves.dart', 'packages/flutter/src/foundation/change_notifier.dart', 'packages/flutter/src/animation/listener_helpers.dart', 'packages/flutter/src/widgets/title.dart'], (function load__packages__flutter__src__material__tab_controller_dart(dart_sdk, packages__flutter__src__material__constants$46dart, packages__flutter__src__animation__animation_controller$46dart, packages__flutter__src__animation__curves$46dart, packages__flutter__src__foundation__change_notifier$46dart, packages__flutter__src__animation__listener_helpers$46dart, packages__flutter__src__widgets__title$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 275,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/material/tab_controller.dart"
      });
    },
    get C2() {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/material/tab_controller.dart",
  ...
  tab_controller.TabController = class TabController extends change_notifier.ChangeNotifier {
    ...
    set offset(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 257, 12, "value != null");
      if (!(value >= -1.0 && value <= 1.0)) dart.assertFailed(null, I[0], 258, 12, "value >= -1.0 && value <= 1.0");
      if (!!this.indexIsChanging) dart.assertFailed(null, I[0], 259, 12, "!indexIsChanging");
  ...
  (tab_controller._TabControllerScope.new = function(opts) {
    ...
    tab_controller._TabControllerScope.__proto__.new.call(this, {child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  (tab_controller.DefaultTabController.new = function(opts) {
    ...
    if (!(initialIndex !== null)) dart.assertFailed(null, I[0], 349, 15, "initialIndex != null");
    if (!(length >= 0)) dart.assertFailed(null, I[0], 350, 15, "length >= 0");
    if (!(length === 0 || initialIndex >= 0 && initialIndex < length)) dart.assertFailed(null, I[0], 351, 15, "length == 0 || (initialIndex >= 0 && initialIndex < length)");
  ...
  tab_controller._DefaultTabControllerState = class _DefaultTabControllerState extends State_SingleTickerProviderStateMixin$36 {
    ...
    set [_controller](library$32package$58flutter$47src$47material$47tab_controller$46dart$58$58_controller$35param) {
      this[___DefaultTabControllerState__controller] = library$32package$58flutter$47src$47material$47tab_controller$46dart$58$58_controller$35param;
    }
    initState() {
      super.initState();
