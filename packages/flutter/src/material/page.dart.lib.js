define(['dart_sdk', 'packages/flutter/src/widgets/title.dart', 'packages/flutter/src/cupertino/route.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/material/icon_button.dart', 'packages/flutter/src/animation/listener_helpers.dart'], (function load__packages__flutter__src__material__page_dart(dart_sdk, packages__flutter__src__widgets__title$46dart, packages__flutter__src__cupertino__route$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__material__icon_button$46dart, packages__flutter__src__animation__listener_helpers$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        ...
        [_Location_column]: 12,
        [_Location_line]: 120,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/material/page.dart"
      });
    }
  }, false);
  var C = Array(2).fill(void 0);
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/material/page.dart",
  ...
  page$.MaterialPageRoute$ = dart.generic(T => {
    ...
    (MaterialPageRoute.new = function(opts) {
      ...
      if (!this.opaque) dart.assertFailed(null, I[0], 45, 12, "opaque");
  ...
  page$.MaterialPage$ = dart.generic(T => {
    ...
    (MaterialPage.new = function(opts) {
      ...
      if (!(child !== null)) dart.assertFailed(null, I[0], 164, 15, "child != null");
      if (!(maintainState !== null)) dart.assertFailed(null, I[0], 165, 15, "maintainState != null");
      if (!(fullscreenDialog !== null)) dart.assertFailed(null, I[0], 166, 15, "fullscreenDialog != null");
  ...
  page$._PageBasedMaterialPageRoute$ = dart.generic(T => {
    ...
    (_PageBasedMaterialPageRoute.new = function(opts) {
      let page = opts && 'page' in opts ? opts.page : null;
      if (!(page !== null)) dart.assertFailed(null, I[0], 190, 15, "page != null");
      _PageBasedMaterialPageRoute.__proto__.new.call(this, {settings: page});
      if (!this.opaque) dart.assertFailed(null, I[0], 192, 12, "opaque");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["page.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAwFqC;MAAiC;;AAGzC;MAAI;;AAGH;MAAI;sBAGc;AAE5C,cAAkB,AAChB,uCADM,SAAS,MAAqC,AAAU,SAAD,qBAC/C,uCAAV,SAAS,MAAsC,AAAU,SAAD;MAChE;gBAIe,SACK,WACA;AAEL,qBAAS,kBAAa,OAAO;AAC1C,aAAO,AAQN;AAPC,cAAI,AAAO,MAAD;AAIP,YAHD,WAAM,4BAAY,AAChB,sCAA0B,AAAS,sBAAK,wBACxC;;AAGJ,gBAAO;;AAET,cAAO,uCACQ,0BACO,aACb,MAAM;MAEjB;uBAGqC,SAA2B,WAA6B,oBAA2B;AAC3F,oBAAc,AAAY,gBAAT,OAAO;AACnD,cAAO,AAAM,MAAD,qBAAqB,MAAM,OAAO,EAAE,SAAS,EAAE,kBAAkB,EAAE,KAAK;MACtF;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAlFoB;;;;;;MAMT;;;;;;;;;;;;;mBAHsB;;AAAY,aAAQ,OAAO;cAAf,AAAO;MAAS;;AAMpC,cAAS,AAA8B,oBAAnB,eAAG,AAAS,sBAAK;MAAE;;;UApBhD;UACR;UACD;UACC;MAHQ;MAET;YAEK,AAAQ,OAAD;YACP,AAAc,aAAD;YACb,AAAiB,gBAAD;AAP5B,4DAEQ,QAAQ,oBAER,gBAAgB;AAItB,WAAO;IACT;;;;;;;;;;;;;;;;;;;;;;;;;MA2Ha;;;;;;MAGF;;;;;;MAGA;;;;;;;;;;;;;;;;kBAGuB;AAChC,cAAO,uDAAqC;MAC9C;;;UAvBgB;UACT;UACA;UACC;UACA;UACA;UACA;MANQ;MACT;MACA;YAKK,AAAM,KAAD;YACL,AAAc,aAAD;YACb,AAAiB,gBAAD;AAVtB,kDAIE,GAAG,QACH,IAAI,aACJ,2BACA,aAAa;;IAGgB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA6BR,cAAS,0BAAT;MAA2B;mBAGvB;AAC/B,cAAO,AAAM;MACf;;AAG0B,cAAA,AAAM;MAAa;;AAGhB,cAAA,AAAM;MAAgB;;AAG1B,cAAS,AAA2B,oBAAhB,eAAG,AAAM,oBAAK;MAAE;;;UApBlC;YACf,AAAK,IAAD;AACX,sEAAgB,IAAI;AACvB,WAAO;IACT","file":"../../../../../../../../../../packages/flutter/src/material/page.dart.lib.js"}');
  // Exports:
  return {
