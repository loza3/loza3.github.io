define(['dart_sdk', 'packages/flutter/src/widgets/title.dart'], (function load__packages__flutter__src__material__tooltip_visibility_dart(dart_sdk, packages__flutter__src__widgets__title$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 8,
        [_Location_file]: "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/material/tooltip_visibility.dart"
      });
    },
    get C1() {
  ...
  tooltip_visibility._TooltipVisibilityScope = class _TooltipVisibilityScope extends framework.InheritedWidget {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new tooltip_visibility._TooltipVisibilityScope.new({child: child, visible: visible, $creationLocationd_0dea112b090073317d4: C[0] || CT.C0});
    }
  ...
  (tooltip_visibility._TooltipVisibilityScope.new = function(opts) {
    ...
    tooltip_visibility._TooltipVisibilityScope.__proto__.new.call(this, {child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["tooltip_visibility.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAYa;;;;;;;;;;;uBAGqC;;AAC9C,YAAO,AAAI,AAAQ,IAAT,aAAY;IACxB;;;QATiB;QACD;;;AAFV,gFACW,KAAK;;EAEpB;;;;;;;;;;;;;;;IAgCW;;;;;;IAGF;;;;;;;;;;;;cAIiB;;AACK,uBAAa,AAAQ,OAAD;AACnD,kBAAO,UAAU,eAAV,OAAY;YAAZ,eAAuB;IAChC;UAG0B;AACxB,YAAO,8DACI,qBACF;IAEX;;;QA7BQ;QACQ;QACA;;IADA;IACA;AAHV,wEACE,GAAG;;EAGT","file":"../../../../../../../../../../packages/flutter/src/material/tooltip_visibility.dart.lib.js"}');
  // Exports:
  return {
