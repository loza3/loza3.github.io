define(['dart_sdk'], (function load__packages__flutter__src__foundation__collections_dart(dart_sdk) {
  ...
  var I = ["file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/foundation/collections.dart"];
  ...
  collections._merge = function _merge(T, compare, firstList, firstStart, firstEnd, secondList, secondStart, secondEnd, target, targetOffset) {
    ...
    if (!(firstStart < firstEnd)) dart.assertFailed(null, I[0], 337, 10, "firstStart < firstEnd");
    if (!(secondStart < secondEnd)) dart.assertFailed(null, I[0], 338, 10, "secondStart < secondEnd");
