define(['dart_sdk'], (function load__packages__flutter__src__foundation__synchronous_future_dart(dart_sdk) {
      ...
      whenComplete(action) {
        try {
          ...
          if (async.Future.is(result)) {
            return result.then(T, dart.fn(value => this[_value$], __t$dynamicToT()));
          }
          return this;
        } catch (e$) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["synchronous_future.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;AA6B8B,yBAAa;AACjB,QAAtB,AAAW,UAAD,KAAK;AACG,QAAlB,AAAW,UAAD;AACV,cAAO,AAAW,WAAD;MACnB;iBAG8B;YAAwC;AAAW,cAAA,AAAe;MAAM;cAGtD;YAAqB;AACrD,qBAAS,AAAO,OAAA,CAAC;AAC/B,YAAW,oBAAP,MAAM;AACR,gBAAO,OAAM;;AAEf,cAAO,oDAA4B,KAAP,MAAM;MACpC;cAG2B;YAAqC;;AAC9D,cAAO,AAAwB,uBAAR,uBAAgB,SAAS,cAAa,SAAS;MACxE;mBAGoD;AAClD;AAC0B,uBAAS,AAAM,MAAA;AACvC,cAAW,gBAAP,MAAM;AACR,kBAAO,AAAO,OAAD,SAAS,QAAS,SAAU;;AAE3C,gBAAO;;cACA;cAAG;AAAV;AACA,kBAAO,uBAAgB,CAAC,EAAE,KAAK;;;;MAEnC;;;MAxCuB;;IAAO","file":"../../../../../../../../../../packages/flutter/src/foundation/synchronous_future.dart.lib.js"}');
  // Exports:
  return {
