define(['dart_sdk'], (function load__packages__flutter__src__foundation___platform_web_dart(dart_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C[0] = dart.constList([C[1] || CT.C1, C[2] || CT.C2, C[3] || CT.C3, C[4] || CT.C4, C[5] || CT.C5, C[6] || CT.C6], platform.TargetPlatform);
    }
  }, false);
  var C = Array(7).fill(void 0);
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/foundation/_platform_web.dart",
  ...
  dart.defineLazy(platform.TargetPlatform, {
    /*platform.TargetPlatform.values*/get values() {
      return C[0] || CT.C0;
    },
    /*platform.TargetPlatform.android*/get android() {
      return C[1] || CT.C1;
    },
    /*platform.TargetPlatform.fuchsia*/get fuchsia() {
      return C[2] || CT.C2;
    },
    /*platform.TargetPlatform.iOS*/get iOS() {
      return C[3] || CT.C3;
    },
    /*platform.TargetPlatform.linux*/get linux() {
      return C[4] || CT.C4;
    },
    /*platform.TargetPlatform.macOS*/get macOS() {
      return C[5] || CT.C5;
    },
    /*platform.TargetPlatform.windows*/get windows() {
      return C[6] || CT.C6;
    }
  }, false);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["_platform_web.dart","platform.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAgBE,aAAmD,kDAAnC,aACZ;YAD+C,eAE/C;IACN;;;MAE+B,2BAAa;YAAG,AAW9C;AAV0B;AACzB,aAAO,AAON;AAJC,cAAO;AACmC,YAAxC,SAAiC;;AAEnC,gBAAO;;AAET,cAAO,OAAM;;;MASe,8BAAgB;YAAG,AAyBhD;;AAxBc,iCAAkE,YAAzC,AAAO,AAAU,+CAAA,OAAU,qBAAV,cAA2B;AAClF,YAAI,AAAkB,iBAAD,cAAY;AAC/B,gBAA+B;;AAEjC,YAAI,AAAkB,iBAAD,cAAY;AAC/B,gBAA+B;;AAEjC,YAAI,AAAkB,iBAAD,YAAU,aAC3B,AAAkB,iBAAD,YAAU,WAC3B,AAAkB,iBAAD,YAAU;AAC7B,gBAA+B;;AAEjC,YAAI,AAAkB,iBAAD,YAAU;AAC7B,gBAA+B;;AAOjC,YAAS,AAAO,AAA8C,yBAAnC;AACzB,gBAA+B;;AAEjC,cAA+B;;;;;;;;;;ICHjC;;;;;;;;;;;;MAlBK,8BAAM;;;MAET,+BAAO;;;MAGP,+BAAO;;;MAGP,2BAAG;;;MAGH,6BAAK;;;MAGL,6BAAK;;;MAGL,+BAAO;;;;;;AAtBmC,YAAS;IAAqB;;;MA4C1D,2CAAkC","file":"../../../../../../../../../../packages/flutter/src/foundation/_platform_web.dart.lib.js"}');
  // Exports:
  return {
