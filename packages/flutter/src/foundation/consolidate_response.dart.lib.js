define(['dart_sdk'], (function load__packages__flutter__src__foundation__consolidate_response_dart(dart_sdk) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/foundation/consolidate_response.dart",
  ...
  consolidate_response._OutputBuffer = class _OutputBuffer extends convert.ByteConversionSinkBase {
    add(chunk) {
      ...
      if (!(this[_bytes] == null)) dart.assertFailed(null, I[0], 109, 12, "_bytes == null");
    ...
    get bytes() {
      if (!(this[_bytes] != null)) dart.assertFailed(null, I[0], 130, 12, "_bytes != null");
  ...
  consolidate_response.consolidateHttpClientResponseBytes = function consolidateHttpClientResponseBytes(response, opts) {
    ...
    if (!(autoUncompress !== null)) dart.assertFailed(null, I[0], 54, 10, "autoUncompress != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["consolidate_response.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;QA2GqB;;AACjB,YAAO,AAAO;AACK,MAAZ,AAAE,eAAT,qBAAa,KAAK;AACY,MAA9B,uBAAA,AAAe,uBAAG,AAAM,KAAD;IACzB;;AAIE,UAAI;AAEF;;AAEgC,MAAlC,eAAS,uCAAU;AACf,mBAAS;AACb,eAAqB,QAAgB,gBAAP;AAC0B,QAAhD,AAAE,eAAR,yBAAiB,MAAM,EAAE,AAAO,MAAD,GAAG,AAAM,KAAD,WAAS,KAAK;AAC/B,QAAtB,SAAA,AAAO,MAAD,GAAI,AAAM,KAAD;;AAEH,MAAd,gBAAU;IACZ;;AAGE,YAAO,AAAO;AACd,YAAa,gBAAN;IACT;;;;;;IA7BiB,gBAAqB;IAClC,uBAAiB;IACV;;;EA4Bb;;;;;;;;;;;;;;;;;;;;;wGAnFqB;QACd;QACkB;AAEvB,UAAO,AAAe,cAAD;AACM,oBAAY;AAEnB,iBAAS;AACV,eAAO,MAAM;AAC3B,gCAAwB,AAAS,QAAD;AACrC,QAAI,AAAsB,qBAAD,KAAI,CAAC;AACA,MAA5B,wBAAwB;;AAE1B,YAAQ,AAAS,QAAD;;;AAEZ,cAAI,cAAc;AAEkC,YAAlD,OAAO,AAAK,AAAQ,uCAAuB,MAAM;;AAEnD;;;;AAI4B,UAA5B,wBAAwB;AACxB;;;;AAGA;;;AAGA,wBAAgB;AACqB;;;;;;;;;;;;;;AAgBgB,IAfzD,mBAAe,AAAS,QAAD,QAAQ,QAAW;AACzB,MAAf,AAAK,IAAD,KAAK,KAAK;AACd,UAAI,eAAe;AACY,QAA7B,gBAAA,AAAc,aAAD,GAAI,AAAM,KAAD;AACtB;AACuD,UAArD,AAAe,eAAA,CAAC,aAAa,EAAE,qBAAqB;;cAC7C;cAAO;AAAd;AAC0C,YAA1C,AAAU,SAAD,eAAe,KAAK,EAAE,UAAU;AACpB,YAArB,AAAa;AACb;;;;;sCAGK;AACG,QAAZ,AAAK,IAAD;AAC4B,QAAhC,AAAU,SAAD,UAAU,AAAO,MAAD;mCACL,UAAV,SAAS,mCAA+B;AAEpD,UAAO,AAAU,UAAD;EAClB","file":"../../../../../../../../../../packages/flutter/src/foundation/consolidate_response.dart.lib.js"}');
  // Exports:
  return {
