define(['dart_sdk'], (function load__packages__flutter__src__foundation__node_dart(dart_sdk) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/packages/flutter/lib/src/foundation/node.dart",
  ...
  node.AbstractNode = class AbstractNode extends core.Object {
    ...
    adoptChild(child) {
      ...
      if (!dart.fn(() => {
        ...
        if (!!node[$_equals](child)) dart.assertFailed(null, I[0], 134, 14, "node != child");
        return true;
    ...
    dropChild(child) {
      node.AbstractNode.as(child);
      if (!(child !== null)) dart.assertFailed(null, I[0], 150, 12, "child != null");
      if (!dart.equals(child[_parent], this)) dart.assertFailed(null, I[0], 151, 12, "child._parent == this");
      if (!(child.attached === this.attached)) dart.assertFailed(null, I[0], 152, 12, "child.attached == attached");
      child[_parent] = null;
      if (this.attached) {
        child.detach();
      }
