define(['dart_sdk'], (function load__packages__my_ticket_care__src__shared__models__workday_dart(dart_sdk) {
  'use strict';
  ...
  var I = ["package:my_ticket_care/src/shared/models/workday.dart"];
  ...
  workday.Workday = class Workday extends core.Object {
    ...
    get dateString() {
      return dart.str(this.date.day) + "/" + dart.str(this.date.month) + "/" + dart.str(this.date.year);
    }
    ...
    static empty() {
      return new workday.Workday.new({workdayId: -1, date: new core.DateTime.now(), day: workday.Days.lunes, isHoliday: false, isWorkday: false, detailDay: "Null", officeId: -1});
    }
    static ['_#empty#tearOff']() {
      return workday.Workday.empty();
    }
  };
  ...
  dart.setStaticMethodSignature(workday.Workday, () => ['fromMap', 'fromJson', 'empty']);
  dart.setGetterSignature(workday.Workday, () => ({
    __proto__: dart.getGetters(workday.Workday.__proto__),
    dateString: core.String
  }));
  ...
  dart.trackLibraries("packages/my_ticket_care/src/shared/models/workday.dart", {
    "package:my_ticket_care/src/shared/models/workday.dart": workday
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["workday.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAEuE;;;;;;;;;;;;MAAlE,mBAAM;;;MAAC,kBAAK;;;MAAE,mBAAM;;;MAAE,sBAAS;;;MAAE,mBAAM;;;MAAE,oBAAO;;;MAAE,mBAAM;;;MAAE,oBAAO;;;;;;;;;;;;IAGhE;;;;;;IACK;;;;;;IACJ;;;;;;IACA;;;;;;IACA;;;;;;IACE;;;;;;IACH;;;;;;;AAGF,YAA+C,UAArC,AAAK,iBAAI,eAAG,AAAK,mBAAM,eAAG,AAAK;IAC3C;;;;;;;;;;;mBAY6C;;AAC3C,YAAO,iDACM,AAAG,GAAA,QAAC,qBACA,mCAAM,AAAG,GAAA,QAAC,gBACf,AAAM,uCAAC,AAAG,GAAA,QAAC,mCACO,KAAjB,AAAG,GAAA,QAAC,cAAD,aAAiB,uCACH,MAAjB,AAAG,GAAA,QAAC,cAAD,cAAiB,0CACH,OAAjB,AAAG,GAAA,QAAC,cAAD,eAAiB,mCACrB,AAAG,GAAA,QAAC;IAElB;;;;oBAEgC;AAC5B,YAAQ,oDAAQ,AAAK,oBAAO,MAAM;IAAE;;;;;AAGtC,YAAO,qCACM,CAAC,SACG,8BACL,+BACC,kBACA,kBACA,kBACD,CAAC;IAEf;;;;;;QAlCgB;QACA;QACA;QACA;QACA;QACA;QACA;IANA;IACA;IACA;IACA;IACA;IACA;IACA;;EACd","file":"../../../../../../../../../../../packages/my_ticket_care/src/shared/models/workday.dart.lib.js"}');
  // Exports:
  return {
    src__shared__models__workday: workday
  };
}));
