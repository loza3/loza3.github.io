define(['dart_sdk', 'packages/archive/src/util/archive_exception.dart', 'packages/archive/src/util/crc32.dart', 'packages/archive/src/zlib/inflate.dart', 'packages/archive/src/util/input_stream.dart'], (function load__packages__archive__src__zip__zip_file_dart(dart_sdk, packages__archive__src__util__archive_exception$46dart, packages__archive__src__util__crc32$46dart, packages__archive__src__zlib__inflate$46dart, packages__archive__src__util__input_stream$46dart) {
  ...
  (zip_file_header.ZipFileHeader.new = function(input = null, bytes = null, password = null) {
    ...
    if (input != null) {
      ...
      if (extraLen > 0) {
        ...
        if (id === 1) {
          if (size >= 8 && this.uncompressedSize === 4294967295) {
            this.uncompressedSize = extra.readUint64();
            size = size - 8;
          }
          if (size >= 8 && this.compressedSize === 4294967295) {
            this.compressedSize = extra.readUint64();
            size = size - 8;
          }
          if (size >= 8 && this.localHeaderOffset === 4294967295) {
            this.localHeaderOffset = extra.readUint64();
            size = size - 8;
          }
          if (size >= 4 && this.diskNumberStart === 65535) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["zip_file.dart","zip_file_header.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAaM;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACC;;;;;;IACA;;;;;;IACA;;;;;;IACE;;;;;;IACG;;;;;;IACK;;;;;;;;;;AAsDuB,MAArB,+BAAf,uBAAmB,eAAS,gBAAb;AACf,YAAO,AAAe,yBAAG;IAC3B;;AAKE,UAAI,AAAS;AACX,YAAI;AACF,cAAI,AAAY,AAAO,4BAAG;AACY,YAApC,iBAAW,AAAY;AACH,YAApB,qBAAe;;AAE6B,YAA5C,oBAAc,wBAAkB;AACZ,YAApB,qBAAe;;;AAInB,YAAI,AAAkB;AAC+C,UAAnE,iBAAmB,AAAsC,2BAA/B,mBAAa;AACd,UAAzB;;AAEoC,UAApC,iBAAW,AAAY;;;AAI3B,YAAe,gBAAR;IACT;;AAGE,UAAI;AACF,cAAO;;AAET,YAAO;IACT;;AAGqB;IAAQ;gBAEP;AACA,MAApB,AAAK,mBAAC,GAAK;AACS,MAApB,AAAK,mBAAC,GAAK;AACS,MAApB,AAAK,mBAAC,GAAK;AACX,eAAW,IAAK,AAAS,SAAD;AACR,QAAd,kBAAY,CAAC;;IAEjB;kBAEqB;;AACU,MAA7B,AAAK,mBAAC,GAAK,YAAM,AAAK,mBAAC,IAAI,CAAC;AACD,WAA3B;WAAM;MAAD,cAAA,AAAI,iBAAG,AAAK,AAAI,mBAAH,KAAK;AACY,MAAnC,AAAK,mBAAC,GAAK,AAAK,AAAI,AAAY,mBAAf,KAAK,YAAY;AACQ,MAA1C,AAAK,mBAAC,GAAK,YAAM,AAAK,mBAAC,IAAI,AAAK,AAAI,mBAAH,gBAAM;IACzC;;AAGQ,iBAAQ,AAAK,AAAI,AAAU,mBAAb,KAAK,QAAU;AACnC,YAAS,AAAK,AAAc,AAAM,KAArB,IAAS,CAAL,IAAI,GAAG,aAAO,IAAK;IACtC;kBAEqB;AACA,MAAnB,IAAE,CAAF,CAAC,GAAI;AACS,MAAd,kBAAY,CAAC;IACf;wBAE8C;AAC5C,eAAS,IAAI,GAAG,AAAE,CAAD,GAAG,IAAM,IAAF,AAAE,CAAC,GAAH;AACa,QAAnC,kBAAY,AAAY;;AAEtB,kBAAQ,AAAY;AACxB,eAAS,IAAI,GAAG,AAAE,CAAD,GAAG,AAAM,KAAD,WAAW,IAAF,AAAE,CAAC,GAAH;AAC1B,mBAAgB,CAAT,AAAK,KAAA,QAAC,CAAC,IAAI;AACP,QAAjB,kBAAY,IAAI;AACD,QAAf,AAAK,KAAA,QAAC,CAAC,EAAI,IAAI;;AAEjB,YAAO,kCAAY,KAAK;IAC1B;;;AAIqB;;IAAW;sBAAX;;IAAW;;mCApIN,cAAY,eAAgB;IAblD;IACA,gBAAU;IACV,cAAQ;IACR,0BAAoB;IACpB,wBAAkB;IAClB,wBAAkB;IACjB;IACA;IACA;IACE,iBAAW;IACR,mBAAa;kCAuIF;IACV;IACN;IACA,qBAAe;IACd,cAAa,qBAAC,GAAG,GAAG;IAxIY;AACpC,QAAI,KAAK;AACuB,MAA9B,iBAAY,AAAM,KAAD;AACjB,UAAI;AAC6C,QAA/C,WAAM,2CAAiB;;AAGG,MAA5B,eAAU,AAAM,KAAD;AACW,MAA1B,aAAQ,AAAM,KAAD;AACyB,MAAtC,yBAAoB,AAAM,KAAD;AACW,MAApC,uBAAkB,AAAM,KAAD;AACa,MAApC,uBAAkB,AAAM,KAAD;AACG,MAA1B,aAAQ,AAAM,KAAD;AACsB,MAAnC,sBAAiB,AAAM,KAAD;AACe,MAArC,wBAAmB,AAAM,KAAD;AAClB,kBAAQ,AAAM,KAAD;AACb,kBAAQ,AAAM,KAAD;AACqB,MAAxC,gBAAW,AAAM,KAAD,mBAAkB,KAAK;AACU,MAAjD,kBAAa,AAAM,AAAiB,KAAlB,WAAW,KAAK;AAIoB,MAAtD,oBAAc,AAAM,KAAD,WAAiC,eAAhB,AAAE,eAAR;AAE9B,UAAI,QAAQ;AACS,QAAnB,gBAAU,QAAQ;AACC,QAAnB,qBAAe;;AAQjB,WAAI,AAAM,aAAE,OAAQ;AACZ,uBAAW,AAAM,KAAD;AACtB,YAAI,AAAS,QAAD,KAAI;AACY,UAA1B,aAAQ,AAAM,KAAD;;AAEG,UAAhB,aAAQ,QAAQ;;AAGiB,QAAnC,sBAAiB,AAAM,KAAD;AACe,QAArC,wBAAmB,AAAM,KAAD;;;EAG9B;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAjEiB,sBAAK;;;MACL,wBAAO;;;MACP,sBAAK;;;MAEL,0BAAS;;;;;;;;;;;;;;;;;;;;;;ICNtB;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACC;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACE;;;;;;IACG;;;;;;IACH;;;;;;IACE;;;;;;;;;;AAqFY;IAAQ;;gDAnFG,cAAwB,cACjC;IAnBnB,sBAAgB;IAChB,+BAAyB;IACzB,8BAAwB;IACxB,2BAAoB;IACpB,6BAAuB;IACvB,6BAAuB;IACtB;IACA;IACA;IACA;IACA;IACA;IACA;IACE,kBAAW;IACR,oBAAa;IAChB,oBAAc;IACZ;AAIP,QAAI,KAAK;AAC2B,MAAlC,qBAAgB,AAAM,KAAD;AACsB,MAA3C,8BAAyB,AAAM,KAAD;AACY,MAA1C,6BAAwB,AAAM,KAAD;AACS,MAAtC,yBAAoB,AAAM,KAAD;AACgB,MAAzC,4BAAuB,AAAM,KAAD;AACa,MAAzC,4BAAuB,AAAM,KAAD;AACF,MAA1B,aAAQ,AAAM,KAAD;AACsB,MAAnC,sBAAiB,AAAM,KAAD;AACe,MAArC,wBAAmB,AAAM,KAAD;AAClB,qBAAW,AAAM,KAAD;AAChB,qBAAW,AAAM,KAAD;AAChB,uBAAa,AAAM,KAAD;AACY,MAApC,uBAAkB,AAAM,KAAD;AACoB,MAA3C,8BAAyB,AAAM,KAAD;AACa,MAA3C,8BAAyB,AAAM,KAAD;AACQ,MAAtC,yBAAoB,AAAM,KAAD;AAEzB,UAAI,AAAS,QAAD,GAAG;AAC8B,QAA3C,gBAAW,AAAM,KAAD,mBAAkB,QAAQ;;AAG5C,UAAI,AAAS,QAAD,GAAG;AACP,oBAAQ,AAAM,KAAD,WAAW,QAAQ;AACN,QAAhC,kBAAa,AAAM,KAAD;AAEI,QAAtB,AAAM,KAAD,QAAQ,QAAQ;AAEf,iBAAK,AAAM,KAAD;AACZ,mBAAO,AAAM,KAAD;AAChB,YAAI,AAAG,EAAD,KAAI;AAoBR,cAAI,AAAK,IAAD,IAAI,KAAK,AAAiB,0BAAG;AACE,YAArC,wBAAmB,AAAM,KAAD;AACf,YAAT,OAAA,AAAK,IAAD,GAAI;;AAEV,cAAI,AAAK,IAAD,IAAI,KAAK,AAAe,wBAAG;AACE,YAAnC,sBAAiB,AAAM,KAAD;AACb,YAAT,OAAA,AAAK,IAAD,GAAI;;AAEV,cAAI,AAAK,IAAD,IAAI,KAAK,AAAkB,2BAAG;AACE,YAAtC,yBAAoB,AAAM,KAAD;AAChB,YAAT,OAAA,AAAK,IAAD,GAAI;;AAEV,cAAI,AAAK,IAAD,IAAI,KAAK,AAAgB,yBAAG;AACE,YAApC,uBAAkB,AAAM,KAAD;AACd,YAAT,OAAA,AAAK,IAAD,GAAI;;;;AAKd,UAAI,AAAW,UAAD,GAAG;AACiC,QAAhD,mBAAc,AAAM,KAAD,mBAAkB,UAAU;;AAGjD,UAAI,KAAK;AAC4B,QAAnC,AAAM,KAAD,YAA6B,eAAjB;AACoB,QAArC,YAAO,yBAAQ,KAAK,EAAE,MAAM,QAAQ;;;EAG1C;;;;;;;;;;;;;;;;;;;;;;;;;;;MAnGiB,uCAAS","file":"../../../../../../../../../../../../packages/archive/src/zip/zip_file.dart.lib.js"}');
  // Exports:
  return {
