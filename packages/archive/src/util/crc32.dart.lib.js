define(['dart_sdk', 'packages/crypto/src/digest.dart', 'packages/crypto/src/hash.dart'], (function load__packages__archive__src__util__crc32_dart(dart_sdk, packages__crypto__src__digest$46dart, packages__crypto__src__hash$46dart) {
  'use strict';
  ...
  var C = [void 0];
  var I = ["package:archive/src/util/crc32.dart"];
  ...
  dart.setLibraryUri(crc32.Crc32, I[0]);
  ...
  dart.setLibraryUri(crc32._Crc32Sink, I[0]);
  ...
  crc32.getCrc32 = function getCrc32(array, crc = 0) {
    ...
    let ip = 0;
    while (len >= 8) {
      crc = (crc32._crc32Table[$_get]((crc ^ array[$_get]((t0 = ip, ip = t0 + 1, t0))) & 255) ^ crc[$rightShift](8)) >>> 0;
      crc = (crc32._crc32Table[$_get]((crc ^ array[$_get]((t0$ = ip, ip = t0$ + 1, t0$))) & 255) ^ crc[$rightShift](8)) >>> 0;
      crc = (crc32._crc32Table[$_get]((crc ^ array[$_get]((t0$0 = ip, ip = t0$0 + 1, t0$0))) & 255) ^ crc[$rightShift](8)) >>> 0;
      crc = (crc32._crc32Table[$_get]((crc ^ array[$_get]((t0$1 = ip, ip = t0$1 + 1, t0$1))) & 255) ^ crc[$rightShift](8)) >>> 0;
      crc = (crc32._crc32Table[$_get]((crc ^ array[$_get]((t0$2 = ip, ip = t0$2 + 1, t0$2))) & 255) ^ crc[$rightShift](8)) >>> 0;
      crc = (crc32._crc32Table[$_get]((crc ^ array[$_get]((t0$3 = ip, ip = t0$3 + 1, t0$3))) & 255) ^ crc[$rightShift](8)) >>> 0;
      crc = (crc32._crc32Table[$_get]((crc ^ array[$_get]((t0$4 = ip, ip = t0$4 + 1, t0$4))) & 255) ^ crc[$rightShift](8)) >>> 0;
      crc = (crc32._crc32Table[$_get]((crc ^ array[$_get]((t0$5 = ip, ip = t0$5 + 1, t0$5))) & 255) ^ crc[$rightShift](8)) >>> 0;
      len = len - 8;
    }
    if (len > 0) {
      do {
        crc = (crc32._crc32Table[$_get]((crc ^ array[$_get]((t0$6 = ip, ip = t0$6 + 1, t0$6))) & 255) ^ crc[$rightShift](8)) >>> 0;
      } while ((len = len - 1) > 0);
    }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["crc32.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAoCkB;IAAK;;AAGA;IAAC;;;;;AAIC;IAAO;2BAGgC;;AAC1D,sCAAW,IAAI;IAAC;QAED;AACY,MAA7B,cAAQ,eAAS,IAAI,EAAE;IACzB;;AAGE,YAAO,sBACH,AAAM,AAAO,yBAAJ,MAAM,KACf,AAAM,AAAO,eAAJ,KAAM,KACf,AAAM,AAAM,eAAH,IAAK,KACf,AAAM,cAAE;IAEb;;;IA3BI,cAAQ;AAQZ;;EAAO;;;;;;;;;;;;;;;;;;;;;;;;;;QAkCY;;AACjB,UAAI,iBAAW,AAAoD,WAA9C,wBAAW;AACH,MAA7B,cAAQ,eAAS,IAAI,EAAE;IACzB;;AAIE,UAAI,iBAAW;AACC,MAAhB,kBAAY;AAOT,MALH,AAAO,kBAAW,sBAAO,qBACrB,AAAM,AAAO,yBAAJ,MAAM,KACf,AAAM,AAAO,eAAJ,KAAM,KACf,AAAM,AAAM,eAAH,IAAK,KACf,AAAM,cAAE;IAEb;;mCAnBgB;IALZ,cAAQ;IAGR,kBAAY;IAEA;AAAhB;;EAAuB;;;;;;;;;;;;;;;+BApEX,KAAS;AAAM,UAA8B,EAA9B,AAAW,yBAAW,CAAT,AAAI,GAAD,GAAG,CAAC,IAAI,OAAS,AAAI,GAAD,cAAI;EAAE;qCAIhD,OAAY;;AAC7B,cAAM,AAAM,KAAD;AACO,IAAtB,MAAU,CAAJ,GAAG,GAAG;AACR,aAAK;AACT,WAAO,AAAI,GAAD,IAAI;AAC8C,MAA1D,MAA8C,CAAxC,AAAW,yBAAqB,CAAnB,AAAI,GAAD,GAAG,AAAK,KAAA,SAAG,KAAF,EAAE,uBAAO,OAAS,AAAI,GAAD,cAAI;AACE,MAA1D,MAA8C,CAAxC,AAAW,yBAAqB,CAAnB,AAAI,GAAD,GAAG,AAAK,KAAA,SAAG,MAAF,EAAE,yBAAO,OAAS,AAAI,GAAD,cAAI;AACE,MAA1D,MAA8C,CAAxC,AAAW,yBAAqB,CAAnB,AAAI,GAAD,GAAG,AAAK,KAAA,SAAG,OAAF,EAAE,2BAAO,OAAS,AAAI,GAAD,cAAI;AACE,MAA1D,MAA8C,CAAxC,AAAW,yBAAqB,CAAnB,AAAI,GAAD,GAAG,AAAK,KAAA,SAAG,OAAF,EAAE,2BAAO,OAAS,AAAI,GAAD,cAAI;AACE,MAA1D,MAA8C,CAAxC,AAAW,yBAAqB,CAAnB,AAAI,GAAD,GAAG,AAAK,KAAA,SAAG,OAAF,EAAE,2BAAO,OAAS,AAAI,GAAD,cAAI;AACE,MAA1D,MAA8C,CAAxC,AAAW,yBAAqB,CAAnB,AAAI,GAAD,GAAG,AAAK,KAAA,SAAG,OAAF,EAAE,2BAAO,OAAS,AAAI,GAAD,cAAI;AACE,MAA1D,MAA8C,CAAxC,AAAW,yBAAqB,CAAnB,AAAI,GAAD,GAAG,AAAK,KAAA,SAAG,OAAF,EAAE,2BAAO,OAAS,AAAI,GAAD,cAAI;AACE,MAA1D,MAA8C,CAAxC,AAAW,yBAAqB,CAAnB,AAAI,GAAD,GAAG,AAAK,KAAA,SAAG,OAAF,EAAE,2BAAO,OAAS,AAAI,GAAD,cAAI;AAChD,MAAR,MAAA,AAAI,GAAD,GAAI;;AAET,QAAI,AAAI,GAAD,GAAG;AACR;AAC4D,QAA1D,MAA8C,CAAxC,AAAW,yBAAqB,CAAnB,AAAI,GAAD,GAAG,AAAK,KAAA,SAAG,OAAF,EAAE,2BAAO,OAAS,AAAI,GAAD,cAAI;eAC3C,CAAJ,MAAF,AAAE,GAAG,GAAL,KAAQ;;AAEnB,UAAW,EAAJ,GAAG,GAAG;EACf;;MAkEgB,iBAAW","file":"../../../../../../../../../../../../packages/archive/src/util/crc32.dart.lib.js"}');
  // Exports:
  return {
