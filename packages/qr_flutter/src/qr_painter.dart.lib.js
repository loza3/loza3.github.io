define(['dart_sdk', 'packages/qr_flutter/src/types.dart', 'packages/qr_flutter/src/paint_cache.dart', 'packages/qr_flutter/src/qr_versions.dart', 'packages/qr_flutter/src/errors.dart', 'packages/qr_flutter/src/validator.dart', 'packages/flutter/src/painting/alignment.dart', 'packages/flutter/src/rendering/custom_paint.dart', 'packages/qr/src/qr_code.dart'], (function load__packages__qr_flutter__src__qr_painter_dart(dart_sdk, packages__qr_flutter__src__types$46dart, packages__qr_flutter__src__paint_cache$46dart, packages__qr_flutter__src__qr_versions$46dart, packages__qr_flutter__src__errors$46dart, packages__qr_flutter__src__validator$46dart, packages__flutter__src__painting__alignment$46dart, packages__flutter__src__rendering__custom_paint$46dart, packages__qr__src__qr_code$46dart) {
  ...
  var I = [
    "file:///home/loza/CosasInstaladasManualmente/flutter_linux_3.0.2-stable/flutter/.pub-cache/hosted/pub.dartlang.org/qr_flutter-4.0.0/lib/src/qr_painter.dart",
  ...
  qr_painter.QrPainter = class QrPainter extends custom_paint.CustomPainter {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new qr_painter.QrPainter.new({data: data, version: version, errorCorrectionLevel: errorCorrectionLevel, color: color, emptyColor: emptyColor, gapless: gapless, embeddedImage: embeddedImage, embeddedImageStyle: embeddedImageStyle, eyeStyle: eyeStyle, dataModuleStyle: dataModuleStyle});
    }
    static ['_#withQr#tearOff'](opts) {
      ...
      let eyeStyle = opts && 'eyeStyle' in opts ? opts.eyeStyle : C[0] || CT.C0;
      let dataModuleStyle = opts && 'dataModuleStyle' in opts ? opts.dataModuleStyle : C[3] || CT.C3;
      return new qr_painter.QrPainter.withQr({qr: qr, color: color, emptyColor: emptyColor, gapless: gapless, embeddedImage: embeddedImage, embeddedImageStyle: embeddedImageStyle, eyeStyle: eyeStyle, dataModuleStyle: dataModuleStyle});
    }
    get [_calcVersion]() {
      let t0;
    ...
    set [_calcVersion](library$32package$58qr_flutter$47src$47qr_painter$46dart$58$58_calcVersion$35param) {
      if (this[__QrPainter__calcVersion] == null)
        this[__QrPainter__calcVersion] = library$32package$58qr_flutter$47src$47qr_painter$46dart$58$58_calcVersion$35param;
      else
    ...
    [_drawImageOverlay](canvas, position, size, style) {
      ...
      if (style != null) {
        if (style.color != null) {
          paint.colorFilter = new _engine.CkBlendModeColorFilter.new(dart.nullCheck(style.color), ui.BlendMode.srcATop);
        }
      }
  ...
  qr_painter._PaintMetrics = class _PaintMetrics extends core.Object {
    static ['_#new#tearOff'](opts) {
      ...
      return new qr_painter._PaintMetrics.new({containerSize: containerSize, gapSize: gapSize, moduleCount: moduleCount});
    }
    get [_pixelSize]() {
      let t0;
      t0 = this[___PaintMetrics__pixelSize];
      return t0 == null ? dart.throw(new _internal.LateError.fieldNI("_pixelSize")) : t0;
    }
    set [_pixelSize](library$32package$58qr_flutter$47src$47qr_painter$46dart$58$58_pixelSize$35param) {
      if (this[___PaintMetrics__pixelSize] == null)
        this[___PaintMetrics__pixelSize] = library$32package$58qr_flutter$47src$47qr_painter$46dart$58$58_pixelSize$35param;
      else
    ...
    get [_innerContentSize]() {
      let t0;
      t0 = this[___PaintMetrics__innerContentSize];
      return t0 == null ? dart.throw(new _internal.LateError.fieldNI("_innerContentSize")) : t0;
    }
    set [_innerContentSize](library$32package$58qr_flutter$47src$47qr_painter$46dart$58$58_innerContentSize$35param) {
      if (this[___PaintMetrics__innerContentSize] == null)
        this[___PaintMetrics__innerContentSize] = library$32package$58qr_flutter$47src$47qr_painter$46dart$58$58_innerContentSize$35param;
      else
    ...
    get [_inset]() {
      let t0;
      t0 = this[___PaintMetrics__inset];
      return t0 == null ? dart.throw(new _internal.LateError.fieldNI("_inset")) : t0;
    }
    set [_inset](library$32package$58qr_flutter$47src$47qr_painter$46dart$58$58_inset$35param) {
      if (this[___PaintMetrics__inset] == null)
        this[___PaintMetrics__inset] = library$32package$58qr_flutter$47src$47qr_painter$46dart$58$58_inset$35param;
      else
